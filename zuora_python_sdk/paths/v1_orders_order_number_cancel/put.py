...
from zuora_python_sdk.model.put_order_cancel_request import PutOrderCancelRequest as PutOrderCancelRequestSchema
from zuora_python_sdk.model.put_order_cancel_response import PutOrderCancelResponse as PutOrderCancelResponseSchema

from zuora_python_sdk.type.put_order_cancel_response import PutOrderCancelResponse
from zuora_python_sdk.type.put_order_cancel_request import PutOrderCancelRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_order_cancel_request import PutOrderCancelRequest as PutOrderCancelRequestPydantic
from zuora_python_sdk.pydantic.put_order_cancel_response import PutOrderCancelResponse as PutOrderCancelResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutOrderCancelRequestSchema


request_body_put_order_cancel_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PutOrderCancelResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _order_cancel_mapped_args(
        ...
        if cancel_reason is not None:
            _body["cancelReason"] = cancel_reason
        args.body = _body
    ...
    async def _aorder_cancel_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/{orderNumber}/cancel',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_put_order_cancel_request.serialize(body, content_type)
...
class OrderCancelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_cancel(
        self,
        order_number: str,
        cancel_reason: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_cancel_mapped_args(
        ...
        return await self._aorder_cancel_oapg(
            body=args.body,
    ...
    def order_cancel(
        ...
        return self._order_cancel_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class OrderCancel(BaseApi):
    ...
    async def aorder_cancel(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PutOrderCancelResponsePydantic:
        raw_response = await self.raw.aorder_cancel(
            order_number=order_number,
            cancel_reason=cancel_reason,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[PutOrderCancelResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PutOrderCancelResponsePydantic, raw_response.body)
    ...
    def order_cancel(
        ...
        raw_response = self.raw.order_cancel(
            order_number=order_number,
            cancel_reason=cancel_reason,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
