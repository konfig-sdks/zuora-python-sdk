...
from zuora_python_sdk.model.get_product_rate_plan_with_external_id_response import GETProductRatePlanWithExternalIdResponse as GETProductRatePlanWithExternalIdResponseSchema

from zuora_python_sdk.type.get_product_rate_plan_with_external_id_response import GETProductRatePlanWithExternalIdResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plan_with_external_id_response import GETProductRatePlanWithExternalIdResponse as GETProductRatePlanWithExternalIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlanWithExternalIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlanWithExternalIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _product_rate_plan_mapped_args(
        self,
        id: str,
    ...
    async def _aproduct_rate_plan_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/product-rate-plans/{id}',
            headers=_headers,
        )
...
class ProductRatePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproduct_rate_plan(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._product_rate_plan_mapped_args(
            id=id,
        ...
        return await self._aproduct_rate_plan_oapg(
    ...
    def product_rate_plan(
        ...
        return self._product_rate_plan_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ProductRatePlan(BaseApi):
    ...
    async def aproduct_rate_plan(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlanWithExternalIdResponsePydantic:
        raw_response = await self.raw.aproduct_rate_plan(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETProductRatePlanWithExternalIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductRatePlanWithExternalIdResponsePydantic, raw_response.body)
    ...
    def product_rate_plan(
        ...
        raw_response = self.raw.product_rate_plan(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
