...
from zuora_python_sdk.model.get_workflow_export404_response import GetWorkflowExport404Response as GetWorkflowExport404ResponseSchema
from zuora_python_sdk.model.export_workflow_version_response import ExportWorkflowVersionResponse as ExportWorkflowVersionResponseSchema
from zuora_python_sdk.model.get_workflow_export_response import GetWorkflowExportResponse as GetWorkflowExportResponseSchema

from zuora_python_sdk.type.export_workflow_version_response import ExportWorkflowVersionResponse
from zuora_python_sdk.type.get_workflow_export404_response import GetWorkflowExport404Response
from zuora_python_sdk.type.get_workflow_export_response import GetWorkflowExportResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_workflow_export_response import GetWorkflowExportResponse as GetWorkflowExportResponsePydantic
from zuora_python_sdk.pydantic.export_workflow_version_response import ExportWorkflowVersionResponse as ExportWorkflowVersionResponsePydantic
from zuora_python_sdk.pydantic.get_workflow_export404_response import GetWorkflowExport404Response as GetWorkflowExport404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExportWorkflowVersionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ExportWorkflowVersionResponse
...
SchemaFor400ResponseBodyApplicationJson = GetWorkflowExportResponseSchema
...
class ApiResponseFor400(api_client.ApiResponse):
    body: GetWorkflowExportResponse
...
SchemaFor404ResponseBodyApplicationJson = GetWorkflowExport404ResponseSchema
...
class ApiResponseFor404(api_client.ApiResponse):
    body: GetWorkflowExport404Response
...
class BaseApi(api_client.Api):
    ...
    def _workflow_export_mapped_args(
        self,
        authorization: str,
        workflow_id: int,
    ...
    async def _aworkflow_export_oapg(
        self,
...
class WorkflowExportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_export(
        self,
        authorization: str,
        workflow_id: int,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflow_export_mapped_args(
        ...
        return await self._aworkflow_export_oapg(
    ...
    def workflow_export(
        ...
        return self._workflow_export_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class WorkflowExport(BaseApi):
    ...
    async def aworkflow_export(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExportWorkflowVersionResponsePydantic:
        raw_response = await self.raw.aworkflow_export(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return ExportWorkflowVersionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExportWorkflowVersionResponsePydantic, raw_response.body)
    ...
    def workflow_export(
        ...
        raw_response = self.raw.workflow_export(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
