...
from zuora_python_sdk.model.put_delete_subscription_response_type import PUTDeleteSubscriptionResponseType as PUTDeleteSubscriptionResponseTypeSchema

from zuora_python_sdk.type.put_delete_subscription_response_type import PUTDeleteSubscriptionResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_delete_subscription_response_type import PUTDeleteSubscriptionResponseType as PUTDeleteSubscriptionResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = PUTDeleteSubscriptionResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTDeleteSubscriptionResponseType
    ...
    async def _adelete_subscription_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/delete',
            headers=_headers,
        )
...
class DeleteSubscription(BaseApi):
    ...
    async def adelete_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTDeleteSubscriptionResponseTypePydantic:
        ...
        if validate:
            return PUTDeleteSubscriptionResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTDeleteSubscriptionResponseTypePydantic, raw_response.body)
