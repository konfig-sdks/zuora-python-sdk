...
from zuora_python_sdk.model.get_ramp_metrics_by_ramp_number_response_type import GETRampMetricsByRampNumberResponseType as GETRampMetricsByRampNumberResponseTypeSchema

from zuora_python_sdk.type.get_ramp_metrics_by_ramp_number_response_type import GETRampMetricsByRampNumberResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_ramp_metrics_by_ramp_number_response_type import GETRampMetricsByRampNumberResponseType as GETRampMetricsByRampNumberResponseTypePydantic
...
# Path params
RampNumberSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'rampNumber': typing.Union[RampNumberSchema, str, ],
    }
)
...
request_path_ramp_number = api_client.PathParameter(
    name="rampNumber",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RampNumberSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETRampMetricsByRampNumberResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRampMetricsByRampNumberResponseType
...
class BaseApi(api_client.Api):
    ...
    def _ramp_metrics_by_ramp_number_mapped_args(
        self,
        ramp_number: str,
    ...
    async def _aramp_metrics_by_ramp_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/ramps/{rampNumber}/ramp-metrics',
            headers=_headers,
        )
    ...
    def _ramp_metrics_by_ramp_number_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RampMetricsByRampNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aramp_metrics_by_ramp_number(
        self,
        ramp_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._ramp_metrics_by_ramp_number_mapped_args(
        ...
        return await self._aramp_metrics_by_ramp_number_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def ramp_metrics_by_ramp_number(
        self,
        ramp_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._ramp_metrics_by_ramp_number_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RampMetricsByRampNumber(BaseApi):
    ...
    async def aramp_metrics_by_ramp_number(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRampMetricsByRampNumberResponseTypePydantic:
        raw_response = await self.raw.aramp_metrics_by_ramp_number(
            ramp_number=ramp_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETRampMetricsByRampNumberResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRampMetricsByRampNumberResponseTypePydantic, raw_response.body)
    ...
    def ramp_metrics_by_ramp_number(
        ...
        raw_response = self.raw.ramp_metrics_by_ramp_number(
            ramp_number=ramp_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
