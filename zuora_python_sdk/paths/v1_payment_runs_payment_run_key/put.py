...
from zuora_python_sdk.model.put_payment_run_request import PUTPaymentRunRequest as PUTPaymentRunRequestSchema
from zuora_python_sdk.model.put_payment_run_request_organization_labels import PUTPaymentRunRequestOrganizationLabels as PUTPaymentRunRequestOrganizationLabelsSchema

from zuora_python_sdk.type.put_payment_run_request import PUTPaymentRunRequest
from zuora_python_sdk.type.put_payment_run_request_organization_labels import PUTPaymentRunRequestOrganizationLabels
from zuora_python_sdk.type.get_payment_run_type import GETPaymentRunType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_payment_run_request_organization_labels import PUTPaymentRunRequestOrganizationLabels as PUTPaymentRunRequestOrganizationLabelsPydantic
from zuora_python_sdk.pydantic.get_payment_run_type import GETPaymentRunType as GETPaymentRunTypePydantic
from zuora_python_sdk.pydantic.put_payment_run_request import PUTPaymentRunRequest as PUTPaymentRunRequestPydantic
...
# Path params
PaymentRunKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'paymentRunKey': typing.Union[PaymentRunKeySchema, str, ],
    }
)
...
request_path_payment_run_key = api_client.PathParameter(
    name="paymentRunKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PaymentRunKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTPaymentRunRequestSchema


request_body_put_payment_run_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _payment_run_1_mapped_args(
        self,
        payment_run_key: str,
        ...
        organization_labels: typing.Optional[PUTPaymentRunRequestOrganizationLabels] = None,
    ...
    async def _apayment_run_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-runs/{paymentRunKey}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_payment_run_request.serialize(body, content_type)
...
class PaymentRun1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_run_1(
        self,
        payment_run_key: str,
        account_id: typing.Optional[str] = None,
        apply_credit_balance: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._payment_run_1_mapped_args(
        ...
        return await self._apayment_run_1_oapg(
            body=args.body,
    ...
    def payment_run_1(
        ...
        return self._payment_run_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentRun1(BaseApi):
    ...
    async def apayment_run_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_run_1(
            payment_run_key=payment_run_key,
            account_id=account_id,
            apply_credit_balance=apply_credit_balance,
            auto_apply_credit_memo=auto_apply_credit_memo,
    ...
    def payment_run_1(
        ...
        raw_response = self.raw.payment_run_1(
            payment_run_key=payment_run_key,
            account_id=account_id,
            apply_credit_balance=apply_credit_balance,
            auto_apply_credit_memo=auto_apply_credit_memo,
