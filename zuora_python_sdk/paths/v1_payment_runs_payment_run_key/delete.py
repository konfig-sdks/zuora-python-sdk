...
class BaseApi(api_client.Api):
    ...
    def _payment_run_2_mapped_args(
        self,
        payment_run_key: str,
    ...
    async def _apayment_run_2_oapg(
        self,
...
class PaymentRun2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_run_2(
        self,
        payment_run_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_run_2_mapped_args(
        ...
        return await self._apayment_run_2_oapg(
    ...
    def payment_run_2(
        ...
        return self._payment_run_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentRun2(BaseApi):
    ...
    async def apayment_run_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_run_2(
            payment_run_key=payment_run_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def payment_run_2(
        ...
        raw_response = self.raw.payment_run_2(
            payment_run_key=payment_run_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
