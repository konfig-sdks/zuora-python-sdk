...
from zuora_python_sdk.model.put_public_email_template_request import PUTPublicEmailTemplateRequest as PUTPublicEmailTemplateRequestSchema
...
from zuora_python_sdk.type.put_public_email_template_request import PUTPublicEmailTemplateRequest
...
from zuora_python_sdk.pydantic.put_public_email_template_request import PUTPublicEmailTemplateRequest as PUTPublicEmailTemplateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTPublicEmailTemplateRequestSchema


request_body_put_public_email_template_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_email_template_mapped_args(
        self,
        authorization: str,
        id: str,
        ...
        from_email_type: typing.Optional[str] = None,
        ...
        to_email_type: typing.Optional[str] = None,
    ...
    async def _aupdate_email_template_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_public_email_template_request.serialize(body, content_type)
    ...
    def _update_email_template_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateEmailTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_email_template(
        self,
        authorization: str,
        id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_email_template_mapped_args(
        ...
        return await self._aupdate_email_template_oapg(
            body=args.body,
    ...
    def update_email_template(
        ...
        return self._update_email_template_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateEmailTemplate(BaseApi):
    ...
    async def aupdate_email_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_email_template(
            authorization=authorization,
            id=id,
            description=description,
            active=active,
    ...
    def update_email_template(
        ...
        raw_response = self.raw.update_email_template(
            authorization=authorization,
            id=id,
            description=description,
            active=active,
