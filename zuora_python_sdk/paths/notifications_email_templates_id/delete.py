...
class BaseApi(api_client.Api):
    ...
    def _delete_email_template_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _adelete_email_template_oapg(
        self,
    ...
    def _delete_email_template_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteEmailTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_email_template(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_email_template_mapped_args(
        ...
        return await self._adelete_email_template_oapg(
    ...
    def delete_email_template(
        ...
        return self._delete_email_template_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteEmailTemplate(BaseApi):
    ...
    async def adelete_email_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_email_template(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def delete_email_template(
        ...
        raw_response = self.raw.delete_email_template(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
