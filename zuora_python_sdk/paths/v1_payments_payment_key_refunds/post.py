...
from zuora_python_sdk.model.post_refund_type import PostRefundType as PostRefundTypeSchema
from zuora_python_sdk.model.get_refund_payment_type import GETRefundPaymentType as GETRefundPaymentTypeSchema

from zuora_python_sdk.type.payment_with_custom_rates_type import PaymentWithCustomRatesType
from zuora_python_sdk.type.get_refund_payment_type import GETRefundPaymentType
from zuora_python_sdk.type.post_refund_type import PostRefundType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_refund_type import PostRefundType as PostRefundTypePydantic
from zuora_python_sdk.pydantic.get_refund_payment_type import GETRefundPaymentType as GETRefundPaymentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostRefundTypeSchema


request_body_post_refund_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETRefundPaymentTypeSchema
    ...
    async def _arefund_payment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/refunds',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_refund_type.serialize(body, content_type)
...
class RefundPayment(BaseApi):
    ...
    async def arefund_payment(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[GETRefundPaymentTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRefundPaymentTypePydantic, raw_response.body)
