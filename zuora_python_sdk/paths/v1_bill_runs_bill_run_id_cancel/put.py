...
from zuora_python_sdk.model.put_cancel_bill_run_request import PutCancelBillRunRequest as PutCancelBillRunRequestSchema
from zuora_python_sdk.model.cancel_bill_run_response_type import CancelBillRunResponseType as CancelBillRunResponseTypeSchema

from zuora_python_sdk.type.cancel_bill_run_response_type import CancelBillRunResponseType
from zuora_python_sdk.type.put_cancel_bill_run_request import PutCancelBillRunRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.cancel_bill_run_response_type import CancelBillRunResponseType as CancelBillRunResponseTypePydantic
from zuora_python_sdk.pydantic.put_cancel_bill_run_request import PutCancelBillRunRequest as PutCancelBillRunRequestPydantic
...
# Path params
BillRunIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'billRunId': typing.Union[BillRunIdSchema, str, ],
    }
)
...
request_path_bill_run_id = api_client.PathParameter(
    name="billRunId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BillRunIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PutCancelBillRunRequestSchema


request_body_put_cancel_bill_run_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CancelBillRunResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CancelBillRunResponseType
...
class BaseApi(api_client.Api):
    ...
    def _cancel_bill_run_mapped_args(
        self,
        bill_run_id: str,
        cancel_once: typing.Optional[bool] = None,
    ...
    async def _acancel_bill_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bill-runs/{billRunId}/cancel',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_cancel_bill_run_request.serialize(body, content_type)
...
class CancelBillRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_bill_run(
        self,
        bill_run_id: str,
        cancel_once: typing.Optional[bool] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_bill_run_mapped_args(
        ...
        return await self._acancel_bill_run_oapg(
            body=args.body,
    ...
    def cancel_bill_run(
        ...
        return self._cancel_bill_run_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CancelBillRun(BaseApi):
    ...
    async def acancel_bill_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CancelBillRunResponseTypePydantic:
        raw_response = await self.raw.acancel_bill_run(
            bill_run_id=bill_run_id,
            cancel_once=cancel_once,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[CancelBillRunResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(CancelBillRunResponseTypePydantic, raw_response.body)
    ...
    def cancel_bill_run(
        ...
        raw_response = self.raw.cancel_bill_run(
            bill_run_id=bill_run_id,
            cancel_once=cancel_once,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
