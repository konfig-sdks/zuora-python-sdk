...
from zuora_python_sdk.model.put_skip_payment_schedule_item_response import PUTSkipPaymentScheduleItemResponse as PUTSkipPaymentScheduleItemResponseSchema

from zuora_python_sdk.type.put_skip_payment_schedule_item_response import PUTSkipPaymentScheduleItemResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_skip_payment_schedule_item_response import PUTSkipPaymentScheduleItemResponse as PUTSkipPaymentScheduleItemResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PUTSkipPaymentScheduleItemResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTSkipPaymentScheduleItemResponse
...
class BaseApi(api_client.Api):
    ...
    def _skip_payment_schedule_item_mapped_args(
        self,
        item_id: str,
    ...
    async def _askip_payment_schedule_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedule-items/{item-id}/skip',
            headers=_headers,
        )
    ...
    def _skip_payment_schedule_item_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SkipPaymentScheduleItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def askip_payment_schedule_item(
        self,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._skip_payment_schedule_item_mapped_args(
            item_id=item_id,
        ...
        return await self._askip_payment_schedule_item_oapg(
    ...
    def skip_payment_schedule_item(
        ...
        return self._skip_payment_schedule_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SkipPaymentScheduleItem(BaseApi):
    ...
    async def askip_payment_schedule_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTSkipPaymentScheduleItemResponsePydantic:
        raw_response = await self.raw.askip_payment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[PUTSkipPaymentScheduleItemResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PUTSkipPaymentScheduleItemResponsePydantic, raw_response.body)
    ...
    def skip_payment_schedule_item(
        ...
        raw_response = self.raw.skip_payment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
