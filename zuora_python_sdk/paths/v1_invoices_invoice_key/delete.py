...
from zuora_python_sdk.model.delete_invoice_response_type import DeleteInvoiceResponseType as DeleteInvoiceResponseTypeSchema

from zuora_python_sdk.type.delete_invoice_response_type import DeleteInvoiceResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.delete_invoice_response_type import DeleteInvoiceResponseType as DeleteInvoiceResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeleteInvoiceResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteInvoiceResponseType
...
class BaseApi(api_client.Api):
    ...
    def _delete_invoice_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _adelete_invoice_oapg(
        self,
...
class DeleteInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_invoice(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_invoice_mapped_args(
        ...
        return await self._adelete_invoice_oapg(
...
class DeleteInvoice(BaseApi):
    ...
    async def adelete_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteInvoiceResponseTypePydantic:
        raw_response = await self.raw.adelete_invoice(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return DeleteInvoiceResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteInvoiceResponseTypePydantic, raw_response.body)
    ...
    def delete_invoice(
        ...
        raw_response = self.raw.delete_invoice(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
