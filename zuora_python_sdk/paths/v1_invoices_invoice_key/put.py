...
from zuora_python_sdk.model.put_invoice_type import PutInvoiceType as PutInvoiceTypeSchema
from zuora_python_sdk.model.put_invoice_response_type import PutInvoiceResponseType as PutInvoiceResponseTypeSchema
from zuora_python_sdk.model.put_invoice_item_type import PutInvoiceItemType as PutInvoiceItemTypeSchema

from zuora_python_sdk.type.put_invoice_type import PutInvoiceType
from zuora_python_sdk.type.put_invoice_response_type import PutInvoiceResponseType
from zuora_python_sdk.type.put_invoice_item_type import PutInvoiceItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_invoice_item_type import PutInvoiceItemType as PutInvoiceItemTypePydantic
from zuora_python_sdk.pydantic.put_invoice_type import PutInvoiceType as PutInvoiceTypePydantic
from zuora_python_sdk.pydantic.put_invoice_response_type import PutInvoiceResponseType as PutInvoiceResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutInvoiceTypeSchema


request_body_put_invoice_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PutInvoiceResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_invoice_mapped_args(
        self,
        body: PutInvoiceType,
        invoice_key: str,
        ...
        invoice_items: typing.Optional[typing.List[PutInvoiceItemType]] = None,
    ...
    async def _aupdate_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_invoice_type.serialize(body, content_type)
...
class UpdateInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_invoice(
        self,
        body: PutInvoiceType,
        invoice_key: str,
        auto_pay: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_invoice_mapped_args(
            body=body,
        ...
        return await self._aupdate_invoice_oapg(
            body=args.body,
...
class UpdateInvoice(BaseApi):
    ...
    async def aupdate_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PutInvoiceResponseTypePydantic:
        raw_response = await self.raw.aupdate_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_pay=auto_pay,
            comments=comments,
        ...
        if validate:
            return RootModel[PutInvoiceResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(PutInvoiceResponseTypePydantic, raw_response.body)
    ...
    def update_invoice(
        ...
        raw_response = self.raw.update_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_pay=auto_pay,
            comments=comments,
