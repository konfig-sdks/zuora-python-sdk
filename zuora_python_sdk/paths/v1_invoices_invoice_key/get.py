...
class GetInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_invoice(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_invoice_mapped_args(
        ...
        return await self._aget_invoice_oapg(
...
class GetInvoice(BaseApi):
    ...
    async def aget_invoice(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_invoice(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def get_invoice(
        ...
        raw_response = self.raw.get_invoice(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
