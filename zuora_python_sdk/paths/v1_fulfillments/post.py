...
from zuora_python_sdk.model.fulfillment_post import FulfillmentPost as FulfillmentPostSchema
from zuora_python_sdk.model.post_fulfillments_response_type import PostFulfillmentsResponseType as PostFulfillmentsResponseTypeSchema
from zuora_python_sdk.model.processing_options import ProcessingOptions as ProcessingOptionsSchema
from zuora_python_sdk.model.post_fulfillments_request_type import PostFulfillmentsRequestType as PostFulfillmentsRequestTypeSchema

from zuora_python_sdk.type.fulfillment_post import FulfillmentPost
from zuora_python_sdk.type.processing_options import ProcessingOptions
from zuora_python_sdk.type.post_fulfillments_request_type import PostFulfillmentsRequestType
from zuora_python_sdk.type.post_fulfillments_response_type import PostFulfillmentsResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_fulfillments_response_type import PostFulfillmentsResponseType as PostFulfillmentsResponseTypePydantic
from zuora_python_sdk.pydantic.fulfillment_post import FulfillmentPost as FulfillmentPostPydantic
from zuora_python_sdk.pydantic.post_fulfillments_request_type import PostFulfillmentsRequestType as PostFulfillmentsRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostFulfillmentsRequestTypeSchema


request_body_post_fulfillments_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostFulfillmentsResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PostFulfillmentsResponseType
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_mapped_args(
        self,
        fulfillments: typing.Optional[typing.List[FulfillmentPost]] = None,
        ...
        if fulfillments is not None:
            _body["fulfillments"] = fulfillments
    ...
    async def _afulfillment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/fulfillments',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_fulfillments_request_type.serialize(body, content_type)
...
class FulfillmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment(
        self,
        fulfillments: typing.Optional[typing.List[FulfillmentPost]] = None,
        processing_options: typing.Optional[ProcessingOptions] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_mapped_args(
        ...
        return await self._afulfillment_oapg(
            body=args.body,
...
class Fulfillment(BaseApi):
    ...
    async def afulfillment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostFulfillmentsResponseTypePydantic:
        raw_response = await self.raw.afulfillment(
            fulfillments=fulfillments,
            processing_options=processing_options,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[PostFulfillmentsResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(PostFulfillmentsResponseTypePydantic, raw_response.body)
    ...
    def fulfillment(
        ...
        raw_response = self.raw.fulfillment(
            fulfillments=fulfillments,
            processing_options=processing_options,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
