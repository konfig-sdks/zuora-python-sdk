...
from zuora_python_sdk.model.get_usage_rate_detail_wrapper import GETUsageRateDetailWrapper as GETUsageRateDetailWrapperSchema

from zuora_python_sdk.type.get_usage_rate_detail_wrapper import GETUsageRateDetailWrapper

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_usage_rate_detail_wrapper import GETUsageRateDetailWrapper as GETUsageRateDetailWrapperPydantic
...
# Path params
InvoiceItemIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'invoice-item-id': typing.Union[InvoiceItemIdSchema, str, ],
    }
)
...
request_path_invoice_item_id = api_client.PathParameter(
    name="invoice-item-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InvoiceItemIdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETUsageRateDetailWrapperSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETUsageRateDetailWrapper
...
class BaseApi(api_client.Api):
    ...
    def _get_rate_detail_mapped_args(
        self,
        invoice_item_id: str,
    ...
    async def _aget_rate_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/invoice-item/{invoice-item-id}/usage-rate-detail',
            headers=_headers,
        )
...
class GetRateDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rate_detail(
        self,
        invoice_item_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_rate_detail_mapped_args(
        ...
        return await self._aget_rate_detail_oapg(
    ...
    def get_rate_detail(
        ...
        return self._get_rate_detail_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRateDetail(BaseApi):
    ...
    async def aget_rate_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETUsageRateDetailWrapperPydantic:
        raw_response = await self.raw.aget_rate_detail(
            invoice_item_id=invoice_item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETUsageRateDetailWrapperPydantic(**raw_response.body)
        return api_client.construct_model_instance(GETUsageRateDetailWrapperPydantic, raw_response.body)
    ...
    def get_rate_detail(
        ...
        raw_response = self.raw.get_rate_detail(
            invoice_item_id=invoice_item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
