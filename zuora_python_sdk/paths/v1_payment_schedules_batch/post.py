...
from zuora_python_sdk.model.post_payment_schedules_request import POSTPaymentSchedulesRequest as POSTPaymentSchedulesRequestSchema
...
from zuora_python_sdk.model.post_payment_schedules_response import POSTPaymentSchedulesResponse as POSTPaymentSchedulesResponseSchema

from zuora_python_sdk.type.post_payment_schedules_request import POSTPaymentSchedulesRequest
from zuora_python_sdk.type.post_payment_schedule_request import POSTPaymentScheduleRequest
from zuora_python_sdk.type.post_payment_schedules_response import POSTPaymentSchedulesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_payment_schedules_request import POSTPaymentSchedulesRequest as POSTPaymentSchedulesRequestPydantic
from zuora_python_sdk.pydantic.post_payment_schedules_response import POSTPaymentSchedulesResponse as POSTPaymentSchedulesResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPaymentSchedulesRequestSchema


request_body_post_payment_schedules_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTPaymentSchedulesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTPaymentSchedulesResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedules_0_mapped_args(
        self,
        payment_schedules: typing.Optional[typing.List[POSTPaymentScheduleRequest]] = None,
        ...
        if payment_schedules is not None:
            _body["paymentSchedules"] = payment_schedules
        args.body = _body
    ...
    async def _apayment_schedules_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/batch',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_payment_schedules_request.serialize(body, content_type)
...
class PaymentSchedules0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedules_0(
        self,
        payment_schedules: typing.Optional[typing.List[POSTPaymentScheduleRequest]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedules_0_mapped_args(
        ...
        return await self._apayment_schedules_0_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def payment_schedules_0(
        self,
        payment_schedules: typing.Optional[typing.List[POSTPaymentScheduleRequest]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._payment_schedules_0_oapg(
            body=args.body,
            header_params=args.header,
        )

class PaymentSchedules0(BaseApi):
    ...
    async def apayment_schedules_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTPaymentSchedulesResponsePydantic:
        raw_response = await self.raw.apayment_schedules_0(
            payment_schedules=payment_schedules,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTPaymentSchedulesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTPaymentSchedulesResponsePydantic, raw_response.body)
    ...
    def payment_schedules_0(
        ...
        raw_response = self.raw.payment_schedules_0(
            payment_schedules=payment_schedules,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
