...
class BaseApi(api_client.Api):
    ...
    def _expire_stored_credential_profile_mapped_args(
        self,
    ...
    async def _aexpire_stored_credential_profile_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/profiles/{profile-number}/expire',
            headers=_headers,
        )
    ...
    def _expire_stored_credential_profile_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ExpireStoredCredentialProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexpire_stored_credential_profile(
        self,
        payment_method_id: str,
        profile_number: int,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._expire_stored_credential_profile_mapped_args(
        ...
        return await self._aexpire_stored_credential_profile_oapg(
    ...
    def expire_stored_credential_profile(
        ...
        return self._expire_stored_credential_profile_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ExpireStoredCredentialProfile(BaseApi):
    ...
    async def aexpire_stored_credential_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexpire_stored_credential_profile(
            payment_method_id=payment_method_id,
            profile_number=profile_number,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def expire_stored_credential_profile(
        ...
        raw_response = self.raw.expire_stored_credential_profile(
            payment_method_id=payment_method_id,
            profile_number=profile_number,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
