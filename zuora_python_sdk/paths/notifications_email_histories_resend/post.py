...
from zuora_python_sdk.model.resend_email_notifications_failed_response import ResendEmailNotificationsFailedResponse as ResendEmailNotificationsFailedResponseSchema
from zuora_python_sdk.model.post_resend_email_notifications import POSTResendEmailNotifications as POSTResendEmailNotificationsSchema

from zuora_python_sdk.type.resend_email_notifications_failed_response import ResendEmailNotificationsFailedResponse
from zuora_python_sdk.type.post_resend_email_notifications import POSTResendEmailNotifications

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.resend_email_notifications_failed_response import ResendEmailNotificationsFailedResponse as ResendEmailNotificationsFailedResponsePydantic
from zuora_python_sdk.pydantic.post_resend_email_notifications import POSTResendEmailNotifications as POSTResendEmailNotificationsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTResendEmailNotificationsSchema


request_body_post_resend_email_notifications = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = ResendEmailNotificationsFailedResponseSchema
...
class ApiResponseFor202(api_client.ApiResponse):
    body: ResendEmailNotificationsFailedResponse
...
SchemaFor400ResponseBodyApplicationJson = ResendEmailNotificationsFailedResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _resend_email_notifications_mapped_args(
        self,
        body: POSTResendEmailNotifications,
        authorization: str,
    ...
    async def _aresend_email_notifications_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/email-histories/resend',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_resend_email_notifications.serialize(body, content_type)
    ...
    def _resend_email_notifications_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ResendEmailNotificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresend_email_notifications(
        self,
        body: POSTResendEmailNotifications,
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._resend_email_notifications_mapped_args(
            body=body,
        ...
        return await self._aresend_email_notifications_oapg(
            body=args.body,
    ...
    def resend_email_notifications(
        ...
        return self._resend_email_notifications_oapg(
            body=args.body,
            header_params=args.header,
        )

class ResendEmailNotifications(BaseApi):
    ...
    async def aresend_email_notifications(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ResendEmailNotificationsFailedResponsePydantic:
        raw_response = await self.raw.aresend_email_notifications(
            body=body,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return ResendEmailNotificationsFailedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ResendEmailNotificationsFailedResponsePydantic, raw_response.body)
    ...
    def resend_email_notifications(
        ...
        raw_response = self.raw.resend_email_notifications(
            body=body,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
