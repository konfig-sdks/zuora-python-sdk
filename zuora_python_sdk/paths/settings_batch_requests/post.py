...
from zuora_python_sdk.model.settings_batch_request import SettingsBatchRequest as SettingsBatchRequestSchema
from zuora_python_sdk.model.settings_batch_response import SettingsBatchResponse as SettingsBatchResponseSchema
from zuora_python_sdk.model.setting_value_request import SettingValueRequest as SettingValueRequestSchema

from zuora_python_sdk.type.setting_value_request import SettingValueRequest
from zuora_python_sdk.type.settings_batch_response import SettingsBatchResponse
from zuora_python_sdk.type.settings_batch_request import SettingsBatchRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.settings_batch_request import SettingsBatchRequest as SettingsBatchRequestPydantic
from zuora_python_sdk.pydantic.settings_batch_response import SettingsBatchResponse as SettingsBatchResponsePydantic
from zuora_python_sdk.pydantic.setting_value_request import SettingValueRequest as SettingValueRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SettingsBatchRequestSchema


request_body_settings_batch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SettingsBatchResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _process_settings_batch_request_mapped_args(
        self,
        authorization: str,
        requests: typing.Optional[typing.List[SettingValueRequest]] = None,
    ...
    async def _aprocess_settings_batch_request_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_settings_batch_request.serialize(body, content_type)
    ...
    def _process_settings_batch_request_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ProcessSettingsBatchRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocess_settings_batch_request(
        self,
        authorization: str,
        requests: typing.Optional[typing.List[SettingValueRequest]] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._process_settings_batch_request_mapped_args(
        ...
        return await self._aprocess_settings_batch_request_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def process_settings_batch_request(
        self,
        authorization: str,
        requests: typing.Optional[typing.List[SettingValueRequest]] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._process_settings_batch_request_oapg(
            body=args.body,
            header_params=args.header,
        )

class ProcessSettingsBatchRequest(BaseApi):
    ...
    async def aprocess_settings_batch_request(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SettingsBatchResponsePydantic:
        raw_response = await self.raw.aprocess_settings_batch_request(
            authorization=authorization,
            requests=requests,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return SettingsBatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SettingsBatchResponsePydantic, raw_response.body)
    ...
    def process_settings_batch_request(
        ...
        raw_response = self.raw.process_settings_batch_request(
            authorization=authorization,
            requests=requests,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
