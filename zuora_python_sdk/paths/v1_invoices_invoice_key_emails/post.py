...
from zuora_python_sdk.model.post_invoice_email_request_type import PostInvoiceEmailRequestType as PostInvoiceEmailRequestTypeSchema

from zuora_python_sdk.type.post_invoice_email_request_type import PostInvoiceEmailRequestType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_invoice_email_request_type import PostInvoiceEmailRequestType as PostInvoiceEmailRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostInvoiceEmailRequestTypeSchema


request_body_post_invoice_email_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _email_invoice_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _aemail_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/emails',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_invoice_email_request_type.serialize(body, content_type)
...
class EmailInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemail_invoice(
        self,
        invoice_key: str,
        email_addresses: typing.Optional[str] = None,
        include_additional_email_addresses: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._email_invoice_mapped_args(
        ...
        return await self._aemail_invoice_oapg(
            body=args.body,
    ...
    def email_invoice(
        ...
        return self._email_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EmailInvoice(BaseApi):
    ...
    async def aemail_invoice(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemail_invoice(
            invoice_key=invoice_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            use_email_template_setting=use_email_template_setting,
    ...
    def email_invoice(
        ...
        raw_response = self.raw.email_invoice(
            invoice_key=invoice_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            use_email_template_setting=use_email_template_setting,
