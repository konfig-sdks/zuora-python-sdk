...
class BaseApi(api_client.Api):
    ...
    def _reopen_accounting_period_mapped_args(
        self,
        ap_id: str,
    ...
    async def _areopen_accounting_period_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-periods/{ap-id}/reopen',
            headers=_headers,
        )
    ...
    def _reopen_accounting_period_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReopenAccountingPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areopen_accounting_period(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._reopen_accounting_period_mapped_args(
            ap_id=ap_id,
        ...
        return await self._areopen_accounting_period_oapg(
    ...
    def reopen_accounting_period(
        ...
        return self._reopen_accounting_period_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ReopenAccountingPeriod(BaseApi):
    ...
    async def areopen_accounting_period(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areopen_accounting_period(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def reopen_accounting_period(
        ...
        raw_response = self.raw.reopen_accounting_period(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
