...
from zuora_python_sdk.model.bulk_debit_memos_response_type import BulkDebitMemosResponseType as BulkDebitMemosResponseTypeSchema
...
from zuora_python_sdk.model.post_bulk_debit_memos_request_type import POSTBulkDebitMemosRequestType as POSTBulkDebitMemosRequestTypeSchema

from zuora_python_sdk.type.debit_memo_from_charge_request import DebitMemoFromChargeRequest
from zuora_python_sdk.type.bulk_debit_memos_response_type import BulkDebitMemosResponseType
from zuora_python_sdk.type.post_bulk_debit_memos_request_type import POSTBulkDebitMemosRequestType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_bulk_debit_memos_request_type import POSTBulkDebitMemosRequestType as POSTBulkDebitMemosRequestTypePydantic
...
from zuora_python_sdk.pydantic.bulk_debit_memos_response_type import BulkDebitMemosResponseType as BulkDebitMemosResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTBulkDebitMemosRequestTypeSchema


request_body_post_bulk_debit_memos_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkDebitMemosResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BulkDebitMemosResponseType
...
class BaseApi(api_client.Api):
    ...
    def _create_debit_memos_mapped_args(
        self,
        body: typing.Optional[POSTBulkDebitMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[DebitMemoFromChargeRequest]] = None,
    ...
    async def _acreate_debit_memos_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/bulk',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_bulk_debit_memos_request_type.serialize(body, content_type)
...
class CreateDebitMemosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_debit_memos(
        self,
        body: typing.Optional[POSTBulkDebitMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[DebitMemoFromChargeRequest]] = None,
        ...
        **kwargs,
        ...
        args = self._create_debit_memos_mapped_args(
            body=body,
        ...
        return await self._acreate_debit_memos_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_debit_memos(
        self,
        body: typing.Optional[POSTBulkDebitMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[DebitMemoFromChargeRequest]] = None,
        ...
        return self._create_debit_memos_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateDebitMemos(BaseApi):
    ...
    async def acreate_debit_memos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BulkDebitMemosResponseTypePydantic:
        raw_response = await self.raw.acreate_debit_memos(
            body=body,
            source_type=source_type,
            memos=memos,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return RootModel[BulkDebitMemosResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(BulkDebitMemosResponseTypePydantic, raw_response.body)
    ...
    def create_debit_memos(
        ...
        raw_response = self.raw.create_debit_memos(
            body=body,
            source_type=source_type,
            memos=memos,
            idempotency_key=idempotency_key,
