...
from zuora_python_sdk.model.put_bulk_debit_memos_request_type import PUTBulkDebitMemosRequestType as PUTBulkDebitMemosRequestTypeSchema
from zuora_python_sdk.model.put_debit_memo_with_id_type import PUTDebitMemoWithIdType as PUTDebitMemoWithIdTypeSchema

from zuora_python_sdk.type.put_bulk_debit_memos_request_type import PUTBulkDebitMemosRequestType
from zuora_python_sdk.type.put_debit_memo_with_id_type import PUTDebitMemoWithIdType
from zuora_python_sdk.type.bulk_debit_memos_response_type import BulkDebitMemosResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_debit_memo_with_id_type import PUTDebitMemoWithIdType as PUTDebitMemoWithIdTypePydantic
from zuora_python_sdk.pydantic.put_bulk_debit_memos_request_type import PUTBulkDebitMemosRequestType as PUTBulkDebitMemosRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTBulkDebitMemosRequestTypeSchema


request_body_put_bulk_debit_memos_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_debit_memos_mapped_args(
        self,
        memos: typing.Optional[typing.List[PUTDebitMemoWithIdType]] = None,
    ...
    async def _aupdate_debit_memos_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_bulk_debit_memos_request_type.serialize(body, content_type)
...
class UpdateDebitMemosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_debit_memos(
        self,
        memos: typing.Optional[typing.List[PUTDebitMemoWithIdType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_debit_memos_mapped_args(
            body=body,
            memos=memos,
        ...
        return await self._aupdate_debit_memos_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def update_debit_memos(
        self,
        memos: typing.Optional[typing.List[PUTDebitMemoWithIdType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._update_debit_memos_oapg(
            body=args.body,
            header_params=args.header,
        )

class UpdateDebitMemos(BaseApi):
    ...
    async def aupdate_debit_memos(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_debit_memos(
            body=body,
            memos=memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def update_debit_memos(
        ...
        raw_response = self.raw.update_debit_memos(
            body=body,
            memos=memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
