...
from zuora_python_sdk.model.create_stored_credential_profile_request import CreateStoredCredentialProfileRequest as CreateStoredCredentialProfileRequestSchema
from zuora_python_sdk.model.modified_stored_credential_profile_response import ModifiedStoredCredentialProfileResponse as ModifiedStoredCredentialProfileResponseSchema

from zuora_python_sdk.type.modified_stored_credential_profile_response import ModifiedStoredCredentialProfileResponse
from zuora_python_sdk.type.create_stored_credential_profile_request import CreateStoredCredentialProfileRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.modified_stored_credential_profile_response import ModifiedStoredCredentialProfileResponse as ModifiedStoredCredentialProfileResponsePydantic
from zuora_python_sdk.pydantic.create_stored_credential_profile_request import CreateStoredCredentialProfileRequest as CreateStoredCredentialProfileRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateStoredCredentialProfileRequestSchema


request_body_create_stored_credential_profile_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ModifiedStoredCredentialProfileResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ModifiedStoredCredentialProfileResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_stored_credential_profile_mapped_args(
        self,
        ...
        agreed_on: typing.Optional[date] = None,
        auth_gateway: typing.Optional[str] = None,
        card_security_code: typing.Optional[str] = None,
        consent_agreement_ref: typing.Optional[str] = None,
        network_transaction_id: typing.Optional[str] = None,
        ...
        if agreed_on is not None:
            _body["agreedOn"] = agreed_on
        if auth_gateway is not None:
            _body["authGateway"] = auth_gateway
        if card_security_code is not None:
            _body["cardSecurityCode"] = card_security_code
        if consent_agreement_ref is not None:
            _body["consentAgreementRef"] = consent_agreement_ref
        if consent_agreement_src is not None:
            _body["consentAgreementSrc"] = consent_agreement_src
        if network_transaction_id is not None:
            _body["networkTransactionId"] = network_transaction_id
    ...
    async def _acreate_stored_credential_profile_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/profiles',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_stored_credential_profile_request.serialize(body, content_type)
    ...
    def _create_stored_credential_profile_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateStoredCredentialProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_stored_credential_profile(
        self,
        consent_agreement_src: str,
        status: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._create_stored_credential_profile_mapped_args(
            consent_agreement_src=consent_agreement_src,
            status=status,
            type=type,
            ...
            consent_agreement_ref=consent_agreement_ref,
        ...
        return await self._acreate_stored_credential_profile_oapg(
            body=args.body,
    ...
    def create_stored_credential_profile(
        ...
        return self._create_stored_credential_profile_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateStoredCredentialProfile(BaseApi):
    ...
    async def acreate_stored_credential_profile(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ModifiedStoredCredentialProfileResponsePydantic:
        raw_response = await self.raw.acreate_stored_credential_profile(
            consent_agreement_src=consent_agreement_src,
            status=status,
            type=type,
            payment_method_id=payment_method_id,
        ...
        if validate:
            return ModifiedStoredCredentialProfileResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ModifiedStoredCredentialProfileResponsePydantic, raw_response.body)
    ...
    def create_stored_credential_profile(
        ...
        raw_response = self.raw.create_stored_credential_profile(
            consent_agreement_src=consent_agreement_src,
            status=status,
            type=type,
            payment_method_id=payment_method_id,
