...
from zuora_python_sdk.model.get_stored_credential_profiles_response import GetStoredCredentialProfilesResponse as GetStoredCredentialProfilesResponseSchema

from zuora_python_sdk.type.get_stored_credential_profiles_response import GetStoredCredentialProfilesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_stored_credential_profiles_response import GetStoredCredentialProfilesResponse as GetStoredCredentialProfilesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetStoredCredentialProfilesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetStoredCredentialProfilesResponse
...
class BaseApi(api_client.Api):
    ...
    def _stored_credential_profiles_mapped_args(
        self,
    ...
    async def _astored_credential_profiles_oapg(
        self,
    ...
    def _stored_credential_profiles_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class StoredCredentialProfilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astored_credential_profiles(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._stored_credential_profiles_mapped_args(
        ...
        return await self._astored_credential_profiles_oapg(
    ...
    def stored_credential_profiles(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._stored_credential_profiles_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class StoredCredentialProfiles(BaseApi):
    ...
    async def astored_credential_profiles(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetStoredCredentialProfilesResponsePydantic:
        raw_response = await self.raw.astored_credential_profiles(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetStoredCredentialProfilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetStoredCredentialProfilesResponsePydantic, raw_response.body)
    ...
    def stored_credential_profiles(
        ...
        raw_response = self.raw.stored_credential_profiles(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
