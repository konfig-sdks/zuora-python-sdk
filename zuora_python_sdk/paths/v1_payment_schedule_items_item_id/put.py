...
from zuora_python_sdk.model.put_payment_schedule_item_request import PUTPaymentScheduleItemRequest as PUTPaymentScheduleItemRequestSchema
from zuora_python_sdk.model.put_payment_schedule_item_response import PUTPaymentScheduleItemResponse as PUTPaymentScheduleItemResponseSchema

from zuora_python_sdk.type.put_payment_schedule_item_request import PUTPaymentScheduleItemRequest
from zuora_python_sdk.type.payment_schedule_payment_option_fields import PaymentSchedulePaymentOptionFields
from zuora_python_sdk.type.put_payment_schedule_item_response import PUTPaymentScheduleItemResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_payment_schedule_item_response import PUTPaymentScheduleItemResponse as PUTPaymentScheduleItemResponsePydantic
...
from zuora_python_sdk.pydantic.put_payment_schedule_item_request import PUTPaymentScheduleItemRequest as PUTPaymentScheduleItemRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'item-id': typing.Union[ItemIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PUTPaymentScheduleItemRequestSchema


request_body_put_payment_schedule_item_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTPaymentScheduleItemResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTPaymentScheduleItemResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_item_0_mapped_args(
        self,
        body: PUTPaymentScheduleItemRequest,
        item_id: str,
        description: typing.Optional[str] = None,
        amount: typing.Optional[typing.Union[int, float]] = None,
        currency: typing.Optional[str] = None,
        link_payments: typing.Optional[typing.List[str]] = None,
        ...
        scheduled_date: typing.Optional[date] = None,
        unlink_payments: typing.Optional[typing.List[str]] = None,
        ...
        if link_payments is not None:
            _body["linkPayments"] = link_payments
        if payment_gateway_id is not None:
            _body["paymentGatewayId"] = payment_gateway_id
        if payment_id is not None:
            _body["paymentId"] = payment_id
        ...
        if run_hour is not None:
            _body["runHour"] = run_hour
        if scheduled_date is not None:
            _body["scheduledDate"] = scheduled_date
        if unlink_payments is not None:
            _body["unlinkPayments"] = unlink_payments
    ...
    async def _apayment_schedule_item_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedule-items/{item-id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_payment_schedule_item_request.serialize(body, content_type)
    ...
    def _payment_schedule_item_0_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class PaymentScheduleItem0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_item_0(
        self,
        body: PUTPaymentScheduleItemRequest,
        item_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_item_0_mapped_args(
            body=body,
            item_id=item_id,
            ...
            unlink_payments=unlink_payments,
        ...
        return await self._apayment_schedule_item_0_oapg(
            body=args.body,
    ...
    def payment_schedule_item_0(
        ...
        return self._payment_schedule_item_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentScheduleItem0(BaseApi):
    ...
    async def apayment_schedule_item_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTPaymentScheduleItemResponsePydantic:
        raw_response = await self.raw.apayment_schedule_item_0(
            body=body,
            item_id=item_id,
            description=description,
            amount=amount,
        ...
        if validate:
            return RootModel[PUTPaymentScheduleItemResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PUTPaymentScheduleItemResponsePydantic, raw_response.body)
    ...
    def payment_schedule_item_0(
        ...
        raw_response = self.raw.payment_schedule_item_0(
            body=body,
            item_id=item_id,
            description=description,
            amount=amount,
