...
from zuora_python_sdk.model.get_payment_schedule_item_response import GETPaymentScheduleItemResponse as GETPaymentScheduleItemResponseSchema

from zuora_python_sdk.type.get_payment_schedule_item_response import GETPaymentScheduleItemResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_schedule_item_response import GETPaymentScheduleItemResponse as GETPaymentScheduleItemResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentScheduleItemResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentScheduleItemResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_item_mapped_args(
        self,
        item_id: str,
    ...
    async def _apayment_schedule_item_oapg(
        self,
    ...
    def _payment_schedule_item_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PaymentScheduleItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_item(
        self,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_item_mapped_args(
            item_id=item_id,
        ...
        return await self._apayment_schedule_item_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def payment_schedule_item(
        self,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._payment_schedule_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentScheduleItem(BaseApi):
    ...
    async def apayment_schedule_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentScheduleItemResponsePydantic:
        raw_response = await self.raw.apayment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETPaymentScheduleItemResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETPaymentScheduleItemResponsePydantic, raw_response.body)
    ...
    def payment_schedule_item(
        ...
        raw_response = self.raw.payment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
