...
from zuora_python_sdk.model.get_payment_method_response_for_account import GETPaymentMethodResponseForAccount as GETPaymentMethodResponseForAccountSchema

from zuora_python_sdk.type.get_payment_method_response_for_account import GETPaymentMethodResponseForAccount

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_method_response_for_account import GETPaymentMethodResponseForAccount as GETPaymentMethodResponseForAccountPydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentMethodResponseForAccountSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentMethodResponseForAccount
...
class BaseApi(api_client.Api):
    ...
    def _acount_default_payment_method_mapped_args(
        self,
        account_key: str,
    ...
    async def _aacount_default_payment_method_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/{account-key}/payment-methods/default',
            headers=_headers,
        )
    ...
    def _acount_default_payment_method_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AcountDefaultPaymentMethodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aacount_default_payment_method(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._acount_default_payment_method_mapped_args(
        ...
        return await self._aacount_default_payment_method_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def acount_default_payment_method(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._acount_default_payment_method_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AcountDefaultPaymentMethod(BaseApi):
    ...
    async def aacount_default_payment_method(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentMethodResponseForAccountPydantic:
        raw_response = await self.raw.aacount_default_payment_method(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETPaymentMethodResponseForAccountPydantic](raw_response.body).root
        return api_client.construct_model_instance(GETPaymentMethodResponseForAccountPydantic, raw_response.body)
    ...
    def acount_default_payment_method(
        ...
        raw_response = self.raw.acount_default_payment_method(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
