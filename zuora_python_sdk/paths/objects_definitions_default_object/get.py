...
from zuora_python_sdk.model.custom_object_definition import CustomObjectDefinition as CustomObjectDefinitionSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.custom_object_definition import CustomObjectDefinition
...
from zuora_python_sdk.pydantic.custom_object_definition import CustomObjectDefinition as CustomObjectDefinitionPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomObjectDefinitionSchema
...
class BaseApi(api_client.Api):
    ...
    def _custom_object_definition_by_type_mapped_args(
        self,
        authorization: str,
        object: str,
    ...
    async def _acustom_object_definition_by_type_oapg(
        self,
    ...
    def _custom_object_definition_by_type_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectDefinitionByTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_definition_by_type(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._custom_object_definition_by_type_mapped_args(
        ...
        return await self._acustom_object_definition_by_type_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def custom_object_definition_by_type(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._custom_object_definition_by_type_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectDefinitionByType(BaseApi):
    ...
    async def acustom_object_definition_by_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomObjectDefinitionPydantic:
        raw_response = await self.raw.acustom_object_definition_by_type(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return CustomObjectDefinitionPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomObjectDefinitionPydantic, raw_response.body)
    ...
    def custom_object_definition_by_type(
        ...
        raw_response = self.raw.custom_object_definition_by_type(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
