...
class BaseApi(api_client.Api):
    ...
    def _custom_object_definition_by_type_0_mapped_args(
        self,
        authorization: str,
        object: str,
    ...
    async def _acustom_object_definition_by_type_0_oapg(
        self,
    ...
    def _custom_object_definition_by_type_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectDefinitionByType0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_definition_by_type_0(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._custom_object_definition_by_type_0_mapped_args(
        ...
        return await self._acustom_object_definition_by_type_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def custom_object_definition_by_type_0(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._custom_object_definition_by_type_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectDefinitionByType0(BaseApi):
    ...
    async def acustom_object_definition_by_type_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acustom_object_definition_by_type_0(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def custom_object_definition_by_type_0(
        ...
        raw_response = self.raw.custom_object_definition_by_type_0(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
