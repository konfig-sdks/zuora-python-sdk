...
from zuora_python_sdk.model.get_billing_doc_volume_summary_response import GetBillingDocVolumeSummaryResponse as GetBillingDocVolumeSummaryResponseSchema

from zuora_python_sdk.type.get_billing_doc_volume_summary_response import GetBillingDocVolumeSummaryResponse
...
from zuora_python_sdk.pydantic.get_billing_doc_volume_summary_response import GetBillingDocVolumeSummaryResponse as GetBillingDocVolumeSummaryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetBillingDocVolumeSummaryResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetBillingDocVolumeSummaryResponse
...
class BaseApi(api_client.Api):
    ...
    def _system_health_billing_doc_volume_summary_mapped_args(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
    ...
    async def _asystem_health_billing_doc_volume_summary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/system-health/billing-documents/volume-summary',
            headers=_headers,
        )
    ...
    def _system_health_billing_doc_volume_summary_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SystemHealthBillingDocVolumeSummaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asystem_health_billing_doc_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        **kwargs,
        ...
        args = self._system_health_billing_doc_volume_summary_mapped_args(
        ...
        return await self._asystem_health_billing_doc_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def system_health_billing_doc_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        return self._system_health_billing_doc_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class SystemHealthBillingDocVolumeSummary(BaseApi):
    ...
    async def asystem_health_billing_doc_volume_summary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetBillingDocVolumeSummaryResponsePydantic:
        raw_response = await self.raw.asystem_health_billing_doc_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GetBillingDocVolumeSummaryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetBillingDocVolumeSummaryResponsePydantic, raw_response.body)
    ...
    def system_health_billing_doc_volume_summary(
        ...
        raw_response = self.raw.system_health_billing_doc_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
