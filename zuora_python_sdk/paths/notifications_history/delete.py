...
SchemaFor202ResponseBodyApplicationJson = NotificationsHistoryDeletionTaskResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_notification_history_for_account_mapped_args(
        self,
        authorization: str,
        account_id: str,
    ...
    async def _adelete_notification_history_for_account_oapg(
        self,
    ...
    def _delete_notification_history_for_account_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteNotificationHistoryForAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_notification_history_for_account(
        self,
        authorization: str,
        account_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_notification_history_for_account_mapped_args(
        ...
        return await self._adelete_notification_history_for_account_oapg(
    ...
    def delete_notification_history_for_account(
        ...
        return self._delete_notification_history_for_account_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DeleteNotificationHistoryForAccount(BaseApi):
    ...
    async def adelete_notification_history_for_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_notification_history_for_account(
            authorization=authorization,
            account_id=account_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def delete_notification_history_for_account(
        ...
        raw_response = self.raw.delete_notification_history_for_account(
            authorization=authorization,
            account_id=account_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
