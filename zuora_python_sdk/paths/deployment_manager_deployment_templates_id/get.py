...
class BaseApi(api_client.Api):
    ...
    def _deployment_template_detail_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _adeployment_template_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployment_templates/{id}',
            headers=_headers,
        )
    ...
    def _deployment_template_detail_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeploymentTemplateDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeployment_template_detail(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._deployment_template_detail_mapped_args(
        ...
        return await self._adeployment_template_detail_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def deployment_template_detail(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._deployment_template_detail_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeploymentTemplateDetail(BaseApi):
    ...
    async def adeployment_template_detail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeployment_template_detail(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def deployment_template_detail(
        ...
        raw_response = self.raw.deployment_template_detail(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
