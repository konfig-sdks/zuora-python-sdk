...
from zuora_python_sdk.model.proxy_create_usage import ProxyCreateUsage as ProxyCreateUsageSchema
...
from zuora_python_sdk.type.proxy_create_usage import ProxyCreateUsage
...
from zuora_python_sdk.pydantic.proxy_create_usage import ProxyCreateUsage as ProxyCreateUsagePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyCreateUsageSchema


request_body_proxy_create_usage = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_usage_mapped_args(
        self,
        body: ProxyCreateUsage,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        charge_id: typing.Optional[str] = None,
        charge_number: typing.Optional[str] = None,
        ...
        unique_key: typing.Optional[str] = None,
        ...
        if charge_id is not None:
            _body["ChargeId"] = charge_id
        if charge_number is not None:
            _body["ChargeNumber"] = charge_number
    ...
    async def _ap_ost_usage_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_create_usage.serialize(body, content_type)
...
class POstUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_usage(
        self,
        body: ProxyCreateUsage,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_ost_usage_mapped_args(
            body=body,
        ...
        return await self._ap_ost_usage_oapg(
            body=args.body,
    ...
    def p_ost_usage(
        ...
        return self._p_ost_usage_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstUsage(BaseApi):
    ...
    async def ap_ost_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ost_usage(
            body=body,
            account_id=account_id,
            account_number=account_number,
            charge_id=charge_id,
    ...
    def p_ost_usage(
        ...
        raw_response = self.raw.p_ost_usage(
            body=body,
            account_id=account_id,
            account_number=account_number,
            charge_id=charge_id,
