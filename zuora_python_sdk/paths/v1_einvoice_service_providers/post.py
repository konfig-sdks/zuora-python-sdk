...
from zuora_python_sdk.model.create_e_invoicing_service_provider_request import CreateEInvoicingServiceProviderRequest as CreateEInvoicingServiceProviderRequestSchema

from zuora_python_sdk.type.create_e_invoicing_service_provider_request import CreateEInvoicingServiceProviderRequest
from zuora_python_sdk.type.get_e_invoicing_service_provider_response import GetEInvoicingServiceProviderResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.create_e_invoicing_service_provider_request import CreateEInvoicingServiceProviderRequest as CreateEInvoicingServiceProviderRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateEInvoicingServiceProviderRequestSchema


request_body_create_e_invoicing_service_provider_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _e_invoicing_service_provider_mapped_args(
        self,
    ...
    async def _ae_invoicing_service_provider_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/service-providers',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_e_invoicing_service_provider_request.serialize(body, content_type)
    ...
    def _e_invoicing_service_provider_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EInvoicingServiceProviderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ae_invoicing_service_provider(
        self,
        company_identifier: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        provider: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._e_invoicing_service_provider_mapped_args(
            body=body,
        ...
        return await self._ae_invoicing_service_provider_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def e_invoicing_service_provider(
        self,
        company_identifier: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        provider: typing.Optional[str] = None,
        ...
        return self._e_invoicing_service_provider_oapg(
            body=args.body,
            header_params=args.header,
        )

class EInvoicingServiceProvider(BaseApi):
    ...
    async def ae_invoicing_service_provider(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ae_invoicing_service_provider(
            body=body,
            company_identifier=company_identifier,
            name=name,
            provider=provider,
    ...
    def e_invoicing_service_provider(
        ...
        raw_response = self.raw.e_invoicing_service_provider(
            body=body,
            company_identifier=company_identifier,
            name=name,
            provider=provider,
