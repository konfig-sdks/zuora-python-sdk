...
from zuora_python_sdk.model.list_e_invoicing_service_providers_response import ListEInvoicingServiceProvidersResponse as ListEInvoicingServiceProvidersResponseSchema

from zuora_python_sdk.type.list_e_invoicing_service_providers_response import ListEInvoicingServiceProvidersResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.list_e_invoicing_service_providers_response import ListEInvoicingServiceProvidersResponse as ListEInvoicingServiceProvidersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListEInvoicingServiceProvidersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ListEInvoicingServiceProvidersResponse
...
class BaseApi(api_client.Api):
    ...
    def _e_invoicing_service_providers_mapped_args(
        self,
    ...
    async def _ae_invoicing_service_providers_oapg(
        self,
    ...
    def _e_invoicing_service_providers_oapg(
        self,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class EInvoicingServiceProvidersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ae_invoicing_service_providers(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._e_invoicing_service_providers_mapped_args(
        ...
        return await self._ae_invoicing_service_providers_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def e_invoicing_service_providers(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._e_invoicing_service_providers_oapg(
            header_params=args.header,
        )

class EInvoicingServiceProviders(BaseApi):
    ...
    async def ae_invoicing_service_providers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListEInvoicingServiceProvidersResponsePydantic:
        raw_response = await self.raw.ae_invoicing_service_providers(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return ListEInvoicingServiceProvidersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListEInvoicingServiceProvidersResponsePydantic, raw_response.body)
    ...
    def e_invoicing_service_providers(
        ...
        raw_response = self.raw.e_invoicing_service_providers(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
