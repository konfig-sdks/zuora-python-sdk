...
from zuora_python_sdk.model.put_subscription_patch_request_type_rate_plans import PUTSubscriptionPatchRequestTypeRatePlans as PUTSubscriptionPatchRequestTypeRatePlansSchema
...
from zuora_python_sdk.model.put_subscription_patch_request_type import PUTSubscriptionPatchRequestType as PUTSubscriptionPatchRequestTypeSchema

from zuora_python_sdk.type.put_subscription_patch_request_type_rate_plans import PUTSubscriptionPatchRequestTypeRatePlans
from zuora_python_sdk.type.put_subscription_patch_request_type import PUTSubscriptionPatchRequestType
...
from zuora_python_sdk.pydantic.put_subscription_patch_request_type_rate_plans import PUTSubscriptionPatchRequestTypeRatePlans as PUTSubscriptionPatchRequestTypeRatePlansPydantic
from zuora_python_sdk.pydantic.put_subscription_patch_request_type import PUTSubscriptionPatchRequestType as PUTSubscriptionPatchRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTSubscriptionPatchRequestTypeSchema


request_body_put_subscription_patch_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_subscription_custom_fields_mapped_args(
        self,
        subscription_number: str,
        custom_fields: typing.Optional[SubscriptionObjectCustomFields] = None,
        rate_plans: typing.Optional[PUTSubscriptionPatchRequestTypeRatePlans] = None,
    ...
    async def _aupdate_subscription_custom_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscriptionNumber}/customFields',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_subscription_patch_request_type.serialize(body, content_type)
    ...
    def _update_subscription_custom_fields_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateSubscriptionCustomFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_subscription_custom_fields(
        self,
        subscription_number: str,
        custom_fields: typing.Optional[SubscriptionObjectCustomFields] = None,
        rate_plans: typing.Optional[PUTSubscriptionPatchRequestTypeRatePlans] = None,
        ...
        **kwargs,
        ...
        args = self._update_subscription_custom_fields_mapped_args(
        ...
        return await self._aupdate_subscription_custom_fields_oapg(
            body=args.body,
    ...
    def update_subscription_custom_fields(
        ...
        return self._update_subscription_custom_fields_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateSubscriptionCustomFields(BaseApi):
    ...
    async def aupdate_subscription_custom_fields(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_subscription_custom_fields(
            subscription_number=subscription_number,
            custom_fields=custom_fields,
            rate_plans=rate_plans,
            accept_encoding=accept_encoding,
    ...
    def update_subscription_custom_fields(
        ...
        raw_response = self.raw.update_subscription_custom_fields(
            subscription_number=subscription_number,
            custom_fields=custom_fields,
            rate_plans=rate_plans,
            accept_encoding=accept_encoding,
