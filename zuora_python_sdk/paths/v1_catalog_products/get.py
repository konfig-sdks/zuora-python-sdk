...
from zuora_python_sdk.model.get_catalog_type import GETCatalogType as GETCatalogTypeSchema

from zuora_python_sdk.type.get_catalog_type import GETCatalogType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_catalog_type import GETCatalogType as GETCatalogTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETCatalogTypeSchema
...
class CatalogRaw(BaseApi):
    ...
    async def acatalog(
        ...
        **kwargs,
        ...
        args = self._catalog_mapped_args(
        ...
        return await self._acatalog_oapg(
...
class Catalog(BaseApi):
    ...
    async def acatalog(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCatalogTypePydantic:
        raw_response = await self.raw.acatalog(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETCatalogTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCatalogTypePydantic, raw_response.body)
