...
from zuora_python_sdk.model.get_taxation_items_of_debit_memo_item_type import GETTaxationItemsOfDebitMemoItemType as GETTaxationItemsOfDebitMemoItemTypeSchema

from zuora_python_sdk.type.get_taxation_items_of_debit_memo_item_type import GETTaxationItemsOfDebitMemoItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_taxation_items_of_debit_memo_item_type import GETTaxationItemsOfDebitMemoItemType as GETTaxationItemsOfDebitMemoItemTypePydantic
...
# Path params
DmitemidSchema = schemas.StrSchema
DebitMemoIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'dmitemid': typing.Union[DmitemidSchema, str, ],
        'debitMemoId': typing.Union[DebitMemoIdSchema, str, ],
    }
)
...
request_path_dmitemid = api_client.PathParameter(
    name="dmitemid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DmitemidSchema,
    required=True,
)
request_path_debit_memo_id = api_client.PathParameter(
    name="debitMemoId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DebitMemoIdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETTaxationItemsOfDebitMemoItemTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETTaxationItemsOfDebitMemoItemType
...
class BaseApi(api_client.Api):
    ...
    def _taxation_items_of_debit_memo_item_mapped_args(
        self,
        dmitemid: str,
        debit_memo_id: str,
        ...
        if dmitemid is not None:
            _path_params["dmitemid"] = dmitemid
        if debit_memo_id is not None:
            _path_params["debitMemoId"] = debit_memo_id
        args.query = _query_params
        args.header = _header_params
        args.path = _path_params
        return args

    async def _ataxation_items_of_debit_memo_item_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_dmitemid,
            request_path_debit_memo_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoId}/items/{dmitemid}/taxation-items',
            headers=_headers,
        )
    ...
    def _taxation_items_of_debit_memo_item_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class TaxationItemsOfDebitMemoItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_items_of_debit_memo_item(
        self,
        dmitemid: str,
        debit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_items_of_debit_memo_item_mapped_args(
            dmitemid=dmitemid,
        ...
        return await self._ataxation_items_of_debit_memo_item_oapg(
    ...
    def taxation_items_of_debit_memo_item(
        self,
        dmitemid: str,
        debit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._taxation_items_of_debit_memo_item_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItemsOfDebitMemoItem(BaseApi):
    ...
    async def ataxation_items_of_debit_memo_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETTaxationItemsOfDebitMemoItemTypePydantic:
        raw_response = await self.raw.ataxation_items_of_debit_memo_item(
            dmitemid=dmitemid,
            debit_memo_id=debit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GETTaxationItemsOfDebitMemoItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETTaxationItemsOfDebitMemoItemTypePydantic, raw_response.body)
    ...
    def taxation_items_of_debit_memo_item(
        ...
        raw_response = self.raw.taxation_items_of_debit_memo_item(
            dmitemid=dmitemid,
            debit_memo_id=debit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
