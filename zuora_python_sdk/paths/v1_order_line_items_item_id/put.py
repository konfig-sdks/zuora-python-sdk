...
from zuora_python_sdk.model.order_line_item_custom_fields import OrderLineItemCustomFields as OrderLineItemCustomFieldsSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.order_line_item_common import OrderLineItemCommon as OrderLineItemCommonSchema

from zuora_python_sdk.type.common_response import CommonResponse
from zuora_python_sdk.type.order_line_item_common import OrderLineItemCommon
from zuora_python_sdk.type.order_line_item_custom_fields import OrderLineItemCustomFields

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.order_line_item_custom_fields import OrderLineItemCustomFields as OrderLineItemCustomFieldsPydantic
from zuora_python_sdk.pydantic.order_line_item_common import OrderLineItemCommon as OrderLineItemCommonPydantic
from zuora_python_sdk.pydantic.common_response import CommonResponse as CommonResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = OrderLineItemCommonSchema


request_body_order_line_item_common = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _order_line_item_0_mapped_args(
        self,
        item_id: str,
        description: typing.Optional[str] = None,
        uom: typing.Optional[str] = None,
        accounting_code: typing.Optional[str] = None,
        adjustment_liability_accounting_code: typing.Optional[str] = None,
        adjustment_revenue_accounting_code: typing.Optional[str] = None,
        amount_per_unit: typing.Optional[typing.Union[int, float]] = None,
        bill_target_date: typing.Optional[date] = None,
        bill_to: typing.Optional[str] = None,
        billing_rule: typing.Optional[str] = None,
        contract_asset_accounting_code: typing.Optional[str] = None,
        contract_liability_accounting_code: typing.Optional[str] = None,
        contract_recognized_revenue_accounting_code: typing.Optional[str] = None,
        custom_fields: typing.Optional[OrderLineItemCustomFields] = None,
        deferred_revenue_accounting_code: typing.Optional[str] = None,
        ...
        invoice_group_number: typing.Optional[typing.Optional[str]] = None,
        inline_discount_per_unit: typing.Optional[typing.Union[int, float]] = None,
        inline_discount_type: typing.Optional[str] = None,
        ...
        list_price_per_unit: typing.Optional[typing.Union[int, float]] = None,
        owner_account_number: typing.Optional[str] = None,
        ...
        recognized_revenue_accounting_code: typing.Optional[str] = None,
        related_subscription_number: typing.Optional[str] = None,
        revenue_recognition_rule: typing.Optional[str] = None,
        ...
        tax_mode: typing.Optional[str] = None,
        transaction_end_date: typing.Optional[date] = None,
        transaction_start_date: typing.Optional[date] = None,
        unbilled_receivables_accounting_code: typing.Optional[str] = None,
        ...
        if adjustment_liability_accounting_code is not None:
            _body["adjustmentLiabilityAccountingCode"] = adjustment_liability_accounting_code
        if adjustment_revenue_accounting_code is not None:
            _body["adjustmentRevenueAccountingCode"] = adjustment_revenue_accounting_code
        if amount_per_unit is not None:
            _body["amountPerUnit"] = amount_per_unit
        if bill_target_date is not None:
            _body["billTargetDate"] = bill_target_date
        if bill_to is not None:
            _body["billTo"] = bill_to
        if billing_rule is not None:
            _body["billingRule"] = billing_rule
        if contract_asset_accounting_code is not None:
            _body["contractAssetAccountingCode"] = contract_asset_accounting_code
        if contract_liability_accounting_code is not None:
            _body["contractLiabilityAccountingCode"] = contract_liability_accounting_code
        if contract_recognized_revenue_accounting_code is not None:
            _body["contractRecognizedRevenueAccountingCode"] = contract_recognized_revenue_accounting_code
        if custom_fields is not None:
            _body["customFields"] = custom_fields
        if deferred_revenue_accounting_code is not None:
            _body["deferredRevenueAccountingCode"] = deferred_revenue_accounting_code
        ...
        if invoice_group_number is not None:
            _body["invoiceGroupNumber"] = invoice_group_number
        if inline_discount_per_unit is not None:
            _body["inlineDiscountPerUnit"] = inline_discount_per_unit
        if inline_discount_type is not None:
            _body["inlineDiscountType"] = inline_discount_type
        ...
        if item_number is not None:
            _body["itemNumber"] = item_number
        if item_state is not None:
            _body["itemState"] = item_state
        if item_type is not None:
            _body["itemType"] = item_type
        if list_price_per_unit is not None:
            _body["listPricePerUnit"] = list_price_per_unit
        if owner_account_number is not None:
            _body["ownerAccountNumber"] = owner_account_number
        if product_code is not None:
            _body["productCode"] = product_code
        if purchase_order_number is not None:
            _body["purchaseOrderNumber"] = purchase_order_number
        if quantity is not None:
            _body["quantity"] = quantity
        if recognized_revenue_accounting_code is not None:
            _body["recognizedRevenueAccountingCode"] = recognized_revenue_accounting_code
        if related_subscription_number is not None:
            _body["relatedSubscriptionNumber"] = related_subscription_number
        if revenue_recognition_rule is not None:
            _body["revenueRecognitionRule"] = revenue_recognition_rule
    ...
    async def _aorder_line_item_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/order-line-items/{itemId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_order_line_item_common.serialize(body, content_type)
...
class OrderLineItem0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_line_item_0(
        self,
        item_id: str,
        description: typing.Optional[str] = None,
        uom: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_line_item_0_mapped_args(
            item_id=item_id,
            description=description,
            uom=uom,
            accounting_code=accounting_code,
            adjustment_liability_accounting_code=adjustment_liability_accounting_code,
            adjustment_revenue_accounting_code=adjustment_revenue_accounting_code,
            amount_per_unit=amount_per_unit,
            bill_target_date=bill_target_date,
            bill_to=bill_to,
            billing_rule=billing_rule,
            contract_asset_accounting_code=contract_asset_accounting_code,
            contract_liability_accounting_code=contract_liability_accounting_code,
            contract_recognized_revenue_accounting_code=contract_recognized_revenue_accounting_code,
            ...
            inline_discount_per_unit=inline_discount_per_unit,
            inline_discount_type=inline_discount_type,
            ...
            revenue_recognition_rule=revenue_recognition_rule,
            ...
            unbilled_receivables_accounting_code=unbilled_receivables_accounting_code,
        ...
        return await self._aorder_line_item_0_oapg(
            body=args.body,
    ...
    def order_line_item_0(
        ...
        return self._order_line_item_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class OrderLineItem0(BaseApi):
    ...
    async def aorder_line_item_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorder_line_item_0(
            item_id=item_id,
            description=description,
            uom=uom,
            accounting_code=accounting_code,
    ...
    def order_line_item_0(
        ...
        raw_response = self.raw.order_line_item_0(
            item_id=item_id,
            description=description,
            uom=uom,
            accounting_code=accounting_code,
