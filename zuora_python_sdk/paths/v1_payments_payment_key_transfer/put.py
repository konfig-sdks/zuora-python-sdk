...
from zuora_python_sdk.model.transfer_payment_type import TransferPaymentType as TransferPaymentTypeSchema

from zuora_python_sdk.type.transfer_payment_type import TransferPaymentType
from zuora_python_sdk.type.getar_payment_type import GETARPaymentType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.transfer_payment_type import TransferPaymentType as TransferPaymentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TransferPaymentTypeSchema


request_body_transfer_payment_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _transfer_payment_mapped_args(
        self,
        payment_key: str,
    ...
    async def _atransfer_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/transfer',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_transfer_payment_type.serialize(body, content_type)
...
class TransferPaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atransfer_payment(
        self,
        payment_key: str,
        account_id: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._transfer_payment_mapped_args(
        ...
        return await self._atransfer_payment_oapg(
            body=args.body,
    ...
    def transfer_payment(
        ...
        return self._transfer_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class TransferPayment(BaseApi):
    ...
    async def atransfer_payment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atransfer_payment(
            payment_key=payment_key,
            account_id=account_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def transfer_payment(
        ...
        raw_response = self.raw.transfer_payment(
            payment_key=payment_key,
            account_id=account_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
