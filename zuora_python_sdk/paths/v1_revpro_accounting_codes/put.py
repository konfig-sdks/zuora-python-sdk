...
from zuora_python_sdk.model.put_revpro_acc_code_response import PUTRevproAccCodeResponse as PUTRevproAccCodeResponseSchema
from zuora_python_sdk.model.revpro_accounting_codes import RevproAccountingCodes as RevproAccountingCodesSchema

from zuora_python_sdk.type.revpro_accounting_codes import RevproAccountingCodes
from zuora_python_sdk.type.put_revpro_acc_code_response import PUTRevproAccCodeResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_revpro_acc_code_response import PUTRevproAccCodeResponse as PUTRevproAccCodeResponsePydantic
from zuora_python_sdk.pydantic.revpro_accounting_codes import RevproAccountingCodes as RevproAccountingCodesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RevproAccountingCodesSchema


request_body_revpro_accounting_codes = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTRevproAccCodeResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _rev_pro_accounting_codes_mapped_args(
        self,
        ...
        _header_params = {}
        _body = {}
        if adjustment_liability_account is not None:
            _body["adjustmentLiabilityAccount"] = adjustment_liability_account
        if adjustment_revenue_account is not None:
            _body["adjustmentRevenueAccount"] = adjustment_revenue_account
        if contract_asset_account is not None:
            _body["contractAssetAccount"] = contract_asset_account
        if contract_liability_account is not None:
            _body["contractLiabilityAccount"] = contract_liability_account
        ...
        if unbilled_receivables_account is not None:
            _body["unbilledReceivablesAccount"] = unbilled_receivables_account
        args.body = _body
    ...
    async def _arev_pro_accounting_codes_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_revpro_accounting_codes.serialize(body, content_type)
    ...
    def _rev_pro_accounting_codes_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RevProAccountingCodesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arev_pro_accounting_codes(
        self,
        adjustment_liability_account: str,
        adjustment_revenue_account: str,
        contract_asset_account: str,
        ...
        **kwargs,
        ...
        args = self._rev_pro_accounting_codes_mapped_args(
        ...
        return await self._arev_pro_accounting_codes_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def rev_pro_accounting_codes(
        self,
        adjustment_liability_account: str,
        adjustment_revenue_account: str,
        contract_asset_account: str,
        ...
        return self._rev_pro_accounting_codes_oapg(
            body=args.body,
            header_params=args.header,
        )

class RevProAccountingCodes(BaseApi):
    ...
    async def arev_pro_accounting_codes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTRevproAccCodeResponsePydantic:
        raw_response = await self.raw.arev_pro_accounting_codes(
            adjustment_liability_account=adjustment_liability_account,
            adjustment_revenue_account=adjustment_revenue_account,
            contract_asset_account=contract_asset_account,
            contract_liability_account=contract_liability_account,
        ...
        if validate:
            return PUTRevproAccCodeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTRevproAccCodeResponsePydantic, raw_response.body)
    ...
    def rev_pro_accounting_codes(
        ...
        raw_response = self.raw.rev_pro_accounting_codes(
            adjustment_liability_account=adjustment_liability_account,
            adjustment_revenue_account=adjustment_revenue_account,
            contract_asset_account=contract_asset_account,
            contract_liability_account=contract_liability_account,
