...
from zuora_python_sdk.model.post_payment_method_response_decryption import POSTPaymentMethodResponseDecryption as POSTPaymentMethodResponseDecryptionSchema
from zuora_python_sdk.model.post_payment_method_decryption import POSTPaymentMethodDecryption as POSTPaymentMethodDecryptionSchema

from zuora_python_sdk.type.post_payment_method_decryption import POSTPaymentMethodDecryption
from zuora_python_sdk.type.create_payment_method_cardholder_info import CreatePaymentMethodCardholderInfo
from zuora_python_sdk.type.post_payment_method_response_decryption import POSTPaymentMethodResponseDecryption

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_payment_method_decryption import POSTPaymentMethodDecryption as POSTPaymentMethodDecryptionPydantic
...
from zuora_python_sdk.pydantic.post_payment_method_response_decryption import POSTPaymentMethodResponseDecryption as POSTPaymentMethodResponseDecryptionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPaymentMethodDecryptionSchema


request_body_post_payment_method_decryption = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTPaymentMethodResponseDecryptionSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTPaymentMethodResponseDecryption
...
class BaseApi(api_client.Api):
    ...
    def _payment_methods_decryption_mapped_args(
        self,
        integration_type: str,
        merchant_id: str,
        payment_token: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        ...
        process_payment: typing.Optional[bool] = None,
        ...
        if integration_type is not None:
            _body["integrationType"] = integration_type
        ...
        if process_payment is not None:
            _body["processPayment"] = process_payment
        args.body = _body
    ...
    async def _apayment_methods_decryption_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_payment_method_decryption.serialize(body, content_type)
    ...
    def _payment_methods_decryption_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PaymentMethodsDecryptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_methods_decryption(
        self,
        integration_type: str,
        merchant_id: str,
        payment_token: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        ...
        **kwargs,
        ...
        args = self._payment_methods_decryption_mapped_args(
        ...
        return await self._apayment_methods_decryption_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def payment_methods_decryption(
        self,
        integration_type: str,
        merchant_id: str,
        payment_token: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        ...
        return self._payment_methods_decryption_oapg(
            body=args.body,
            header_params=args.header,
        )

class PaymentMethodsDecryption(BaseApi):
    ...
    async def apayment_methods_decryption(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTPaymentMethodResponseDecryptionPydantic:
        raw_response = await self.raw.apayment_methods_decryption(
            integration_type=integration_type,
            merchant_id=merchant_id,
            payment_token=payment_token,
            account_id=account_id,
        ...
        if validate:
            return POSTPaymentMethodResponseDecryptionPydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTPaymentMethodResponseDecryptionPydantic, raw_response.body)
    ...
    def payment_methods_decryption(
        ...
        raw_response = self.raw.payment_methods_decryption(
            integration_type=integration_type,
            merchant_id=merchant_id,
            payment_token=payment_token,
            account_id=account_id,
