...
from zuora_python_sdk.model.get_refund_type import GETRefundType as GETRefundTypeSchema
from zuora_python_sdk.model.put_refund_type import PUTRefundType as PUTRefundTypeSchema

from zuora_python_sdk.type.get_refund_type import GETRefundType
from zuora_python_sdk.type.put_refund_type import PUTRefundType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_refund_type import PUTRefundType as PUTRefundTypePydantic
from zuora_python_sdk.pydantic.get_refund_type import GETRefundType as GETRefundTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTRefundTypeSchema


request_body_put_refund_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETRefundTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_refund_mapped_args(
        self,
        body: PUTRefundType,
        refund_id: str,
    ...
    async def _aupdate_refund_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_refund_type.serialize(body, content_type)
...
class UpdateRefundRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_refund(
        self,
        body: PUTRefundType,
        refund_id: str,
        comment: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_refund_mapped_args(
            body=body,
            refund_id=refund_id,
            comment=comment,
        ...
        return await self._aupdate_refund_oapg(
            body=args.body,
    ...
    def update_refund(
        ...
        return self._update_refund_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateRefund(BaseApi):
    ...
    async def aupdate_refund(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundTypePydantic:
        raw_response = await self.raw.aupdate_refund(
            body=body,
            refund_id=refund_id,
            comment=comment,
            finance_information=finance_information,
        ...
        if validate:
            return RootModel[GETRefundTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRefundTypePydantic, raw_response.body)
    ...
    def update_refund(
        ...
        raw_response = self.raw.update_refund(
            body=body,
            refund_id=refund_id,
            comment=comment,
            finance_information=finance_information,
