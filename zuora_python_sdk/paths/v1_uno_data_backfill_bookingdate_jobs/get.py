...
from zuora_python_sdk.model.get_list_booking_date_backfill_jobs_response import GetListBookingDateBackfillJobsResponse as GetListBookingDateBackfillJobsResponseSchema

from zuora_python_sdk.type.get_list_booking_date_backfill_jobs_response import GetListBookingDateBackfillJobsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_list_booking_date_backfill_jobs_response import GetListBookingDateBackfillJobsResponse as GetListBookingDateBackfillJobsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetListBookingDateBackfillJobsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetListBookingDateBackfillJobsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_booking_date_backfill_jobs_mapped_args(
        self,
        authorization: str,
    ...
    async def _alist_booking_date_backfill_jobs_oapg(
        self,
    ...
    def _list_booking_date_backfill_jobs_oapg(
        self,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListBookingDateBackfillJobsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_booking_date_backfill_jobs(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_booking_date_backfill_jobs_mapped_args(
        ...
        return await self._alist_booking_date_backfill_jobs_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def list_booking_date_backfill_jobs(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._list_booking_date_backfill_jobs_oapg(
            header_params=args.header,
        )

class ListBookingDateBackfillJobs(BaseApi):
    ...
    async def alist_booking_date_backfill_jobs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetListBookingDateBackfillJobsResponsePydantic:
        raw_response = await self.raw.alist_booking_date_backfill_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return RootModel[GetListBookingDateBackfillJobsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetListBookingDateBackfillJobsResponsePydantic, raw_response.body)
    ...
    def list_booking_date_backfill_jobs(
        ...
        raw_response = self.raw.list_booking_date_backfill_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
