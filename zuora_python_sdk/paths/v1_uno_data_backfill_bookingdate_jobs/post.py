...
from zuora_python_sdk.model.post_create_booking_date_backfill_job_response import PostCreateBookingDateBackfillJobResponse as PostCreateBookingDateBackfillJobResponseSchema

from zuora_python_sdk.type.post_create_booking_date_backfill_job_response import PostCreateBookingDateBackfillJobResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_create_booking_date_backfill_job_response import PostCreateBookingDateBackfillJobResponse as PostCreateBookingDateBackfillJobResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PostCreateBookingDateBackfillJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PostCreateBookingDateBackfillJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_booking_date_backfill_job_mapped_args(
        self,
        authorization: str,
    ...
    async def _acreate_booking_date_backfill_job_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/uno/data-backfill/bookingdate/jobs',
            headers=_headers,
        )
    ...
    def _create_booking_date_backfill_job_oapg(
        self,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateBookingDateBackfillJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_booking_date_backfill_job(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_booking_date_backfill_job_mapped_args(
        ...
        return await self._acreate_booking_date_backfill_job_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def create_booking_date_backfill_job(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._create_booking_date_backfill_job_oapg(
            header_params=args.header,
        )

class CreateBookingDateBackfillJob(BaseApi):
    ...
    async def acreate_booking_date_backfill_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostCreateBookingDateBackfillJobResponsePydantic:
        raw_response = await self.raw.acreate_booking_date_backfill_job(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return RootModel[PostCreateBookingDateBackfillJobResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PostCreateBookingDateBackfillJobResponsePydantic, raw_response.body)
    ...
    def create_booking_date_backfill_job(
        ...
        raw_response = self.raw.create_booking_date_backfill_job(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            idempotency_key=idempotency_key,
