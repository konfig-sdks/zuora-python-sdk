...
from zuora_python_sdk.model.get_aggregate_query_job_response import GetAggregateQueryJobResponse as GetAggregateQueryJobResponseSchema

from zuora_python_sdk.type.get_aggregate_query_job_response import GetAggregateQueryJobResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_aggregate_query_job_response import GetAggregateQueryJobResponse as GetAggregateQueryJobResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetAggregateQueryJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetAggregateQueryJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _last_batch_query_job_mapped_args(
        self,
        authorization: str,
        partner: str,
        project: str,
    ...
    async def _alast_batch_query_job_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batch-query/jobs/partner/{partner}/project/{project}',
            headers=_headers,
        )
    ...
    def _last_batch_query_job_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class LastBatchQueryJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alast_batch_query_job(
        self,
        authorization: str,
        partner: str,
        project: str,
        ...
        **kwargs,
        ...
        args = self._last_batch_query_job_mapped_args(
        ...
        return await self._alast_batch_query_job_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def last_batch_query_job(
        self,
        authorization: str,
        partner: str,
        project: str,
        ...
        return self._last_batch_query_job_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class LastBatchQueryJob(BaseApi):
    ...
    async def alast_batch_query_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetAggregateQueryJobResponsePydantic:
        raw_response = await self.raw.alast_batch_query_job(
            authorization=authorization,
            partner=partner,
            project=project,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GetAggregateQueryJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetAggregateQueryJobResponsePydantic, raw_response.body)
    ...
    def last_batch_query_job(
        ...
        raw_response = self.raw.last_batch_query_job(
            authorization=authorization,
            partner=partner,
            project=project,
            accept_encoding=accept_encoding,
