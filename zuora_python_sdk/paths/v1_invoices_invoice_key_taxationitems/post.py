...
from zuora_python_sdk.model.post_taxation_item_list import POSTTaxationItemList as POSTTaxationItemListSchema
from zuora_python_sdk.model.post_taxation_item_type_for_invoice import POSTTaxationItemTypeForInvoice as POSTTaxationItemTypeForInvoiceSchema

from zuora_python_sdk.type.post_taxation_item_type_for_invoice import POSTTaxationItemTypeForInvoice
from zuora_python_sdk.type.get_taxation_item_list_type import GETTaxationItemListType
from zuora_python_sdk.type.post_taxation_item_list import POSTTaxationItemList

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_taxation_item_type_for_invoice import POSTTaxationItemTypeForInvoice as POSTTaxationItemTypeForInvoicePydantic
...
from zuora_python_sdk.pydantic.post_taxation_item_list import POSTTaxationItemList as POSTTaxationItemListPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTTaxationItemListSchema


request_body_post_taxation_item_list = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_taxation_items_mapped_args(
        self,
        invoice_key: str,
        taxation_items: typing.Optional[typing.List[POSTTaxationItemTypeForInvoice]] = None,
    ...
    async def _acreate_taxation_items_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/taxationitems',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_taxation_item_list.serialize(body, content_type)
