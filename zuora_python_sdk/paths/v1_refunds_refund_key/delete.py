...
class Refund0Raw(BaseApi):
    ...
    async def arefund_0(
        ...
        **kwargs,
        ...
        args = self._refund_0_mapped_args(
        ...
        return await self._arefund_0_oapg(
    ...
    def refund_0(
        ...
        return self._refund_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Refund0(BaseApi):
    ...
    async def arefund_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arefund_0(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def refund_0(
        ...
        raw_response = self.raw.refund_0(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
