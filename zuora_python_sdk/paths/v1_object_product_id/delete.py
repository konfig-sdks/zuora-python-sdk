...
class BaseApi(api_client.Api):
    ...
    def _d_elete_product_mapped_args(
        self,
        id: str,
    ...
    async def _ad_elete_product_oapg(
        self,
...
class DEleteProductRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ad_elete_product(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._d_elete_product_mapped_args(
            id=id,
        ...
        return await self._ad_elete_product_oapg(
    ...
    def d_elete_product(
        ...
        return self._d_elete_product_oapg(
            header_params=args.header,
            path_params=args.path,
        )
...
class DEleteProduct(BaseApi):
    ...
    async def ad_elete_product(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ad_elete_product(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def d_elete_product(
        ...
        raw_response = self.raw.d_elete_product(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
