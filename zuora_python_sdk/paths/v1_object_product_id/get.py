...
from zuora_python_sdk.model.proxy_get_product import ProxyGetProduct as ProxyGetProductSchema
...
from zuora_python_sdk.type.proxy_get_product import ProxyGetProduct
...
from zuora_python_sdk.pydantic.proxy_get_product import ProxyGetProduct as ProxyGetProductPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetProductSchema
...
class GEtProductRaw(BaseApi):
    ...
    async def ag_et_product(
        ...
        **kwargs,
        ...
        args = self._g_et_product_mapped_args(
            id=id,
        ...
        return await self._ag_et_product_oapg(
    ...
    def g_et_product(
        ...
        return self._g_et_product_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )
...
class GEtProduct(BaseApi):
    ...
    async def ag_et_product(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetProductPydantic:
        raw_response = await self.raw.ag_et_product(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[ProxyGetProductPydantic](raw_response.body).root
        return api_client.construct_model_instance(ProxyGetProductPydantic, raw_response.body)
    ...
    def g_et_product(
        ...
        raw_response = self.raw.g_et_product(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
