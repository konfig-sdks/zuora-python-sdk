...
from zuora_python_sdk.model.proxy_modify_product import ProxyModifyProduct as ProxyModifyProductSchema
...
from zuora_python_sdk.type.proxy_modify_product import ProxyModifyProduct

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.proxy_modify_product import ProxyModifyProduct as ProxyModifyProductPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyModifyProductSchema


request_body_proxy_modify_product = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ut_product_mapped_args(
        self,
        body: ProxyModifyProduct,
        id: str,
    ...
    async def _ap_ut_product_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_modify_product.serialize(body, content_type)
...
class PUtProductRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ut_product(
        self,
        body: ProxyModifyProduct,
        id: str,
        allow_feature_changes: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._p_ut_product_mapped_args(
            body=body,
            id=id,
        ...
        return await self._ap_ut_product_oapg(
            body=args.body,
    ...
    def p_ut_product(
        ...
        return self._p_ut_product_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class PUtProduct(BaseApi):
    ...
    async def ap_ut_product(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ut_product(
            body=body,
            id=id,
            allow_feature_changes=allow_feature_changes,
            category=category,
    ...
    def p_ut_product(
        ...
        raw_response = self.raw.p_ut_product(
            body=body,
            id=id,
            allow_feature_changes=allow_feature_changes,
            category=category,
