...
from zuora_python_sdk.model.get_operation_job_response_type import GetOperationJobResponseType as GetOperationJobResponseTypeSchema

from zuora_python_sdk.type.get_operation_job_response_type import GetOperationJobResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_operation_job_response_type import GetOperationJobResponseType as GetOperationJobResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetOperationJobResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetOperationJobResponseType
...
class BaseApi(api_client.Api):
    ...
    def _operation_job_mapped_args(
        self,
        job_id: str,
    ...
    async def _aoperation_job_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/operations/jobs/{jobId}',
            headers=_headers,
        )
...
class OperationJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aoperation_job(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._operation_job_mapped_args(
            job_id=job_id,
        ...
        return await self._aoperation_job_oapg(
    ...
    def operation_job(
        ...
        return self._operation_job_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class OperationJob(BaseApi):
    ...
    async def aoperation_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOperationJobResponseTypePydantic:
        raw_response = await self.raw.aoperation_job(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetOperationJobResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetOperationJobResponseTypePydantic, raw_response.body)
    ...
    def operation_job(
        ...
        raw_response = self.raw.operation_job(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
