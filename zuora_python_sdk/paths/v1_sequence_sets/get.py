...
from zuora_python_sdk.model.get_sequence_sets_response import GETSequenceSetsResponse as GETSequenceSetsResponseSchema

from zuora_python_sdk.type.get_sequence_sets_response import GETSequenceSetsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_sequence_sets_response import GETSequenceSetsResponse as GETSequenceSetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETSequenceSetsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _sequence_sets_mapped_args(
        self,
    ...
    async def _asequence_sets_oapg(
        self,
...
class SequenceSetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asequence_sets(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._sequence_sets_mapped_args(
        ...
        return await self._asequence_sets_oapg(
    ...
    def sequence_sets(
        ...
        return self._sequence_sets_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class SequenceSets(BaseApi):
    ...
    async def asequence_sets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETSequenceSetsResponsePydantic:
        raw_response = await self.raw.asequence_sets(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return GETSequenceSetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETSequenceSetsResponsePydantic, raw_response.body)
    ...
    def sequence_sets(
        ...
        raw_response = self.raw.sequence_sets(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_entity_ids=zuora_entity_ids,
