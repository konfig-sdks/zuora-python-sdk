...
from zuora_python_sdk.model.post_sequence_sets_response import POSTSequenceSetsResponse as POSTSequenceSetsResponseSchema
from zuora_python_sdk.model.post_sequence_sets_request import POSTSequenceSetsRequest as POSTSequenceSetsRequestSchema
from zuora_python_sdk.model.post_sequence_set_request import POSTSequenceSetRequest as POSTSequenceSetRequestSchema

from zuora_python_sdk.type.post_sequence_set_request import POSTSequenceSetRequest
from zuora_python_sdk.type.post_sequence_sets_request import POSTSequenceSetsRequest
from zuora_python_sdk.type.post_sequence_sets_response import POSTSequenceSetsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_sequence_sets_request import POSTSequenceSetsRequest as POSTSequenceSetsRequestPydantic
from zuora_python_sdk.pydantic.post_sequence_set_request import POSTSequenceSetRequest as POSTSequenceSetRequestPydantic
from zuora_python_sdk.pydantic.post_sequence_sets_response import POSTSequenceSetsResponse as POSTSequenceSetsResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTSequenceSetsRequestSchema


request_body_post_sequence_sets_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTSequenceSetsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _sequence_sets_0_mapped_args(
        self,
        sequence_sets: typing.Optional[typing.List[POSTSequenceSetRequest]] = None,
        ...
        if sequence_sets is not None:
            _body["sequenceSets"] = sequence_sets
        args.body = _body
    ...
    async def _asequence_sets_0_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_sequence_sets_request.serialize(body, content_type)
...
class SequenceSets0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asequence_sets_0(
        self,
        sequence_sets: typing.Optional[typing.List[POSTSequenceSetRequest]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._sequence_sets_0_mapped_args(
        ...
        return await self._asequence_sets_0_oapg(
            body=args.body,
    ...
    def sequence_sets_0(
        ...
        return self._sequence_sets_0_oapg(
            body=args.body,
            header_params=args.header,
        )

class SequenceSets0(BaseApi):
    ...
    async def asequence_sets_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTSequenceSetsResponsePydantic:
        raw_response = await self.raw.asequence_sets_0(
            sequence_sets=sequence_sets,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTSequenceSetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTSequenceSetsResponsePydantic, raw_response.body)
    ...
    def sequence_sets_0(
        ...
        raw_response = self.raw.sequence_sets_0(
            sequence_sets=sequence_sets,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
