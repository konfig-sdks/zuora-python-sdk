...
from zuora_python_sdk.model.post_add_items_to_payment_schedule_request import POSTAddItemsToPaymentScheduleRequest as POSTAddItemsToPaymentScheduleRequestSchema
from zuora_python_sdk.model.payment_schedule_item_common import PaymentScheduleItemCommon as PaymentScheduleItemCommonSchema
...
from zuora_python_sdk.type.post_add_items_to_payment_schedule_request import POSTAddItemsToPaymentScheduleRequest
from zuora_python_sdk.type.payment_schedule_item_common import PaymentScheduleItemCommon
from zuora_python_sdk.type.get_payment_schedule_response import GETPaymentScheduleResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_add_items_to_payment_schedule_request import POSTAddItemsToPaymentScheduleRequest as POSTAddItemsToPaymentScheduleRequestPydantic
...
from zuora_python_sdk.pydantic.payment_schedule_item_common import PaymentScheduleItemCommon as PaymentScheduleItemCommonPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTAddItemsToPaymentScheduleRequestSchema


request_body_post_add_items_to_payment_schedule_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_items_to_custom_payment_schedule_mapped_args(
        self,
        payment_schedule_key: str,
        items: typing.Optional[typing.List[PaymentScheduleItemCommon]] = None,
    ...
    async def _aadd_items_to_custom_payment_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/{paymentScheduleKey}/items',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_add_items_to_payment_schedule_request.serialize(body, content_type)
    ...
    def _add_items_to_custom_payment_schedule_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddItemsToCustomPaymentScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_items_to_custom_payment_schedule(
        self,
        payment_schedule_key: str,
        items: typing.Optional[typing.List[PaymentScheduleItemCommon]] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._add_items_to_custom_payment_schedule_mapped_args(
        ...
        return await self._aadd_items_to_custom_payment_schedule_oapg(
            body=args.body,
    ...
    def add_items_to_custom_payment_schedule(
        ...
        return self._add_items_to_custom_payment_schedule_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class AddItemsToCustomPaymentSchedule(BaseApi):
    ...
    async def aadd_items_to_custom_payment_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_items_to_custom_payment_schedule(
            payment_schedule_key=payment_schedule_key,
            items=items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def add_items_to_custom_payment_schedule(
        ...
        raw_response = self.raw.add_items_to_custom_payment_schedule(
            payment_schedule_key=payment_schedule_key,
            items=items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
