...
from zuora_python_sdk.model.migration_update_custom_object_definitions_request import MigrationUpdateCustomObjectDefinitionsRequest as MigrationUpdateCustomObjectDefinitionsRequestSchema
from zuora_python_sdk.model.custom_object_definition_update_action_request import CustomObjectDefinitionUpdateActionRequest as CustomObjectDefinitionUpdateActionRequestSchema
from zuora_python_sdk.model.migration_update_custom_object_definitions_response import MigrationUpdateCustomObjectDefinitionsResponse as MigrationUpdateCustomObjectDefinitionsResponseSchema

from zuora_python_sdk.type.custom_object_definition_update_action_request import CustomObjectDefinitionUpdateActionRequest
from zuora_python_sdk.type.migration_update_custom_object_definitions_request import MigrationUpdateCustomObjectDefinitionsRequest
from zuora_python_sdk.type.migration_update_custom_object_definitions_response import MigrationUpdateCustomObjectDefinitionsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.migration_update_custom_object_definitions_response import MigrationUpdateCustomObjectDefinitionsResponse as MigrationUpdateCustomObjectDefinitionsResponsePydantic
from zuora_python_sdk.pydantic.migration_update_custom_object_definitions_request import MigrationUpdateCustomObjectDefinitionsRequest as MigrationUpdateCustomObjectDefinitionsRequestPydantic
from zuora_python_sdk.pydantic.custom_object_definition_update_action_request import CustomObjectDefinitionUpdateActionRequest as CustomObjectDefinitionUpdateActionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MigrationUpdateCustomObjectDefinitionsRequestSchema


request_body_migration_update_custom_object_definitions_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MigrationUpdateCustomObjectDefinitionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: MigrationUpdateCustomObjectDefinitionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_custom_object_definition_mapped_args(
        self,
        actions: typing.List[CustomObjectDefinitionUpdateActionRequest],
        authorization: str,
    ...
    async def _aupdate_custom_object_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_migration_update_custom_object_definitions_request.serialize(body, content_type)
    ...
    def _update_custom_object_definition_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCustomObjectDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_custom_object_definition(
        self,
        actions: typing.List[CustomObjectDefinitionUpdateActionRequest],
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_custom_object_definition_mapped_args(
            actions=actions,
        ...
        return await self._aupdate_custom_object_definition_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def update_custom_object_definition(
        self,
        actions: typing.List[CustomObjectDefinitionUpdateActionRequest],
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._update_custom_object_definition_oapg(
            body=args.body,
            header_params=args.header,
        )

class UpdateCustomObjectDefinition(BaseApi):
    ...
    async def aupdate_custom_object_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MigrationUpdateCustomObjectDefinitionsResponsePydantic:
        raw_response = await self.raw.aupdate_custom_object_definition(
            actions=actions,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return MigrationUpdateCustomObjectDefinitionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MigrationUpdateCustomObjectDefinitionsResponsePydantic, raw_response.body)
    ...
    def update_custom_object_definition(
        ...
        raw_response = self.raw.update_custom_object_definition(
            actions=actions,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
