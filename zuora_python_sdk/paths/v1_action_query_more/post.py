...
from zuora_python_sdk.model.proxy_actionquery_more_request_conf import ProxyActionqueryMoreRequestConf as ProxyActionqueryMoreRequestConfSchema
from zuora_python_sdk.model.proxy_actionquery_more_request import ProxyActionqueryMoreRequest as ProxyActionqueryMoreRequestSchema
...
from zuora_python_sdk.model.proxy_actionquery_more_response import ProxyActionqueryMoreResponse as ProxyActionqueryMoreResponseSchema

from zuora_python_sdk.type.proxy_actionquery_more_request_conf import ProxyActionqueryMoreRequestConf
from zuora_python_sdk.type.proxy_actionquery_more_response import ProxyActionqueryMoreResponse
from zuora_python_sdk.type.proxy_unauthorized_response import ProxyUnauthorizedResponse
from zuora_python_sdk.type.proxy_actionquery_more_request import ProxyActionqueryMoreRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.proxy_actionquery_more_request_conf import ProxyActionqueryMoreRequestConf as ProxyActionqueryMoreRequestConfPydantic
...
from zuora_python_sdk.pydantic.proxy_actionquery_more_response import ProxyActionqueryMoreResponse as ProxyActionqueryMoreResponsePydantic
from zuora_python_sdk.pydantic.proxy_actionquery_more_request import ProxyActionqueryMoreRequest as ProxyActionqueryMoreRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyActionqueryMoreRequestSchema


request_body_proxy_actionquery_more_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProxyActionqueryMoreResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProxyActionqueryMoreResponse
...
class BaseApi(api_client.Api):
    ...
    def _p_os_tquery_more_mapped_args(
        self,
        query_locator: str,
        conf: typing.Optional[ProxyActionqueryMoreRequestConf] = None,
        ...
        if query_locator is not None:
            _body["queryLocator"] = query_locator
        args.body = _body
    ...
    async def _ap_os_tquery_more_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_actionquery_more_request.serialize(body, content_type)
...
class POsTqueryMoreRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_os_tquery_more(
        self,
        query_locator: str,
        conf: typing.Optional[ProxyActionqueryMoreRequestConf] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_os_tquery_more_mapped_args(
        ...
        return await self._ap_os_tquery_more_oapg(
            body=args.body,
    ...
    def p_os_tquery_more(
        ...
        return self._p_os_tquery_more_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POsTqueryMore(BaseApi):
    ...
    async def ap_os_tquery_more(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyActionqueryMoreResponsePydantic:
        raw_response = await self.raw.ap_os_tquery_more(
            query_locator=query_locator,
            conf=conf,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return ProxyActionqueryMoreResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyActionqueryMoreResponsePydantic, raw_response.body)
    ...
    def p_os_tquery_more(
        ...
        raw_response = self.raw.p_os_tquery_more(
            query_locator=query_locator,
            conf=conf,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
