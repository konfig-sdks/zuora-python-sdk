...
from zuora_python_sdk.model.get_product_type import GETProductType as GETProductTypeSchema

from zuora_python_sdk.type.get_product_type import GETProductType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_type import GETProductType as GETProductTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETProductTypeSchema
    ...
    async def _aproduct_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/catalog/products/{product-key}',
            headers=_headers,
        )
...
class ProductRaw(BaseApi):
    ...
    async def aproduct(
        ...
        **kwargs,
        ...
        args = self._product_mapped_args(
        ...
        return await self._aproduct_oapg(
...
class Product(BaseApi):
    ...
    async def aproduct(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductTypePydantic:
        raw_response = await self.raw.aproduct(
            product_key=product_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETProductTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETProductTypePydantic, raw_response.body)
