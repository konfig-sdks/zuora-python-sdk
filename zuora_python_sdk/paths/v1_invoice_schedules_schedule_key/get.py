...
class BaseApi(api_client.Api):
    ...
    def _invoice_schedule_mapped_args(
        self,
        schedule_key: str,
    ...
    async def _ainvoice_schedule_oapg(
        self,
...
class InvoiceScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoice_schedule(
        self,
        schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._invoice_schedule_mapped_args(
        ...
        return await self._ainvoice_schedule_oapg(
    ...
    def invoice_schedule(
        ...
        return self._invoice_schedule_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class InvoiceSchedule(BaseApi):
    ...
    async def ainvoice_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainvoice_schedule(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def invoice_schedule(
        ...
        raw_response = self.raw.invoice_schedule(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
