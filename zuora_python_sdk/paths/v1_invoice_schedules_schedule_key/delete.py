...
class BaseApi(api_client.Api):
    ...
    def _invoice_schedule_0_mapped_args(
        self,
        schedule_key: str,
    ...
    async def _ainvoice_schedule_0_oapg(
        self,
...
class InvoiceSchedule0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoice_schedule_0(
        self,
        schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._invoice_schedule_0_mapped_args(
        ...
        return await self._ainvoice_schedule_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def invoice_schedule_0(
        self,
        schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._invoice_schedule_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class InvoiceSchedule0(BaseApi):
    ...
    async def ainvoice_schedule_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainvoice_schedule_0(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def invoice_schedule_0(
        ...
        raw_response = self.raw.invoice_schedule_0(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
