...
from zuora_python_sdk.model.post_create_invoice_schedule_request import POSTCreateInvoiceScheduleRequest as POSTCreateInvoiceScheduleRequestSchema
from zuora_python_sdk.model.post_schedule_item_type import POSTScheduleItemType as POSTScheduleItemTypeSchema

from zuora_python_sdk.type.invoice_schedule_responses import InvoiceScheduleResponses
from zuora_python_sdk.type.post_create_invoice_schedule_request import POSTCreateInvoiceScheduleRequest
from zuora_python_sdk.type.invoice_schedule_specific_subscriptions import InvoiceScheduleSpecificSubscriptions
from zuora_python_sdk.type.post_schedule_item_type import POSTScheduleItemType
...
from zuora_python_sdk.pydantic.post_schedule_item_type import POSTScheduleItemType as POSTScheduleItemTypePydantic
...
from zuora_python_sdk.pydantic.post_create_invoice_schedule_request import POSTCreateInvoiceScheduleRequest as POSTCreateInvoiceScheduleRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreateInvoiceScheduleRequestSchema


request_body_post_create_invoice_schedule_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_invoice_schedule_mapped_args(
        self,
        body: POSTCreateInvoiceScheduleRequest,
        ...
        schedule_items: typing.Optional[typing.List[POSTScheduleItemType]] = None,
    ...
    async def _acreate_invoice_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoice-schedules',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_invoice_schedule_request.serialize(body, content_type)
    ...
    def _create_invoice_schedule_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateInvoiceScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_invoice_schedule(
        self,
        body: POSTCreateInvoiceScheduleRequest,
        account_key: typing.Optional[str] = None,
        additional_subscriptions_to_bill: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._create_invoice_schedule_mapped_args(
            body=body,
        ...
        return await self._acreate_invoice_schedule_oapg(
            body=args.body,
    ...
    def create_invoice_schedule(
        ...
        return self._create_invoice_schedule_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateInvoiceSchedule(BaseApi):
    ...
    async def acreate_invoice_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_invoice_schedule(
            body=body,
            account_key=account_key,
            additional_subscriptions_to_bill=additional_subscriptions_to_bill,
            invoice_separately=invoice_separately,
    ...
    def create_invoice_schedule(
        ...
        raw_response = self.raw.create_invoice_schedule(
            body=body,
            account_key=account_key,
            additional_subscriptions_to_bill=additional_subscriptions_to_bill,
            invoice_separately=invoice_separately,
