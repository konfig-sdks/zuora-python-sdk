...
from zuora_python_sdk.model.put_subscription_type import PUTSubscriptionType as PUTSubscriptionTypeSchema
from zuora_python_sdk.model.put_subscription_response_type import PUTSubscriptionResponseType as PUTSubscriptionResponseTypeSchema
from zuora_python_sdk.model.put_srp_remove_type import PUTSrpRemoveType as PUTSrpRemoveTypeSchema
from zuora_python_sdk.model.put_srp_change_type import PUTSrpChangeType as PUTSrpChangeTypeSchema
from zuora_python_sdk.model.put_srp_add_type import PUTSrpAddType as PUTSrpAddTypeSchema
from zuora_python_sdk.model.put_srp_update_type import PUTSrpUpdateType as PUTSrpUpdateTypeSchema

from zuora_python_sdk.type.put_subscription_type import PUTSubscriptionType
from zuora_python_sdk.type.put_srp_remove_type import PUTSrpRemoveType
from zuora_python_sdk.type.put_srp_update_type import PUTSrpUpdateType
from zuora_python_sdk.type.put_srp_change_type import PUTSrpChangeType
from zuora_python_sdk.type.put_srp_add_type import PUTSrpAddType
from zuora_python_sdk.type.put_subscription_response_type import PUTSubscriptionResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_subscription_type import PUTSubscriptionType as PUTSubscriptionTypePydantic
from zuora_python_sdk.pydantic.put_srp_add_type import PUTSrpAddType as PUTSrpAddTypePydantic
from zuora_python_sdk.pydantic.put_srp_remove_type import PUTSrpRemoveType as PUTSrpRemoveTypePydantic
from zuora_python_sdk.pydantic.put_srp_change_type import PUTSrpChangeType as PUTSrpChangeTypePydantic
from zuora_python_sdk.pydantic.put_subscription_response_type import PUTSubscriptionResponseType as PUTSubscriptionResponseTypePydantic
from zuora_python_sdk.pydantic.put_srp_update_type import PUTSrpUpdateType as PUTSrpUpdateTypePydantic
...
# Path params
SubscriptionKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'subscription-key': typing.Union[SubscriptionKeySchema, str, ],
    }
)
...
request_path_subscription_key = api_client.PathParameter(
    name="subscription-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubscriptionKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTSubscriptionTypeSchema


request_body_put_subscription_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTSubscriptionResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTSubscriptionResponseType
...
class BaseApi(api_client.Api):
    ...
    def _subscription_0_mapped_args(
        self,
        body: PUTSubscriptionType,
        subscription_key: str,
        add: typing.Optional[typing.List[PUTSrpAddType]] = None,
        ...
        booking_date: typing.Optional[date] = None,
        change: typing.Optional[typing.List[PUTSrpChangeType]] = None,
        collect: typing.Optional[bool] = None,
        credit_memo_reason_code: typing.Optional[str] = None,
        current_term: typing.Optional[int] = None,
        current_term_period_type: typing.Optional[str] = None,
        document_date: typing.Optional[date] = None,
        externally_managed_by: typing.Optional[str] = None,
        include_existing_draft_doc_items: typing.Optional[bool] = None,
        include_existing_draft_invoice_items: typing.Optional[bool] = None,
        ...
        preview_type: typing.Optional[str] = None,
        remove: typing.Optional[typing.List[PUTSrpRemoveType]] = None,
        ...
        update: typing.Optional[typing.List[PUTSrpUpdateType]] = None,
        ...
        if booking_date is not None:
            _body["bookingDate"] = booking_date
        ...
        if current_term is not None:
            _body["currentTerm"] = current_term
        if current_term_period_type is not None:
            _body["currentTermPeriodType"] = current_term_period_type
        ...
        if include_existing_draft_doc_items is not None:
            _body["includeExistingDraftDocItems"] = include_existing_draft_doc_items
        if include_existing_draft_invoice_items is not None:
            _body["includeExistingDraftInvoiceItems"] = include_existing_draft_invoice_items
        ...
        if preview is not None:
            _body["preview"] = preview
        if preview_type is not None:
            _body["previewType"] = preview_type
    ...
    async def _asubscription_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_subscription_type.serialize(body, content_type)
...
class Subscription0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubscription_0(
        self,
        body: PUTSubscriptionType,
        subscription_key: str,
        add: typing.Optional[typing.List[PUTSrpAddType]] = None,
        ...
        **kwargs,
        ...
        args = self._subscription_0_mapped_args(
            body=body,
            ...
            current_term_period_type=current_term_period_type,
            document_date=document_date,
            externally_managed_by=externally_managed_by,
            include_existing_draft_doc_items=include_existing_draft_doc_items,
            include_existing_draft_invoice_items=include_existing_draft_invoice_items,
            invoice=invoice,
        ...
        return await self._asubscription_0_oapg(
            body=args.body,
    ...
    def subscription_0(
        ...
        return self._subscription_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class Subscription0(BaseApi):
    ...
    async def asubscription_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTSubscriptionResponseTypePydantic:
        raw_response = await self.raw.asubscription_0(
            body=body,
            subscription_key=subscription_key,
            add=add,
            application_order=application_order,
        ...
        if validate:
            return PUTSubscriptionResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTSubscriptionResponseTypePydantic, raw_response.body)
    ...
    def subscription_0(
        ...
        raw_response = self.raw.subscription_0(
            body=body,
            subscription_key=subscription_key,
            add=add,
            application_order=application_order,
