...
class BaseApi(api_client.Api):
    ...
    def _subscriptions_by_key_mapped_args(
        self,
    ...
    async def _asubscriptions_by_key_oapg(
        self,
    ...
    def _subscriptions_by_key_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SubscriptionsByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubscriptions_by_key(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._subscriptions_by_key_mapped_args(
        ...
        return await self._asubscriptions_by_key_oapg(
    ...
    def subscriptions_by_key(
        ...
        return self._subscriptions_by_key_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class SubscriptionsByKey(BaseApi):
    ...
    async def asubscriptions_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubscriptions_by_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def subscriptions_by_key(
        ...
        raw_response = self.raw.subscriptions_by_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
