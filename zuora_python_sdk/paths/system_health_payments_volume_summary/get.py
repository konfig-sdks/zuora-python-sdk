...
from zuora_python_sdk.model.system_health_error_response import SystemHealthErrorResponse as SystemHealthErrorResponseSchema
from zuora_python_sdk.model.get_payment_volume_summary_response import GetPaymentVolumeSummaryResponse as GetPaymentVolumeSummaryResponseSchema

from zuora_python_sdk.type.get_payment_volume_summary_response import GetPaymentVolumeSummaryResponse
from zuora_python_sdk.type.system_health_error_response import SystemHealthErrorResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.system_health_error_response import SystemHealthErrorResponse as SystemHealthErrorResponsePydantic
from zuora_python_sdk.pydantic.get_payment_volume_summary_response import GetPaymentVolumeSummaryResponse as GetPaymentVolumeSummaryResponsePydantic

from . import path

# Query params
PaymentGatewayTypeSchema = schemas.StrSchema
PaymentMethodTypeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'paymentGatewayType': typing.Union[PaymentGatewayTypeSchema, str, ],
        'paymentMethodType': typing.Union[PaymentMethodTypeSchema, str, ],
    },
    total=False
)
...
request_query_payment_gateway_type = api_client.QueryParameter(
    name="paymentGatewayType",
    style=api_client.ParameterStyle.FORM,
    schema=PaymentGatewayTypeSchema,
    explode=True,
)
request_query_payment_method_type = api_client.QueryParameter(
...
SchemaFor200ResponseBodyApplicationJson = GetPaymentVolumeSummaryResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetPaymentVolumeSummaryResponse
...
SchemaFor400ResponseBodyApplicationJson = SystemHealthErrorResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _system_health_payment_volume_summary_mapped_args(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        payment_gateway_type: typing.Optional[str] = None,
        ...
        if payment_gateway_type is not None:
            _query_params["paymentGatewayType"] = payment_gateway_type
        if payment_method_type is not None:
            _query_params["paymentMethodType"] = payment_method_type
    ...
    async def _asystem_health_payment_volume_summary_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_payment_gateway_type,
            request_query_payment_method_type,
        ...
        request_before_hook(
            ...
            path_template='/system-health/payments/volume-summary',
            headers=_headers,
        )
    ...
    def _system_health_payment_volume_summary_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SystemHealthPaymentVolumeSummaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asystem_health_payment_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        **kwargs,
        ...
        args = self._system_health_payment_volume_summary_mapped_args(
        ...
        return await self._asystem_health_payment_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def system_health_payment_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        return self._system_health_payment_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class SystemHealthPaymentVolumeSummary(BaseApi):
    ...
    async def asystem_health_payment_volume_summary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetPaymentVolumeSummaryResponsePydantic:
        raw_response = await self.raw.asystem_health_payment_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GetPaymentVolumeSummaryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetPaymentVolumeSummaryResponsePydantic, raw_response.body)
    ...
    def system_health_payment_volume_summary(
        ...
        raw_response = self.raw.system_health_payment_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
