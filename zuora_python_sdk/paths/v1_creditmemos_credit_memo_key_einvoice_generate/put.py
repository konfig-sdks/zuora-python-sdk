...
class BaseApi(api_client.Api):
    ...
    def _generate_e_invoice_file_for_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _agenerate_e_invoice_file_for_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/einvoice/generate',
            headers=_headers,
        )
    ...
    def _generate_e_invoice_file_for_credit_memo_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GenerateEInvoiceFileForCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_e_invoice_file_for_credit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._generate_e_invoice_file_for_credit_memo_mapped_args(
        ...
        return await self._agenerate_e_invoice_file_for_credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def generate_e_invoice_file_for_credit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._generate_e_invoice_file_for_credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GenerateEInvoiceFileForCreditMemo(BaseApi):
    ...
    async def agenerate_e_invoice_file_for_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_e_invoice_file_for_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def generate_e_invoice_file_for_credit_memo(
        ...
        raw_response = self.raw.generate_e_invoice_file_for_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
