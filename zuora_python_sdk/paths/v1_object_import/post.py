...
from zuora_python_sdk.model.proxy_post_import import ProxyPostImport as ProxyPostImportSchema
from zuora_python_sdk.model.object_post_import_request import ObjectPostImportRequest as ObjectPostImportRequestSchema
...
from zuora_python_sdk.type.object_post_import_request import ObjectPostImportRequest
from zuora_python_sdk.type.proxy_post_import import ProxyPostImport
...
from zuora_python_sdk.pydantic.proxy_post_import import ProxyPostImport as ProxyPostImportPydantic
from zuora_python_sdk.pydantic.object_post_import_request import ObjectPostImportRequest as ObjectPostImportRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = ObjectPostImportRequestSchema


request_body_object_post_import_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProxyPostImportSchema
...
class BaseApi(api_client.Api):
    ...
    async def _ap_ost_import_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_object_post_import_request.serialize(body, content_type)
...
class POstImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_import(
        self,
        file: typing.IO,
        import_type: str,
        name: str,
        ...
        **kwargs,
        ...
        args = self._p_ost_import_mapped_args(
            file=file,
        ...
        return await self._ap_ost_import_oapg(
            body=args.body,
    ...
    def p_ost_import(
        ...
        return self._p_ost_import_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstImport(BaseApi):
    ...
    async def ap_ost_import(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyPostImportPydantic:
        raw_response = await self.raw.ap_ost_import(
            file=file,
            import_type=import_type,
            name=name,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return ProxyPostImportPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyPostImportPydantic, raw_response.body)
    ...
    def p_ost_import(
        ...
        raw_response = self.raw.p_ost_import(
            file=file,
            import_type=import_type,
            name=name,
            idempotency_key=idempotency_key,
