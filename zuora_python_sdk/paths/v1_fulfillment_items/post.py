...
from zuora_python_sdk.model.post_fulfillment_items_request_type import PostFulfillmentItemsRequestType as PostFulfillmentItemsRequestTypeSchema
from zuora_python_sdk.model.fulfillment_item_post import FulfillmentItemPost as FulfillmentItemPostSchema
from zuora_python_sdk.model.post_fulfillment_items_response_type import PostFulfillmentItemsResponseType as PostFulfillmentItemsResponseTypeSchema

from zuora_python_sdk.type.fulfillment_item_post import FulfillmentItemPost
from zuora_python_sdk.type.post_fulfillment_items_request_type import PostFulfillmentItemsRequestType
from zuora_python_sdk.type.post_fulfillment_items_response_type import PostFulfillmentItemsResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.fulfillment_item_post import FulfillmentItemPost as FulfillmentItemPostPydantic
from zuora_python_sdk.pydantic.post_fulfillment_items_request_type import PostFulfillmentItemsRequestType as PostFulfillmentItemsRequestTypePydantic
from zuora_python_sdk.pydantic.post_fulfillment_items_response_type import PostFulfillmentItemsResponseType as PostFulfillmentItemsResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostFulfillmentItemsRequestTypeSchema


request_body_post_fulfillment_items_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostFulfillmentItemsResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PostFulfillmentItemsResponseType
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_item_mapped_args(
        self,
        fulfillment_items: typing.Optional[typing.List[FulfillmentItemPost]] = None,
        ...
        if fulfillment_items is not None:
            _body["fulfillmentItems"] = fulfillment_items
        args.body = _body
    ...
    async def _afulfillment_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/fulfillment-items',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_fulfillment_items_request_type.serialize(body, content_type)
...
class FulfillmentItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_item(
        self,
        fulfillment_items: typing.Optional[typing.List[FulfillmentItemPost]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_item_mapped_args(
        ...
        return await self._afulfillment_item_oapg(
            body=args.body,
    ...
    def fulfillment_item(
        ...
        return self._fulfillment_item_oapg(
            body=args.body,
            header_params=args.header,
        )

class FulfillmentItem(BaseApi):
    ...
    async def afulfillment_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostFulfillmentItemsResponseTypePydantic:
        raw_response = await self.raw.afulfillment_item(
            fulfillment_items=fulfillment_items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[PostFulfillmentItemsResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(PostFulfillmentItemsResponseTypePydantic, raw_response.body)
    ...
    def fulfillment_item(
        ...
        raw_response = self.raw.fulfillment_item(
            fulfillment_items=fulfillment_items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
