...
from zuora_python_sdk.model.post_memo_pdf_response import POSTMemoPdfResponse as POSTMemoPdfResponseSchema

from zuora_python_sdk.type.post_memo_pdf_response import POSTMemoPdfResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_memo_pdf_response import POSTMemoPdfResponse as POSTMemoPdfResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = POSTMemoPdfResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_pdf_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _acredit_memo_pdf_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/pdfs',
            headers=_headers,
        )
...
class CreditMemoPdfRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_pdf(
        self,
        credit_memo_key: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_pdf_mapped_args(
        ...
        return await self._acredit_memo_pdf_oapg(
    ...
    def credit_memo_pdf(
        ...
        return self._credit_memo_pdf_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoPdf(BaseApi):
    ...
    async def acredit_memo_pdf(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTMemoPdfResponsePydantic:
        raw_response = await self.raw.acredit_memo_pdf(
            credit_memo_key=credit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTMemoPdfResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTMemoPdfResponsePydantic, raw_response.body)
    ...
    def credit_memo_pdf(
        ...
        raw_response = self.raw.credit_memo_pdf(
            credit_memo_key=credit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
