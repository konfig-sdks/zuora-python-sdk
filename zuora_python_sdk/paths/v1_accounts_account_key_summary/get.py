...
from zuora_python_sdk.model.get_account_summary_type import GETAccountSummaryType as GETAccountSummaryTypeSchema

from zuora_python_sdk.type.get_account_summary_type import GETAccountSummaryType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_account_summary_type import GETAccountSummaryType as GETAccountSummaryTypePydantic

from . import path

# Query params
ExcludeUsageSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'excludeUsage': typing.Union[ExcludeUsageSchema, bool, ],
    },
    total=False
)
...
request_query_exclude_usage = api_client.QueryParameter(
    name="excludeUsage",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeUsageSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GETAccountSummaryTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _account_summary_mapped_args(
        self,
        account_key: str,
        ...
        exclude_usage: typing.Optional[bool] = None,
        ...
        if exclude_usage is not None:
            _query_params["excludeUsage"] = exclude_usage
    ...
    async def _aaccount_summary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/{account-key}/summary',
            headers=_headers,
        )
...
class AccountSummaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccount_summary(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._account_summary_mapped_args(
        ...
        return await self._aaccount_summary_oapg(
    ...
    def account_summary(
        ...
        return self._account_summary_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class AccountSummary(BaseApi):
    ...
    async def aaccount_summary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountSummaryTypePydantic:
        raw_response = await self.raw.aaccount_summary(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETAccountSummaryTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAccountSummaryTypePydantic, raw_response.body)
    ...
    def account_summary(
        ...
        raw_response = self.raw.account_summary(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
