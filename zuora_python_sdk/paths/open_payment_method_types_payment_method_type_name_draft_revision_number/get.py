...
from zuora_python_sdk.model.get_open_payment_method_type_revision_response import GetOpenPaymentMethodTypeRevisionResponse as GetOpenPaymentMethodTypeRevisionResponseSchema

from zuora_python_sdk.type.get_open_payment_method_type_revision_response import GetOpenPaymentMethodTypeRevisionResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_open_payment_method_type_revision_response import GetOpenPaymentMethodTypeRevisionResponse as GetOpenPaymentMethodTypeRevisionResponsePydantic
...
RevisionNumberSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'paymentMethodTypeName': typing.Union[PaymentMethodTypeNameSchema, str, ],
        'revisionNumber': typing.Union[RevisionNumberSchema, decimal.Decimal, int, ],
    }
)
...
request_path_revision_number = api_client.PathParameter(
    name="revisionNumber",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RevisionNumberSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GetOpenPaymentMethodTypeRevisionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetOpenPaymentMethodTypeRevisionResponse
...
class BaseApi(api_client.Api):
    ...
    def _open_payment_method_type_revision_mapped_args(
        self,
        authorization: str,
    ...
    async def _aopen_payment_method_type_revision_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/open-payment-method-types/{paymentMethodTypeName}/draft/{revisionNumber}',
            headers=_headers,
        )
    ...
    def _open_payment_method_type_revision_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class OpenPaymentMethodTypeRevisionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aopen_payment_method_type_revision(
        self,
        authorization: str,
        payment_method_type_name: str,
        revision_number: int,
        ...
        **kwargs,
        ...
        args = self._open_payment_method_type_revision_mapped_args(
        ...
        return await self._aopen_payment_method_type_revision_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def open_payment_method_type_revision(
        self,
        authorization: str,
        payment_method_type_name: str,
        revision_number: int,
        ...
        return self._open_payment_method_type_revision_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class OpenPaymentMethodTypeRevision(BaseApi):
    ...
    async def aopen_payment_method_type_revision(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOpenPaymentMethodTypeRevisionResponsePydantic:
        raw_response = await self.raw.aopen_payment_method_type_revision(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            revision_number=revision_number,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GetOpenPaymentMethodTypeRevisionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetOpenPaymentMethodTypeRevisionResponsePydantic, raw_response.body)
    ...
    def open_payment_method_type_revision(
        ...
        raw_response = self.raw.open_payment_method_type_revision(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            revision_number=revision_number,
            accept_encoding=accept_encoding,
