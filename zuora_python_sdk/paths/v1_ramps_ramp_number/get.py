...
from zuora_python_sdk.model.get_ramp_by_ramp_number_response_type import GETRampByRampNumberResponseType as GETRampByRampNumberResponseTypeSchema

from zuora_python_sdk.type.get_ramp_by_ramp_number_response_type import GETRampByRampNumberResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_ramp_by_ramp_number_response_type import GETRampByRampNumberResponseType as GETRampByRampNumberResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETRampByRampNumberResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRampByRampNumberResponseType
...
class BaseApi(api_client.Api):
    ...
    def _ramp_by_ramp_number_mapped_args(
        self,
        ramp_number: str,
    ...
    async def _aramp_by_ramp_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/ramps/{rampNumber}',
            headers=_headers,
        )
...
class RampByRampNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aramp_by_ramp_number(
        self,
        ramp_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._ramp_by_ramp_number_mapped_args(
        ...
        return await self._aramp_by_ramp_number_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def ramp_by_ramp_number(
        self,
        ramp_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._ramp_by_ramp_number_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RampByRampNumber(BaseApi):
    ...
    async def aramp_by_ramp_number(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRampByRampNumberResponseTypePydantic:
        raw_response = await self.raw.aramp_by_ramp_number(
            ramp_number=ramp_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETRampByRampNumberResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRampByRampNumberResponseTypePydantic, raw_response.body)
    ...
    def ramp_by_ramp_number(
        ...
        raw_response = self.raw.ramp_by_ramp_number(
            ramp_number=ramp_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
