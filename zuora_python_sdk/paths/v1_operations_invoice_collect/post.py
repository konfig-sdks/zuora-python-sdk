...
from zuora_python_sdk.model.post_invoice_collect_type import POSTInvoiceCollectType as POSTInvoiceCollectTypeSchema
from zuora_python_sdk.model.post_invoice_collect_response_type import POSTInvoiceCollectResponseType as POSTInvoiceCollectResponseTypeSchema

from zuora_python_sdk.type.post_invoice_collect_response_type import POSTInvoiceCollectResponseType
from zuora_python_sdk.type.post_invoice_collect_type import POSTInvoiceCollectType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_invoice_collect_response_type import POSTInvoiceCollectResponseType as POSTInvoiceCollectResponseTypePydantic
from zuora_python_sdk.pydantic.post_invoice_collect_type import POSTInvoiceCollectType as POSTInvoiceCollectTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTInvoiceCollectTypeSchema


request_body_post_invoice_collect_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTInvoiceCollectResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTInvoiceCollectResponseType
...
class BaseApi(api_client.Api):
    ...
    def _transaction_invoice_payment_mapped_args(
        self,
        account_key: str,
    ...
    async def _atransaction_invoice_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_invoice_collect_type.serialize(body, content_type)
    ...
    def _transaction_invoice_payment_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class TransactionInvoicePaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atransaction_invoice_payment(
        self,
        account_key: str,
        document_date: typing.Optional[date] = None,
        invoice_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._transaction_invoice_payment_mapped_args(
        ...
        return await self._atransaction_invoice_payment_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def transaction_invoice_payment(
        self,
        account_key: str,
        document_date: typing.Optional[date] = None,
        invoice_date: typing.Optional[date] = None,
        ...
        return self._transaction_invoice_payment_oapg(
            body=args.body,
            header_params=args.header,
        )

class TransactionInvoicePayment(BaseApi):
    ...
    async def atransaction_invoice_payment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTInvoiceCollectResponseTypePydantic:
        raw_response = await self.raw.atransaction_invoice_payment(
            account_key=account_key,
            document_date=document_date,
            invoice_date=invoice_date,
            invoice_id=invoice_id,
        ...
        if validate:
            return POSTInvoiceCollectResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTInvoiceCollectResponseTypePydantic, raw_response.body)
    ...
    def transaction_invoice_payment(
        ...
        raw_response = self.raw.transaction_invoice_payment(
            account_key=account_key,
            document_date=document_date,
            invoice_date=invoice_date,
            invoice_id=invoice_id,
