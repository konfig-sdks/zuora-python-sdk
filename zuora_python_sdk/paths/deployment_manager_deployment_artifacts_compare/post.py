...
from zuora_python_sdk.model.post_compare_template_request import PostCompareTemplateRequest as PostCompareTemplateRequestSchema
from zuora_python_sdk.model.compare_schema_info_response import CompareSchemaInfoResponse as CompareSchemaInfoResponseSchema

from zuora_python_sdk.type.post_compare_template_request import PostCompareTemplateRequest
from zuora_python_sdk.type.compare_schema_info_response import CompareSchemaInfoResponse
from zuora_python_sdk.type.config_template_error_response import ConfigTemplateErrorResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.compare_schema_info_response import CompareSchemaInfoResponse as CompareSchemaInfoResponsePydantic
...
from zuora_python_sdk.pydantic.post_compare_template_request import PostCompareTemplateRequest as PostCompareTemplateRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostCompareTemplateRequestSchema


request_body_post_compare_template_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CompareSchemaInfoResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CompareSchemaInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _compare_template_mapped_args(
        self,
        authorization: str,
        tenant: str,
        ...
        template: typing.Optional[typing.IO] = None,
    ...
    async def _acompare_template_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployment_artifacts/compare',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_post_compare_template_request.serialize(body, content_type)
...
class CompareTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acompare_template(
        self,
        authorization: str,
        tenant: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._compare_template_mapped_args(
        ...
        return await self._acompare_template_oapg(
            body=args.body,
    ...
    def compare_template(
        ...
        return self._compare_template_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class CompareTemplate(BaseApi):
    ...
    async def acompare_template(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompareSchemaInfoResponsePydantic:
        raw_response = await self.raw.acompare_template(
            authorization=authorization,
            tenant=tenant,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return CompareSchemaInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompareSchemaInfoResponsePydantic, raw_response.body)
    ...
    def compare_template(
        ...
        raw_response = self.raw.compare_template(
            authorization=authorization,
            tenant=tenant,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
