...
from zuora_python_sdk.model.post_billing_preview_run_response import PostBillingPreviewRunResponse as PostBillingPreviewRunResponseSchema
from zuora_python_sdk.model.post_billing_preview_run_param_organization_labels import PostBillingPreviewRunParamOrganizationLabels as PostBillingPreviewRunParamOrganizationLabelsSchema
from zuora_python_sdk.model.post_billing_preview_run_param import PostBillingPreviewRunParam as PostBillingPreviewRunParamSchema

from zuora_python_sdk.type.post_billing_preview_run_param_organization_labels import PostBillingPreviewRunParamOrganizationLabels
from zuora_python_sdk.type.post_billing_preview_run_response import PostBillingPreviewRunResponse
from zuora_python_sdk.type.post_billing_preview_run_param import PostBillingPreviewRunParam

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_billing_preview_run_response import PostBillingPreviewRunResponse as PostBillingPreviewRunResponsePydantic
from zuora_python_sdk.pydantic.post_billing_preview_run_param import PostBillingPreviewRunParam as PostBillingPreviewRunParamPydantic
from zuora_python_sdk.pydantic.post_billing_preview_run_param_organization_labels import PostBillingPreviewRunParamOrganizationLabels as PostBillingPreviewRunParamOrganizationLabelsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostBillingPreviewRunParamSchema


request_body_post_billing_preview_run_param = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostBillingPreviewRunResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PostBillingPreviewRunResponse
...
class BaseApi(api_client.Api):
    ...
    def _billing_preview_run_mapped_args(
        self,
        target_date: date,
        assume_renewal: typing.Optional[str] = None,
        batch: typing.Optional[str] = None,
        batches: typing.Optional[str] = None,
        charge_type_to_exclude: typing.Optional[str] = None,
        including_draft_items: typing.Optional[bool] = None,
        including_evergreen_subscription: typing.Optional[bool] = None,
        organization_labels: typing.Optional[PostBillingPreviewRunParamOrganizationLabels] = None,
        storage_option: typing.Optional[str] = None,
        ...
        if assume_renewal is not None:
            _body["assumeRenewal"] = assume_renewal
    ...
    async def _abilling_preview_run_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_billing_preview_run_param.serialize(body, content_type)
...
class BillingPreviewRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abilling_preview_run(
        self,
        target_date: date,
        assume_renewal: typing.Optional[str] = None,
        batch: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._billing_preview_run_mapped_args(
            target_date=target_date,
            assume_renewal=assume_renewal,
            batch=batch,
            batches=batches,
            charge_type_to_exclude=charge_type_to_exclude,
            including_draft_items=including_draft_items,
            including_evergreen_subscription=including_evergreen_subscription,
        ...
        return await self._abilling_preview_run_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def billing_preview_run(
        self,
        target_date: date,
        assume_renewal: typing.Optional[str] = None,
        batch: typing.Optional[str] = None,
        ...
        return self._billing_preview_run_oapg(
            body=args.body,
            header_params=args.header,
        )

class BillingPreviewRun(BaseApi):
    ...
    async def abilling_preview_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostBillingPreviewRunResponsePydantic:
        raw_response = await self.raw.abilling_preview_run(
            target_date=target_date,
            assume_renewal=assume_renewal,
            batch=batch,
            batches=batches,
        ...
        if validate:
            return PostBillingPreviewRunResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PostBillingPreviewRunResponsePydantic, raw_response.body)
    ...
    def billing_preview_run(
        ...
        raw_response = self.raw.billing_preview_run(
            target_date=target_date,
            assume_renewal=assume_renewal,
            batch=batch,
            batches=batches,
