...
from zuora_python_sdk.model.get_accounting_period_type import GETAccountingPeriodType as GETAccountingPeriodTypeSchema

from zuora_python_sdk.type.get_accounting_period_type import GETAccountingPeriodType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_accounting_period_type import GETAccountingPeriodType as GETAccountingPeriodTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAccountingPeriodTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _accounting_period_0_mapped_args(
        self,
        ap_id: str,
    ...
    async def _aaccounting_period_0_oapg(
        self,
...
class AccountingPeriod0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_period_0(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_period_0_mapped_args(
            ap_id=ap_id,
        ...
        return await self._aaccounting_period_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def accounting_period_0(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._accounting_period_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AccountingPeriod0(BaseApi):
    ...
    async def aaccounting_period_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountingPeriodTypePydantic:
        raw_response = await self.raw.aaccounting_period_0(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETAccountingPeriodTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAccountingPeriodTypePydantic, raw_response.body)
    ...
    def accounting_period_0(
        ...
        raw_response = self.raw.accounting_period_0(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
