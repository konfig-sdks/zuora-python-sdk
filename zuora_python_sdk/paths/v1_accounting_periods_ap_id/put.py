...
from zuora_python_sdk.model.put_accounting_period_type import PUTAccountingPeriodType as PUTAccountingPeriodTypeSchema

from zuora_python_sdk.type.put_accounting_period_type import PUTAccountingPeriodType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_accounting_period_type import PUTAccountingPeriodType as PUTAccountingPeriodTypePydantic
...
# Path params
ApIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ap-id': typing.Union[ApIdSchema, str, ],
    }
)
...
request_path_ap_id = api_client.PathParameter(
    name="ap-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ApIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = PUTAccountingPeriodTypeSchema


request_body_put_accounting_period_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_accounting_period_mapped_args(
        self,
        body: PUTAccountingPeriodType,
        ap_id: str,
    ...
    async def _aupdate_accounting_period_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-periods/{ap-id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_accounting_period_type.serialize(body, content_type)
    ...
    def _update_accounting_period_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateAccountingPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_accounting_period(
        self,
        body: PUTAccountingPeriodType,
        ap_id: str,
        end_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._update_accounting_period_mapped_args(
            body=body,
            ap_id=ap_id,
            end_date=end_date,
        ...
        return await self._aupdate_accounting_period_oapg(
            body=args.body,
    ...
    def update_accounting_period(
        ...
        return self._update_accounting_period_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateAccountingPeriod(BaseApi):
    ...
    async def aupdate_accounting_period(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_accounting_period(
            body=body,
            ap_id=ap_id,
            end_date=end_date,
            fiscal_year=fiscal_year,
    ...
    def update_accounting_period(
        ...
        raw_response = self.raw.update_accounting_period(
            body=body,
            ap_id=ap_id,
            end_date=end_date,
            fiscal_year=fiscal_year,
