...
class BaseApi(api_client.Api):
    ...
    def _accounting_period_1_mapped_args(
        self,
        ap_id: str,
    ...
    async def _aaccounting_period_1_oapg(
        self,
...
class AccountingPeriod1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_period_1(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_period_1_mapped_args(
            ap_id=ap_id,
        ...
        return await self._aaccounting_period_1_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def accounting_period_1(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._accounting_period_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AccountingPeriod1(BaseApi):
    ...
    async def aaccounting_period_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccounting_period_1(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def accounting_period_1(
        ...
        raw_response = self.raw.accounting_period_1(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
