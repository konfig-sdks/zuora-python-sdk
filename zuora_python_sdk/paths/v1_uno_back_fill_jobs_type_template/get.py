...
from zuora_python_sdk.model.data_backfill_job_type import DataBackfillJobType as DataBackfillJobTypeSchema

from zuora_python_sdk.type.data_backfill_job_type import DataBackfillJobType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.data_backfill_job_type import DataBackfillJobType as DataBackfillJobTypePydantic
...
# Path params
TypeSchema = DataBackfillJobTypeSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'type': typing.Union[DataBackfillJobTypeSchema, ],
    }
)
...
request_path_type = api_client.PathParameter(
    name="type",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DataBackfillJobTypeSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _data_backfill_template_mapped_args(
        self,
        authorization: str,
        type: DataBackfillJobType,
    ...
    async def _adata_backfill_template_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/uno/back-fill/jobs/{type}/template',
            headers=_headers,
        )
    ...
    def _data_backfill_template_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DataBackfillTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_backfill_template(
        self,
        authorization: str,
        type: DataBackfillJobType,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_backfill_template_mapped_args(
        ...
        return await self._adata_backfill_template_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def data_backfill_template(
        self,
        authorization: str,
        type: DataBackfillJobType,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._data_backfill_template_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DataBackfillTemplate(BaseApi):
    ...
    async def adata_backfill_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adata_backfill_template(
            authorization=authorization,
            type=type,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def data_backfill_template(
        ...
        raw_response = self.raw.data_backfill_template(
            authorization=authorization,
            type=type,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
