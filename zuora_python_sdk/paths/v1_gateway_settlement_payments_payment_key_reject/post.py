...
from zuora_python_sdk.model.post_reject_payment_request import POSTRejectPaymentRequest as POSTRejectPaymentRequestSchema
from zuora_python_sdk.model.post_reject_payment_response import POSTRejectPaymentResponse as POSTRejectPaymentResponseSchema

from zuora_python_sdk.type.post_reject_payment_request import POSTRejectPaymentRequest
from zuora_python_sdk.type.post_reject_payment_response import POSTRejectPaymentResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_reject_payment_response import POSTRejectPaymentResponse as POSTRejectPaymentResponsePydantic
from zuora_python_sdk.pydantic.post_reject_payment_request import POSTRejectPaymentRequest as POSTRejectPaymentRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTRejectPaymentRequestSchema


request_body_post_reject_payment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTRejectPaymentResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTRejectPaymentResponse
...
class BaseApi(api_client.Api):
    ...
    def _reject_payment_mapped_args(
        self,
        payment_key: str,
    ...
    async def _areject_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/gateway-settlement/payments/{payment-key}/reject',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_reject_payment_request.serialize(body, content_type)
...
class RejectPaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areject_payment(
        self,
        payment_key: str,
        gateway_reconciliation_reason: typing.Optional[str] = None,
        gateway_reconciliation_status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._reject_payment_mapped_args(
        ...
        return await self._areject_payment_oapg(
            body=args.body,
    ...
    def reject_payment(
        ...
        return self._reject_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RejectPayment(BaseApi):
    ...
    async def areject_payment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTRejectPaymentResponsePydantic:
        raw_response = await self.raw.areject_payment(
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
            gateway_response=gateway_response,
        ...
        if validate:
            return POSTRejectPaymentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTRejectPaymentResponsePydantic, raw_response.body)
    ...
    def reject_payment(
        ...
        raw_response = self.raw.reject_payment(
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
            gateway_response=gateway_response,
