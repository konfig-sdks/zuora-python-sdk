...
from zuora_python_sdk.model.get_fulfillment_item_response_type import GetFulfillmentItemResponseType as GetFulfillmentItemResponseTypeSchema

from zuora_python_sdk.type.get_fulfillment_item_response_type import GetFulfillmentItemResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_fulfillment_item_response_type import GetFulfillmentItemResponseType as GetFulfillmentItemResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetFulfillmentItemResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetFulfillmentItemResponseType
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_item_0_mapped_args(
        self,
        id: str,
    ...
    async def _afulfillment_item_0_oapg(
        self,
...
class FulfillmentItem0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_item_0(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_item_0_mapped_args(
            id=id,
        ...
        return await self._afulfillment_item_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def fulfillment_item_0(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._fulfillment_item_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class FulfillmentItem0(BaseApi):
    ...
    async def afulfillment_item_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetFulfillmentItemResponseTypePydantic:
        raw_response = await self.raw.afulfillment_item_0(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GetFulfillmentItemResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetFulfillmentItemResponseTypePydantic, raw_response.body)
    ...
    def fulfillment_item_0(
        ...
        raw_response = self.raw.fulfillment_item_0(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
