...
from zuora_python_sdk.model.put_fulfillment_item_request_type import PutFulfillmentItemRequestType as PutFulfillmentItemRequestTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.fulfillment_item_custom_fields import FulfillmentItemCustomFields as FulfillmentItemCustomFieldsSchema

from zuora_python_sdk.type.fulfillment_item_custom_fields import FulfillmentItemCustomFields
from zuora_python_sdk.type.put_fulfillment_item_request_type import PutFulfillmentItemRequestType
...
from zuora_python_sdk.pydantic.fulfillment_item_custom_fields import FulfillmentItemCustomFields as FulfillmentItemCustomFieldsPydantic
from zuora_python_sdk.pydantic.put_fulfillment_item_request_type import PutFulfillmentItemRequestType as PutFulfillmentItemRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutFulfillmentItemRequestTypeSchema


request_body_put_fulfillment_item_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_item_1_mapped_args(
        self,
        id: str,
        description: typing.Optional[str] = None,
        custom_fields: typing.Optional[FulfillmentItemCustomFields] = None,
        item_identifier: typing.Optional[str] = None,
        ...
        if item_identifier is not None:
            _body["itemIdentifier"] = item_identifier
        args.body = _body
    ...
    async def _afulfillment_item_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/fulfillment-items/{id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_fulfillment_item_request_type.serialize(body, content_type)
...
class FulfillmentItem1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_item_1(
        self,
        id: str,
        description: typing.Optional[str] = None,
        custom_fields: typing.Optional[FulfillmentItemCustomFields] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_item_1_mapped_args(
            id=id,
        ...
        return await self._afulfillment_item_1_oapg(
            body=args.body,
    ...
    def fulfillment_item_1(
        ...
        return self._fulfillment_item_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class FulfillmentItem1(BaseApi):
    ...
    async def afulfillment_item_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afulfillment_item_1(
            id=id,
            description=description,
            custom_fields=custom_fields,
            item_identifier=item_identifier,
    ...
    def fulfillment_item_1(
        ...
        raw_response = self.raw.fulfillment_item_1(
            id=id,
            description=description,
            custom_fields=custom_fields,
            item_identifier=item_identifier,
