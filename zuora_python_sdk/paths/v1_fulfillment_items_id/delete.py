...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_item_2_mapped_args(
        self,
        id: str,
    ...
    async def _afulfillment_item_2_oapg(
        self,
...
class FulfillmentItem2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_item_2(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_item_2_mapped_args(
            id=id,
        ...
        return await self._afulfillment_item_2_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def fulfillment_item_2(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._fulfillment_item_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class FulfillmentItem2(BaseApi):
    ...
    async def afulfillment_item_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afulfillment_item_2(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def fulfillment_item_2(
        ...
        raw_response = self.raw.fulfillment_item_2(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
