...
from zuora_python_sdk.model.notifications_history_deletion_task_response import NotificationsHistoryDeletionTaskResponse as NotificationsHistoryDeletionTaskResponseSchema

from zuora_python_sdk.type.error_response import ErrorResponse
from zuora_python_sdk.type.notifications_history_deletion_task_response import NotificationsHistoryDeletionTaskResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.notifications_history_deletion_task_response import NotificationsHistoryDeletionTaskResponse as NotificationsHistoryDeletionTaskResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NotificationsHistoryDeletionTaskResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: NotificationsHistoryDeletionTaskResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_notification_history_deletion_task_by_id_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _aget_notification_history_deletion_task_by_id_oapg(
        self,
    ...
    def _get_notification_history_deletion_task_by_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetNotificationHistoryDeletionTaskByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_notification_history_deletion_task_by_id(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_notification_history_deletion_task_by_id_mapped_args(
        ...
        return await self._aget_notification_history_deletion_task_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def get_notification_history_deletion_task_by_id(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._get_notification_history_deletion_task_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetNotificationHistoryDeletionTaskById(BaseApi):
    ...
    async def aget_notification_history_deletion_task_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NotificationsHistoryDeletionTaskResponsePydantic:
        raw_response = await self.raw.aget_notification_history_deletion_task_by_id(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return NotificationsHistoryDeletionTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NotificationsHistoryDeletionTaskResponsePydantic, raw_response.body)
    ...
    def get_notification_history_deletion_task_by_id(
        ...
        raw_response = self.raw.get_notification_history_deletion_task_by_id(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
