...
from zuora_python_sdk.model.get_subscription_type_with_success import GETSubscriptionTypeWithSuccess as GETSubscriptionTypeWithSuccessSchema

from zuora_python_sdk.type.get_subscription_type_with_success import GETSubscriptionTypeWithSuccess

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_subscription_type_with_success import GETSubscriptionTypeWithSuccess as GETSubscriptionTypeWithSuccessPydantic

from . import path

# Query params
ChargeDetailSchema = schemas.StrSchema
ExcludeRatePlansWithNoChargesSchema = schemas.BoolSchema
GetDetailedMetricsSchema = schemas.BoolSchema
AsOfDaySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'charge-detail': typing.Union[ChargeDetailSchema, str, ],
        'exclude-rate-plans-with-no-charges': typing.Union[ExcludeRatePlansWithNoChargesSchema, bool, ],
        'getDetailedMetrics': typing.Union[GetDetailedMetricsSchema, bool, ],
        'asOfDay': typing.Union[AsOfDaySchema, str, ],
    },
    total=False
)
...
request_query_charge_detail = api_client.QueryParameter(
    name="charge-detail",
    style=api_client.ParameterStyle.FORM,
    schema=ChargeDetailSchema,
    explode=True,
)
request_query_exclude_rate_plans_with_no_charges = api_client.QueryParameter(
    name="exclude-rate-plans-with-no-charges",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeRatePlansWithNoChargesSchema,
    explode=True,
)
request_query_get_detailed_metrics = api_client.QueryParameter(
    name="getDetailedMetrics",
    style=api_client.ParameterStyle.FORM,
    schema=GetDetailedMetricsSchema,
    explode=True,
)
request_query_as_of_day = api_client.QueryParameter(
    name="asOfDay",
    style=api_client.ParameterStyle.FORM,
    schema=AsOfDaySchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GETSubscriptionTypeWithSuccessSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETSubscriptionTypeWithSuccess
...
class BaseApi(api_client.Api):
    ...
    def _subscriptions_by_key_and_version_mapped_args(
        self,
        ...
        charge_detail: typing.Optional[str] = None,
        exclude_rate_plans_with_no_charges: typing.Optional[bool] = None,
        get_detailed_metrics: typing.Optional[bool] = None,
        as_of_day: typing.Optional[str] = None,
        ...
        if charge_detail is not None:
            _query_params["charge-detail"] = charge_detail
        if exclude_rate_plans_with_no_charges is not None:
            _query_params["exclude-rate-plans-with-no-charges"] = exclude_rate_plans_with_no_charges
        if get_detailed_metrics is not None:
            _query_params["getDetailedMetrics"] = get_detailed_metrics
        if as_of_day is not None:
            _query_params["asOfDay"] = as_of_day
    ...
    async def _asubscriptions_by_key_and_version_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_charge_detail,
            request_query_exclude_rate_plans_with_no_charges,
            request_query_get_detailed_metrics,
            request_query_as_of_day,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/versions/{version}',
            headers=_headers,
        )
    ...
    def _subscriptions_by_key_and_version_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SubscriptionsByKeyAndVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubscriptions_by_key_and_version(
        self,
        subscription_key: str,
        version: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._subscriptions_by_key_and_version_mapped_args(
        ...
        return await self._asubscriptions_by_key_and_version_oapg(
    ...
    def subscriptions_by_key_and_version(
        self,
        subscription_key: str,
        version: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._subscriptions_by_key_and_version_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class SubscriptionsByKeyAndVersion(BaseApi):
    ...
    async def asubscriptions_by_key_and_version(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETSubscriptionTypeWithSuccessPydantic:
        raw_response = await self.raw.asubscriptions_by_key_and_version(
            subscription_key=subscription_key,
            version=version,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GETSubscriptionTypeWithSuccessPydantic](raw_response.body).root
        return api_client.construct_model_instance(GETSubscriptionTypeWithSuccessPydantic, raw_response.body)
    ...
    def subscriptions_by_key_and_version(
        ...
        raw_response = self.raw.subscriptions_by_key_and_version(
            subscription_key=subscription_key,
            version=version,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
