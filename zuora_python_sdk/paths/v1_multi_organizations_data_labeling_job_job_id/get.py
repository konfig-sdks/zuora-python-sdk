...
from zuora_python_sdk.model.get_data_labeling_job_response import GetDataLabelingJobResponse as GetDataLabelingJobResponseSchema

from zuora_python_sdk.type.get_data_labeling_job_response import GetDataLabelingJobResponse
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_data_labeling_job_response import GetDataLabelingJobResponse as GetDataLabelingJobResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetDataLabelingJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetDataLabelingJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _data_labeling_job_0_mapped_args(
        self,
        authorization: str,
        job_id: str,
    ...
    async def _adata_labeling_job_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/multi-organizations/data-labeling-job/{job-id}',
            headers=_headers,
        )
...
class DataLabelingJob0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_labeling_job_0(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_labeling_job_0_mapped_args(
        ...
        return await self._adata_labeling_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def data_labeling_job_0(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._data_labeling_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DataLabelingJob0(BaseApi):
    ...
    async def adata_labeling_job_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDataLabelingJobResponsePydantic:
        raw_response = await self.raw.adata_labeling_job_0(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GetDataLabelingJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetDataLabelingJobResponsePydantic, raw_response.body)
    ...
    def data_labeling_job_0(
        ...
        raw_response = self.raw.data_labeling_job_0(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
