...
from zuora_python_sdk.model.get_email_history_vos_type import GETEmailHistoryVOsType as GETEmailHistoryVOsTypeSchema

from zuora_python_sdk.type.get_email_history_vos_type import GETEmailHistoryVOsType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_email_history_vos_type import GETEmailHistoryVOsType as GETEmailHistoryVOsTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETEmailHistoryVOsTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _email_history_mapped_args(
        self,
    ...
    async def _aemail_history_oapg(
        self,
...
class EmailHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemail_history(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._email_history_mapped_args(
        ...
        return await self._aemail_history_oapg(
    ...
    def email_history(
        ...
        return self._email_history_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class EmailHistory(BaseApi):
    ...
    async def aemail_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETEmailHistoryVOsTypePydantic:
        raw_response = await self.raw.aemail_history(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETEmailHistoryVOsTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETEmailHistoryVOsTypePydantic, raw_response.body)
    ...
    def email_history(
        ...
        raw_response = self.raw.email_history(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
