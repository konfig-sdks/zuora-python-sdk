...
from zuora_python_sdk.model.refund_part_response_type import RefundPartResponseType as RefundPartResponseTypeSchema

from zuora_python_sdk.type.refund_part_response_type import RefundPartResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.refund_part_response_type import RefundPartResponseType as RefundPartResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = RefundPartResponseTypeSchema
    ...
    async def _arefund_part_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundKey}/parts/{refundpartid}',
            headers=_headers,
        )
...
class RefundPartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefund_part(
        self,
        refundpartid: str,
        refund_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._refund_part_mapped_args(
        ...
        return await self._arefund_part_oapg(
    ...
    def refund_part(
        ...
        return self._refund_part_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RefundPart(BaseApi):
    ...
    async def arefund_part(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RefundPartResponseTypePydantic:
        raw_response = await self.raw.arefund_part(
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RefundPartResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(RefundPartResponseTypePydantic, raw_response.body)
    ...
    def refund_part(
        ...
        raw_response = self.raw.refund_part(
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
