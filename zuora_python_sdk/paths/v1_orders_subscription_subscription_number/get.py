...
from zuora_python_sdk.model.get_orders_response import GetOrdersResponse as GetOrdersResponseSchema

from zuora_python_sdk.type.get_orders_response import GetOrdersResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_orders_response import GetOrdersResponse as GetOrdersResponsePydantic
...
DateFilterOptionSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'dateFilterOption': typing.Union[DateFilterOptionSchema, str, ],
...
request_query_date_filter_option = api_client.QueryParameter(
    name="dateFilterOption",
    style=api_client.ParameterStyle.FORM,
    schema=DateFilterOptionSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GetOrdersResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _orders_by_subscription_number_mapped_args(
        self,
        ...
        date_filter_option: typing.Optional[str] = None,
        ...
        if date_filter_option is not None:
            _query_params["dateFilterOption"] = date_filter_option
    ...
    async def _aorders_by_subscription_number_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_date_filter_option,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/subscription/{subscriptionNumber}',
            headers=_headers,
        )
    ...
    def _orders_by_subscription_number_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class OrdersBySubscriptionNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorders_by_subscription_number(
        self,
        subscription_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._orders_by_subscription_number_mapped_args(
        ...
        return await self._aorders_by_subscription_number_oapg(
    ...
    def orders_by_subscription_number(
        self,
        subscription_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._orders_by_subscription_number_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class OrdersBySubscriptionNumber(BaseApi):
    ...
    async def aorders_by_subscription_number(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOrdersResponsePydantic:
        raw_response = await self.raw.aorders_by_subscription_number(
            subscription_number=subscription_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GetOrdersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetOrdersResponsePydantic, raw_response.body)
    ...
    def orders_by_subscription_number(
        ...
        raw_response = self.raw.orders_by_subscription_number(
            subscription_number=subscription_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
