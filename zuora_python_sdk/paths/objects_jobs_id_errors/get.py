...
from zuora_python_sdk.model.custom_object_bulk_job_error_response_collection import CustomObjectBulkJobErrorResponseCollection as CustomObjectBulkJobErrorResponseCollectionSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.custom_object_bulk_job_error_response_collection import CustomObjectBulkJobErrorResponseCollection
...
from zuora_python_sdk.pydantic.custom_object_bulk_job_error_response_collection import CustomObjectBulkJobErrorResponseCollection as CustomObjectBulkJobErrorResponseCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomObjectBulkJobErrorResponseCollectionSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomObjectBulkJobErrorResponseCollection
...
class BaseApi(api_client.Api):
    ...
    def _custom_object_bulk_job_errors_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _acustom_object_bulk_job_errors_oapg(
        self,
    ...
    def _custom_object_bulk_job_errors_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectBulkJobErrorsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_bulk_job_errors(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._custom_object_bulk_job_errors_mapped_args(
        ...
        return await self._acustom_object_bulk_job_errors_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def custom_object_bulk_job_errors(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._custom_object_bulk_job_errors_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectBulkJobErrors(BaseApi):
    ...
    async def acustom_object_bulk_job_errors(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomObjectBulkJobErrorResponseCollectionPydantic:
        raw_response = await self.raw.acustom_object_bulk_job_errors(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return CustomObjectBulkJobErrorResponseCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomObjectBulkJobErrorResponseCollectionPydantic, raw_response.body)
    ...
    def custom_object_bulk_job_errors(
        ...
        raw_response = self.raw.custom_object_bulk_job_errors(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
