...
from zuora_python_sdk.model.get_product_rate_plan_definition_response import GETProductRatePlanDefinitionResponse as GETProductRatePlanDefinitionResponseSchema

from zuora_python_sdk.type.get_product_rate_plan_definition_response import GETProductRatePlanDefinitionResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plan_definition_response import GETProductRatePlanDefinitionResponse as GETProductRatePlanDefinitionResponsePydantic
...
# Path params
ProductRateplanDefinitionKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product-rateplan-definition-key': typing.Union[ProductRateplanDefinitionKeySchema, str, ],
    }
)
...
request_path_product_rateplan_definition_key = api_client.PathParameter(
    name="product-rateplan-definition-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProductRateplanDefinitionKeySchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlanDefinitionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlanDefinitionResponse
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_product_rate_plan_definition_mapped_args(
        self,
        product_rateplan_definition_key: str,
        ...
        if product_rateplan_definition_key is not None:
            _path_params["product-rateplan-definition-key"] = product_rateplan_definition_key
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aretrieve_product_rate_plan_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_product_rateplan_definition_key,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/product-rateplan-definitions/{product-rateplan-definition-key}',
            headers=_headers,
        )
    ...
    def _retrieve_product_rate_plan_definition_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetrieveProductRatePlanDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_product_rate_plan_definition(
        self,
        product_rateplan_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_product_rate_plan_definition_mapped_args(
            product_rateplan_definition_key=product_rateplan_definition_key,
        ...
        return await self._aretrieve_product_rate_plan_definition_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def retrieve_product_rate_plan_definition(
        self,
        product_rateplan_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._retrieve_product_rate_plan_definition_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RetrieveProductRatePlanDefinition(BaseApi):
    ...
    async def aretrieve_product_rate_plan_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlanDefinitionResponsePydantic:
        raw_response = await self.raw.aretrieve_product_rate_plan_definition(
            product_rateplan_definition_key=product_rateplan_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETProductRatePlanDefinitionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductRatePlanDefinitionResponsePydantic, raw_response.body)
    ...
    def retrieve_product_rate_plan_definition(
        ...
        raw_response = self.raw.retrieve_product_rate_plan_definition(
            product_rateplan_definition_key=product_rateplan_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
