...
class BaseApi(api_client.Api):
    ...
    def _product_rate_plan_defnition_mapped_args(
        self,
    ...
    async def _aproduct_rate_plan_defnition_oapg(
        self,
    ...
    def _product_rate_plan_defnition_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ProductRatePlanDefnitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproduct_rate_plan_defnition(
        self,
        product_rateplan_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._product_rate_plan_defnition_mapped_args(
        ...
        return await self._aproduct_rate_plan_defnition_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def product_rate_plan_defnition(
        self,
        product_rateplan_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._product_rate_plan_defnition_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ProductRatePlanDefnition(BaseApi):
    ...
    async def aproduct_rate_plan_defnition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aproduct_rate_plan_defnition(
            product_rateplan_definition_key=product_rateplan_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def product_rate_plan_defnition(
        ...
        raw_response = self.raw.product_rate_plan_defnition(
            product_rateplan_definition_key=product_rateplan_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
