...
class BaseApi(api_client.Api):
    ...
    def _activate_accounting_code_mapped_args(
        self,
        ac_id: str,
    ...
    async def _aactivate_accounting_code_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-codes/{ac-id}/activate',
            headers=_headers,
        )
    ...
    def _activate_accounting_code_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ActivateAccountingCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aactivate_accounting_code(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._activate_accounting_code_mapped_args(
            ac_id=ac_id,
        ...
        return await self._aactivate_accounting_code_oapg(
    ...
    def activate_accounting_code(
        ...
        return self._activate_accounting_code_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ActivateAccountingCode(BaseApi):
    ...
    async def aactivate_accounting_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aactivate_accounting_code(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def activate_accounting_code(
        ...
        raw_response = self.raw.activate_accounting_code(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
