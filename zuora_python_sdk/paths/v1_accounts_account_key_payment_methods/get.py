...
from zuora_python_sdk.model.get_account_payment_method_type import GETAccountPaymentMethodType as GETAccountPaymentMethodTypeSchema

from zuora_python_sdk.type.get_account_payment_method_type import GETAccountPaymentMethodType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_account_payment_method_type import GETAccountPaymentMethodType as GETAccountPaymentMethodTypePydantic

from . import path

# Query params
IsDefaultOnlySchema = schemas.BoolSchema
IsActiveOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'isDefaultOnly': typing.Union[IsDefaultOnlySchema, bool, ],
        'isActiveOnly': typing.Union[IsActiveOnlySchema, bool, ],
    },
    total=False
)
...
request_query_is_default_only = api_client.QueryParameter(
    name="isDefaultOnly",
    style=api_client.ParameterStyle.FORM,
    schema=IsDefaultOnlySchema,
    explode=True,
)
request_query_is_active_only = api_client.QueryParameter(
    name="isActiveOnly",
    style=api_client.ParameterStyle.FORM,
    schema=IsActiveOnlySchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GETAccountPaymentMethodTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAccountPaymentMethodType
...
class BaseApi(api_client.Api):
    ...
    def _acount_payment_methods_mapped_args(
        self,
        account_key: str,
        ...
        is_default_only: typing.Optional[bool] = None,
        is_active_only: typing.Optional[bool] = None,
        ...
        if is_default_only is not None:
            _query_params["isDefaultOnly"] = is_default_only
        if is_active_only is not None:
            _query_params["isActiveOnly"] = is_active_only
    ...
    async def _aacount_payment_methods_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_is_default_only,
            request_query_is_active_only,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/{account-key}/payment-methods',
            headers=_headers,
        )
    ...
    def _acount_payment_methods_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AcountPaymentMethodsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aacount_payment_methods(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._acount_payment_methods_mapped_args(
        ...
        return await self._aacount_payment_methods_oapg(
    ...
    def acount_payment_methods(
        ...
        return self._acount_payment_methods_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class AcountPaymentMethods(BaseApi):
    ...
    async def aacount_payment_methods(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountPaymentMethodTypePydantic:
        raw_response = await self.raw.aacount_payment_methods(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETAccountPaymentMethodTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAccountPaymentMethodTypePydantic, raw_response.body)
    ...
    def acount_payment_methods(
        ...
        raw_response = self.raw.acount_payment_methods(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
