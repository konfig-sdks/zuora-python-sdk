...
# Query params
ShowCurrencyConversionInformationSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'showCurrencyConversionInformation': typing.Union[ShowCurrencyConversionInformationSchema, str, ],
    },
    total=False
)
...
request_query_show_currency_conversion_information = api_client.QueryParameter(
    name="showCurrencyConversionInformation",
    style=api_client.ParameterStyle.FORM,
    schema=ShowCurrencyConversionInformationSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyTextXmlCharsetutf8 = schemas.StrSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'text/xml; charset=utf-8': api_client.MediaType(
            schema=SchemaFor200ResponseBodyTextXmlCharsetutf8),
    },
    headers=[
...
SchemaFor404ResponseBodyTextXmlCharsetutf8 = schemas.StrSchema
...
_response_for_404 = api_client.OpenApiResponse(
    ...
    content={
        'text/xml; charset=utf-8': api_client.MediaType(
            schema=SchemaFor404ResponseBodyTextXmlCharsetutf8),
    },
    headers=[
        content_encoding_parameter,
        rate_limit_limit_parameter,
...
class BaseApi(api_client.Api):
    ...
    def _describe_mapped_args(
        ...
        show_currency_conversion_information: typing.Optional[str] = None,
        ...
        if show_currency_conversion_information is not None:
            _query_params["showCurrencyConversionInformation"] = show_currency_conversion_information
    ...
    async def _adescribe_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_show_currency_conversion_information,
        ):
...
class DescribeRaw(BaseApi):
    ...
    async def adescribe(
        ...
        **kwargs,
        ...
        args = self._describe_mapped_args(
            object=object,
        ...
        return await self._adescribe_oapg(
    ...
    def describe(
        ...
        return self._describe_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class Describe(BaseApi):
    ...
    async def adescribe(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adescribe(
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def describe(
        ...
        raw_response = self.raw.describe(
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
