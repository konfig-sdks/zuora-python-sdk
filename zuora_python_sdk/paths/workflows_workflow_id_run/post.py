...
from zuora_python_sdk.model.workflow_instance import WorkflowInstance as WorkflowInstanceSchema
from zuora_python_sdk.model.workflows_run_workflow_response import WorkflowsRunWorkflowResponse as WorkflowsRunWorkflowResponseSchema
from zuora_python_sdk.model.workflows_run_workflow409_response import WorkflowsRunWorkflow409Response as WorkflowsRunWorkflow409ResponseSchema
from zuora_python_sdk.model.workflows_run_workflow406_response import WorkflowsRunWorkflow406Response as WorkflowsRunWorkflow406ResponseSchema
from zuora_python_sdk.model.workflows_run_workflow_request import WorkflowsRunWorkflowRequest as WorkflowsRunWorkflowRequestSchema

from zuora_python_sdk.type.workflows_run_workflow409_response import WorkflowsRunWorkflow409Response
from zuora_python_sdk.type.workflows_run_workflow406_response import WorkflowsRunWorkflow406Response
from zuora_python_sdk.type.workflows_run_workflow_response import WorkflowsRunWorkflowResponse
from zuora_python_sdk.type.workflow_instance import WorkflowInstance
from zuora_python_sdk.type.workflows_run_workflow_request import WorkflowsRunWorkflowRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.workflows_run_workflow409_response import WorkflowsRunWorkflow409Response as WorkflowsRunWorkflow409ResponsePydantic
from zuora_python_sdk.pydantic.workflows_run_workflow406_response import WorkflowsRunWorkflow406Response as WorkflowsRunWorkflow406ResponsePydantic
from zuora_python_sdk.pydantic.workflows_run_workflow_request import WorkflowsRunWorkflowRequest as WorkflowsRunWorkflowRequestPydantic
from zuora_python_sdk.pydantic.workflow_instance import WorkflowInstance as WorkflowInstancePydantic
from zuora_python_sdk.pydantic.workflows_run_workflow_response import WorkflowsRunWorkflowResponse as WorkflowsRunWorkflowResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'workflow_id': typing.Union[WorkflowIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = WorkflowsRunWorkflowRequestSchema


request_body_workflows_run_workflow_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WorkflowInstanceSchema
...
SchemaFor400ResponseBodyApplicationJson = WorkflowsRunWorkflowResponseSchema
...
class ApiResponseFor400(api_client.ApiResponse):
    body: WorkflowsRunWorkflowResponse
...
SchemaFor406ResponseBodyApplicationJson = WorkflowsRunWorkflow406ResponseSchema
...
class ApiResponseFor406(api_client.ApiResponse):
    body: WorkflowsRunWorkflow406Response
...
SchemaFor409ResponseBodyApplicationJson = WorkflowsRunWorkflow409ResponseSchema
...
class ApiResponseFor409(api_client.ApiResponse):
    body: WorkflowsRunWorkflow409Response
    ...
    async def _arun_workflow_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_workflows_run_workflow_request.serialize(body, content_type)
...
class RunWorkflowRaw(BaseApi):
    ...
    async def arun_workflow(
        ...
        **kwargs,
        ...
        args = self._run_workflow_mapped_args(
        ...
        return await self._arun_workflow_oapg(
            body=args.body,
...
class RunWorkflow(BaseApi):
    ...
    async def arun_workflow(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowInstancePydantic:
        raw_response = await self.raw.arun_workflow(
            authorization=authorization,
            workflow_id=workflow_id,
            account_id=account_id,
            payment_id=payment_id,
        ...
        if validate:
            return WorkflowInstancePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowInstancePydantic, raw_response.body)
    ...
    def run_workflow(
        ...
        raw_response = self.raw.run_workflow(
            authorization=authorization,
            workflow_id=workflow_id,
            account_id=account_id,
            payment_id=payment_id,
