...
class Payment0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_0(
        self,
        payment_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_0_mapped_args(
        ...
        return await self._apayment_0_oapg(
    ...
    def payment_0(
        ...
        return self._payment_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Payment0(BaseApi):
    ...
    async def apayment_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_0(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def payment_0(
        ...
        raw_response = self.raw.payment_0(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
