    ...
    async def _apayment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}',
            headers=_headers,
        )
...
class PaymentRaw(BaseApi):
    ...
    async def apayment(
        ...
        **kwargs,
        ...
        args = self._payment_mapped_args(
        ...
        return await self._apayment_oapg(
...
class Payment(BaseApi):
    ...
    async def apayment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
