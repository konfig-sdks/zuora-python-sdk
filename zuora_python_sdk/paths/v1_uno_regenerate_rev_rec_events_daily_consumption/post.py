...
from zuora_python_sdk.model.daily_consumption_rev_rec_request import DailyConsumptionRevRecRequest as DailyConsumptionRevRecRequestSchema
from zuora_python_sdk.model.regenerate_rev_rec_events_response import RegenerateRevRecEventsResponse as RegenerateRevRecEventsResponseSchema

from zuora_python_sdk.type.regenerate_rev_rec_events_response import RegenerateRevRecEventsResponse
from zuora_python_sdk.type.daily_consumption_rev_rec_request import DailyConsumptionRevRecRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.regenerate_rev_rec_events_response import RegenerateRevRecEventsResponse as RegenerateRevRecEventsResponsePydantic
from zuora_python_sdk.pydantic.daily_consumption_rev_rec_request import DailyConsumptionRevRecRequest as DailyConsumptionRevRecRequestPydantic

from . import path

# Query params
ForRevenueRecollectSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'forRevenueRecollect': typing.Union[ForRevenueRecollectSchema, bool, ],
    },
    total=False
)
...
request_query_for_revenue_recollect = api_client.QueryParameter(
    name="forRevenueRecollect",
    style=api_client.ParameterStyle.FORM,
    schema=ForRevenueRecollectSchema,
    explode=True,
)
# Header params
...
# body param
SchemaForRequestBodyApplicationJson = DailyConsumptionRevRecRequestSchema


request_body_daily_consumption_rev_rec_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RegenerateRevRecEventsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: RegenerateRevRecEventsResponse
...
class BaseApi(api_client.Api):
    ...
    def _generate_rev_rec_events_for_daily_consumption_mapped_args(
        self,
        original_charge_id: str,
        authorization: str,
        charge_segment_number: typing.Optional[str] = None,
        ...
        for_revenue_recollect: typing.Optional[bool] = None,
        ...
        if charge_segment_number is not None:
            _body["chargeSegmentNumber"] = charge_segment_number
        if fund_id is not None:
            _body["fundId"] = fund_id
        if original_charge_id is not None:
            _body["originalChargeId"] = original_charge_id
        args.body = _body
        if for_revenue_recollect is not None:
            _query_params["forRevenueRecollect"] = for_revenue_recollect
    ...
    async def _agenerate_rev_rec_events_for_daily_consumption_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_for_revenue_recollect,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/uno-regenerate/rev-rec-events/daily-consumption',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_daily_consumption_rev_rec_request.serialize(body, content_type)
    ...
    def _generate_rev_rec_events_for_daily_consumption_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class GenerateRevRecEventsForDailyConsumptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_rev_rec_events_for_daily_consumption(
        self,
        original_charge_id: str,
        authorization: str,
        charge_segment_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._generate_rev_rec_events_for_daily_consumption_mapped_args(
            original_charge_id=original_charge_id,
            authorization=authorization,
            charge_segment_number=charge_segment_number,
            fund_id=fund_id,
        ...
        return await self._agenerate_rev_rec_events_for_daily_consumption_oapg(
            body=args.body,
    ...
    def generate_rev_rec_events_for_daily_consumption(
        self,
        original_charge_id: str,
        authorization: str,
        charge_segment_number: typing.Optional[str] = None,
        ...
        return self._generate_rev_rec_events_for_daily_consumption_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class GenerateRevRecEventsForDailyConsumption(BaseApi):
    ...
    async def agenerate_rev_rec_events_for_daily_consumption(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RegenerateRevRecEventsResponsePydantic:
        raw_response = await self.raw.agenerate_rev_rec_events_for_daily_consumption(
            original_charge_id=original_charge_id,
            authorization=authorization,
            charge_segment_number=charge_segment_number,
            fund_id=fund_id,
        ...
        if validate:
            return RegenerateRevRecEventsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RegenerateRevRecEventsResponsePydantic, raw_response.body)
    ...
    def generate_rev_rec_events_for_daily_consumption(
        ...
        raw_response = self.raw.generate_rev_rec_events_for_daily_consumption(
            original_charge_id=original_charge_id,
            authorization=authorization,
            charge_segment_number=charge_segment_number,
            fund_id=fund_id,
