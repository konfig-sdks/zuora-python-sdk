...
from zuora_python_sdk.model.data_query_error_response import DataQueryErrorResponse as DataQueryErrorResponseSchema
from zuora_python_sdk.model.submit_data_query_response import SubmitDataQueryResponse as SubmitDataQueryResponseSchema
from zuora_python_sdk.model.submit_data_query_request import SubmitDataQueryRequest as SubmitDataQueryRequestSchema
from zuora_python_sdk.model.submit_data_query_request_output import SubmitDataQueryRequestOutput as SubmitDataQueryRequestOutputSchema

from zuora_python_sdk.type.submit_data_query_request import SubmitDataQueryRequest
from zuora_python_sdk.type.data_query_error_response import DataQueryErrorResponse
from zuora_python_sdk.type.submit_data_query_response import SubmitDataQueryResponse
from zuora_python_sdk.type.submit_data_query_request_output import SubmitDataQueryRequestOutput

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.data_query_error_response import DataQueryErrorResponse as DataQueryErrorResponsePydantic
from zuora_python_sdk.pydantic.submit_data_query_request import SubmitDataQueryRequest as SubmitDataQueryRequestPydantic
from zuora_python_sdk.pydantic.submit_data_query_request_output import SubmitDataQueryRequestOutput as SubmitDataQueryRequestOutputPydantic
from zuora_python_sdk.pydantic.submit_data_query_response import SubmitDataQueryResponse as SubmitDataQueryResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = SubmitDataQueryRequestSchema


request_body_submit_data_query_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SubmitDataQueryResponseSchema
...
SchemaFor400ResponseBodyApplicationJson = DataQueryErrorResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _data_query_job_mapped_args(
        self,
        compression: str,
        ...
        query: str,
        authorization: str,
        column_separator: typing.Optional[str] = None,
        encryption_key: typing.Optional[str] = None,
        read_deleted: typing.Optional[bool] = None,
        source_data: typing.Optional[str] = None,
        use_index_join: typing.Optional[bool] = None,
        warehouse_size: typing.Optional[str] = None,
        ...
        if column_separator is not None:
            _body["columnSeparator"] = column_separator
        if compression is not None:
            _body["compression"] = compression
        if encryption_key is not None:
            _body["encryptionKey"] = encryption_key
        if output is not None:
            _body["output"] = output
        if output_format is not None:
            _body["outputFormat"] = output_format
        if query is not None:
            _body["query"] = query
        if read_deleted is not None:
            _body["readDeleted"] = read_deleted
        if source_data is not None:
            _body["sourceData"] = source_data
        if use_index_join is not None:
            _body["useIndexJoin"] = use_index_join
        if warehouse_size is not None:
            _body["warehouseSize"] = warehouse_size
        args.body = _body
    ...
    async def _adata_query_job_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_submit_data_query_request.serialize(body, content_type)
...
class DataQueryJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_query_job(
        self,
        compression: str,
        output: SubmitDataQueryRequestOutput,
        output_format: str,
        ...
        **kwargs,
        ...
        args = self._data_query_job_mapped_args(
        ...
        return await self._adata_query_job_oapg(
            body=args.body,
    ...
    def data_query_job(
        ...
        return self._data_query_job_oapg(
            body=args.body,
            header_params=args.header,
        )

class DataQueryJob(BaseApi):
    ...
    async def adata_query_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SubmitDataQueryResponsePydantic:
        raw_response = await self.raw.adata_query_job(
            compression=compression,
            output=output,
            output_format=output_format,
            query=query,
        ...
        if validate:
            return SubmitDataQueryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SubmitDataQueryResponsePydantic, raw_response.body)
    ...
    def data_query_job(
        ...
        raw_response = self.raw.data_query_job(
            compression=compression,
            output=output,
            output_format=output_format,
            query=query,
