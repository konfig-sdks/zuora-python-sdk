...
from zuora_python_sdk.model.get_data_query_jobs_response import GetDataQueryJobsResponse as GetDataQueryJobsResponseSchema

from zuora_python_sdk.type.get_data_query_jobs_response import GetDataQueryJobsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_data_query_jobs_response import GetDataQueryJobsResponse as GetDataQueryJobsResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'queryStatus': typing.Union[QueryStatusSchema, str, ],
...
request_query_query_status = api_client.QueryParameter(
    name="queryStatus",
    style=api_client.ParameterStyle.FORM,
    schema=QueryStatusSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GetDataQueryJobsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _data_query_jobs_mapped_args(
        self,
        authorization: str,
        ...
        query_status: typing.Optional[str] = None,
        ...
        if query_status is not None:
            _query_params["queryStatus"] = query_status
    ...
    async def _adata_query_jobs_oapg(
        self,
...
class DataQueryJobsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_query_jobs(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_query_jobs_mapped_args(
        ...
        return await self._adata_query_jobs_oapg(
    ...
    def data_query_jobs(
        ...
        return self._data_query_jobs_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DataQueryJobs(BaseApi):
    ...
    async def adata_query_jobs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDataQueryJobsResponsePydantic:
        raw_response = await self.raw.adata_query_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return GetDataQueryJobsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetDataQueryJobsResponsePydantic, raw_response.body)
    ...
    def data_query_jobs(
        ...
        raw_response = self.raw.data_query_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
