...
class BaseApi(api_client.Api):
    ...
    def _mass_updater_1_mapped_args(
        self,
        bulk_key: str,
    ...
    async def _amass_updater_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bulk/{bulk-key}/stop',
            headers=_headers,
        )
...
class MassUpdater1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amass_updater_1(
        self,
        bulk_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._mass_updater_1_mapped_args(
            bulk_key=bulk_key,
        ...
        return await self._amass_updater_1_oapg(
    ...
    def mass_updater_1(
        ...
        return self._mass_updater_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class MassUpdater1(BaseApi):
    ...
    async def amass_updater_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amass_updater_1(
            bulk_key=bulk_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def mass_updater_1(
        ...
        raw_response = self.raw.mass_updater_1(
            bulk_key=bulk_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
