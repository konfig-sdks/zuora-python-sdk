...
from zuora_python_sdk.model.get_debit_memo_application_part_collection_type import GetDebitMemoApplicationPartCollectionType as GetDebitMemoApplicationPartCollectionTypeSchema

from zuora_python_sdk.type.get_debit_memo_application_part_collection_type import GetDebitMemoApplicationPartCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_application_part_collection_type import GetDebitMemoApplicationPartCollectionType as GetDebitMemoApplicationPartCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetDebitMemoApplicationPartCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetDebitMemoApplicationPartCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_application_parts_mapped_args(
        self,
        debit_memo_id: str,
    ...
    async def _adebit_memo_application_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoId}/application-parts',
            headers=_headers,
        )
    ...
    def _debit_memo_application_parts_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DebitMemoApplicationPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_application_parts(
        self,
        debit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_application_parts_mapped_args(
        ...
        return await self._adebit_memo_application_parts_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def debit_memo_application_parts(
        self,
        debit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._debit_memo_application_parts_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoApplicationParts(BaseApi):
    ...
    async def adebit_memo_application_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDebitMemoApplicationPartCollectionTypePydantic:
        raw_response = await self.raw.adebit_memo_application_parts(
            debit_memo_id=debit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetDebitMemoApplicationPartCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetDebitMemoApplicationPartCollectionTypePydantic, raw_response.body)
    ...
    def debit_memo_application_parts(
        ...
        raw_response = self.raw.debit_memo_application_parts(
            debit_memo_id=debit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
