...
from zuora_python_sdk.model.get_refund_part_collection_type import GETRefundPartCollectionType as GETRefundPartCollectionTypeSchema

from zuora_python_sdk.type.get_refund_part_collection_type import GETRefundPartCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_refund_part_collection_type import GETRefundPartCollectionType as GETRefundPartCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETRefundPartCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRefundPartCollectionType
    ...
    async def _arefund_parts_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundKey}/parts',
            headers=_headers,
        )
...
class RefundPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefund_parts(
        self,
        refund_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._refund_parts_mapped_args(
        ...
        return await self._arefund_parts_oapg(
    ...
    def refund_parts(
        ...
        return self._refund_parts_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RefundParts(BaseApi):
    ...
    async def arefund_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundPartCollectionTypePydantic:
        raw_response = await self.raw.arefund_parts(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETRefundPartCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETRefundPartCollectionTypePydantic, raw_response.body)
    ...
    def refund_parts(
        ...
        raw_response = self.raw.refund_parts(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
