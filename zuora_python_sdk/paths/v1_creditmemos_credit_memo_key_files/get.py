...
from zuora_python_sdk.model.get_credit_memo_files_response import GETCreditMemoFilesResponse as GETCreditMemoFilesResponseSchema

from zuora_python_sdk.type.get_credit_memo_files_response import GETCreditMemoFilesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_credit_memo_files_response import GETCreditMemoFilesResponse as GETCreditMemoFilesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETCreditMemoFilesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETCreditMemoFilesResponse
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_files_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _acredit_memo_files_oapg(
        self,
...
class CreditMemoFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_files(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_files_mapped_args(
        ...
        return await self._acredit_memo_files_oapg(
    ...
    def credit_memo_files(
        ...
        return self._credit_memo_files_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoFiles(BaseApi):
    ...
    async def acredit_memo_files(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCreditMemoFilesResponsePydantic:
        raw_response = await self.raw.acredit_memo_files(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETCreditMemoFilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCreditMemoFilesResponsePydantic, raw_response.body)
    ...
    def credit_memo_files(
        ...
        raw_response = self.raw.credit_memo_files(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
