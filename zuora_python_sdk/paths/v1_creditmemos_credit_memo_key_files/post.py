...
from zuora_python_sdk.model.post_upload_file_response import POSTUploadFileResponse as POSTUploadFileResponseSchema
from zuora_python_sdk.model.post_upload_file_for_credit_memo_request import PostUploadFileForCreditMemoRequest as PostUploadFileForCreditMemoRequestSchema

from zuora_python_sdk.type.post_upload_file_for_credit_memo_request import PostUploadFileForCreditMemoRequest
from zuora_python_sdk.type.post_upload_file_response import POSTUploadFileResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_upload_file_response import POSTUploadFileResponse as POSTUploadFileResponsePydantic
from zuora_python_sdk.pydantic.post_upload_file_for_credit_memo_request import PostUploadFileForCreditMemoRequest as PostUploadFileForCreditMemoRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostUploadFileForCreditMemoRequestSchema


request_body_post_upload_file_for_credit_memo_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTUploadFileResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _upload_file_for_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _aupload_file_for_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/files',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_post_upload_file_for_credit_memo_request.serialize(body, content_type)
    ...
    def _upload_file_for_credit_memo_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UploadFileForCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_file_for_credit_memo(
        self,
        credit_memo_key: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._upload_file_for_credit_memo_mapped_args(
        ...
        return await self._aupload_file_for_credit_memo_oapg(
            body=args.body,
    ...
    def upload_file_for_credit_memo(
        ...
        return self._upload_file_for_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UploadFileForCreditMemo(BaseApi):
    ...
    async def aupload_file_for_credit_memo(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTUploadFileResponsePydantic:
        raw_response = await self.raw.aupload_file_for_credit_memo(
            credit_memo_key=credit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTUploadFileResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTUploadFileResponsePydantic, raw_response.body)
    ...
    def upload_file_for_credit_memo(
        ...
        raw_response = self.raw.upload_file_for_credit_memo(
            credit_memo_key=credit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
