...
from zuora_python_sdk.model.put_bulk_credit_memos_request_type import PUTBulkCreditMemosRequestType as PUTBulkCreditMemosRequestTypeSchema
...
from zuora_python_sdk.model.put_credit_memos_with_id_type import PUTCreditMemosWithIdType as PUTCreditMemosWithIdTypeSchema

from zuora_python_sdk.type.bulk_credit_memos_response_type import BulkCreditMemosResponseType
from zuora_python_sdk.type.put_bulk_credit_memos_request_type import PUTBulkCreditMemosRequestType
from zuora_python_sdk.type.put_credit_memos_with_id_type import PUTCreditMemosWithIdType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_bulk_credit_memos_request_type import PUTBulkCreditMemosRequestType as PUTBulkCreditMemosRequestTypePydantic
...
from zuora_python_sdk.pydantic.put_credit_memos_with_id_type import PUTCreditMemosWithIdType as PUTCreditMemosWithIdTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTBulkCreditMemosRequestTypeSchema


request_body_put_bulk_credit_memos_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_credit_memos_mapped_args(
        self,
        memos: typing.Optional[typing.List[PUTCreditMemosWithIdType]] = None,
    ...
    async def _aupdate_credit_memos_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_bulk_credit_memos_request_type.serialize(body, content_type)
...
class UpdateCreditMemosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_credit_memos(
        self,
        memos: typing.Optional[typing.List[PUTCreditMemosWithIdType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_credit_memos_mapped_args(
            body=body,
            memos=memos,
        ...
        return await self._aupdate_credit_memos_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def update_credit_memos(
        self,
        memos: typing.Optional[typing.List[PUTCreditMemosWithIdType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._update_credit_memos_oapg(
            body=args.body,
            header_params=args.header,
        )

class UpdateCreditMemos(BaseApi):
    ...
    async def aupdate_credit_memos(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_credit_memos(
            body=body,
            memos=memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def update_credit_memos(
        ...
        raw_response = self.raw.update_credit_memos(
            body=body,
            memos=memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
