...
from zuora_python_sdk.model.post_bulk_credit_memos_request_type import POSTBulkCreditMemosRequestType as POSTBulkCreditMemosRequestTypeSchema
from zuora_python_sdk.model.bulk_credit_memos_response_type import BulkCreditMemosResponseType as BulkCreditMemosResponseTypeSchema

from zuora_python_sdk.type.bulk_credit_memos_response_type import BulkCreditMemosResponseType
from zuora_python_sdk.type.post_bulk_credit_memos_request_type import POSTBulkCreditMemosRequestType
...
from zuora_python_sdk.pydantic.bulk_credit_memos_response_type import BulkCreditMemosResponseType as BulkCreditMemosResponseTypePydantic
from zuora_python_sdk.pydantic.post_bulk_credit_memos_request_type import POSTBulkCreditMemosRequestType as POSTBulkCreditMemosRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTBulkCreditMemosRequestTypeSchema


request_body_post_bulk_credit_memos_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkCreditMemosResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BulkCreditMemosResponseType
...
class BaseApi(api_client.Api):
    ...
    def _create_credit_memos_mapped_args(
        self,
        body: typing.Optional[POSTBulkCreditMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[CreditMemoFromChargeRequest]] = None,
    ...
    async def _acreate_credit_memos_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/bulk',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_bulk_credit_memos_request_type.serialize(body, content_type)
...
class CreateCreditMemosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_credit_memos(
        self,
        body: typing.Optional[POSTBulkCreditMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[CreditMemoFromChargeRequest]] = None,
        ...
        **kwargs,
        ...
        args = self._create_credit_memos_mapped_args(
            body=body,
        ...
        return await self._acreate_credit_memos_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_credit_memos(
        self,
        body: typing.Optional[POSTBulkCreditMemosRequestType] = None,
        source_type: typing.Optional[str] = None,
        memos: typing.Optional[typing.List[CreditMemoFromChargeRequest]] = None,
        ...
        return self._create_credit_memos_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateCreditMemos(BaseApi):
    ...
    async def acreate_credit_memos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BulkCreditMemosResponseTypePydantic:
        raw_response = await self.raw.acreate_credit_memos(
            body=body,
            source_type=source_type,
            memos=memos,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return RootModel[BulkCreditMemosResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(BulkCreditMemosResponseTypePydantic, raw_response.body)
    ...
    def create_credit_memos(
        ...
        raw_response = self.raw.create_credit_memos(
            body=body,
            source_type=source_type,
            memos=memos,
            idempotency_key=idempotency_key,
