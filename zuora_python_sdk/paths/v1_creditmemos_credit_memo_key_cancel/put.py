...
class BaseApi(api_client.Api):
    ...
    def _cancel_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _acancel_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/cancel',
            headers=_headers,
        )
...
class CancelCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_credit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_credit_memo_mapped_args(
        ...
        return await self._acancel_credit_memo_oapg(
    ...
    def cancel_credit_memo(
        ...
        return self._cancel_credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelCreditMemo(BaseApi):
    ...
    async def acancel_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def cancel_credit_memo(
        ...
        raw_response = self.raw.cancel_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
