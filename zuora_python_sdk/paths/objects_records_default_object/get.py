...
from zuora_python_sdk.model.query_custom_object_records_response import QueryCustomObjectRecordsResponse as QueryCustomObjectRecordsResponseSchema

from zuora_python_sdk.type.query_custom_object_records_response import QueryCustomObjectRecordsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.query_custom_object_records_response import QueryCustomObjectRecordsResponse as QueryCustomObjectRecordsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = QueryCustomObjectRecordsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: QueryCustomObjectRecordsResponse
...
class BaseApi(api_client.Api):
    ...
    def _all_records_for_custom_object_type_mapped_args(
        self,
        authorization: str,
        object: str,
    ...
    async def _aall_records_for_custom_object_type_oapg(
        self,
    ...
    def _all_records_for_custom_object_type_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AllRecordsForCustomObjectTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_records_for_custom_object_type(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_records_for_custom_object_type_mapped_args(
        ...
        return await self._aall_records_for_custom_object_type_oapg(
    ...
    def all_records_for_custom_object_type(
        self,
        authorization: str,
        object: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._all_records_for_custom_object_type_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class AllRecordsForCustomObjectType(BaseApi):
    ...
    async def aall_records_for_custom_object_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> QueryCustomObjectRecordsResponsePydantic:
        raw_response = await self.raw.aall_records_for_custom_object_type(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return QueryCustomObjectRecordsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(QueryCustomObjectRecordsResponsePydantic, raw_response.body)
    ...
    def all_records_for_custom_object_type(
        ...
        raw_response = self.raw.all_records_for_custom_object_type(
            authorization=authorization,
            object=object,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
