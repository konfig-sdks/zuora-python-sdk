...
from zuora_python_sdk.model.z_object_update import ZObjectUpdate as ZObjectUpdateSchema
...
from zuora_python_sdk.model.action_pos_tupdate_response import ActionPosTupdateResponse as ActionPosTupdateResponseSchema
from zuora_python_sdk.model.proxy_actionupdate_request import ProxyActionupdateRequest as ProxyActionupdateRequestSchema

from zuora_python_sdk.type.proxy_actionupdate_request import ProxyActionupdateRequest
from zuora_python_sdk.type.z_object_update import ZObjectUpdate
from zuora_python_sdk.type.action_pos_tupdate_response import ActionPosTupdateResponse
...
from zuora_python_sdk.pydantic.z_object_update import ZObjectUpdate as ZObjectUpdatePydantic
from zuora_python_sdk.pydantic.proxy_actionupdate_request import ProxyActionupdateRequest as ProxyActionupdateRequestPydantic
from zuora_python_sdk.pydantic.action_pos_tupdate_response import ActionPosTupdateResponse as ActionPosTupdateResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyActionupdateRequestSchema


request_body_proxy_actionupdate_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ActionPosTupdateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _p_os_tupdate_mapped_args(
        self,
        objects: typing.List[ZObjectUpdate],
        type: str,
    ...
    async def _ap_os_tupdate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_actionupdate_request.serialize(body, content_type)
...
class POsTupdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_os_tupdate(
        self,
        objects: typing.List[ZObjectUpdate],
        type: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_os_tupdate_mapped_args(
            objects=objects,
            type=type,
        ...
        return await self._ap_os_tupdate_oapg(
            body=args.body,
    ...
    def p_os_tupdate(
        ...
        return self._p_os_tupdate_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POsTupdate(BaseApi):
    ...
    async def ap_os_tupdate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionPosTupdateResponsePydantic:
        raw_response = await self.raw.ap_os_tupdate(
            objects=objects,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[ActionPosTupdateResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActionPosTupdateResponsePydantic, raw_response.body)
    ...
    def p_os_tupdate(
        ...
        raw_response = self.raw.p_os_tupdate(
            objects=objects,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
