...
from zuora_python_sdk.model.get_payment_item_part_type import GETPaymentItemPartType as GETPaymentItemPartTypeSchema

from zuora_python_sdk.type.get_payment_item_part_type import GETPaymentItemPartType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_item_part_type import GETPaymentItemPartType as GETPaymentItemPartTypePydantic
...
request_path_partid = api_client.PathParameter(
    name="partid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PartidSchema,
    required=True,
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentItemPartTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _payment_item_part_mapped_args(
        self,
        partid: str,
        itempartid: str,
        payment_key: str,
    ...
    async def _apayment_item_part_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/parts/{partid}/itemparts/{itempartid}',
            headers=_headers,
        )
...
class PaymentItemPartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_item_part(
        self,
        partid: str,
        itempartid: str,
        payment_key: str,
        ...
        **kwargs,
        ...
        args = self._payment_item_part_mapped_args(
            partid=partid,
        ...
        return await self._apayment_item_part_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def payment_item_part(
        self,
        partid: str,
        itempartid: str,
        payment_key: str,
        ...
        return self._payment_item_part_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentItemPart(BaseApi):
    ...
    async def apayment_item_part(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentItemPartTypePydantic:
        raw_response = await self.raw.apayment_item_part(
            partid=partid,
            itempartid=itempartid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GETPaymentItemPartTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentItemPartTypePydantic, raw_response.body)
    ...
    def payment_item_part(
        ...
        raw_response = self.raw.payment_item_part(
            partid=partid,
            itempartid=itempartid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
