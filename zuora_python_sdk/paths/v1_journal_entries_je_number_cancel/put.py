...
class BaseApi(api_client.Api):
    ...
    def _summary_journal_entry_2_mapped_args(
        self,
        je_number: str,
    ...
    async def _asummary_journal_entry_2_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-entries/{je-number}/cancel',
            headers=_headers,
        )
    ...
    def _summary_journal_entry_2_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SummaryJournalEntry2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asummary_journal_entry_2(
        self,
        je_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._summary_journal_entry_2_mapped_args(
            je_number=je_number,
        ...
        return await self._asummary_journal_entry_2_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def summary_journal_entry_2(
        self,
        je_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._summary_journal_entry_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SummaryJournalEntry2(BaseApi):
    ...
    async def asummary_journal_entry_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asummary_journal_entry_2(
            je_number=je_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def summary_journal_entry_2(
        ...
        raw_response = self.raw.summary_journal_entry_2(
            je_number=je_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
