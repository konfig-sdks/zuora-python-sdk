...
class BaseApi(api_client.Api):
    ...
    def _scrub_contact_mapped_args(
        self,
        contact_id: str,
    ...
    async def _ascrub_contact_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/contacts/{contactId}/scrub',
            headers=_headers,
        )
...
class ScrubContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascrub_contact(
        self,
        contact_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._scrub_contact_mapped_args(
        ...
        return await self._ascrub_contact_oapg(
    ...
    def scrub_contact(
        ...
        return self._scrub_contact_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ScrubContact(BaseApi):
    ...
    async def ascrub_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ascrub_contact(
            contact_id=contact_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def scrub_contact(
        ...
        raw_response = self.raw.scrub_contact(
            contact_id=contact_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
