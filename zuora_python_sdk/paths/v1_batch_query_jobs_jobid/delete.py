...
from zuora_python_sdk.model.delete_batch_query_job_response import DeleteBatchQueryJobResponse as DeleteBatchQueryJobResponseSchema

from zuora_python_sdk.type.delete_batch_query_job_response import DeleteBatchQueryJobResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.delete_batch_query_job_response import DeleteBatchQueryJobResponse as DeleteBatchQueryJobResponsePydantic
...
request_path_jobid = api_client.PathParameter(
    name="jobid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JobidSchema,
    required=True,
...
SchemaFor200ResponseBodyApplicationJson = DeleteBatchQueryJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteBatchQueryJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _batch_query_job_0_mapped_args(
        self,
        authorization: str,
        jobid: str,
    ...
    async def _abatch_query_job_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batch-query/jobs/{jobid}',
            headers=_headers,
        )
...
class BatchQueryJob0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abatch_query_job_0(
        self,
        authorization: str,
        jobid: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._batch_query_job_0_mapped_args(
        ...
        return await self._abatch_query_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def batch_query_job_0(
        self,
        authorization: str,
        jobid: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._batch_query_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BatchQueryJob0(BaseApi):
    ...
    async def abatch_query_job_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteBatchQueryJobResponsePydantic:
        raw_response = await self.raw.abatch_query_job_0(
            authorization=authorization,
            jobid=jobid,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return DeleteBatchQueryJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteBatchQueryJobResponsePydantic, raw_response.body)
    ...
    def batch_query_job_0(
        ...
        raw_response = self.raw.batch_query_job_0(
            authorization=authorization,
            jobid=jobid,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
