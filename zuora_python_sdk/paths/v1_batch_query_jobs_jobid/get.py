...
class BaseApi(api_client.Api):
    ...
    def _batch_query_job_mapped_args(
        self,
        authorization: str,
        jobid: str,
    ...
    async def _abatch_query_job_oapg(
        self,
...
class BatchQueryJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abatch_query_job(
        self,
        authorization: str,
        jobid: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._batch_query_job_mapped_args(
        ...
        return await self._abatch_query_job_oapg(
    ...
    def batch_query_job(
        ...
        return self._batch_query_job_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BatchQueryJob(BaseApi):
    ...
    async def abatch_query_job(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abatch_query_job(
            authorization=authorization,
            jobid=jobid,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def batch_query_job(
        ...
        raw_response = self.raw.batch_query_job(
            authorization=authorization,
            jobid=jobid,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
