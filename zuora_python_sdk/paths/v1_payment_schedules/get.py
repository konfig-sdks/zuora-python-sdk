...
from zuora_python_sdk.model.get_payment_schedules_response import GETPaymentSchedulesResponse as GETPaymentSchedulesResponseSchema

from zuora_python_sdk.type.get_payment_schedules_response import GETPaymentSchedulesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_schedules_response import GETPaymentSchedulesResponse as GETPaymentSchedulesResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'accountNumber': typing.Union[AccountNumberSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentSchedulesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentSchedulesResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedules_mapped_args(
        self,
    ...
    async def _apayment_schedules_oapg(
        self,
...
class PaymentSchedulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedules(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedules_mapped_args(
        ...
        return await self._apayment_schedules_oapg(
    ...
    def payment_schedules(
        ...
        return self._payment_schedules_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class PaymentSchedules(BaseApi):
    ...
    async def apayment_schedules(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentSchedulesResponsePydantic:
        raw_response = await self.raw.apayment_schedules(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return RootModel[GETPaymentSchedulesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETPaymentSchedulesResponsePydantic, raw_response.body)
    ...
    def payment_schedules(
        ...
        raw_response = self.raw.payment_schedules(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
