...
from zuora_python_sdk.model.post_payment_schedule_request import POSTPaymentScheduleRequest as POSTPaymentScheduleRequestSchema
...
from zuora_python_sdk.model.post_payment_schedule_response import POSTPaymentScheduleResponse as POSTPaymentScheduleResponseSchema

from zuora_python_sdk.type.post_payment_schedule_response import POSTPaymentScheduleResponse
from zuora_python_sdk.type.payment_schedule_payment_option_fields import PaymentSchedulePaymentOptionFields
from zuora_python_sdk.type.post_payment_schedule_request import POSTPaymentScheduleRequest
...
from zuora_python_sdk.pydantic.post_payment_schedule_request import POSTPaymentScheduleRequest as POSTPaymentScheduleRequestPydantic
from zuora_python_sdk.pydantic.post_payment_schedule_response import POSTPaymentScheduleResponse as POSTPaymentScheduleResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPaymentScheduleRequestSchema


request_body_post_payment_schedule_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTPaymentScheduleResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTPaymentScheduleResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_mapped_args(
        self,
        body: POSTPaymentScheduleRequest,
        description: typing.Optional[str] = None,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        amount: typing.Optional[typing.Union[int, float]] = None,
        billing_document: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        currency: typing.Optional[str] = None,
        items: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        payment_schedule_number: typing.Optional[str] = None,
        ...
        if billing_document is not None:
            _body["billingDocument"] = billing_document
        ...
        if payment_schedule_number is not None:
            _body["paymentScheduleNumber"] = payment_schedule_number
    ...
    async def _apayment_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_payment_schedule_request.serialize(body, content_type)
...
class PaymentScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule(
        self,
        body: POSTPaymentScheduleRequest,
        description: typing.Optional[str] = None,
        account_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_mapped_args(
            body=body,
        ...
        return await self._apayment_schedule_oapg(
            body=args.body,
    ...
    def payment_schedule(
        ...
        return self._payment_schedule_oapg(
            body=args.body,
            header_params=args.header,
        )

class PaymentSchedule(BaseApi):
    ...
    async def apayment_schedule(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTPaymentScheduleResponsePydantic:
        raw_response = await self.raw.apayment_schedule(
            body=body,
            description=description,
            account_id=account_id,
            account_number=account_number,
        ...
        if validate:
            return RootModel[POSTPaymentScheduleResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(POSTPaymentScheduleResponsePydantic, raw_response.body)
    ...
    def payment_schedule(
        ...
        raw_response = self.raw.payment_schedule(
            body=body,
            description=description,
            account_id=account_id,
            account_number=account_number,
