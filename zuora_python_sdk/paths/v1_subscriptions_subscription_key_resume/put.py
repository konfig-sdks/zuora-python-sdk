...
from zuora_python_sdk.model.put_subscription_resume_response_type import PUTSubscriptionResumeResponseType as PUTSubscriptionResumeResponseTypeSchema
from zuora_python_sdk.model.put_subscription_resume_type import PUTSubscriptionResumeType as PUTSubscriptionResumeTypeSchema
from zuora_python_sdk.model.put_subscription_resume_type_application_order import PUTSubscriptionResumeTypeApplicationOrder as PUTSubscriptionResumeTypeApplicationOrderSchema

from zuora_python_sdk.type.put_subscription_resume_type import PUTSubscriptionResumeType
from zuora_python_sdk.type.put_subscription_resume_type_application_order import PUTSubscriptionResumeTypeApplicationOrder
from zuora_python_sdk.type.put_subscription_resume_response_type import PUTSubscriptionResumeResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_subscription_resume_response_type import PUTSubscriptionResumeResponseType as PUTSubscriptionResumeResponseTypePydantic
from zuora_python_sdk.pydantic.put_subscription_resume_type_application_order import PUTSubscriptionResumeTypeApplicationOrder as PUTSubscriptionResumeTypeApplicationOrderPydantic
from zuora_python_sdk.pydantic.put_subscription_resume_type import PUTSubscriptionResumeType as PUTSubscriptionResumeTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTSubscriptionResumeTypeSchema


request_body_put_subscription_resume_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTSubscriptionResumeResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTSubscriptionResumeResponseType
...
class BaseApi(api_client.Api):
    ...
    def _resume_subscription_mapped_args(
        self,
        resume_policy: str,
        subscription_key: str,
        application_order: typing.Optional[PUTSubscriptionResumeTypeApplicationOrder] = None,
    ...
    async def _aresume_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/resume',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_subscription_resume_type.serialize(body, content_type)
...
class ResumeSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresume_subscription(
        self,
        resume_policy: str,
        subscription_key: str,
        application_order: typing.Optional[PUTSubscriptionResumeTypeApplicationOrder] = None,
        ...
        **kwargs,
        ...
        args = self._resume_subscription_mapped_args(
        ...
        return await self._aresume_subscription_oapg(
            body=args.body,
...
class ResumeSubscription(BaseApi):
    ...
    async def aresume_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTSubscriptionResumeResponseTypePydantic:
        raw_response = await self.raw.aresume_subscription(
            resume_policy=resume_policy,
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
        ...
        if validate:
            return PUTSubscriptionResumeResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTSubscriptionResumeResponseTypePydantic, raw_response.body)
    ...
    def resume_subscription(
        ...
        raw_response = self.raw.resume_subscription(
            resume_policy=resume_policy,
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
