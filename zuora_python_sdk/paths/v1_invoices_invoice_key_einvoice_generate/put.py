...
class BaseApi(api_client.Api):
    ...
    def _generation_e_invoice_generation_for_invoices_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _ageneration_e_invoice_generation_for_invoices_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/einvoice/generate',
            headers=_headers,
        )
    ...
    def _generation_e_invoice_generation_for_invoices_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GenerationEInvoiceGenerationForInvoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ageneration_e_invoice_generation_for_invoices(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._generation_e_invoice_generation_for_invoices_mapped_args(
        ...
        return await self._ageneration_e_invoice_generation_for_invoices_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def generation_e_invoice_generation_for_invoices(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._generation_e_invoice_generation_for_invoices_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GenerationEInvoiceGenerationForInvoices(BaseApi):
    ...
    async def ageneration_e_invoice_generation_for_invoices(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ageneration_e_invoice_generation_for_invoices(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def generation_e_invoice_generation_for_invoices(
        ...
        raw_response = self.raw.generation_e_invoice_generation_for_invoices(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
