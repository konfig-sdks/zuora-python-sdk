...
class ContactRaw(BaseApi):
    ...
    async def acontact(
        ...
        **kwargs,
        ...
        args = self._contact_mapped_args(
        ...
        return await self._acontact_oapg(
...
class Contact(BaseApi):
    ...
    async def acontact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontact(
            contact_id=contact_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
