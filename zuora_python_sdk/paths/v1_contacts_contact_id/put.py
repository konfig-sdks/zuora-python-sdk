...
from zuora_python_sdk.model.contact_response import ContactResponse as ContactResponseSchema
from zuora_python_sdk.model.put_contact_type import PUTContactType as PUTContactTypeSchema

from zuora_python_sdk.type.put_contact_type import PUTContactType
from zuora_python_sdk.type.contact_response import ContactResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.contact_response import ContactResponse as ContactResponsePydantic
from zuora_python_sdk.pydantic.put_contact_type import PUTContactType as PUTContactTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTContactTypeSchema


request_body_put_contact_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContactResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _contact_0_mapped_args(
        ...
        contact_description: typing.Optional[str] = None,
        ...
        other_phone_type: typing.Optional[str] = None,
        personal_email: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        tax_region: typing.Optional[str] = None,
        ...
        if contact_description is not None:
            _body["contactDescription"] = contact_description
    ...
    async def _acontact_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/contacts/{contactId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_contact_type.serialize(body, content_type)
...
class Contact0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontact_0(
        self,
        body: PUTContactType,
        contact_id: str,
        address1: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._contact_0_mapped_args(
            body=body,
        ...
        return await self._acontact_0_oapg(
            body=args.body,
    ...
    def contact_0(
        ...
        return self._contact_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class Contact0(BaseApi):
    ...
    async def acontact_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactResponsePydantic:
        raw_response = await self.raw.acontact_0(
            body=body,
            contact_id=contact_id,
            address1=address1,
            address2=address2,
        ...
        if validate:
            return RootModel[ContactResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContactResponsePydantic, raw_response.body)
    ...
    def contact_0(
        ...
        raw_response = self.raw.contact_0(
            body=body,
            contact_id=contact_id,
            address1=address1,
            address2=address2,
