...
class Contact1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontact_1(
        self,
        contact_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._contact_1_mapped_args(
        ...
        return await self._acontact_1_oapg(
    ...
    def contact_1(
        ...
        return self._contact_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Contact1(BaseApi):
    ...
    async def acontact_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontact_1(
            contact_id=contact_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def contact_1(
        ...
        raw_response = self.raw.contact_1(
            contact_id=contact_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
