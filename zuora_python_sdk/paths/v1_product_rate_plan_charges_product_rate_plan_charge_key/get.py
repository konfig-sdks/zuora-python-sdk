...
from zuora_python_sdk.model.get_product_rate_plan_charge_response import GETProductRatePlanChargeResponse as GETProductRatePlanChargeResponseSchema

from zuora_python_sdk.type.get_product_rate_plan_charge_response import GETProductRatePlanChargeResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plan_charge_response import GETProductRatePlanChargeResponse as GETProductRatePlanChargeResponsePydantic

from . import path

# Query params
ShowChargeDefinitionsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'show-charge-definitions': typing.Union[ShowChargeDefinitionsSchema, bool, ],
    },
    total=False
)
...
request_query_show_charge_definitions = api_client.QueryParameter(
    name="show-charge-definitions",
    style=api_client.ParameterStyle.FORM,
    schema=ShowChargeDefinitionsSchema,
    explode=True,
)
# Header params
...
# Path params
ProductRatePlanChargeKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product-rate-plan-charge-key': typing.Union[ProductRatePlanChargeKeySchema, str, ],
    }
)
...
request_path_product_rate_plan_charge_key = api_client.PathParameter(
    name="product-rate-plan-charge-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProductRatePlanChargeKeySchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlanChargeResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlanChargeResponse
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_product_rate_plan_charge_mapped_args(
        self,
        product_rate_plan_charge_key: str,
        ...
        show_charge_definitions: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _header_params = {}
        _path_params = {}
        if show_charge_definitions is not None:
            _query_params["show-charge-definitions"] = show_charge_definitions
    ...
    async def _aretrieve_product_rate_plan_charge_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_product_rate_plan_charge_key,
        ):
        ...
        for parameter in (
            request_query_show_charge_definitions,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/product-rate-plan-charges/{product-rate-plan-charge-key}',
            headers=_headers,
        )
    ...
    def _retrieve_product_rate_plan_charge_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RetrieveProductRatePlanChargeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_product_rate_plan_charge(
        self,
        product_rate_plan_charge_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_product_rate_plan_charge_mapped_args(
            ...
            show_charge_definitions=show_charge_definitions,
        )
        return await self._aretrieve_product_rate_plan_charge_oapg(
    ...
    def retrieve_product_rate_plan_charge(
        self,
        product_rate_plan_charge_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._retrieve_product_rate_plan_charge_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class RetrieveProductRatePlanCharge(BaseApi):
    ...
    async def aretrieve_product_rate_plan_charge(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlanChargeResponsePydantic:
        raw_response = await self.raw.aretrieve_product_rate_plan_charge(
            product_rate_plan_charge_key=product_rate_plan_charge_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETProductRatePlanChargeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductRatePlanChargeResponsePydantic, raw_response.body)
    ...
    def retrieve_product_rate_plan_charge(
        ...
        raw_response = self.raw.retrieve_product_rate_plan_charge(
            product_rate_plan_charge_key=product_rate_plan_charge_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
