...
from zuora_python_sdk.model.post_journal_entry_response_type import POSTJournalEntryResponseType as POSTJournalEntryResponseTypeSchema
from zuora_python_sdk.model.post_journal_entry_item_type import POSTJournalEntryItemType as POSTJournalEntryItemTypeSchema
from zuora_python_sdk.model.post_journal_entry_type import POSTJournalEntryType as POSTJournalEntryTypeSchema
from zuora_python_sdk.model.post_journal_entry_segment_type import POSTJournalEntrySegmentType as POSTJournalEntrySegmentTypeSchema

from zuora_python_sdk.type.post_journal_entry_item_type import POSTJournalEntryItemType
from zuora_python_sdk.type.post_journal_entry_segment_type import POSTJournalEntrySegmentType
from zuora_python_sdk.type.post_journal_entry_type import POSTJournalEntryType
from zuora_python_sdk.type.post_journal_entry_response_type import POSTJournalEntryResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_journal_entry_type import POSTJournalEntryType as POSTJournalEntryTypePydantic
from zuora_python_sdk.pydantic.post_journal_entry_item_type import POSTJournalEntryItemType as POSTJournalEntryItemTypePydantic
from zuora_python_sdk.pydantic.post_journal_entry_response_type import POSTJournalEntryResponseType as POSTJournalEntryResponseTypePydantic
from zuora_python_sdk.pydantic.post_journal_entry_segment_type import POSTJournalEntrySegmentType as POSTJournalEntrySegmentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTJournalEntryTypeSchema


request_body_post_journal_entry_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTJournalEntryResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTJournalEntryResponseType
...
class BaseApi(api_client.Api):
    ...
    def _summary_journal_entry_mapped_args(
        self,
        body: POSTJournalEntryType,
        accounting_period_name: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        journal_entry_date: typing.Optional[date] = None,
        journal_entry_items: typing.Optional[typing.List[POSTJournalEntryItemType]] = None,
        notes: typing.Optional[str] = None,
        organization_label: typing.Optional[str] = None,
        segments: typing.Optional[typing.List[POSTJournalEntrySegmentType]] = None,
    ...
    async def _asummary_journal_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_journal_entry_type.serialize(body, content_type)
    ...
    def _summary_journal_entry_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SummaryJournalEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asummary_journal_entry(
        self,
        body: POSTJournalEntryType,
        accounting_period_name: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._summary_journal_entry_mapped_args(
            body=body,
        ...
        return await self._asummary_journal_entry_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def summary_journal_entry(
        self,
        body: POSTJournalEntryType,
        accounting_period_name: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        ...
        return self._summary_journal_entry_oapg(
            body=args.body,
            header_params=args.header,
        )

class SummaryJournalEntry(BaseApi):
    ...
    async def asummary_journal_entry(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTJournalEntryResponseTypePydantic:
        raw_response = await self.raw.asummary_journal_entry(
            body=body,
            accounting_period_name=accounting_period_name,
            currency=currency,
            journal_entry_date=journal_entry_date,
        ...
        if validate:
            return POSTJournalEntryResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTJournalEntryResponseTypePydantic, raw_response.body)
    ...
    def summary_journal_entry(
        ...
        raw_response = self.raw.summary_journal_entry(
            body=body,
            accounting_period_name=accounting_period_name,
            currency=currency,
            journal_entry_date=journal_entry_date,
