...
from zuora_python_sdk.model.post_journal_run_type_organization_labels import POSTJournalRunTypeOrganizationLabels as POSTJournalRunTypeOrganizationLabelsSchema
from zuora_python_sdk.model.post_journal_run_transaction_type import POSTJournalRunTransactionType as POSTJournalRunTransactionTypeSchema
from zuora_python_sdk.model.post_journal_run_type import POSTJournalRunType as POSTJournalRunTypeSchema
from zuora_python_sdk.model.post_journal_run_response_type import POSTJournalRunResponseType as POSTJournalRunResponseTypeSchema

from zuora_python_sdk.type.post_journal_run_type import POSTJournalRunType
from zuora_python_sdk.type.post_journal_run_type_organization_labels import POSTJournalRunTypeOrganizationLabels
from zuora_python_sdk.type.post_journal_run_response_type import POSTJournalRunResponseType
from zuora_python_sdk.type.post_journal_run_transaction_type import POSTJournalRunTransactionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_journal_run_type import POSTJournalRunType as POSTJournalRunTypePydantic
from zuora_python_sdk.pydantic.post_journal_run_type_organization_labels import POSTJournalRunTypeOrganizationLabels as POSTJournalRunTypeOrganizationLabelsPydantic
from zuora_python_sdk.pydantic.post_journal_run_response_type import POSTJournalRunResponseType as POSTJournalRunResponseTypePydantic
from zuora_python_sdk.pydantic.post_journal_run_transaction_type import POSTJournalRunTransactionType as POSTJournalRunTransactionTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTJournalRunTypeSchema


request_body_post_journal_run_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTJournalRunResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTJournalRunResponseType
...
class BaseApi(api_client.Api):
    ...
    def _journal_run_mapped_args(
        self,
        journal_entry_date: date,
        transaction_types: typing.List[POSTJournalRunTransactionType],
        accounting_period_name: typing.Optional[str] = None,
        organization_labels: typing.Optional[POSTJournalRunTypeOrganizationLabels] = None,
        target_end_date: typing.Optional[date] = None,
        target_start_date: typing.Optional[date] = None,
        ...
        if target_end_date is not None:
            _body["targetEndDate"] = target_end_date
        if target_start_date is not None:
            _body["targetStartDate"] = target_start_date
        if transaction_types is not None:
            _body["transactionTypes"] = transaction_types
        args.body = _body
    ...
    async def _ajournal_run_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_journal_run_type.serialize(body, content_type)
...
class JournalRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajournal_run(
        self,
        journal_entry_date: date,
        transaction_types: typing.List[POSTJournalRunTransactionType],
        accounting_period_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._journal_run_mapped_args(
        ...
        return await self._ajournal_run_oapg(
            body=args.body,
    ...
    def journal_run(
        ...
        return self._journal_run_oapg(
            body=args.body,
            header_params=args.header,
        )

class JournalRun(BaseApi):
    ...
    async def ajournal_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTJournalRunResponseTypePydantic:
        raw_response = await self.raw.ajournal_run(
            journal_entry_date=journal_entry_date,
            transaction_types=transaction_types,
            accounting_period_name=accounting_period_name,
            organization_labels=organization_labels,
        ...
        if validate:
            return POSTJournalRunResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTJournalRunResponseTypePydantic, raw_response.body)
    ...
    def journal_run(
        ...
        raw_response = self.raw.journal_run(
            journal_entry_date=journal_entry_date,
            transaction_types=transaction_types,
            accounting_period_name=accounting_period_name,
            organization_labels=organization_labels,
