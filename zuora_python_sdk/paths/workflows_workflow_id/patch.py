...
from zuora_python_sdk.model.patch_update_workflow_request import PatchUpdateWorkflowRequest as PatchUpdateWorkflowRequestSchema
from zuora_python_sdk.model.validation_errors import ValidationErrors as ValidationErrorsSchema
from zuora_python_sdk.model.workflow_definition import WorkflowDefinition as WorkflowDefinitionSchema
from zuora_python_sdk.model.delete_workflow_error import DeleteWorkflowError as DeleteWorkflowErrorSchema

from zuora_python_sdk.type.delete_workflow_error import DeleteWorkflowError
from zuora_python_sdk.type.workflow_definition import WorkflowDefinition
from zuora_python_sdk.type.patch_update_workflow_request import PatchUpdateWorkflowRequest
from zuora_python_sdk.type.validation_errors import ValidationErrors

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.patch_update_workflow_request import PatchUpdateWorkflowRequest as PatchUpdateWorkflowRequestPydantic
from zuora_python_sdk.pydantic.validation_errors import ValidationErrors as ValidationErrorsPydantic
from zuora_python_sdk.pydantic.delete_workflow_error import DeleteWorkflowError as DeleteWorkflowErrorPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchUpdateWorkflowRequestSchema


request_body_patch_update_workflow_request = api_client.RequestBody(
    content={
...
SchemaFor404ResponseBodyApplicationJson = DeleteWorkflowErrorSchema
...
SchemaFor422ResponseBodyApplicationJson = ValidationErrorsSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_workflow_mapped_args(
        ...
        active_workflow_version_id: typing.Optional[int] = None,
        ...
        if active_workflow_version_id is not None:
            _body["active_workflow_version_id"] = active_workflow_version_id
        if name is not None:
            _body["name"] = name
    ...
    async def _aupdate_workflow_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_update_workflow_request.serialize(body, content_type)
