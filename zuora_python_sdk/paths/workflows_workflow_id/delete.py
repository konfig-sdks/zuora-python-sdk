...
class Workflow0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_0(
        self,
        authorization: str,
        workflow_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflow_0_mapped_args(
        ...
        return await self._aworkflow_0_oapg(
    ...
    def workflow_0(
        ...
        return self._workflow_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Workflow0(BaseApi):
    ...
    async def aworkflow_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aworkflow_0(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def workflow_0(
        ...
        raw_response = self.raw.workflow_0(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
