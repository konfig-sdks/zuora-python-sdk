...
from zuora_python_sdk.model.get_credit_memo_part_type import GETCreditMemoPartType as GETCreditMemoPartTypeSchema

from zuora_python_sdk.type.get_credit_memo_part_type import GETCreditMemoPartType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_credit_memo_part_type import GETCreditMemoPartType as GETCreditMemoPartTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETCreditMemoPartTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_part_mapped_args(
        self,
        partid: str,
        credit_memo_key: str,
    ...
    async def _acredit_memo_part_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/parts/{partid}',
            headers=_headers,
        )
...
class CreditMemoPartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_part(
        self,
        partid: str,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_part_mapped_args(
            partid=partid,
        ...
        return await self._acredit_memo_part_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def credit_memo_part(
        self,
        partid: str,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._credit_memo_part_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoPart(BaseApi):
    ...
    async def acredit_memo_part(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCreditMemoPartTypePydantic:
        raw_response = await self.raw.acredit_memo_part(
            partid=partid,
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETCreditMemoPartTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCreditMemoPartTypePydantic, raw_response.body)
    ...
    def credit_memo_part(
        ...
        raw_response = self.raw.credit_memo_part(
            partid=partid,
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
