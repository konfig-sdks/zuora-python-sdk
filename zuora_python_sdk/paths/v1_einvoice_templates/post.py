...
from zuora_python_sdk.model.create_e_invoice_file_template_request import CreateEInvoiceFileTemplateRequest as CreateEInvoiceFileTemplateRequestSchema
from zuora_python_sdk.model.get_e_invoice_file_template_response import GetEInvoiceFileTemplateResponse as GetEInvoiceFileTemplateResponseSchema

from zuora_python_sdk.type.get_e_invoice_file_template_response import GetEInvoiceFileTemplateResponse
from zuora_python_sdk.type.create_e_invoice_file_template_request import CreateEInvoiceFileTemplateRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.create_e_invoice_file_template_request import CreateEInvoiceFileTemplateRequest as CreateEInvoiceFileTemplateRequestPydantic
from zuora_python_sdk.pydantic.get_e_invoice_file_template_response import GetEInvoiceFileTemplateResponse as GetEInvoiceFileTemplateResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateEInvoiceFileTemplateRequestSchema


request_body_create_e_invoice_file_template_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetEInvoiceFileTemplateResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetEInvoiceFileTemplateResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_e_invoice_file_template_mapped_args(
        self,
    ...
    async def _acreate_e_invoice_file_template_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/templates',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_e_invoice_file_template_request.serialize(body, content_type)
    ...
    def _create_e_invoice_file_template_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateEInvoiceFileTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_e_invoice_file_template(
        self,
        content: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        document_type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_e_invoice_file_template_mapped_args(
            body=body,
            content=content,
            country=country,
        ...
        return await self._acreate_e_invoice_file_template_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_e_invoice_file_template(
        self,
        content: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        document_type: typing.Optional[str] = None,
        ...
        return self._create_e_invoice_file_template_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateEInvoiceFileTemplate(BaseApi):
    ...
    async def acreate_e_invoice_file_template(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetEInvoiceFileTemplateResponsePydantic:
        raw_response = await self.raw.acreate_e_invoice_file_template(
            body=body,
            content=content,
            country=country,
            document_type=document_type,
        ...
        if validate:
            return RootModel[GetEInvoiceFileTemplateResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetEInvoiceFileTemplateResponsePydantic, raw_response.body)
    ...
    def create_e_invoice_file_template(
        ...
        raw_response = self.raw.create_e_invoice_file_template(
            body=body,
            content=content,
            country=country,
            document_type=document_type,
