...
from zuora_python_sdk.model.list_e_invoice_file_templates_response import ListEInvoiceFileTemplatesResponse as ListEInvoiceFileTemplatesResponseSchema

from zuora_python_sdk.type.list_e_invoice_file_templates_response import ListEInvoiceFileTemplatesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.list_e_invoice_file_templates_response import ListEInvoiceFileTemplatesResponse as ListEInvoiceFileTemplatesResponsePydantic
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'documentType': typing.Union[DocumentTypeSchema, str, ],
...
request_query_document_type = api_client.QueryParameter(
    name="documentType",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ListEInvoiceFileTemplatesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ListEInvoiceFileTemplatesResponse
...
class BaseApi(api_client.Api):
    ...
    def _e_invoice_file_templates_mapped_args(
        self,
        country: str,
        document_type: str,
        provider: str,
        ...
        if document_type is not None:
            _query_params["documentType"] = document_type
    ...
    async def _ae_invoice_file_templates_oapg(
        self,
    ...
    def _e_invoice_file_templates_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EInvoiceFileTemplatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ae_invoice_file_templates(
        self,
        country: str,
        document_type: str,
        provider: str,
        ...
        **kwargs,
        ...
        args = self._e_invoice_file_templates_mapped_args(
            country=country,
        ...
        return await self._ae_invoice_file_templates_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def e_invoice_file_templates(
        self,
        country: str,
        document_type: str,
        provider: str,
        ...
        return self._e_invoice_file_templates_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class EInvoiceFileTemplates(BaseApi):
    ...
    async def ae_invoice_file_templates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListEInvoiceFileTemplatesResponsePydantic:
        raw_response = await self.raw.ae_invoice_file_templates(
            country=country,
            document_type=document_type,
            provider=provider,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return ListEInvoiceFileTemplatesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListEInvoiceFileTemplatesResponsePydantic, raw_response.body)
    ...
    def e_invoice_file_templates(
        ...
        raw_response = self.raw.e_invoice_file_templates(
            country=country,
            document_type=document_type,
            provider=provider,
            accept_encoding=accept_encoding,
