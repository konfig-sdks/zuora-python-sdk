...
from zuora_python_sdk.model.get_event_triggers_response import GetEventTriggersResponse as GetEventTriggersResponseSchema
...
from zuora_python_sdk.type.get_event_triggers_response import GetEventTriggersResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.get_event_triggers_response import GetEventTriggersResponse as GetEventTriggersResponsePydantic

from . import path

# Query params
BaseObjectSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'baseObject': typing.Union[BaseObjectSchema, str, ],
...
request_query_base_object = api_client.QueryParameter(
    name="baseObject",
...
SchemaFor200ResponseBodyApplicationJson = GetEventTriggersResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _event_triggers_mapped_args(
        self,
        authorization: str,
        ...
        base_object: typing.Optional[str] = None,
        ...
        if base_object is not None:
            _query_params["baseObject"] = base_object
    ...
    async def _aevent_triggers_oapg(
        self,
...
class EventTriggersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_triggers(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._event_triggers_mapped_args(
        ...
        return await self._aevent_triggers_oapg(
    ...
    def event_triggers(
        ...
        return self._event_triggers_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class EventTriggers(BaseApi):
    ...
    async def aevent_triggers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetEventTriggersResponsePydantic:
        raw_response = await self.raw.aevent_triggers(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return GetEventTriggersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetEventTriggersResponsePydantic, raw_response.body)
    ...
    def event_triggers(
        ...
        raw_response = self.raw.event_triggers(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
