...
from zuora_python_sdk.model.event_type import EventType as EventTypeSchema
from zuora_python_sdk.model.post_event_trigger_request import PostEventTriggerRequest as PostEventTriggerRequestSchema
...
from zuora_python_sdk.type.event_type import EventType
from zuora_python_sdk.type.post_event_trigger_request import PostEventTriggerRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.event_trigger import EventTrigger as EventTriggerPydantic
from zuora_python_sdk.pydantic.post_event_trigger_request import PostEventTriggerRequest as PostEventTriggerRequestPydantic
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.event_type import EventType as EventTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostEventTriggerRequestSchema


request_body_post_event_trigger_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _event_trigger_mapped_args(
        self,
        active: bool,
        base_object: str,
        condition: str,
    ...
    async def _aevent_trigger_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_event_trigger_request.serialize(body, content_type)
...
class EventTriggerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_trigger(
        self,
        active: bool,
        base_object: str,
        condition: str,
        ...
        **kwargs,
        ...
        args = self._event_trigger_mapped_args(
            active=active,
        ...
        return await self._aevent_trigger_oapg(
            body=args.body,
    ...
    def event_trigger(
        ...
        return self._event_trigger_oapg(
            body=args.body,
            header_params=args.header,
        )

class EventTrigger(BaseApi):
    ...
    async def aevent_trigger(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevent_trigger(
            active=active,
            base_object=base_object,
            condition=condition,
            event_type=event_type,
    ...
    def event_trigger(
        ...
        raw_response = self.raw.event_trigger(
            active=active,
            base_object=base_object,
            condition=condition,
            event_type=event_type,
