...
from zuora_python_sdk.model.get_journal_entry_detail_type import GETJournalEntryDetailType as GETJournalEntryDetailTypeSchema

from zuora_python_sdk.type.get_journal_entry_detail_type import GETJournalEntryDetailType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_journal_entry_detail_type import GETJournalEntryDetailType as GETJournalEntryDetailTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETJournalEntryDetailTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETJournalEntryDetailType
...
class BaseApi(api_client.Api):
    ...
    def _summary_journal_entry_0_mapped_args(
        self,
        je_number: str,
    ...
    async def _asummary_journal_entry_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-entries/{je-number}',
            headers=_headers,
        )
    ...
    def _summary_journal_entry_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SummaryJournalEntry0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asummary_journal_entry_0(
        self,
        je_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._summary_journal_entry_0_mapped_args(
            je_number=je_number,
        ...
        return await self._asummary_journal_entry_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def summary_journal_entry_0(
        self,
        je_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._summary_journal_entry_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SummaryJournalEntry0(BaseApi):
    ...
    async def asummary_journal_entry_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETJournalEntryDetailTypePydantic:
        raw_response = await self.raw.asummary_journal_entry_0(
            je_number=je_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETJournalEntryDetailTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETJournalEntryDetailTypePydantic, raw_response.body)
    ...
    def summary_journal_entry_0(
        ...
        raw_response = self.raw.summary_journal_entry_0(
            je_number=je_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
