...
from zuora_python_sdk.model.get_data_backfill_job_by_id_response import GetDataBackfillJobByIdResponse as GetDataBackfillJobByIdResponseSchema

from zuora_python_sdk.type.get_data_backfill_job_by_id_response import GetDataBackfillJobByIdResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_data_backfill_job_by_id_response import GetDataBackfillJobByIdResponse as GetDataBackfillJobByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetDataBackfillJobByIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetDataBackfillJobByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _data_backfill_job_by_id_mapped_args(
        self,
        authorization: str,
        job_id: str,
    ...
    async def _adata_backfill_job_by_id_oapg(
        self,
    ...
    def _data_backfill_job_by_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DataBackfillJobByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_backfill_job_by_id(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_backfill_job_by_id_mapped_args(
        ...
        return await self._adata_backfill_job_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def data_backfill_job_by_id(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._data_backfill_job_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DataBackfillJobById(BaseApi):
    ...
    async def adata_backfill_job_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDataBackfillJobByIdResponsePydantic:
        raw_response = await self.raw.adata_backfill_job_by_id(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GetDataBackfillJobByIdResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetDataBackfillJobByIdResponsePydantic, raw_response.body)
    ...
    def data_backfill_job_by_id(
        ...
        raw_response = self.raw.data_backfill_job_by_id(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
