...
from zuora_python_sdk.model.put_stop_data_backfill_job_by_id_request import PutStopDataBackfillJobByIdRequest as PutStopDataBackfillJobByIdRequestSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.put_stop_data_backfill_job_by_id_request import PutStopDataBackfillJobByIdRequest
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_stop_data_backfill_job_by_id_request import PutStopDataBackfillJobByIdRequest as PutStopDataBackfillJobByIdRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutStopDataBackfillJobByIdRequestSchema


request_body_put_stop_data_backfill_job_by_id_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _stop_data_backfill_job_by_id_mapped_args(
        self,
        status: str,
        authorization: str,
        job_id: str,
    ...
    async def _astop_data_backfill_job_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/uno/data-backfill/jobs/{jobId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_put_stop_data_backfill_job_by_id_request.serialize(body, content_type)
    ...
    def _stop_data_backfill_job_by_id_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class StopDataBackfillJobByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astop_data_backfill_job_by_id(
        self,
        status: str,
        authorization: str,
        job_id: str,
        ...
        **kwargs,
        ...
        args = self._stop_data_backfill_job_by_id_mapped_args(
            status=status,
        ...
        return await self._astop_data_backfill_job_by_id_oapg(
            body=args.body,
    ...
    def stop_data_backfill_job_by_id(
        self,
        status: str,
        authorization: str,
        job_id: str,
        ...
        return self._stop_data_backfill_job_by_id_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class StopDataBackfillJobById(BaseApi):
    ...
    async def astop_data_backfill_job_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astop_data_backfill_job_by_id(
            status=status,
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
    ...
    def stop_data_backfill_job_by_id(
        ...
        raw_response = self.raw.stop_data_backfill_job_by_id(
            status=status,
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
