...
from zuora_python_sdk.model.post_create_draft_open_payment_method_type_response import PostCreateDraftOpenPaymentMethodTypeResponse as PostCreateDraftOpenPaymentMethodTypeResponseSchema
...
from zuora_python_sdk.model.post_create_open_payment_method_type_request import POSTCreateOpenPaymentMethodTypeRequest as POSTCreateOpenPaymentMethodTypeRequestSchema

from zuora_python_sdk.type.post_create_draft_open_payment_method_type_response import PostCreateDraftOpenPaymentMethodTypeResponse
from zuora_python_sdk.type.open_payment_method_type_request_fields import OpenPaymentMethodTypeRequestFields
from zuora_python_sdk.type.post_create_open_payment_method_type_request import POSTCreateOpenPaymentMethodTypeRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_create_draft_open_payment_method_type_response import PostCreateDraftOpenPaymentMethodTypeResponse as PostCreateDraftOpenPaymentMethodTypeResponsePydantic
...
from zuora_python_sdk.pydantic.post_create_open_payment_method_type_request import POSTCreateOpenPaymentMethodTypeRequest as POSTCreateOpenPaymentMethodTypeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreateOpenPaymentMethodTypeRequestSchema


request_body_post_create_open_payment_method_type_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostCreateDraftOpenPaymentMethodTypeResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PostCreateDraftOpenPaymentMethodTypeResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_draft_open_payment_method_type_mapped_args(
        self,
    ...
    async def _acreate_draft_open_payment_method_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/open-payment-method-types',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_open_payment_method_type_request.serialize(body, content_type)
    ...
    def _create_draft_open_payment_method_type_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateDraftOpenPaymentMethodTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_draft_open_payment_method_type(
        self,
        fields: typing.List[OpenPaymentMethodTypeRequestFields],
        internal_name: str,
        label: str,
        ...
        **kwargs,
        ...
        args = self._create_draft_open_payment_method_type_mapped_args(
            body=body,
            fields=fields,
        ...
        return await self._acreate_draft_open_payment_method_type_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_draft_open_payment_method_type(
        self,
        fields: typing.List[OpenPaymentMethodTypeRequestFields],
        internal_name: str,
        label: str,
        ...
        return self._create_draft_open_payment_method_type_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateDraftOpenPaymentMethodType(BaseApi):
    ...
    async def acreate_draft_open_payment_method_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostCreateDraftOpenPaymentMethodTypeResponsePydantic:
        raw_response = await self.raw.acreate_draft_open_payment_method_type(
            body=body,
            fields=fields,
            internal_name=internal_name,
            label=label,
        ...
        if validate:
            return PostCreateDraftOpenPaymentMethodTypeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PostCreateDraftOpenPaymentMethodTypeResponsePydantic, raw_response.body)
    ...
    def create_draft_open_payment_method_type(
        ...
        raw_response = self.raw.create_draft_open_payment_method_type(
            body=body,
            fields=fields,
            internal_name=internal_name,
            label=label,
