...
class BaseApi(api_client.Api):
    ...
    def _retrieve_catalog_group_mapped_args(
        self,
    ...
    async def _aretrieve_catalog_group_oapg(
        self,
    ...
    def _retrieve_catalog_group_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetrieveCatalogGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_catalog_group(
        self,
        catalog_group_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_catalog_group_mapped_args(
        ...
        return await self._aretrieve_catalog_group_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def retrieve_catalog_group(
        self,
        catalog_group_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._retrieve_catalog_group_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RetrieveCatalogGroup(BaseApi):
    ...
    async def aretrieve_catalog_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aretrieve_catalog_group(
            catalog_group_key=catalog_group_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def retrieve_catalog_group(
        ...
        raw_response = self.raw.retrieve_catalog_group(
            catalog_group_key=catalog_group_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
