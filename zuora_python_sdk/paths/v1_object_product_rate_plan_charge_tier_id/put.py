...
from zuora_python_sdk.model.proxy_modify_product_rate_plan_charge_tier import ProxyModifyProductRatePlanChargeTier as ProxyModifyProductRatePlanChargeTierSchema
...
from zuora_python_sdk.type.proxy_modify_product_rate_plan_charge_tier import ProxyModifyProductRatePlanChargeTier
...
from zuora_python_sdk.pydantic.proxy_modify_product_rate_plan_charge_tier import ProxyModifyProductRatePlanChargeTier as ProxyModifyProductRatePlanChargeTierPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyModifyProductRatePlanChargeTierSchema


request_body_proxy_modify_product_rate_plan_charge_tier = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ut_product_rate_plan_charge_tier_mapped_args(
        self,
        id: str,
    ...
    async def _ap_ut_product_rate_plan_charge_tier_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_modify_product_rate_plan_charge_tier.serialize(body, content_type)
    ...
    def _p_ut_product_rate_plan_charge_tier_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class PUtProductRatePlanChargeTierRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ut_product_rate_plan_charge_tier(
        self,
        id: str,
        price: typing.Optional[typing.Union[int, float]] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_ut_product_rate_plan_charge_tier_mapped_args(
            id=id,
            price=price,
        ...
        return await self._ap_ut_product_rate_plan_charge_tier_oapg(
            body=args.body,
    ...
    def p_ut_product_rate_plan_charge_tier(
        self,
        id: str,
        price: typing.Optional[typing.Union[int, float]] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._p_ut_product_rate_plan_charge_tier_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class PUtProductRatePlanChargeTier(BaseApi):
    ...
    async def ap_ut_product_rate_plan_charge_tier(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ut_product_rate_plan_charge_tier(
            id=id,
            price=price,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def p_ut_product_rate_plan_charge_tier(
        ...
        raw_response = self.raw.p_ut_product_rate_plan_charge_tier(
            id=id,
            price=price,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
