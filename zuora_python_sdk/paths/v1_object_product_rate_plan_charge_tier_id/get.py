...
from zuora_python_sdk.model.proxy_get_product_rate_plan_charge_tier import ProxyGetProductRatePlanChargeTier as ProxyGetProductRatePlanChargeTierSchema
...
from zuora_python_sdk.type.proxy_get_product_rate_plan_charge_tier import ProxyGetProductRatePlanChargeTier
...
from zuora_python_sdk.pydantic.proxy_get_product_rate_plan_charge_tier import ProxyGetProductRatePlanChargeTier as ProxyGetProductRatePlanChargeTierPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetProductRatePlanChargeTierSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProxyGetProductRatePlanChargeTier
...
class BaseApi(api_client.Api):
    ...
    def _g_et_product_rate_plan_charge_tier_mapped_args(
        self,
        id: str,
    ...
    async def _ag_et_product_rate_plan_charge_tier_oapg(
        self,
    ...
    def _g_et_product_rate_plan_charge_tier_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GEtProductRatePlanChargeTierRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ag_et_product_rate_plan_charge_tier(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._g_et_product_rate_plan_charge_tier_mapped_args(
            id=id,
        ...
        return await self._ag_et_product_rate_plan_charge_tier_oapg(
    ...
    def g_et_product_rate_plan_charge_tier(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._g_et_product_rate_plan_charge_tier_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GEtProductRatePlanChargeTier(BaseApi):
    ...
    async def ag_et_product_rate_plan_charge_tier(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetProductRatePlanChargeTierPydantic:
        raw_response = await self.raw.ag_et_product_rate_plan_charge_tier(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return ProxyGetProductRatePlanChargeTierPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyGetProductRatePlanChargeTierPydantic, raw_response.body)
    ...
    def g_et_product_rate_plan_charge_tier(
        ...
        raw_response = self.raw.g_et_product_rate_plan_charge_tier(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
