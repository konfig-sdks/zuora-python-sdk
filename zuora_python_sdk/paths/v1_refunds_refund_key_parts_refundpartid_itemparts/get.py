...
from zuora_python_sdk.model.get_refund_item_part_collection_type import GETRefundItemPartCollectionType as GETRefundItemPartCollectionTypeSchema

from zuora_python_sdk.type.get_refund_item_part_collection_type import GETRefundItemPartCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_refund_item_part_collection_type import GETRefundItemPartCollectionType as GETRefundItemPartCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETRefundItemPartCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRefundItemPartCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _refund_item_parts_mapped_args(
        self,
        refundpartid: str,
        refund_key: str,
    ...
    async def _arefund_item_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundKey}/parts/{refundpartid}/itemparts',
            headers=_headers,
        )
...
class RefundItemPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefund_item_parts(
        self,
        refundpartid: str,
        refund_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._refund_item_parts_mapped_args(
        ...
        return await self._arefund_item_parts_oapg(
    ...
    def refund_item_parts(
        ...
        return self._refund_item_parts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class RefundItemParts(BaseApi):
    ...
    async def arefund_item_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundItemPartCollectionTypePydantic:
        raw_response = await self.raw.arefund_item_parts(
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETRefundItemPartCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETRefundItemPartCollectionTypePydantic, raw_response.body)
    ...
    def refund_item_parts(
        ...
        raw_response = self.raw.refund_item_parts(
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
