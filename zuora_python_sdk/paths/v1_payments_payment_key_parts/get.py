...
from zuora_python_sdk.model.get_payment_parts_collection_type import GETPaymentPartsCollectionType as GETPaymentPartsCollectionTypeSchema

from zuora_python_sdk.type.get_payment_parts_collection_type import GETPaymentPartsCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_parts_collection_type import GETPaymentPartsCollectionType as GETPaymentPartsCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentPartsCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentPartsCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _payment_parts_mapped_args(
        self,
        payment_key: str,
    ...
    async def _apayment_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/parts',
            headers=_headers,
        )
...
class PaymentPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_parts(
        self,
        payment_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_parts_mapped_args(
        ...
        return await self._apayment_parts_oapg(
    ...
    def payment_parts(
        ...
        return self._payment_parts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentParts(BaseApi):
    ...
    async def apayment_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentPartsCollectionTypePydantic:
        raw_response = await self.raw.apayment_parts(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETPaymentPartsCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentPartsCollectionTypePydantic, raw_response.body)
    ...
    def payment_parts(
        ...
        raw_response = self.raw.payment_parts(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
