...
from zuora_python_sdk.model.submit_batch_query_response import SubmitBatchQueryResponse as SubmitBatchQueryResponseSchema
from zuora_python_sdk.model.submit_batch_query_request import SubmitBatchQueryRequest as SubmitBatchQueryRequestSchema
from zuora_python_sdk.model.batch_query import BatchQuery as BatchQuerySchema

from zuora_python_sdk.type.submit_batch_query_response import SubmitBatchQueryResponse
from zuora_python_sdk.type.submit_batch_query_request import SubmitBatchQueryRequest
from zuora_python_sdk.type.batch_query import BatchQuery

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.batch_query import BatchQuery as BatchQueryPydantic
from zuora_python_sdk.pydantic.submit_batch_query_request import SubmitBatchQueryRequest as SubmitBatchQueryRequestPydantic
from zuora_python_sdk.pydantic.submit_batch_query_response import SubmitBatchQueryResponse as SubmitBatchQueryResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = SubmitBatchQueryRequestSchema


request_body_submit_batch_query_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SubmitBatchQueryResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _batch_query_job_1_mapped_args(
        self,
        authorization: str,
        version: typing.Optional[typing.Union[int, float]] = None,
        date_time_utc: typing.Optional[bool] = None,
        format: typing.Optional[str] = None,
        incremental_time: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        notify_url: typing.Optional[str] = None,
        null_replacement: typing.Optional[str] = None,
        offset: typing.Optional[typing.Union[int, float]] = None,
        partner: typing.Optional[str] = None,
        project: typing.Optional[str] = None,
        queries: typing.Optional[typing.List[BatchQuery]] = None,
        source_data: typing.Optional[str] = None,
        use_query_labels: typing.Optional[bool] = None,
        ...
        if date_time_utc is not None:
            _body["dateTimeUtc"] = date_time_utc
        if format is not None:
            _body["format"] = format
        if incremental_time is not None:
            _body["incrementalTime"] = incremental_time
        if name is not None:
            _body["name"] = name
        if notify_url is not None:
            _body["notifyUrl"] = notify_url
        if null_replacement is not None:
            _body["nullReplacement"] = null_replacement
        if offset is not None:
            _body["offset"] = offset
        if partner is not None:
            _body["partner"] = partner
        ...
        if use_query_labels is not None:
            _body["useQueryLabels"] = use_query_labels
    ...
    async def _abatch_query_job_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batch-query',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_submit_batch_query_request.serialize(body, content_type)
...
class BatchQueryJob1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abatch_query_job_1(
        self,
        authorization: str,
        version: typing.Optional[typing.Union[int, float]] = None,
        date_time_utc: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._batch_query_job_1_mapped_args(
            ...
            use_query_labels=use_query_labels,
        ...
        return await self._abatch_query_job_1_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def batch_query_job_1(
        self,
        authorization: str,
        version: typing.Optional[typing.Union[int, float]] = None,
        date_time_utc: typing.Optional[bool] = None,
        ...
        return self._batch_query_job_1_oapg(
            body=args.body,
            header_params=args.header,
        )

class BatchQueryJob1(BaseApi):
    ...
    async def abatch_query_job_1(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SubmitBatchQueryResponsePydantic:
        raw_response = await self.raw.abatch_query_job_1(
            authorization=authorization,
            version=version,
            date_time_utc=date_time_utc,
            format=format,
        ...
        if validate:
            return SubmitBatchQueryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SubmitBatchQueryResponsePydantic, raw_response.body)
    ...
    def batch_query_job_1(
        ...
        raw_response = self.raw.batch_query_job_1(
            authorization=authorization,
            version=version,
            date_time_utc=date_time_utc,
            format=format,
