...
from zuora_python_sdk.model.post_usage_request import PostUsageRequest as PostUsageRequestSchema
from zuora_python_sdk.model.post_usage_response_type import POSTUsageResponseType as POSTUsageResponseTypeSchema

from zuora_python_sdk.type.post_usage_request import PostUsageRequest
from zuora_python_sdk.type.post_usage_response_type import POSTUsageResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_usage_response_type import POSTUsageResponseType as POSTUsageResponseTypePydantic
from zuora_python_sdk.pydantic.post_usage_request import PostUsageRequest as PostUsageRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostUsageRequestSchema


request_body_post_usage_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTUsageResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    async def _ausage_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_usage_request.serialize(body, content_type)
...
class UsageRaw(BaseApi):
    ...
    async def ausage(
        ...
        **kwargs,
        ...
        return await self._ausage_oapg(
            body=args.body,
...
class Usage(BaseApi):
    ...
    async def ausage(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTUsageResponseTypePydantic:
        raw_response = await self.raw.ausage(
            file=file,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTUsageResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTUsageResponseTypePydantic, raw_response.body)
