...
from zuora_python_sdk.model.metadata_revert_deployment_response import MetadataRevertDeploymentResponse as MetadataRevertDeploymentResponseSchema

from zuora_python_sdk.type.metadata_revert_deployment_response import MetadataRevertDeploymentResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.metadata_revert_deployment_response import MetadataRevertDeploymentResponse as MetadataRevertDeploymentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MetadataRevertDeploymentResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: MetadataRevertDeploymentResponse
...
class BaseApi(api_client.Api):
    ...
    def _revert_deployment_mapped_args(
        self,
        migration_id: str,
    ...
    async def _arevert_deployment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployments/{migrationId}/revert',
            headers=_headers,
        )
...
class RevertDeploymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevert_deployment(
        self,
        migration_id: str,
        zuora_entity_ids: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._revert_deployment_mapped_args(
            migration_id=migration_id,
            zuora_entity_ids=zuora_entity_ids,
        )
        return await self._arevert_deployment_oapg(
    ...
    def revert_deployment(
        ...
        return self._revert_deployment_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RevertDeployment(BaseApi):
    ...
    async def arevert_deployment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetadataRevertDeploymentResponsePydantic:
        raw_response = await self.raw.arevert_deployment(
            migration_id=migration_id,
            zuora_entity_ids=zuora_entity_ids,
            **kwargs,
        )
        if validate:
            return MetadataRevertDeploymentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MetadataRevertDeploymentResponsePydantic, raw_response.body)
    ...
    def revert_deployment(
        ...
        raw_response = self.raw.revert_deployment(
            migration_id=migration_id,
            zuora_entity_ids=zuora_entity_ids,
        )
        if validate:
