...
class BaseApi(api_client.Api):
    ...
    def _orders_by_invoice_owner_mapped_args(
        self,
        account_number: str,
    ...
    async def _aorders_by_invoice_owner_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/invoiceOwner/{accountNumber}',
            headers=_headers,
        )
    ...
    def _orders_by_invoice_owner_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class OrdersByInvoiceOwnerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorders_by_invoice_owner(
        self,
        account_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._orders_by_invoice_owner_mapped_args(
        ...
        return await self._aorders_by_invoice_owner_oapg(
    ...
    def orders_by_invoice_owner(
        ...
        return self._orders_by_invoice_owner_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class OrdersByInvoiceOwner(BaseApi):
    ...
    async def aorders_by_invoice_owner(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorders_by_invoice_owner(
            account_number=account_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def orders_by_invoice_owner(
        ...
        raw_response = self.raw.orders_by_invoice_owner(
            account_number=account_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
