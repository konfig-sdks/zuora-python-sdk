...
class BaseApi(api_client.Api):
    ...
    def _scheduled_event_by_id_1_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _ascheduled_event_by_id_1_oapg(
        self,
    ...
    def _scheduled_event_by_id_1_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ScheduledEventById1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascheduled_event_by_id_1(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._scheduled_event_by_id_1_mapped_args(
        ...
        return await self._ascheduled_event_by_id_1_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def scheduled_event_by_id_1(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._scheduled_event_by_id_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ScheduledEventById1(BaseApi):
    ...
    async def ascheduled_event_by_id_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ascheduled_event_by_id_1(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def scheduled_event_by_id_1(
        ...
        raw_response = self.raw.scheduled_event_by_id_1(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
