...
from zuora_python_sdk.model.get_scheduled_event_response import GetScheduledEventResponse as GetScheduledEventResponseSchema
from zuora_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema
from zuora_python_sdk.model.put_scheduled_event_request_parameters import PutScheduledEventRequestParameters as PutScheduledEventRequestParametersSchema
from zuora_python_sdk.model.put_scheduled_event_request import PutScheduledEventRequest as PutScheduledEventRequestSchema

from zuora_python_sdk.type.error_response import ErrorResponse
from zuora_python_sdk.type.get_scheduled_event_response import GetScheduledEventResponse
from zuora_python_sdk.type.put_scheduled_event_request import PutScheduledEventRequest
from zuora_python_sdk.type.put_scheduled_event_request_parameters import PutScheduledEventRequestParameters

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_scheduled_event_request import PutScheduledEventRequest as PutScheduledEventRequestPydantic
from zuora_python_sdk.pydantic.get_scheduled_event_response import GetScheduledEventResponse as GetScheduledEventResponsePydantic
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.put_scheduled_event_request_parameters import PutScheduledEventRequestParameters as PutScheduledEventRequestParametersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutScheduledEventRequestSchema


request_body_put_scheduled_event_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetScheduledEventResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetScheduledEventResponse
...
class BaseApi(api_client.Api):
    ...
    def _scheduled_event_by_id_0_mapped_args(
        self,
        authorization: str,
        id: str,
        description: typing.Optional[str] = None,
        parameters: typing.Optional[PutScheduledEventRequestParameters] = None,
    ...
    async def _ascheduled_event_by_id_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/events/scheduled-events/{id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_scheduled_event_request.serialize(body, content_type)
    ...
    def _scheduled_event_by_id_0_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ScheduledEventById0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascheduled_event_by_id_0(
        self,
        authorization: str,
        id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._scheduled_event_by_id_0_mapped_args(
        ...
        return await self._ascheduled_event_by_id_0_oapg(
            body=args.body,
    ...
    def scheduled_event_by_id_0(
        ...
        return self._scheduled_event_by_id_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ScheduledEventById0(BaseApi):
    ...
    async def ascheduled_event_by_id_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetScheduledEventResponsePydantic:
        raw_response = await self.raw.ascheduled_event_by_id_0(
            authorization=authorization,
            id=id,
            description=description,
            parameters=parameters,
        ...
        if validate:
            return GetScheduledEventResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetScheduledEventResponsePydantic, raw_response.body)
    ...
    def scheduled_event_by_id_0(
        ...
        raw_response = self.raw.scheduled_event_by_id_0(
            authorization=authorization,
            id=id,
            description=description,
            parameters=parameters,
