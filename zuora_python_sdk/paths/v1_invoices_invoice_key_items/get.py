...
from zuora_python_sdk.model.get_invoice_items_response import GETInvoiceItemsResponse as GETInvoiceItemsResponseSchema

from zuora_python_sdk.type.get_invoice_items_response import GETInvoiceItemsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_invoice_items_response import GETInvoiceItemsResponse as GETInvoiceItemsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETInvoiceItemsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _invoice_items_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _ainvoice_items_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/items',
            headers=_headers,
        )
...
class InvoiceItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoice_items(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._invoice_items_mapped_args(
        ...
        return await self._ainvoice_items_oapg(
    ...
    def invoice_items(
        ...
        return self._invoice_items_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )
...
class InvoiceItems(BaseApi):
    ...
    async def ainvoice_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETInvoiceItemsResponsePydantic:
        raw_response = await self.raw.ainvoice_items(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETInvoiceItemsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETInvoiceItemsResponsePydantic, raw_response.body)
    ...
    def invoice_items(
        ...
        raw_response = self.raw.invoice_items(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
