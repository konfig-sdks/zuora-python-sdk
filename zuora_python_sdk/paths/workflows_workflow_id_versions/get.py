...
from zuora_python_sdk.model.get_versions_response import GetVersionsResponse as GetVersionsResponseSchema

from zuora_python_sdk.type.get_versions_response import GetVersionsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_versions_response import GetVersionsResponse as GetVersionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetVersionsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflow_versions_mapped_args(
        self,
        authorization: str,
        workflow_id: int,
    ...
    async def _aworkflow_versions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workflows/{workflow_id}/versions',
            headers=_headers,
        )
...
class WorkflowVersionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_versions(
        self,
        authorization: str,
        workflow_id: int,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflow_versions_mapped_args(
        ...
        return await self._aworkflow_versions_oapg(
    ...
    def workflow_versions(
        ...
        return self._workflow_versions_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class WorkflowVersions(BaseApi):
    ...
    async def aworkflow_versions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetVersionsResponsePydantic:
        raw_response = await self.raw.aworkflow_versions(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GetVersionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetVersionsResponsePydantic, raw_response.body)
    ...
    def workflow_versions(
        ...
        raw_response = self.raw.workflow_versions(
            authorization=authorization,
            workflow_id=workflow_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
