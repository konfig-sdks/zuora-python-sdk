...
from zuora_python_sdk.model.proxy_create_product_rate_plan_charge import ProxyCreateProductRatePlanCharge as ProxyCreateProductRatePlanChargeSchema
...
from zuora_python_sdk.type.proxy_create_product_rate_plan_charge import ProxyCreateProductRatePlanCharge
...
from zuora_python_sdk.pydantic.proxy_create_product_rate_plan_charge import ProxyCreateProductRatePlanCharge as ProxyCreateProductRatePlanChargePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyCreateProductRatePlanChargeSchema


request_body_proxy_create_product_rate_plan_charge = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_product_rate_plan_charge_mapped_args(
        self,
        body: ProxyCreateProductRatePlanCharge,
        ...
        overage_calculation_option: typing.Optional[str] = None,
        overage_unused_units_credit_option: typing.Optional[typing.Optional[str]] = None,
        prepaid_operation_type: typing.Optional[str] = None,
        prepaid_quantity: typing.Optional[typing.Union[int, float]] = None,
        prepaid_total_quantity: typing.Optional[typing.Union[int, float]] = None,
        prepaid_uom: typing.Optional[str] = None,
        price_change_option: typing.Optional[str] = None,
    ...
    async def _ap_ost_product_rate_plan_charge_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_create_product_rate_plan_charge.serialize(body, content_type)
    ...
    def _p_ost_product_rate_plan_charge_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class POstProductRatePlanChargeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_product_rate_plan_charge(
        self,
        body: ProxyCreateProductRatePlanCharge,
        accounting_code: typing.Optional[str] = None,
        apply_discount_to: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_ost_product_rate_plan_charge_mapped_args(
            body=body,
            ...
            prepaid_operation_type=prepaid_operation_type,
            prepaid_quantity=prepaid_quantity,
            prepaid_total_quantity=prepaid_total_quantity,
        ...
        return await self._ap_ost_product_rate_plan_charge_oapg(
            body=args.body,
    ...
    def p_ost_product_rate_plan_charge(
        self,
        body: ProxyCreateProductRatePlanCharge,
        accounting_code: typing.Optional[str] = None,
        apply_discount_to: typing.Optional[str] = None,
        ...
        return self._p_ost_product_rate_plan_charge_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstProductRatePlanCharge(BaseApi):
    ...
    async def ap_ost_product_rate_plan_charge(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ost_product_rate_plan_charge(
            body=body,
            accounting_code=accounting_code,
            apply_discount_to=apply_discount_to,
            bill_cycle_day=bill_cycle_day,
    ...
    def p_ost_product_rate_plan_charge(
        ...
        raw_response = self.raw.p_ost_product_rate_plan_charge(
            body=body,
            accounting_code=accounting_code,
            apply_discount_to=apply_discount_to,
            bill_cycle_day=bill_cycle_day,
