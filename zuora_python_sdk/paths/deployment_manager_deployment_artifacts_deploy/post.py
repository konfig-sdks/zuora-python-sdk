...
from zuora_python_sdk.model.template_migration_client_request import TemplateMigrationClientRequest as TemplateMigrationClientRequestSchema
...
from zuora_python_sdk.model.migration_client_response import MigrationClientResponse as MigrationClientResponseSchema
from zuora_python_sdk.model.migration_component_content import MigrationComponentContent as MigrationComponentContentSchema

from zuora_python_sdk.type.migration_client_response import MigrationClientResponse
from zuora_python_sdk.type.template_migration_client_request import TemplateMigrationClientRequest
from zuora_python_sdk.type.migration_component_content import MigrationComponentContent
...
from zuora_python_sdk.pydantic.migration_component_content import MigrationComponentContent as MigrationComponentContentPydantic
from zuora_python_sdk.pydantic.template_migration_client_request import TemplateMigrationClientRequest as TemplateMigrationClientRequestPydantic
from zuora_python_sdk.pydantic.migration_client_response import MigrationClientResponse as MigrationClientResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TemplateMigrationClientRequestSchema


request_body_template_migration_client_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MigrationClientResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _migrate_tenant_settings_mapped_args(
        self,
        description: str,
        entity_uuid: str,
        name: str,
        ...
        email_ids: typing.Optional[str] = None,
        meta_data: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        request: typing.Optional[typing.List[MigrationComponentContent]] = None,
        ...
        if email_ids is not None:
            _body["emailIds"] = email_ids
        if entity_uuid is not None:
            _body["entityUuid"] = entity_uuid
        if meta_data is not None:
            _body["metaData"] = meta_data
        if name is not None:
            _body["name"] = name
        if request is not None:
            _body["request"] = request
        if send_email is not None:
            _body["sendEmail"] = send_email
        args.body = _body
        if tenant is not None:
            _query_params["tenant"] = tenant
    ...
    async def _amigrate_tenant_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployment_artifacts/deploy',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_template_migration_client_request.serialize(body, content_type)
    ...
    def _migrate_tenant_settings_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class MigrateTenantSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amigrate_tenant_settings(
        self,
        description: str,
        entity_uuid: str,
        name: str,
        ...
        **kwargs,
        ...
        args = self._migrate_tenant_settings_mapped_args(
        ...
        return await self._amigrate_tenant_settings_oapg(
            body=args.body,
    ...
    def migrate_tenant_settings(
        ...
        return self._migrate_tenant_settings_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class MigrateTenantSettings(BaseApi):
    ...
    async def amigrate_tenant_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MigrationClientResponsePydantic:
        raw_response = await self.raw.amigrate_tenant_settings(
            description=description,
            entity_uuid=entity_uuid,
            name=name,
            send_email=send_email,
        ...
        if validate:
            return MigrationClientResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MigrationClientResponsePydantic, raw_response.body)
    ...
    def migrate_tenant_settings(
        ...
        raw_response = self.raw.migrate_tenant_settings(
            description=description,
            entity_uuid=entity_uuid,
            name=name,
            send_email=send_email,
