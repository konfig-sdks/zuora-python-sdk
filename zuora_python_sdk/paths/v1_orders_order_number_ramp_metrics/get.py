...
from zuora_python_sdk.model.get_ramp_metrics_by_order_number_response_type import GETRampMetricsByOrderNumberResponseType as GETRampMetricsByOrderNumberResponseTypeSchema

from zuora_python_sdk.type.get_ramp_metrics_by_order_number_response_type import GETRampMetricsByOrderNumberResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_ramp_metrics_by_order_number_response_type import GETRampMetricsByOrderNumberResponseType as GETRampMetricsByOrderNumberResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETRampMetricsByOrderNumberResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRampMetricsByOrderNumberResponseType
...
class BaseApi(api_client.Api):
    ...
    def _ramp_metrics_by_order_number_mapped_args(
        self,
        order_number: str,
    ...
    async def _aramp_metrics_by_order_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/{orderNumber}/ramp-metrics',
            headers=_headers,
        )
    ...
    def _ramp_metrics_by_order_number_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RampMetricsByOrderNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aramp_metrics_by_order_number(
        self,
        order_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._ramp_metrics_by_order_number_mapped_args(
        ...
        return await self._aramp_metrics_by_order_number_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def ramp_metrics_by_order_number(
        self,
        order_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._ramp_metrics_by_order_number_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RampMetricsByOrderNumber(BaseApi):
    ...
    async def aramp_metrics_by_order_number(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRampMetricsByOrderNumberResponseTypePydantic:
        raw_response = await self.raw.aramp_metrics_by_order_number(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETRampMetricsByOrderNumberResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRampMetricsByOrderNumberResponseTypePydantic, raw_response.body)
    ...
    def ramp_metrics_by_order_number(
        ...
        raw_response = self.raw.ramp_metrics_by_order_number(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
