...
from zuora_python_sdk.model.post_credit_memo_email_request_type import PostCreditMemoEmailRequestType as PostCreditMemoEmailRequestTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.post_credit_memo_email_request_type import PostCreditMemoEmailRequestType
...
from zuora_python_sdk.pydantic.post_credit_memo_email_request_type import PostCreditMemoEmailRequestType as PostCreditMemoEmailRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostCreditMemoEmailRequestTypeSchema


request_body_post_credit_memo_email_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _email_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
        email_addresses: typing.Optional[str] = None,
        include_additional_email_addresses: typing.Optional[bool] = None,
        pdf_file_id: typing.Optional[str] = None,
        use_email_template_setting: typing.Optional[bool] = None,
        ...
        if include_additional_email_addresses is not None:
            _body["includeAdditionalEmailAddresses"] = include_additional_email_addresses
        if pdf_file_id is not None:
            _body["pdfFileId"] = pdf_file_id
        if use_email_template_setting is not None:
            _body["useEmailTemplateSetting"] = use_email_template_setting
        args.body = _body
    ...
    async def _aemail_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/emails',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_credit_memo_email_request_type.serialize(body, content_type)
...
class EmailCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemail_credit_memo(
        self,
        credit_memo_key: str,
        email_addresses: typing.Optional[str] = None,
        include_additional_email_addresses: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._email_credit_memo_mapped_args(
            credit_memo_key=credit_memo_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            pdf_file_id=pdf_file_id,
            use_email_template_setting=use_email_template_setting,
        ...
        return await self._aemail_credit_memo_oapg(
            body=args.body,
    ...
    def email_credit_memo(
        ...
        return self._email_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EmailCreditMemo(BaseApi):
    ...
    async def aemail_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemail_credit_memo(
            credit_memo_key=credit_memo_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            pdf_file_id=pdf_file_id,
    ...
    def email_credit_memo(
        ...
        raw_response = self.raw.email_credit_memo(
            credit_memo_key=credit_memo_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            pdf_file_id=pdf_file_id,
