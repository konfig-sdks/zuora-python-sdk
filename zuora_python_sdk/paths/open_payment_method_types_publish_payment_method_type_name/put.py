...
from zuora_python_sdk.model.put_publish_open_payment_method_type_response import PutPublishOpenPaymentMethodTypeResponse as PutPublishOpenPaymentMethodTypeResponseSchema

from zuora_python_sdk.type.put_publish_open_payment_method_type_response import PutPublishOpenPaymentMethodTypeResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_publish_open_payment_method_type_response import PutPublishOpenPaymentMethodTypeResponse as PutPublishOpenPaymentMethodTypeResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PutPublishOpenPaymentMethodTypeResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PutPublishOpenPaymentMethodTypeResponse
...
class BaseApi(api_client.Api):
    ...
    def _publish_open_payment_method_type_mapped_args(
        self,
        authorization: str,
    ...
    async def _apublish_open_payment_method_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/open-payment-method-types/publish/{paymentMethodTypeName}',
            headers=_headers,
        )
    ...
    def _publish_open_payment_method_type_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PublishOpenPaymentMethodTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apublish_open_payment_method_type(
        self,
        authorization: str,
        payment_method_type_name: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._publish_open_payment_method_type_mapped_args(
        ...
        return await self._apublish_open_payment_method_type_oapg(
    ...
    def publish_open_payment_method_type(
        ...
        return self._publish_open_payment_method_type_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PublishOpenPaymentMethodType(BaseApi):
    ...
    async def apublish_open_payment_method_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PutPublishOpenPaymentMethodTypeResponsePydantic:
        raw_response = await self.raw.apublish_open_payment_method_type(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return PutPublishOpenPaymentMethodTypeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PutPublishOpenPaymentMethodTypeResponsePydantic, raw_response.body)
    ...
    def publish_open_payment_method_type(
        ...
        raw_response = self.raw.publish_open_payment_method_type(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
