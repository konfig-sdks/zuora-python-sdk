...
from zuora_python_sdk.model.put_order_action_trigger_dates_request_type import PUTOrderActionTriggerDatesRequestType as PUTOrderActionTriggerDatesRequestTypeSchema
from zuora_python_sdk.model.put_order_action_trigger_dates_request_type_subscriptions import PUTOrderActionTriggerDatesRequestTypeSubscriptions as PUTOrderActionTriggerDatesRequestTypeSubscriptionsSchema
from zuora_python_sdk.model.put_order_trigger_dates_response_type import PUTOrderTriggerDatesResponseType as PUTOrderTriggerDatesResponseTypeSchema

from zuora_python_sdk.type.put_order_action_trigger_dates_request_type import PUTOrderActionTriggerDatesRequestType
from zuora_python_sdk.type.put_order_action_trigger_dates_request_type_subscriptions import PUTOrderActionTriggerDatesRequestTypeSubscriptions
from zuora_python_sdk.type.put_order_trigger_dates_response_type import PUTOrderTriggerDatesResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_order_action_trigger_dates_request_type import PUTOrderActionTriggerDatesRequestType as PUTOrderActionTriggerDatesRequestTypePydantic
from zuora_python_sdk.pydantic.put_order_action_trigger_dates_request_type_subscriptions import PUTOrderActionTriggerDatesRequestTypeSubscriptions as PUTOrderActionTriggerDatesRequestTypeSubscriptionsPydantic
from zuora_python_sdk.pydantic.put_order_trigger_dates_response_type import PUTOrderTriggerDatesResponseType as PUTOrderTriggerDatesResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTOrderActionTriggerDatesRequestTypeSchema


request_body_put_order_action_trigger_dates_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTOrderTriggerDatesResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTOrderTriggerDatesResponseType
...
class BaseApi(api_client.Api):
    ...
    def _order_trigger_dates_mapped_args(
        self,
        order_number: str,
        subscriptions: typing.Optional[PUTOrderActionTriggerDatesRequestTypeSubscriptions] = None,
    ...
    async def _aorder_trigger_dates_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/{orderNumber}/triggerDates',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_order_action_trigger_dates_request_type.serialize(body, content_type)
...
class OrderTriggerDatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_trigger_dates(
        self,
        order_number: str,
        subscriptions: typing.Optional[PUTOrderActionTriggerDatesRequestTypeSubscriptions] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_trigger_dates_mapped_args(
        ...
        return await self._aorder_trigger_dates_oapg(
            body=args.body,
    ...
    def order_trigger_dates(
        ...
        return self._order_trigger_dates_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class OrderTriggerDates(BaseApi):
    ...
    async def aorder_trigger_dates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTOrderTriggerDatesResponseTypePydantic:
        raw_response = await self.raw.aorder_trigger_dates(
            order_number=order_number,
            subscriptions=subscriptions,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[PUTOrderTriggerDatesResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(PUTOrderTriggerDatesResponseTypePydantic, raw_response.body)
    ...
    def order_trigger_dates(
        ...
        raw_response = self.raw.order_trigger_dates(
            order_number=order_number,
            subscriptions=subscriptions,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
