...
from zuora_python_sdk.model.post_subscription_cancellation_response_type import POSTSubscriptionCancellationResponseType as POSTSubscriptionCancellationResponseTypeSchema
from zuora_python_sdk.model.post_subscription_cancellation_type_application_order import POSTSubscriptionCancellationTypeApplicationOrder as POSTSubscriptionCancellationTypeApplicationOrderSchema
from zuora_python_sdk.model.post_subscription_cancellation_type import POSTSubscriptionCancellationType as POSTSubscriptionCancellationTypeSchema

from zuora_python_sdk.type.post_subscription_cancellation_type import POSTSubscriptionCancellationType
from zuora_python_sdk.type.post_subscription_cancellation_type_application_order import POSTSubscriptionCancellationTypeApplicationOrder
from zuora_python_sdk.type.post_subscription_cancellation_response_type import POSTSubscriptionCancellationResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_subscription_cancellation_response_type import POSTSubscriptionCancellationResponseType as POSTSubscriptionCancellationResponseTypePydantic
from zuora_python_sdk.pydantic.post_subscription_cancellation_type import POSTSubscriptionCancellationType as POSTSubscriptionCancellationTypePydantic
from zuora_python_sdk.pydantic.post_subscription_cancellation_type_application_order import POSTSubscriptionCancellationTypeApplicationOrder as POSTSubscriptionCancellationTypeApplicationOrderPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTSubscriptionCancellationTypeSchema


request_body_post_subscription_cancellation_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTSubscriptionCancellationResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTSubscriptionCancellationResponseType
...
class BaseApi(api_client.Api):
    ...
    def _cancel_subscription_mapped_args(
        ...
        application_order: typing.Optional[POSTSubscriptionCancellationTypeApplicationOrder] = None,
        ...
        cancellation_effective_date: typing.Optional[date] = None,
        ...
        if cancellation_effective_date is not None:
            _body["cancellationEffectiveDate"] = cancellation_effective_date
        if cancellation_policy is not None:
            _body["cancellationPolicy"] = cancellation_policy
    ...
    async def _acancel_subscription_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/cancel',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_subscription_cancellation_type.serialize(body, content_type)
...
class CancelSubscription(BaseApi):
    ...
    async def acancel_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTSubscriptionCancellationResponseTypePydantic:
        ...
        if validate:
            return POSTSubscriptionCancellationResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTSubscriptionCancellationResponseTypePydantic, raw_response.body)
