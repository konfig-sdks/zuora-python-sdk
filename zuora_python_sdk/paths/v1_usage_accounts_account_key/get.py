...
from zuora_python_sdk.model.get_usage_wrapper import GETUsageWrapper as GETUsageWrapperSchema

from zuora_python_sdk.type.get_usage_wrapper import GETUsageWrapper

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_usage_wrapper import GETUsageWrapper as GETUsageWrapperPydantic
...
SchemaFor200ResponseBodyApplicationJson = GETUsageWrapperSchema
    ...
    async def _ausage_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/usage/accounts/{account-key}',
            headers=_headers,
        )
...
class Usage0Raw(BaseApi):
    ...
    async def ausage_0(
        ...
        **kwargs,
        ...
        args = self._usage_0_mapped_args(
        ...
        return await self._ausage_0_oapg(
    ...
    def usage_0(
        ...
        return self._usage_0_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class Usage0(BaseApi):
    ...
    async def ausage_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETUsageWrapperPydantic:
        raw_response = await self.raw.ausage_0(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETUsageWrapperPydantic(**raw_response.body)
        return api_client.construct_model_instance(GETUsageWrapperPydantic, raw_response.body)
