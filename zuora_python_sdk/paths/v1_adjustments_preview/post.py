...
from zuora_python_sdk.model.post_preview_billing_adjustment_request_type import POSTPreviewBillingAdjustmentRequestType as POSTPreviewBillingAdjustmentRequestTypeSchema
from zuora_python_sdk.model.post_preview_billing_adjustment_request_type_charge_numbers import POSTPreviewBillingAdjustmentRequestTypeChargeNumbers as POSTPreviewBillingAdjustmentRequestTypeChargeNumbersSchema
...
from zuora_python_sdk.type.post_preview_billing_adjustment_request_type import POSTPreviewBillingAdjustmentRequestType
from zuora_python_sdk.type.post_preview_billing_adjustment_request_type_charge_numbers import POSTPreviewBillingAdjustmentRequestTypeChargeNumbers
from zuora_python_sdk.type.get_adjustments_response_type import GETAdjustmentsResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_preview_billing_adjustment_request_type_charge_numbers import POSTPreviewBillingAdjustmentRequestTypeChargeNumbers as POSTPreviewBillingAdjustmentRequestTypeChargeNumbersPydantic
from zuora_python_sdk.pydantic.post_preview_billing_adjustment_request_type import POSTPreviewBillingAdjustmentRequestType as POSTPreviewBillingAdjustmentRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPreviewBillingAdjustmentRequestTypeSchema


request_body_post_preview_billing_adjustment_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _adjustment_0_mapped_args(
        self,
        end_date: date,
        start_date: date,
        account_number: typing.Optional[str] = None,
        charge_numbers: typing.Optional[POSTPreviewBillingAdjustmentRequestTypeChargeNumbers] = None,
    ...
    async def _aadjustment_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/adjustments/preview',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_preview_billing_adjustment_request_type.serialize(body, content_type)
...
class Adjustment0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadjustment_0(
        self,
        end_date: date,
        start_date: date,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._adjustment_0_mapped_args(
            end_date=end_date,
        ...
        return await self._aadjustment_0_oapg(
            body=args.body,
    ...
    def adjustment_0(
        ...
        return self._adjustment_0_oapg(
            body=args.body,
            header_params=args.header,
        )

class Adjustment0(BaseApi):
    ...
    async def aadjustment_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadjustment_0(
            end_date=end_date,
            start_date=start_date,
            account_number=account_number,
            charge_numbers=charge_numbers,
    ...
    def adjustment_0(
        ...
        raw_response = self.raw.adjustment_0(
            end_date=end_date,
            start_date=start_date,
            account_number=account_number,
            charge_numbers=charge_numbers,
