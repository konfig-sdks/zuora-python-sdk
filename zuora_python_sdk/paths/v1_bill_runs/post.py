...
from zuora_python_sdk.model.bill_run_filter_request_type import BillRunFilterRequestType as BillRunFilterRequestTypeSchema
from zuora_python_sdk.model.post_create_bill_run_request_type import POSTCreateBillRunRequestType as POSTCreateBillRunRequestTypeSchema
from zuora_python_sdk.model.get_bill_run_response_type import GetBillRunResponseType as GetBillRunResponseTypeSchema
from zuora_python_sdk.model.bill_run_schedule_request_type import BillRunScheduleRequestType as BillRunScheduleRequestTypeSchema

from zuora_python_sdk.type.post_create_bill_run_request_type import POSTCreateBillRunRequestType
from zuora_python_sdk.type.bill_run_filter_request_type import BillRunFilterRequestType
from zuora_python_sdk.type.get_bill_run_response_type import GetBillRunResponseType
from zuora_python_sdk.type.bill_run_schedule_request_type import BillRunScheduleRequestType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.bill_run_schedule_request_type import BillRunScheduleRequestType as BillRunScheduleRequestTypePydantic
from zuora_python_sdk.pydantic.get_bill_run_response_type import GetBillRunResponseType as GetBillRunResponseTypePydantic
from zuora_python_sdk.pydantic.bill_run_filter_request_type import BillRunFilterRequestType as BillRunFilterRequestTypePydantic
from zuora_python_sdk.pydantic.post_create_bill_run_request_type import POSTCreateBillRunRequestType as POSTCreateBillRunRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreateBillRunRequestTypeSchema


request_body_post_create_bill_run_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetBillRunResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_bill_run_mapped_args(
        self,
        auto_email: typing.Optional[bool] = None,
        auto_post: typing.Optional[bool] = None,
        auto_renewal: typing.Optional[bool] = None,
        batches: typing.Optional[typing.List[str]] = None,
        bill_cycle_day: typing.Optional[str] = None,
        bill_run_filters: typing.Optional[typing.List[BillRunFilterRequestType]] = None,
        bill_run_type: typing.Optional[str] = None,
        charge_type_to_exclude: typing.Optional[typing.List[str]] = None,
        invoice_date: typing.Optional[date] = None,
        name: typing.Optional[str] = None,
        no_email_for_zero_amount_invoice: typing.Optional[bool] = None,
        organization_labels: typing.Optional[typing.List[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        schedule: typing.Optional[BillRunScheduleRequestType] = None,
    ...
    async def _acreate_bill_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bill-runs',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_bill_run_request_type.serialize(body, content_type)
...
class CreateBillRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_bill_run(
        self,
        auto_email: typing.Optional[bool] = None,
        auto_post: typing.Optional[bool] = None,
        auto_renewal: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_bill_run_mapped_args(
            body=body,
            ...
            bill_run_filters=bill_run_filters,
            bill_run_type=bill_run_type,
        ...
        return await self._acreate_bill_run_oapg(
            body=args.body,
    ...
    def create_bill_run(
        ...
        return self._create_bill_run_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateBillRun(BaseApi):
    ...
    async def acreate_bill_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetBillRunResponseTypePydantic:
        raw_response = await self.raw.acreate_bill_run(
            body=body,
            auto_email=auto_email,
            auto_post=auto_post,
            auto_renewal=auto_renewal,
        ...
        if validate:
            return RootModel[GetBillRunResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetBillRunResponseTypePydantic, raw_response.body)
    ...
    def create_bill_run(
        ...
        raw_response = self.raw.create_bill_run(
            body=body,
            auto_email=auto_email,
            auto_post=auto_post,
            auto_renewal=auto_renewal,
