...
from zuora_python_sdk.model.post_email_billing_docfrom_bill_run_type import POSTEmailBillingDocfromBillRunType as POSTEmailBillingDocfromBillRunTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.post_email_billing_docfrom_bill_run_type import POSTEmailBillingDocfromBillRunType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_email_billing_docfrom_bill_run_type import POSTEmailBillingDocfromBillRunType as POSTEmailBillingDocfromBillRunTypePydantic
...
# Path params
BillRunKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'billRunKey': typing.Union[BillRunKeySchema, str, ],
    }
)
...
request_path_bill_run_key = api_client.PathParameter(
    name="billRunKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BillRunKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = POSTEmailBillingDocfromBillRunTypeSchema


request_body_post_email_billing_docfrom_bill_run_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _email_billing_documentsfrom_bill_run_mapped_args(
        self,
        bill_run_key: str,
    ...
    async def _aemail_billing_documentsfrom_bill_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bill-runs/{billRunKey}/emails',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_email_billing_docfrom_bill_run_type.serialize(body, content_type)
    ...
    def _email_billing_documentsfrom_bill_run_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class EmailBillingDocumentsfromBillRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemail_billing_documentsfrom_bill_run(
        self,
        bill_run_key: str,
        resend: typing.Optional[bool] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._email_billing_documentsfrom_bill_run_mapped_args(
        ...
        return await self._aemail_billing_documentsfrom_bill_run_oapg(
            body=args.body,
    ...
    def email_billing_documentsfrom_bill_run(
        self,
        bill_run_key: str,
        resend: typing.Optional[bool] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._email_billing_documentsfrom_bill_run_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EmailBillingDocumentsfromBillRun(BaseApi):
    ...
    async def aemail_billing_documentsfrom_bill_run(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemail_billing_documentsfrom_bill_run(
            bill_run_key=bill_run_key,
            resend=resend,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def email_billing_documentsfrom_bill_run(
        ...
        raw_response = self.raw.email_billing_documentsfrom_bill_run(
            bill_run_key=bill_run_key,
            resend=resend,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
