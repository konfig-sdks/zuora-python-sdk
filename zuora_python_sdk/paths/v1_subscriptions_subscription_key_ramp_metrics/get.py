...
from zuora_python_sdk.model.get_ramp_metrics_by_subscription_key_response_type import GETRampMetricsBySubscriptionKeyResponseType as GETRampMetricsBySubscriptionKeyResponseTypeSchema

from zuora_python_sdk.type.get_ramp_metrics_by_subscription_key_response_type import GETRampMetricsBySubscriptionKeyResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_ramp_metrics_by_subscription_key_response_type import GETRampMetricsBySubscriptionKeyResponseType as GETRampMetricsBySubscriptionKeyResponseTypePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'subscriptionKey': typing.Union[SubscriptionKeySchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GETRampMetricsBySubscriptionKeyResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRampMetricsBySubscriptionKeyResponseType
...
class BaseApi(api_client.Api):
    ...
    def _ramp_metrics_by_subscription_key_mapped_args(
        self,
    ...
    async def _aramp_metrics_by_subscription_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscriptionKey}/ramp-metrics',
            headers=_headers,
        )
    ...
    def _ramp_metrics_by_subscription_key_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RampMetricsBySubscriptionKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aramp_metrics_by_subscription_key(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._ramp_metrics_by_subscription_key_mapped_args(
        ...
        return await self._aramp_metrics_by_subscription_key_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def ramp_metrics_by_subscription_key(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._ramp_metrics_by_subscription_key_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RampMetricsBySubscriptionKey(BaseApi):
    ...
    async def aramp_metrics_by_subscription_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRampMetricsBySubscriptionKeyResponseTypePydantic:
        raw_response = await self.raw.aramp_metrics_by_subscription_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETRampMetricsBySubscriptionKeyResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRampMetricsBySubscriptionKeyResponseTypePydantic, raw_response.body)
    ...
    def ramp_metrics_by_subscription_key(
        ...
        raw_response = self.raw.ramp_metrics_by_subscription_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
