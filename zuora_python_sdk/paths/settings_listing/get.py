...
from zuora_python_sdk.model.list_all_settings_response import ListAllSettingsResponse as ListAllSettingsResponseSchema

from zuora_python_sdk.type.list_all_settings_response import ListAllSettingsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.list_all_settings_response import ListAllSettingsResponse as ListAllSettingsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListAllSettingsResponseSchema
SchemaFor200ResponseBodyApplicationCsv = ListAllSettingsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_all_settings_mapped_args(
        self,
        authorization: str,
    ...
    async def _alist_all_settings_oapg(
        self,
...
class ListAllSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_settings(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_all_settings_mapped_args(
        ...
        return await self._alist_all_settings_oapg(
    ...
    def list_all_settings(
        ...
        return self._list_all_settings_oapg(
            header_params=args.header,
        )

class ListAllSettings(BaseApi):
    ...
    async def alist_all_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListAllSettingsResponsePydantic:
        raw_response = await self.raw.alist_all_settings(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return ListAllSettingsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListAllSettingsResponsePydantic, raw_response.body)
    ...
    def list_all_settings(
        ...
        raw_response = self.raw.list_all_settings(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
