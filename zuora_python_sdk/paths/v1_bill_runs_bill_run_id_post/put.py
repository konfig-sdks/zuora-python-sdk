...
from zuora_python_sdk.model.put_post_bill_run_request import PutPostBillRunRequest as PutPostBillRunRequestSchema

from zuora_python_sdk.type.put_post_bill_run_request import PutPostBillRunRequest
...
from zuora_python_sdk.pydantic.put_post_bill_run_request import PutPostBillRunRequest as PutPostBillRunRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutPostBillRunRequestSchema


request_body_put_post_bill_run_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_bill_run_mapped_args(
        self,
        invoice_date: date,
        bill_run_id: str,
    ...
    async def _apost_bill_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bill-runs/{billRunId}/post',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_post_bill_run_request.serialize(body, content_type)
...
class PostBillRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apost_bill_run(
        self,
        invoice_date: date,
        bill_run_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._post_bill_run_mapped_args(
        ...
        return await self._apost_bill_run_oapg(
            body=args.body,
    ...
    def post_bill_run(
        ...
        return self._post_bill_run_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PostBillRun(BaseApi):
    ...
    async def apost_bill_run(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apost_bill_run(
            invoice_date=invoice_date,
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def post_bill_run(
        ...
        raw_response = self.raw.post_bill_run(
            invoice_date=invoice_date,
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
