...
from zuora_python_sdk.model.post_create_payment_session_response import POSTCreatePaymentSessionResponse as POSTCreatePaymentSessionResponseSchema
from zuora_python_sdk.model.post_create_payment_session_request import POSTCreatePaymentSessionRequest as POSTCreatePaymentSessionRequestSchema

from zuora_python_sdk.type.post_create_payment_session_response import POSTCreatePaymentSessionResponse
from zuora_python_sdk.type.post_create_payment_session_request import POSTCreatePaymentSessionRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_create_payment_session_response import POSTCreatePaymentSessionResponse as POSTCreatePaymentSessionResponsePydantic
from zuora_python_sdk.pydantic.post_create_payment_session_request import POSTCreatePaymentSessionRequest as POSTCreatePaymentSessionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreatePaymentSessionRequestSchema


request_body_post_create_payment_session_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTCreatePaymentSessionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTCreatePaymentSessionResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_payment_session_mapped_args(
        self,
        account_id: str,
        currency: str,
        payment_gateway: str,
        ...
        auth_amount: typing.Optional[typing.Union[int, float]] = None,
    ...
    async def _acreate_payment_session_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/web-payments/sessions',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_payment_session_request.serialize(body, content_type)
    ...
    def _create_payment_session_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreatePaymentSessionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_payment_session(
        self,
        account_id: str,
        currency: str,
        payment_gateway: str,
        ...
        **kwargs,
        ...
        args = self._create_payment_session_mapped_args(
        ...
        return await self._acreate_payment_session_oapg(
            body=args.body,
    ...
    def create_payment_session(
        ...
        return self._create_payment_session_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreatePaymentSession(BaseApi):
    ...
    async def acreate_payment_session(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTCreatePaymentSessionResponsePydantic:
        raw_response = await self.raw.acreate_payment_session(
            account_id=account_id,
            currency=currency,
            payment_gateway=payment_gateway,
            process_payment=process_payment,
        ...
        if validate:
            return POSTCreatePaymentSessionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTCreatePaymentSessionResponsePydantic, raw_response.body)
    ...
    def create_payment_session(
        ...
        raw_response = self.raw.create_payment_session(
            account_id=account_id,
            currency=currency,
            payment_gateway=payment_gateway,
            process_payment=process_payment,
