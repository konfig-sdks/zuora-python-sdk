...
from zuora_python_sdk.model.get_payment_part_type import GETPaymentPartType as GETPaymentPartTypeSchema

from zuora_python_sdk.type.get_payment_part_type import GETPaymentPartType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_part_type import GETPaymentPartType as GETPaymentPartTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentPartTypeSchema
    ...
    async def _apayment_part_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/parts/{partid}',
            headers=_headers,
        )
...
class PaymentPartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_part(
        self,
        partid: str,
        payment_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_part_mapped_args(
            partid=partid,
        ...
        return await self._apayment_part_oapg(
    ...
    def payment_part(
        ...
        return self._payment_part_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentPart(BaseApi):
    ...
    async def apayment_part(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentPartTypePydantic:
        raw_response = await self.raw.apayment_part(
            partid=partid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETPaymentPartTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentPartTypePydantic, raw_response.body)
    ...
    def payment_part(
        ...
        raw_response = self.raw.payment_part(
            partid=partid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
