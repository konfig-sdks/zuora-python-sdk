...
from zuora_python_sdk.model.get_debit_memo_pdf_status_batch_response import GetDebitMemoPdfStatusBatchResponse as GetDebitMemoPdfStatusBatchResponseSchema

from zuora_python_sdk.type.get_debit_memo_pdf_status_batch_response import GetDebitMemoPdfStatusBatchResponse
...
from zuora_python_sdk.pydantic.get_debit_memo_pdf_status_batch_response import GetDebitMemoPdfStatusBatchResponse as GetDebitMemoPdfStatusBatchResponsePydantic

from . import path

# Query params
DebitMemoKeysSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'debitMemoKeys': typing.Union[DebitMemoKeysSchema, str, ],
    }
)
...
request_query_debit_memo_keys = api_client.QueryParameter(
    name="debitMemoKeys",
    style=api_client.ParameterStyle.FORM,
    schema=DebitMemoKeysSchema,
    required=True,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetDebitMemoPdfStatusBatchResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetDebitMemoPdfStatusBatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_pdf_status_mapped_args(
        self,
        debit_memo_keys: str,
        ...
        if debit_memo_keys is not None:
            _query_params["debitMemoKeys"] = debit_memo_keys
    ...
    async def _adebit_memo_pdf_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/pdf-status',
            headers=_headers,
        )
    ...
    def _debit_memo_pdf_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DebitMemoPdfStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_pdf_status(
        self,
        debit_memo_keys: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_pdf_status_mapped_args(
        ...
        return await self._adebit_memo_pdf_status_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def debit_memo_pdf_status(
        self,
        debit_memo_keys: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._debit_memo_pdf_status_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DebitMemoPdfStatus(BaseApi):
    ...
    async def adebit_memo_pdf_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDebitMemoPdfStatusBatchResponsePydantic:
        raw_response = await self.raw.adebit_memo_pdf_status(
            debit_memo_keys=debit_memo_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetDebitMemoPdfStatusBatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetDebitMemoPdfStatusBatchResponsePydantic, raw_response.body)
    ...
    def debit_memo_pdf_status(
        ...
        raw_response = self.raw.debit_memo_pdf_status(
            debit_memo_keys=debit_memo_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
