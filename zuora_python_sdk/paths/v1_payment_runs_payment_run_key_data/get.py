...
from zuora_python_sdk.model.get_payment_run_data_array_response import GETPaymentRunDataArrayResponse as GETPaymentRunDataArrayResponseSchema

from zuora_python_sdk.type.get_payment_run_data_array_response import GETPaymentRunDataArrayResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_run_data_array_response import GETPaymentRunDataArrayResponse as GETPaymentRunDataArrayResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentRunDataArrayResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentRunDataArrayResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_run_data_mapped_args(
        self,
        payment_run_key: str,
    ...
    async def _apayment_run_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-runs/{paymentRunKey}/data',
            headers=_headers,
        )
...
class PaymentRunDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_run_data(
        self,
        payment_run_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_run_data_mapped_args(
        ...
        return await self._apayment_run_data_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def payment_run_data(
        self,
        payment_run_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._payment_run_data_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentRunData(BaseApi):
    ...
    async def apayment_run_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentRunDataArrayResponsePydantic:
        raw_response = await self.raw.apayment_run_data(
            payment_run_key=payment_run_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETPaymentRunDataArrayResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentRunDataArrayResponsePydantic, raw_response.body)
    ...
    def payment_run_data(
        ...
        raw_response = self.raw.payment_run_data(
            payment_run_key=payment_run_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
