...
from zuora_python_sdk.model.get_scheduled_events_response import GetScheduledEventsResponse as GetScheduledEventsResponseSchema

from zuora_python_sdk.type.error_response import ErrorResponse
from zuora_python_sdk.type.get_scheduled_events_response import GetScheduledEventsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.get_scheduled_events_response import GetScheduledEventsResponse as GetScheduledEventsResponsePydantic

from . import path

# Query params
EventTypeNameSchema = schemas.StrSchema
ApiObjectSchema = schemas.StrSchema
ApiFieldSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'apiObject': typing.Union[ApiObjectSchema, str, ],
        'apiField': typing.Union[ApiFieldSchema, str, ],
...
request_query_api_object = api_client.QueryParameter(
    name="apiObject",
    style=api_client.ParameterStyle.FORM,
    schema=ApiObjectSchema,
    explode=True,
)
request_query_api_field = api_client.QueryParameter(
    name="apiField",
    style=api_client.ParameterStyle.FORM,
    schema=ApiFieldSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GetScheduledEventsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetScheduledEventsResponse
...
class BaseApi(api_client.Api):
    ...
    def _scheduled_events_mapped_args(
        self,
        authorization: str,
        ...
        api_object: typing.Optional[str] = None,
        api_field: typing.Optional[str] = None,
        ...
        if api_object is not None:
            _query_params["apiObject"] = api_object
        if api_field is not None:
            _query_params["apiField"] = api_field
    ...
    async def _ascheduled_events_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_api_object,
            request_query_api_field,
...
class ScheduledEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascheduled_events(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._scheduled_events_mapped_args(
        ...
        return await self._ascheduled_events_oapg(
    ...
    def scheduled_events(
        ...
        return self._scheduled_events_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ScheduledEvents(BaseApi):
    ...
    async def ascheduled_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetScheduledEventsResponsePydantic:
        raw_response = await self.raw.ascheduled_events(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return GetScheduledEventsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetScheduledEventsResponsePydantic, raw_response.body)
    ...
    def scheduled_events(
        ...
        raw_response = self.raw.scheduled_events(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
