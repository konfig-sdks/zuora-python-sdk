...
from zuora_python_sdk.model.post_scheduled_event_request_parameters import PostScheduledEventRequestParameters as PostScheduledEventRequestParametersSchema
from zuora_python_sdk.model.post_scheduled_event_request import PostScheduledEventRequest as PostScheduledEventRequestSchema
...
from zuora_python_sdk.type.post_scheduled_event_request import PostScheduledEventRequest
from zuora_python_sdk.type.post_scheduled_event_request_parameters import PostScheduledEventRequestParameters

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_scheduled_event_request_parameters import PostScheduledEventRequestParameters as PostScheduledEventRequestParametersPydantic
...
from zuora_python_sdk.pydantic.post_scheduled_event_request import PostScheduledEventRequest as PostScheduledEventRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostScheduledEventRequestSchema


request_body_post_scheduled_event_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _scheduled_event_mapped_args(
        self,
        api_field: str,
        api_object: str,
        display_name: str,
        ...
        parameters: typing.Optional[PostScheduledEventRequestParameters] = None,
        ...
        if api_field is not None:
            _body["apiField"] = api_field
        if api_object is not None:
            _body["apiObject"] = api_object
    ...
    async def _ascheduled_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/events/scheduled-events',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_scheduled_event_request.serialize(body, content_type)
...
class ScheduledEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascheduled_event(
        self,
        api_field: str,
        api_object: str,
        display_name: str,
        ...
        **kwargs,
        ...
        args = self._scheduled_event_mapped_args(
            api_field=api_field,
        ...
        return await self._ascheduled_event_oapg(
            body=args.body,
    ...
    def scheduled_event(
        ...
        return self._scheduled_event_oapg(
            body=args.body,
            header_params=args.header,
        )

class ScheduledEvent(BaseApi):
    ...
    async def ascheduled_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ascheduled_event(
            api_field=api_field,
            api_object=api_object,
            display_name=display_name,
            hours=hours,
    ...
    def scheduled_event(
        ...
        raw_response = self.raw.scheduled_event(
            api_field=api_field,
            api_object=api_object,
            display_name=display_name,
            hours=hours,
