...
class BaseApi(api_client.Api):
    ...
    def _cancel_payment_schedule_item_mapped_args(
        self,
        item_id: str,
    ...
    async def _acancel_payment_schedule_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedule-items/{item-id}/cancel',
            headers=_headers,
        )
    ...
    def _cancel_payment_schedule_item_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CancelPaymentScheduleItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_payment_schedule_item(
        self,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_payment_schedule_item_mapped_args(
            item_id=item_id,
        ...
        return await self._acancel_payment_schedule_item_oapg(
    ...
    def cancel_payment_schedule_item(
        ...
        return self._cancel_payment_schedule_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelPaymentScheduleItem(BaseApi):
    ...
    async def acancel_payment_schedule_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_payment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def cancel_payment_schedule_item(
        ...
        raw_response = self.raw.cancel_payment_schedule_item(
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
