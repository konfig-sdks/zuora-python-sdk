...
from zuora_python_sdk.model.get_credit_memo_item_type import GETCreditMemoItemType as GETCreditMemoItemTypeSchema

from zuora_python_sdk.type.get_credit_memo_item_type import GETCreditMemoItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_credit_memo_item_type import GETCreditMemoItemType as GETCreditMemoItemTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETCreditMemoItemTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_item_mapped_args(
        self,
        cmitemid: str,
        credit_memo_key: str,
    ...
    async def _acredit_memo_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/items/{cmitemid}',
            headers=_headers,
        )
...
class CreditMemoItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_item(
        self,
        cmitemid: str,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_item_mapped_args(
            cmitemid=cmitemid,
        ...
        return await self._acredit_memo_item_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def credit_memo_item(
        self,
        cmitemid: str,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._credit_memo_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoItem(BaseApi):
    ...
    async def acredit_memo_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCreditMemoItemTypePydantic:
        raw_response = await self.raw.acredit_memo_item(
            cmitemid=cmitemid,
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GETCreditMemoItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETCreditMemoItemTypePydantic, raw_response.body)
    ...
    def credit_memo_item(
        ...
        raw_response = self.raw.credit_memo_item(
            cmitemid=cmitemid,
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
