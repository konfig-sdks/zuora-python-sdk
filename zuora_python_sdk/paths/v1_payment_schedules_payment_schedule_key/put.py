...
from zuora_python_sdk.model.put_payment_schedule_request import PUTPaymentScheduleRequest as PUTPaymentScheduleRequestSchema

from zuora_python_sdk.type.payment_schedule_payment_option_fields import PaymentSchedulePaymentOptionFields
from zuora_python_sdk.type.put_payment_schedule_request import PUTPaymentScheduleRequest
...
from zuora_python_sdk.pydantic.put_payment_schedule_request import PUTPaymentScheduleRequest as PUTPaymentScheduleRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTPaymentScheduleRequestSchema


request_body_put_payment_schedule_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_1_mapped_args(
        self,
        body: PUTPaymentScheduleRequest,
    ...
    async def _apayment_schedule_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/{paymentScheduleKey}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_payment_schedule_request.serialize(body, content_type)
...
class PaymentSchedule1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_1(
        self,
        body: PUTPaymentScheduleRequest,
        payment_schedule_key: str,
        amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_1_mapped_args(
            body=body,
        ...
        return await self._apayment_schedule_1_oapg(
            body=args.body,
    ...
    def payment_schedule_1(
        ...
        return self._payment_schedule_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentSchedule1(BaseApi):
    ...
    async def apayment_schedule_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_schedule_1(
            body=body,
            payment_schedule_key=payment_schedule_key,
            amount=amount,
            currency=currency,
    ...
    def payment_schedule_1(
        ...
        raw_response = self.raw.payment_schedule_1(
            body=body,
            payment_schedule_key=payment_schedule_key,
            amount=amount,
            currency=currency,
