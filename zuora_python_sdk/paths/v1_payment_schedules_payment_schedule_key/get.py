...
# Query params
NextPendingItemsSchema = schemas.IntSchema
LastProcessedItemsSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'nextPendingItems': typing.Union[NextPendingItemsSchema, decimal.Decimal, int, ],
        'lastProcessedItems': typing.Union[LastProcessedItemsSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_next_pending_items = api_client.QueryParameter(
    name="nextPendingItems",
    style=api_client.ParameterStyle.FORM,
    schema=NextPendingItemsSchema,
    explode=True,
)
request_query_last_processed_items = api_client.QueryParameter(
    name="lastProcessedItems",
    style=api_client.ParameterStyle.FORM,
    schema=LastProcessedItemsSchema,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_0_mapped_args(
        self,
        ...
        next_pending_items: typing.Optional[int] = None,
        last_processed_items: typing.Optional[int] = None,
        ...
        if next_pending_items is not None:
            _query_params["nextPendingItems"] = next_pending_items
        if last_processed_items is not None:
            _query_params["lastProcessedItems"] = last_processed_items
    ...
    async def _apayment_schedule_0_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_next_pending_items,
            request_query_last_processed_items,
        ):
...
class PaymentSchedule0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_0(
        self,
        payment_schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_0_mapped_args(
        ...
        return await self._apayment_schedule_0_oapg(
    ...
    def payment_schedule_0(
        ...
        return self._payment_schedule_0_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentSchedule0(BaseApi):
    ...
    async def apayment_schedule_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_schedule_0(
            payment_schedule_key=payment_schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def payment_schedule_0(
        ...
        raw_response = self.raw.payment_schedule_0(
            payment_schedule_key=payment_schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
