...
from zuora_python_sdk.model.get_e_invoicing_service_provider_response import GetEInvoicingServiceProviderResponse as GetEInvoicingServiceProviderResponseSchema
from zuora_python_sdk.model.update_e_invoicing_service_provider_request import UpdateEInvoicingServiceProviderRequest as UpdateEInvoicingServiceProviderRequestSchema

from zuora_python_sdk.type.get_e_invoicing_service_provider_response import GetEInvoicingServiceProviderResponse
from zuora_python_sdk.type.update_e_invoicing_service_provider_request import UpdateEInvoicingServiceProviderRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.update_e_invoicing_service_provider_request import UpdateEInvoicingServiceProviderRequest as UpdateEInvoicingServiceProviderRequestPydantic
from zuora_python_sdk.pydantic.get_e_invoicing_service_provider_response import GetEInvoicingServiceProviderResponse as GetEInvoicingServiceProviderResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEInvoicingServiceProviderRequestSchema


request_body_update_e_invoicing_service_provider_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetEInvoicingServiceProviderResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetEInvoicingServiceProviderResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_e_invoicing_service_provider_mapped_args(
        self,
        key: str,
        ...
        if company_identifier is not None:
            _body["companyIdentifier"] = company_identifier
        if name is not None:
            _body["name"] = name
        if test is not None:
            _body["test"] = test
    ...
    async def _aupdate_e_invoicing_service_provider_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/service-providers/{key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_e_invoicing_service_provider_request.serialize(body, content_type)
    ...
    def _update_e_invoicing_service_provider_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateEInvoicingServiceProviderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_e_invoicing_service_provider(
        self,
        key: str,
        company_identifier: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_e_invoicing_service_provider_mapped_args(
            body=body,
            key=key,
        ...
        return await self._aupdate_e_invoicing_service_provider_oapg(
            body=args.body,
    ...
    def update_e_invoicing_service_provider(
        self,
        key: str,
        company_identifier: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        return self._update_e_invoicing_service_provider_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateEInvoicingServiceProvider(BaseApi):
    ...
    async def aupdate_e_invoicing_service_provider(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetEInvoicingServiceProviderResponsePydantic:
        raw_response = await self.raw.aupdate_e_invoicing_service_provider(
            body=body,
            key=key,
            company_identifier=company_identifier,
            name=name,
        ...
        if validate:
            return RootModel[GetEInvoicingServiceProviderResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetEInvoicingServiceProviderResponsePydantic, raw_response.body)
    ...
    def update_e_invoicing_service_provider(
        ...
        raw_response = self.raw.update_e_invoicing_service_provider(
            body=body,
            key=key,
            company_identifier=company_identifier,
            name=name,
