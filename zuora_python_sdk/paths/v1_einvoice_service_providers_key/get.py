...
class BaseApi(api_client.Api):
    ...
    def _e_invoicing_service_provider_0_mapped_args(
        self,
        key: str,
    ...
    async def _ae_invoicing_service_provider_0_oapg(
        self,
    ...
    def _e_invoicing_service_provider_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EInvoicingServiceProvider0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ae_invoicing_service_provider_0(
        self,
        key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._e_invoicing_service_provider_0_mapped_args(
            key=key,
        ...
        return await self._ae_invoicing_service_provider_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def e_invoicing_service_provider_0(
        self,
        key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._e_invoicing_service_provider_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class EInvoicingServiceProvider0(BaseApi):
    ...
    async def ae_invoicing_service_provider_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ae_invoicing_service_provider_0(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def e_invoicing_service_provider_0(
        ...
        raw_response = self.raw.e_invoicing_service_provider_0(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
