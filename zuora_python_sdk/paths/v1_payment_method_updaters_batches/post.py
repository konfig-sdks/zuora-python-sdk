...
from zuora_python_sdk.model.post_payment_method_updater_batch_request import POSTPaymentMethodUpdaterBatchRequest as POSTPaymentMethodUpdaterBatchRequestSchema
from zuora_python_sdk.model.post_payment_method_updater_response import POSTPaymentMethodUpdaterResponse as POSTPaymentMethodUpdaterResponseSchema

from zuora_python_sdk.type.post_payment_method_updater_batch_request import POSTPaymentMethodUpdaterBatchRequest
from zuora_python_sdk.type.post_payment_method_updater_response import POSTPaymentMethodUpdaterResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_payment_method_updater_response import POSTPaymentMethodUpdaterResponse as POSTPaymentMethodUpdaterResponsePydantic
from zuora_python_sdk.pydantic.post_payment_method_updater_batch_request import POSTPaymentMethodUpdaterBatchRequest as POSTPaymentMethodUpdaterBatchRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPaymentMethodUpdaterBatchRequestSchema


request_body_post_payment_method_updater_batch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTPaymentMethodUpdaterResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTPaymentMethodUpdaterResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_method_updater_batch_mapped_args(
        self,
        ...
        if billing_cycle_day is not None:
            _body["billingCycleDay"] = billing_cycle_day
        if updater_account_id is not None:
            _body["updaterAccountId"] = updater_account_id
        args.body = _body
    ...
    async def _apayment_method_updater_batch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-method-updaters/batches',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_payment_method_updater_batch_request.serialize(body, content_type)
    ...
    def _payment_method_updater_batch_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PaymentMethodUpdaterBatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_method_updater_batch(
        self,
        billing_cycle_day: int,
        updater_account_id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_method_updater_batch_mapped_args(
            billing_cycle_day=billing_cycle_day,
            updater_account_id=updater_account_id,
        ...
        return await self._apayment_method_updater_batch_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def payment_method_updater_batch(
        self,
        billing_cycle_day: int,
        updater_account_id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._payment_method_updater_batch_oapg(
            body=args.body,
            header_params=args.header,
        )

class PaymentMethodUpdaterBatch(BaseApi):
    ...
    async def apayment_method_updater_batch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTPaymentMethodUpdaterResponsePydantic:
        raw_response = await self.raw.apayment_method_updater_batch(
            billing_cycle_day=billing_cycle_day,
            updater_account_id=updater_account_id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return POSTPaymentMethodUpdaterResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTPaymentMethodUpdaterResponsePydantic, raw_response.body)
    ...
    def payment_method_updater_batch(
        ...
        raw_response = self.raw.payment_method_updater_batch(
            billing_cycle_day=billing_cycle_day,
            updater_account_id=updater_account_id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
