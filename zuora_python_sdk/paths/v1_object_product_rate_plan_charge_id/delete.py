...
from zuora_python_sdk.model.proxy_delete_response import ProxyDeleteResponse as ProxyDeleteResponseSchema
...
from zuora_python_sdk.type.proxy_delete_response import ProxyDeleteResponse
...
from zuora_python_sdk.pydantic.proxy_delete_response import ProxyDeleteResponse as ProxyDeleteResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyDeleteResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _d_elete_product_rate_plan_charge_mapped_args(
        self,
        id: str,
    ...
    async def _ad_elete_product_rate_plan_charge_oapg(
        self,
    ...
    def _d_elete_product_rate_plan_charge_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DEleteProductRatePlanChargeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ad_elete_product_rate_plan_charge(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._d_elete_product_rate_plan_charge_mapped_args(
            id=id,
        ...
        return await self._ad_elete_product_rate_plan_charge_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def d_elete_product_rate_plan_charge(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._d_elete_product_rate_plan_charge_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DEleteProductRatePlanCharge(BaseApi):
    ...
    async def ad_elete_product_rate_plan_charge(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyDeleteResponsePydantic:
        raw_response = await self.raw.ad_elete_product_rate_plan_charge(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return ProxyDeleteResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyDeleteResponsePydantic, raw_response.body)
    ...
    def d_elete_product_rate_plan_charge(
        ...
        raw_response = self.raw.d_elete_product_rate_plan_charge(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
