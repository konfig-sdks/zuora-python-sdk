...
from zuora_python_sdk.model.proxy_get_product_rate_plan_charge import ProxyGetProductRatePlanCharge as ProxyGetProductRatePlanChargeSchema

from zuora_python_sdk.type.proxy_get_product_rate_plan_charge import ProxyGetProductRatePlanCharge
...
from zuora_python_sdk.pydantic.proxy_get_product_rate_plan_charge import ProxyGetProductRatePlanCharge as ProxyGetProductRatePlanChargePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetProductRatePlanChargeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProxyGetProductRatePlanCharge
...
class BaseApi(api_client.Api):
    ...
    def _g_et_product_rate_plan_charge_mapped_args(
        self,
        id: str,
    ...
    async def _ag_et_product_rate_plan_charge_oapg(
        self,
    ...
    def _g_et_product_rate_plan_charge_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GEtProductRatePlanChargeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ag_et_product_rate_plan_charge(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._g_et_product_rate_plan_charge_mapped_args(
            id=id,
        ...
        return await self._ag_et_product_rate_plan_charge_oapg(
    ...
    def g_et_product_rate_plan_charge(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._g_et_product_rate_plan_charge_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GEtProductRatePlanCharge(BaseApi):
    ...
    async def ag_et_product_rate_plan_charge(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetProductRatePlanChargePydantic:
        raw_response = await self.raw.ag_et_product_rate_plan_charge(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[ProxyGetProductRatePlanChargePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProxyGetProductRatePlanChargePydantic, raw_response.body)
    ...
    def g_et_product_rate_plan_charge(
        ...
        raw_response = self.raw.g_et_product_rate_plan_charge(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
