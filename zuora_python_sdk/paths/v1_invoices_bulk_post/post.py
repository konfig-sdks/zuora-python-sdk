...
from zuora_python_sdk.model.post_invoices_batch_post_type import POSTInvoicesBatchPostType as POSTInvoicesBatchPostTypeSchema
from zuora_python_sdk.model.invoices_batch_post_response_type import InvoicesBatchPostResponseType as InvoicesBatchPostResponseTypeSchema
from zuora_python_sdk.model.invoice_post_type import InvoicePostType as InvoicePostTypeSchema

from zuora_python_sdk.type.invoices_batch_post_response_type import InvoicesBatchPostResponseType
from zuora_python_sdk.type.invoice_post_type import InvoicePostType
from zuora_python_sdk.type.post_invoices_batch_post_type import POSTInvoicesBatchPostType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_invoices_batch_post_type import POSTInvoicesBatchPostType as POSTInvoicesBatchPostTypePydantic
from zuora_python_sdk.pydantic.invoices_batch_post_response_type import InvoicesBatchPostResponseType as InvoicesBatchPostResponseTypePydantic
from zuora_python_sdk.pydantic.invoice_post_type import InvoicePostType as InvoicePostTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTInvoicesBatchPostTypeSchema


request_body_post_invoices_batch_post_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = InvoicesBatchPostResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: InvoicesBatchPostResponseType
...
class BaseApi(api_client.Api):
    ...
    def _post_invoices_mapped_args(
        self,
        invoices: typing.Optional[typing.List[InvoicePostType]] = None,
    ...
    async def _apost_invoices_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/bulk-post',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_invoices_batch_post_type.serialize(body, content_type)
...
class PostInvoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apost_invoices(
        self,
        invoices: typing.Optional[typing.List[InvoicePostType]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._post_invoices_mapped_args(
            body=body,
            invoices=invoices,
        ...
        return await self._apost_invoices_oapg(
            body=args.body,
    ...
    def post_invoices(
        ...
        return self._post_invoices_oapg(
            body=args.body,
            header_params=args.header,
        )

class PostInvoices(BaseApi):
    ...
    async def apost_invoices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InvoicesBatchPostResponseTypePydantic:
        raw_response = await self.raw.apost_invoices(
            body=body,
            invoices=invoices,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[InvoicesBatchPostResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(InvoicesBatchPostResponseTypePydantic, raw_response.body)
    ...
    def post_invoices(
        ...
        raw_response = self.raw.post_invoices(
            body=body,
            invoices=invoices,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
