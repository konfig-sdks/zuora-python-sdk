...
from zuora_python_sdk.model.get_product_rate_plan_with_external_id_multi_response import GETProductRatePlanWithExternalIdMultiResponse as GETProductRatePlanWithExternalIdMultiResponseSchema

from zuora_python_sdk.type.get_product_rate_plan_with_external_id_multi_response import GETProductRatePlanWithExternalIdMultiResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plan_with_external_id_multi_response import GETProductRatePlanWithExternalIdMultiResponse as GETProductRatePlanWithExternalIdMultiResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlanWithExternalIdMultiResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlanWithExternalIdMultiResponse
...
class BaseApi(api_client.Api):
    ...
    def _product_rate_plans_by_external_id_mapped_args(
        self,
        id: str,
    ...
    async def _aproduct_rate_plans_by_external_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/product-rate-plans/external-id/{id}',
            headers=_headers,
        )
    ...
    def _product_rate_plans_by_external_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ProductRatePlansByExternalIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproduct_rate_plans_by_external_id(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._product_rate_plans_by_external_id_mapped_args(
            id=id,
        ...
        return await self._aproduct_rate_plans_by_external_id_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def product_rate_plans_by_external_id(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._product_rate_plans_by_external_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ProductRatePlansByExternalId(BaseApi):
    ...
    async def aproduct_rate_plans_by_external_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlanWithExternalIdMultiResponsePydantic:
        raw_response = await self.raw.aproduct_rate_plans_by_external_id(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETProductRatePlanWithExternalIdMultiResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETProductRatePlanWithExternalIdMultiResponsePydantic, raw_response.body)
    ...
    def product_rate_plans_by_external_id(
        ...
        raw_response = self.raw.product_rate_plans_by_external_id(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
