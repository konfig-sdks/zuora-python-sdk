...
from zuora_python_sdk.model.post_debit_memo_email_type import PostDebitMemoEmailType as PostDebitMemoEmailTypeSchema

from zuora_python_sdk.type.common_response import CommonResponse
from zuora_python_sdk.type.post_debit_memo_email_type import PostDebitMemoEmailType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_debit_memo_email_type import PostDebitMemoEmailType as PostDebitMemoEmailTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostDebitMemoEmailTypeSchema


request_body_post_debit_memo_email_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _email_debit_memo_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _aemail_debit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/emails',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_debit_memo_email_type.serialize(body, content_type)
...
class EmailDebitMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemail_debit_memo(
        self,
        debit_memo_key: str,
        email_addresses: typing.Optional[str] = None,
        include_additional_email_addresses: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._email_debit_memo_mapped_args(
        ...
        return await self._aemail_debit_memo_oapg(
            body=args.body,
    ...
    def email_debit_memo(
        ...
        return self._email_debit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EmailDebitMemo(BaseApi):
    ...
    async def aemail_debit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemail_debit_memo(
            debit_memo_key=debit_memo_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            pdf_file_id=pdf_file_id,
    ...
    def email_debit_memo(
        ...
        raw_response = self.raw.email_debit_memo(
            debit_memo_key=debit_memo_key,
            email_addresses=email_addresses,
            include_additional_email_addresses=include_additional_email_addresses,
            pdf_file_id=pdf_file_id,
