...
class BaseApi(api_client.Api):
    ...
    def _pause_invoice_schedule_mapped_args(
        self,
        schedule_key: str,
    ...
    async def _apause_invoice_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoice-schedules/{scheduleKey}/pause',
            headers=_headers,
        )
    ...
    def _pause_invoice_schedule_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PauseInvoiceScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apause_invoice_schedule(
        self,
        schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._pause_invoice_schedule_mapped_args(
        ...
        return await self._apause_invoice_schedule_oapg(
    ...
    def pause_invoice_schedule(
        ...
        return self._pause_invoice_schedule_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PauseInvoiceSchedule(BaseApi):
    ...
    async def apause_invoice_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apause_invoice_schedule(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def pause_invoice_schedule(
        ...
        raw_response = self.raw.pause_invoice_schedule(
            schedule_key=schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
