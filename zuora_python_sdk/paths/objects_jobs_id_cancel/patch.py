...
class BaseApi(api_client.Api):
    ...
    def _custom_object_bulk_job_1_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _acustom_object_bulk_job_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/objects/jobs/{id}/cancel',
            headers=_headers,
        )
    ...
    def _custom_object_bulk_job_1_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectBulkJob1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_bulk_job_1(
        self,
        authorization: str,
        id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._custom_object_bulk_job_1_mapped_args(
        ...
        return await self._acustom_object_bulk_job_1_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def custom_object_bulk_job_1(
        self,
        authorization: str,
        id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._custom_object_bulk_job_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectBulkJob1(BaseApi):
    ...
    async def acustom_object_bulk_job_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acustom_object_bulk_job_1(
            authorization=authorization,
            id=id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def custom_object_bulk_job_1(
        ...
        raw_response = self.raw.custom_object_bulk_job_1(
            authorization=authorization,
            id=id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
