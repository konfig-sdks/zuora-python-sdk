...
class BaseApi(api_client.Api):
    ...
    def _workflows_task_rerun_mapped_args(
        self,
        authorization: str,
        task_id: str,
    ...
    async def _aworkflows_task_rerun_oapg(
        self,
    ...
    def _workflows_task_rerun_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class WorkflowsTaskRerunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflows_task_rerun(
        self,
        authorization: str,
        task_id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflows_task_rerun_mapped_args(
        ...
        return await self._aworkflows_task_rerun_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def workflows_task_rerun(
        self,
        authorization: str,
        task_id: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._workflows_task_rerun_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class WorkflowsTaskRerun(BaseApi):
    ...
    async def aworkflows_task_rerun(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aworkflows_task_rerun(
            authorization=authorization,
            task_id=task_id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def workflows_task_rerun(
        ...
        raw_response = self.raw.workflows_task_rerun(
            authorization=authorization,
            task_id=task_id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
