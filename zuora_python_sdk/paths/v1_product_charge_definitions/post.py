...
from zuora_python_sdk.model.post_charge_definition_request import POSTChargeDefinitionRequest as POSTChargeDefinitionRequestSchema
...
from zuora_python_sdk.model.post_charge_definition_response import POSTChargeDefinitionResponse as POSTChargeDefinitionResponseSchema

from zuora_python_sdk.type.post_charge_definition_response import POSTChargeDefinitionResponse
from zuora_python_sdk.type.post_charge_definition_request import POSTChargeDefinitionRequest
...
from zuora_python_sdk.pydantic.post_charge_definition_request import POSTChargeDefinitionRequest as POSTChargeDefinitionRequestPydantic
from zuora_python_sdk.pydantic.post_charge_definition_response import POSTChargeDefinitionResponse as POSTChargeDefinitionResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTChargeDefinitionRequestSchema


request_body_post_charge_definition_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTChargeDefinitionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTChargeDefinitionResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_product_charge_definition_mapped_args(
        self,
        ...
        product_rate_plan_charge_id: typing.Optional[str] = None,
        product_rate_plan_charge_number: typing.Optional[str] = None,
        product_rate_plan_id: typing.Optional[str] = None,
        product_rate_plan_number: typing.Optional[str] = None,
        ...
        if product_rate_plan_charge_id is not None:
            _body["productRatePlanChargeId"] = product_rate_plan_charge_id
        ...
        if product_rate_plan_number is not None:
            _body["productRatePlanNumber"] = product_rate_plan_number
    ...
    async def _acreate_product_charge_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/product-charge-definitions',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_charge_definition_request.serialize(body, content_type)
    ...
    def _create_product_charge_definition_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateProductChargeDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_product_charge_definition(
        self,
        billing_period: typing.Optional[str] = None,
        billing_timing: typing.Optional[str] = None,
        charge_model: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_product_charge_definition_mapped_args(
            ...
            product_rate_plan_number=product_rate_plan_number,
        ...
        return await self._acreate_product_charge_definition_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_product_charge_definition(
        self,
        billing_period: typing.Optional[str] = None,
        billing_timing: typing.Optional[str] = None,
        charge_model: typing.Optional[str] = None,
        ...
        return self._create_product_charge_definition_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateProductChargeDefinition(BaseApi):
    ...
    async def acreate_product_charge_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTChargeDefinitionResponsePydantic:
        raw_response = await self.raw.acreate_product_charge_definition(
            billing_period=billing_period,
            billing_timing=billing_timing,
            charge_model=charge_model,
            default_quantity=default_quantity,
        ...
        if validate:
            return POSTChargeDefinitionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTChargeDefinitionResponsePydantic, raw_response.body)
    ...
    def create_product_charge_definition(
        ...
        raw_response = self.raw.create_product_charge_definition(
            billing_period=billing_period,
            billing_timing=billing_timing,
            charge_model=charge_model,
            default_quantity=default_quantity,
