...
# Query params
ChargeSchema = schemas.StrSchema
RateplanSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'charge': typing.Union[ChargeSchema, str, ],
        'rateplan': typing.Union[RateplanSchema, str, ],
...
request_query_charge = api_client.QueryParameter(
    name="charge",
    style=api_client.ParameterStyle.FORM,
    schema=ChargeSchema,
    explode=True,
)
request_query_rateplan = api_client.QueryParameter(
    name="rateplan",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_product_charge_definitions_mapped_args(
        self,
        ...
        rateplan: typing.Optional[str] = None,
        ...
        if charge is not None:
            _query_params["charge"] = charge
        if rateplan is not None:
            _query_params["rateplan"] = rateplan
    ...
    async def _aretrieve_product_charge_definitions_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_charge,
            request_query_rateplan,
    ...
    def _retrieve_product_charge_definitions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetrieveProductChargeDefinitionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_product_charge_definitions(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_product_charge_definitions_mapped_args(
        ...
        return await self._aretrieve_product_charge_definitions_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def retrieve_product_charge_definitions(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._retrieve_product_charge_definitions_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class RetrieveProductChargeDefinitions(BaseApi):
    ...
    async def aretrieve_product_charge_definitions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aretrieve_product_charge_definitions(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
    ...
    def retrieve_product_charge_definitions(
        ...
        raw_response = self.raw.retrieve_product_charge_definitions(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
