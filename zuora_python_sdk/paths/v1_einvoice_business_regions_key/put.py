...
from zuora_python_sdk.model.get_e_invoicing_business_region_response import GetEInvoicingBusinessRegionResponse as GetEInvoicingBusinessRegionResponseSchema
from zuora_python_sdk.model.update_e_invoicing_business_region_request import UpdateEInvoicingBusinessRegionRequest as UpdateEInvoicingBusinessRegionRequestSchema

from zuora_python_sdk.type.get_e_invoicing_business_region_response import GetEInvoicingBusinessRegionResponse
from zuora_python_sdk.type.update_e_invoicing_business_region_request import UpdateEInvoicingBusinessRegionRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_e_invoicing_business_region_response import GetEInvoicingBusinessRegionResponse as GetEInvoicingBusinessRegionResponsePydantic
from zuora_python_sdk.pydantic.update_e_invoicing_business_region_request import UpdateEInvoicingBusinessRegionRequest as UpdateEInvoicingBusinessRegionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEInvoicingBusinessRegionRequestSchema


request_body_update_e_invoicing_business_region_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetEInvoicingBusinessRegionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetEInvoicingBusinessRegionResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_e_invoicing_business_region_mapped_args(
        self,
        key: str,
        address_line1: typing.Optional[str] = None,
        address_line2: typing.Optional[str] = None,
        business_name: typing.Optional[str] = None,
        business_number: typing.Optional[str] = None,
        business_number_schema_id: typing.Optional[str] = None,
        city: typing.Optional[str] = None,
        contact_name: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        digital_signature_enable: typing.Optional[bool] = None,
        digital_signature_box_enable: typing.Optional[bool] = None,
        digital_signature_box_pos_x: typing.Optional[typing.Union[int, float]] = None,
        digital_signature_box_pos_y: typing.Optional[typing.Union[int, float]] = None,
        email: typing.Optional[str] = None,
        endpoint_id: typing.Optional[str] = None,
        endpoint_scheme_id: typing.Optional[str] = None,
        phone_number: typing.Optional[str] = None,
        postal_code: typing.Optional[str] = None,
        service_provider_id: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        tax_register_number: typing.Optional[str] = None,
        ...
        if business_number is not None:
            _body["businessNumber"] = business_number
        if business_number_schema_id is not None:
            _body["businessNumberSchemaId"] = business_number_schema_id
        if city is not None:
            _body["city"] = city
        ...
        if digital_signature_enable is not None:
            _body["digitalSignatureEnable"] = digital_signature_enable
        if digital_signature_box_enable is not None:
            _body["digitalSignatureBoxEnable"] = digital_signature_box_enable
        if digital_signature_box_pos_x is not None:
            _body["digitalSignatureBoxPosX"] = digital_signature_box_pos_x
        if digital_signature_box_pos_y is not None:
            _body["digitalSignatureBoxPosY"] = digital_signature_box_pos_y
        if email is not None:
            _body["email"] = email
        if endpoint_id is not None:
            _body["endpointId"] = endpoint_id
        if endpoint_scheme_id is not None:
            _body["endpointSchemeId"] = endpoint_scheme_id
        if phone_number is not None:
            _body["phoneNumber"] = phone_number
        if postal_code is not None:
            _body["postalCode"] = postal_code
        if service_provider_id is not None:
            _body["serviceProviderId"] = service_provider_id
        if state is not None:
            _body["state"] = state
        if tax_register_number is not None:
            _body["taxRegisterNumber"] = tax_register_number
        if trade_name is not None:
            _body["tradeName"] = trade_name
        args.body = _body
    ...
    async def _aupdate_e_invoicing_business_region_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/business-regions/{key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_e_invoicing_business_region_request.serialize(body, content_type)
    ...
    def _update_e_invoicing_business_region_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateEInvoicingBusinessRegionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_e_invoicing_business_region(
        self,
        key: str,
        address_line1: typing.Optional[str] = None,
        address_line2: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_e_invoicing_business_region_mapped_args(
            body=body,
            key=key,
            ...
            business_number_schema_id=business_number_schema_id,
            city=city,
            contact_name=contact_name,
            country=country,
            digital_signature_enable=digital_signature_enable,
            digital_signature_box_enable=digital_signature_box_enable,
            digital_signature_box_pos_x=digital_signature_box_pos_x,
            digital_signature_box_pos_y=digital_signature_box_pos_y,
            email=email,
            endpoint_id=endpoint_id,
            endpoint_scheme_id=endpoint_scheme_id,
        ...
        return await self._aupdate_e_invoicing_business_region_oapg(
            body=args.body,
    ...
    def update_e_invoicing_business_region(
        self,
        key: str,
        address_line1: typing.Optional[str] = None,
        address_line2: typing.Optional[str] = None,
        ...
        return self._update_e_invoicing_business_region_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateEInvoicingBusinessRegion(BaseApi):
    ...
    async def aupdate_e_invoicing_business_region(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetEInvoicingBusinessRegionResponsePydantic:
        raw_response = await self.raw.aupdate_e_invoicing_business_region(
            body=body,
            key=key,
            address_line1=address_line1,
            address_line2=address_line2,
        ...
        if validate:
            return RootModel[GetEInvoicingBusinessRegionResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetEInvoicingBusinessRegionResponsePydantic, raw_response.body)
    ...
    def update_e_invoicing_business_region(
        ...
        raw_response = self.raw.update_e_invoicing_business_region(
            body=body,
            key=key,
            address_line1=address_line1,
            address_line2=address_line2,
