...
from zuora_python_sdk.model.get_invoice_taxation_items_response import GETInvoiceTaxationItemsResponse as GETInvoiceTaxationItemsResponseSchema

from zuora_python_sdk.type.get_invoice_taxation_items_response import GETInvoiceTaxationItemsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_invoice_taxation_items_response import GETInvoiceTaxationItemsResponse as GETInvoiceTaxationItemsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETInvoiceTaxationItemsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETInvoiceTaxationItemsResponse
...
class BaseApi(api_client.Api):
    ...
    def _taxation_items_of_invoice_item_mapped_args(
        self,
        invoice_key: str,
        item_id: str,
    ...
    async def _ataxation_items_of_invoice_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/items/{itemId}/taxation-items',
            headers=_headers,
        )
    ...
    def _taxation_items_of_invoice_item_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class TaxationItemsOfInvoiceItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_items_of_invoice_item(
        self,
        invoice_key: str,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_items_of_invoice_item_mapped_args(
        ...
        return await self._ataxation_items_of_invoice_item_oapg(
    ...
    def taxation_items_of_invoice_item(
        self,
        invoice_key: str,
        item_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._taxation_items_of_invoice_item_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItemsOfInvoiceItem(BaseApi):
    ...
    async def ataxation_items_of_invoice_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETInvoiceTaxationItemsResponsePydantic:
        raw_response = await self.raw.ataxation_items_of_invoice_item(
            invoice_key=invoice_key,
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETInvoiceTaxationItemsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETInvoiceTaxationItemsResponsePydantic, raw_response.body)
    ...
    def taxation_items_of_invoice_item(
        ...
        raw_response = self.raw.taxation_items_of_invoice_item(
            invoice_key=invoice_key,
            item_id=item_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
