...
from zuora_python_sdk.model.get_accounting_code_item_type import GETAccountingCodeItemType as GETAccountingCodeItemTypeSchema

from zuora_python_sdk.type.get_accounting_code_item_type import GETAccountingCodeItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_accounting_code_item_type import GETAccountingCodeItemType as GETAccountingCodeItemTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAccountingCodeItemTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAccountingCodeItemType
...
class BaseApi(api_client.Api):
    ...
    def _accounting_code_0_mapped_args(
        self,
        ac_id: str,
    ...
    async def _aaccounting_code_0_oapg(
        self,
...
class AccountingCode0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_code_0(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_code_0_mapped_args(
            ac_id=ac_id,
        ...
        return await self._aaccounting_code_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def accounting_code_0(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._accounting_code_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AccountingCode0(BaseApi):
    ...
    async def aaccounting_code_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountingCodeItemTypePydantic:
        raw_response = await self.raw.aaccounting_code_0(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETAccountingCodeItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAccountingCodeItemTypePydantic, raw_response.body)
    ...
    def accounting_code_0(
        ...
        raw_response = self.raw.accounting_code_0(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
