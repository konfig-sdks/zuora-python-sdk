...
from zuora_python_sdk.model.put_accounting_code_type import PUTAccountingCodeType as PUTAccountingCodeTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.put_accounting_code_type import PUTAccountingCodeType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_accounting_code_type import PUTAccountingCodeType as PUTAccountingCodeTypePydantic
...
# Path params
AcIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ac-id': typing.Union[AcIdSchema, str, ],
    }
)
...
request_path_ac_id = api_client.PathParameter(
    name="ac-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AcIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = PUTAccountingCodeTypeSchema


request_body_put_accounting_code_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _accounting_code_1_mapped_args(
        self,
        body: PUTAccountingCodeType,
        ac_id: str,
    ...
    async def _aaccounting_code_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-codes/{ac-id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_accounting_code_type.serialize(body, content_type)
...
class AccountingCode1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_code_1(
        self,
        body: PUTAccountingCodeType,
        ac_id: str,
        gl_account_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_code_1_mapped_args(
            body=body,
            ac_id=ac_id,
        ...
        return await self._aaccounting_code_1_oapg(
            body=args.body,
    ...
    def accounting_code_1(
        ...
        return self._accounting_code_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class AccountingCode1(BaseApi):
    ...
    async def aaccounting_code_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccounting_code_1(
            body=body,
            ac_id=ac_id,
            gl_account_name=gl_account_name,
            gl_account_number=gl_account_number,
    ...
    def accounting_code_1(
        ...
        raw_response = self.raw.accounting_code_1(
            body=body,
            ac_id=ac_id,
            gl_account_name=gl_account_name,
            gl_account_number=gl_account_number,
