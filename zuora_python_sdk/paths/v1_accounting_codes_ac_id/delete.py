...
class BaseApi(api_client.Api):
    ...
    def _accounting_code_2_mapped_args(
        self,
        ac_id: str,
    ...
    async def _aaccounting_code_2_oapg(
        self,
...
class AccountingCode2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_code_2(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_code_2_mapped_args(
            ac_id=ac_id,
        ...
        return await self._aaccounting_code_2_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def accounting_code_2(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._accounting_code_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AccountingCode2(BaseApi):
    ...
    async def aaccounting_code_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccounting_code_2(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def accounting_code_2(
        ...
        raw_response = self.raw.accounting_code_2(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
