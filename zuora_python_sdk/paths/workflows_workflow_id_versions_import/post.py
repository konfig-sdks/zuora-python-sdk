...
from zuora_python_sdk.model.workflow_definition import WorkflowDefinition as WorkflowDefinitionSchema
from zuora_python_sdk.model.linkage import Linkage as LinkageSchema
from zuora_python_sdk.model.task import Task as TaskSchema
from zuora_python_sdk.model.detailed_workflow import DetailedWorkflow as DetailedWorkflowSchema
from zuora_python_sdk.model.post_workflow_versions_import_request import PostWorkflowVersionsImportRequest as PostWorkflowVersionsImportRequestSchema

from zuora_python_sdk.type.post_workflow_versions_import_request import PostWorkflowVersionsImportRequest
from zuora_python_sdk.type.workflow_definition import WorkflowDefinition
from zuora_python_sdk.type.detailed_workflow import DetailedWorkflow
from zuora_python_sdk.type.task import Task
from zuora_python_sdk.type.linkage import Linkage

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_workflow_versions_import_request import PostWorkflowVersionsImportRequest as PostWorkflowVersionsImportRequestPydantic
from zuora_python_sdk.pydantic.detailed_workflow import DetailedWorkflow as DetailedWorkflowPydantic
from zuora_python_sdk.pydantic.linkage import Linkage as LinkagePydantic
from zuora_python_sdk.pydantic.task import Task as TaskPydantic
from zuora_python_sdk.pydantic.workflow_definition import WorkflowDefinition as WorkflowDefinitionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostWorkflowVersionsImportRequestSchema


request_body_post_workflow_versions_import_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WorkflowDefinitionSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflow_versions_import_mapped_args(
        self,
        authorization: str,
        workflow_id: int,
        version: str,
        linkages: typing.Optional[typing.List[Linkage]] = None,
        tasks: typing.Optional[typing.List[Task]] = None,
        workflow: typing.Optional[DetailedWorkflow] = None,
    ...
    async def _aworkflow_versions_import_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workflows/{workflow_id}/versions/import',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_post_workflow_versions_import_request.serialize(body, content_type)
    ...
    def _workflow_versions_import_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class WorkflowVersionsImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_versions_import(
        self,
        authorization: str,
        workflow_id: int,
        version: str,
        ...
        **kwargs,
        ...
        args = self._workflow_versions_import_mapped_args(
        ...
        return await self._aworkflow_versions_import_oapg(
            body=args.body,
    ...
    def workflow_versions_import(
        ...
        return self._workflow_versions_import_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class WorkflowVersionsImport(BaseApi):
    ...
    async def aworkflow_versions_import(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowDefinitionPydantic:
        raw_response = await self.raw.aworkflow_versions_import(
            authorization=authorization,
            workflow_id=workflow_id,
            version=version,
            linkages=linkages,
        ...
        if validate:
            return WorkflowDefinitionPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowDefinitionPydantic, raw_response.body)
    ...
    def workflow_versions_import(
        ...
        raw_response = self.raw.workflow_versions_import(
            authorization=authorization,
            workflow_id=workflow_id,
            version=version,
            linkages=linkages,
