...
from zuora_python_sdk.model.post_trigger_rollover_response_type import POSTTriggerRolloverResponseType as POSTTriggerRolloverResponseTypeSchema
...
from zuora_python_sdk.model.post_trigger_rollover_request_type import POSTTriggerRolloverRequestType as POSTTriggerRolloverRequestTypeSchema
...
from zuora_python_sdk.type.post_trigger_rollover_response_type import POSTTriggerRolloverResponseType
from zuora_python_sdk.type.source_validity_period_info import SourceValidityPeriodInfo
from zuora_python_sdk.type.post_trigger_rollover_request_type import POSTTriggerRolloverRequestType
...
from zuora_python_sdk.pydantic.post_trigger_rollover_response_type import POSTTriggerRolloverResponseType as POSTTriggerRolloverResponseTypePydantic
from zuora_python_sdk.pydantic.post_trigger_rollover_request_type import POSTTriggerRolloverRequestType as POSTTriggerRolloverRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTTriggerRolloverRequestTypeSchema


request_body_post_trigger_rollover_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTTriggerRolloverResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTTriggerRolloverResponseType
    ...
    async def _arollover_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/ppdd/rollover',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_trigger_rollover_request_type.serialize(body, content_type)
...
class RolloverRaw(BaseApi):
    ...
    async def arollover(
        ...
        **kwargs,
        ...
        args = self._rollover_mapped_args(
            body=body,
        ...
        return await self._arollover_oapg(
            body=args.body,
    ...
    def rollover(
        ...
        return self._rollover_oapg(
            body=args.body,
            header_params=args.header,
        )

class Rollover(BaseApi):
    ...
    async def arollover(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTTriggerRolloverResponseTypePydantic:
        raw_response = await self.raw.arollover(
            body=body,
            destination_validity_period=destination_validity_period,
            prepayment_uom=prepayment_uom,
            priority=priority,
        ...
        if validate:
            return POSTTriggerRolloverResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTTriggerRolloverResponseTypePydantic, raw_response.body)
    ...
    def rollover(
        ...
        raw_response = self.raw.rollover(
            body=body,
            destination_validity_period=destination_validity_period,
            prepayment_uom=prepayment_uom,
            priority=priority,
