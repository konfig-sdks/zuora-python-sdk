...
from zuora_python_sdk.model.get_billing_document_files_deletion_job_response import GETBillingDocumentFilesDeletionJobResponse as GETBillingDocumentFilesDeletionJobResponseSchema

from zuora_python_sdk.type.get_billing_document_files_deletion_job_response import GETBillingDocumentFilesDeletionJobResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_billing_document_files_deletion_job_response import GETBillingDocumentFilesDeletionJobResponse as GETBillingDocumentFilesDeletionJobResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETBillingDocumentFilesDeletionJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETBillingDocumentFilesDeletionJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _billing_document_files_deletion_job_0_mapped_args(
        self,
        job_id: str,
    ...
    async def _abilling_document_files_deletion_job_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/billing-documents/files/deletion-jobs/{jobId}',
            headers=_headers,
        )
    ...
    def _billing_document_files_deletion_job_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BillingDocumentFilesDeletionJob0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abilling_document_files_deletion_job_0(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._billing_document_files_deletion_job_0_mapped_args(
            job_id=job_id,
        ...
        return await self._abilling_document_files_deletion_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def billing_document_files_deletion_job_0(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._billing_document_files_deletion_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BillingDocumentFilesDeletionJob0(BaseApi):
    ...
    async def abilling_document_files_deletion_job_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETBillingDocumentFilesDeletionJobResponsePydantic:
        raw_response = await self.raw.abilling_document_files_deletion_job_0(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETBillingDocumentFilesDeletionJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETBillingDocumentFilesDeletionJobResponsePydantic, raw_response.body)
    ...
    def billing_document_files_deletion_job_0(
        ...
        raw_response = self.raw.billing_document_files_deletion_job_0(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
