...
from zuora_python_sdk.model.post_retry_payment_schedule_item_response import POSTRetryPaymentScheduleItemResponse as POSTRetryPaymentScheduleItemResponseSchema
from zuora_python_sdk.model.post_retry_payment_schedule_item_info import POSTRetryPaymentScheduleItemInfo as POSTRetryPaymentScheduleItemInfoSchema
from zuora_python_sdk.model.post_retry_payment_schedule_item_request import POSTRetryPaymentScheduleItemRequest as POSTRetryPaymentScheduleItemRequestSchema

from zuora_python_sdk.type.post_retry_payment_schedule_item_request import POSTRetryPaymentScheduleItemRequest
from zuora_python_sdk.type.post_retry_payment_schedule_item_info import POSTRetryPaymentScheduleItemInfo
from zuora_python_sdk.type.post_retry_payment_schedule_item_response import POSTRetryPaymentScheduleItemResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_retry_payment_schedule_item_response import POSTRetryPaymentScheduleItemResponse as POSTRetryPaymentScheduleItemResponsePydantic
from zuora_python_sdk.pydantic.post_retry_payment_schedule_item_info import POSTRetryPaymentScheduleItemInfo as POSTRetryPaymentScheduleItemInfoPydantic
from zuora_python_sdk.pydantic.post_retry_payment_schedule_item_request import POSTRetryPaymentScheduleItemRequest as POSTRetryPaymentScheduleItemRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTRetryPaymentScheduleItemRequestSchema


request_body_post_retry_payment_schedule_item_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTRetryPaymentScheduleItemResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTRetryPaymentScheduleItemResponse
...
class BaseApi(api_client.Api):
    ...
    def _retry_payment_schedule_item_mapped_args(
        self,
        items: typing.Optional[typing.List[POSTRetryPaymentScheduleItemInfo]] = None,
    ...
    async def _aretry_payment_schedule_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedule-items/retry-payment',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_retry_payment_schedule_item_request.serialize(body, content_type)
    ...
    def _retry_payment_schedule_item_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetryPaymentScheduleItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretry_payment_schedule_item(
        self,
        items: typing.Optional[typing.List[POSTRetryPaymentScheduleItemInfo]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retry_payment_schedule_item_mapped_args(
            items=items,
        ...
        return await self._aretry_payment_schedule_item_oapg(
            body=args.body,
    ...
    def retry_payment_schedule_item(
        ...
        return self._retry_payment_schedule_item_oapg(
            body=args.body,
            header_params=args.header,
        )

class RetryPaymentScheduleItem(BaseApi):
    ...
    async def aretry_payment_schedule_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTRetryPaymentScheduleItemResponsePydantic:
        raw_response = await self.raw.aretry_payment_schedule_item(
            items=items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTRetryPaymentScheduleItemResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTRetryPaymentScheduleItemResponsePydantic, raw_response.body)
    ...
    def retry_payment_schedule_item(
        ...
        raw_response = self.raw.retry_payment_schedule_item(
            items=items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
