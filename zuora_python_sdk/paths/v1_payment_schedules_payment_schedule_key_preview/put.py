...
from zuora_python_sdk.model.put_preview_payment_schedule_request import PUTPreviewPaymentScheduleRequest as PUTPreviewPaymentScheduleRequestSchema
...
from zuora_python_sdk.model.get_payment_schedule_response import GETPaymentScheduleResponse as GETPaymentScheduleResponseSchema

from zuora_python_sdk.type.put_preview_payment_schedule_request import PUTPreviewPaymentScheduleRequest
from zuora_python_sdk.type.payment_schedule_payment_option_fields import PaymentSchedulePaymentOptionFields
from zuora_python_sdk.type.get_payment_schedule_response import GETPaymentScheduleResponse
...
from zuora_python_sdk.pydantic.get_payment_schedule_response import GETPaymentScheduleResponse as GETPaymentScheduleResponsePydantic
from zuora_python_sdk.pydantic.put_preview_payment_schedule_request import PUTPreviewPaymentScheduleRequest as PUTPreviewPaymentScheduleRequestPydantic
...
# Path params
PaymentScheduleKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'paymentScheduleKey': typing.Union[PaymentScheduleKeySchema, str, ],
    }
)
...
request_path_payment_schedule_key = api_client.PathParameter(
    name="paymentScheduleKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PaymentScheduleKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTPreviewPaymentScheduleRequestSchema


request_body_put_preview_payment_schedule_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentScheduleResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentScheduleResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_update_preview_mapped_args(
        self,
        body: PUTPreviewPaymentScheduleRequest,
        payment_schedule_key: str,
        ...
        if period_start_date is not None:
            _body["periodStartDate"] = period_start_date
    ...
    async def _apayment_schedule_update_preview_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_payment_schedule_key,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/{paymentScheduleKey}/preview',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_preview_payment_schedule_request.serialize(body, content_type)
    ...
    def _payment_schedule_update_preview_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class PaymentScheduleUpdatePreviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_update_preview(
        self,
        body: PUTPreviewPaymentScheduleRequest,
        payment_schedule_key: str,
        amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_update_preview_mapped_args(
            body=body,
        ...
        return await self._apayment_schedule_update_preview_oapg(
            body=args.body,
    ...
    def payment_schedule_update_preview(
        self,
        body: PUTPreviewPaymentScheduleRequest,
        payment_schedule_key: str,
        amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._payment_schedule_update_preview_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentScheduleUpdatePreview(BaseApi):
    ...
    async def apayment_schedule_update_preview(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentScheduleResponsePydantic:
        raw_response = await self.raw.apayment_schedule_update_preview(
            body=body,
            payment_schedule_key=payment_schedule_key,
            amount=amount,
            currency=currency,
        ...
        if validate:
            return RootModel[GETPaymentScheduleResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETPaymentScheduleResponsePydantic, raw_response.body)
    ...
    def payment_schedule_update_preview(
        ...
        raw_response = self.raw.payment_schedule_update_preview(
            body=body,
            payment_schedule_key=payment_schedule_key,
            amount=amount,
            currency=currency,
