...
from zuora_python_sdk.model.custom_object_bulk_job_response_collection import CustomObjectBulkJobResponseCollection as CustomObjectBulkJobResponseCollectionSchema

from zuora_python_sdk.type.custom_object_bulk_job_response_collection import CustomObjectBulkJobResponseCollection

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.custom_object_bulk_job_response_collection import CustomObjectBulkJobResponseCollection as CustomObjectBulkJobResponseCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomObjectBulkJobResponseCollectionSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomObjectBulkJobResponseCollection
...
class BaseApi(api_client.Api):
    ...
    def _all_custom_object_bulk_jobs_mapped_args(
        self,
        authorization: str,
    ...
    async def _aall_custom_object_bulk_jobs_oapg(
        self,
    ...
    def _all_custom_object_bulk_jobs_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AllCustomObjectBulkJobsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_custom_object_bulk_jobs(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_custom_object_bulk_jobs_mapped_args(
        ...
        return await self._aall_custom_object_bulk_jobs_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def all_custom_object_bulk_jobs(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._all_custom_object_bulk_jobs_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class AllCustomObjectBulkJobs(BaseApi):
    ...
    async def aall_custom_object_bulk_jobs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomObjectBulkJobResponseCollectionPydantic:
        raw_response = await self.raw.aall_custom_object_bulk_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return CustomObjectBulkJobResponseCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomObjectBulkJobResponseCollectionPydantic, raw_response.body)
    ...
    def all_custom_object_bulk_jobs(
        ...
        raw_response = self.raw.all_custom_object_bulk_jobs(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
