...
from zuora_python_sdk.model.custom_object_bulk_job_response import CustomObjectBulkJobResponse as CustomObjectBulkJobResponseSchema
from zuora_python_sdk.model.custom_object_bulk_job_request import CustomObjectBulkJobRequest as CustomObjectBulkJobRequestSchema
from zuora_python_sdk.model.custom_object_bulk_delete_filter import CustomObjectBulkDeleteFilter as CustomObjectBulkDeleteFilterSchema

from zuora_python_sdk.type.custom_object_bulk_job_response import CustomObjectBulkJobResponse
from zuora_python_sdk.type.custom_object_bulk_delete_filter import CustomObjectBulkDeleteFilter
from zuora_python_sdk.type.custom_object_bulk_job_request import CustomObjectBulkJobRequest
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.custom_object_bulk_job_request import CustomObjectBulkJobRequest as CustomObjectBulkJobRequestPydantic
from zuora_python_sdk.pydantic.custom_object_bulk_delete_filter import CustomObjectBulkDeleteFilter as CustomObjectBulkDeleteFilterPydantic
from zuora_python_sdk.pydantic.custom_object_bulk_job_response import CustomObjectBulkJobResponse as CustomObjectBulkJobResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CustomObjectBulkJobRequestSchema


request_body_custom_object_bulk_job_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CustomObjectBulkJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomObjectBulkJobResponse
...
SchemaFor403ResponseBodyApplicationJson = CommonResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _custom_object_bulk_job_mapped_args(
        self,
        namespace: str,
        object: str,
        operation: str,
        authorization: str,
        filter: typing.Optional[CustomObjectBulkDeleteFilter] = None,
    ...
    async def _acustom_object_bulk_job_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_custom_object_bulk_job_request.serialize(body, content_type)
    ...
    def _custom_object_bulk_job_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectBulkJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_bulk_job(
        self,
        namespace: str,
        object: str,
        operation: str,
        ...
        **kwargs,
        ...
        args = self._custom_object_bulk_job_mapped_args(
            namespace=namespace,
            object=object,
            operation=operation,
        ...
        return await self._acustom_object_bulk_job_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def custom_object_bulk_job(
        self,
        namespace: str,
        object: str,
        operation: str,
        ...
        return self._custom_object_bulk_job_oapg(
            body=args.body,
            header_params=args.header,
        )

class CustomObjectBulkJob(BaseApi):
    ...
    async def acustom_object_bulk_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomObjectBulkJobResponsePydantic:
        raw_response = await self.raw.acustom_object_bulk_job(
            namespace=namespace,
            object=object,
            operation=operation,
            authorization=authorization,
        ...
        if validate:
            return CustomObjectBulkJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomObjectBulkJobResponsePydantic, raw_response.body)
    ...
    def custom_object_bulk_job(
        ...
        raw_response = self.raw.custom_object_bulk_job(
            namespace=namespace,
            object=object,
            operation=operation,
            authorization=authorization,
