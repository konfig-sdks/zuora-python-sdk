...
from zuora_python_sdk.model.debit_memo_collect_request import DebitMemoCollectRequest as DebitMemoCollectRequestSchema
from zuora_python_sdk.model.debit_memo_collect_request_application_order import DebitMemoCollectRequestApplicationOrder as DebitMemoCollectRequestApplicationOrderSchema
from zuora_python_sdk.model.debit_memo_collect_response import DebitMemoCollectResponse as DebitMemoCollectResponseSchema
from zuora_python_sdk.model.debit_memo_collect_request_payment import DebitMemoCollectRequestPayment as DebitMemoCollectRequestPaymentSchema

from zuora_python_sdk.type.debit_memo_collect_response import DebitMemoCollectResponse
from zuora_python_sdk.type.debit_memo_collect_request_payment import DebitMemoCollectRequestPayment
from zuora_python_sdk.type.debit_memo_collect_request import DebitMemoCollectRequest
from zuora_python_sdk.type.debit_memo_collect_request_application_order import DebitMemoCollectRequestApplicationOrder

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.debit_memo_collect_request_application_order import DebitMemoCollectRequestApplicationOrder as DebitMemoCollectRequestApplicationOrderPydantic
from zuora_python_sdk.pydantic.debit_memo_collect_request import DebitMemoCollectRequest as DebitMemoCollectRequestPydantic
from zuora_python_sdk.pydantic.debit_memo_collect_response import DebitMemoCollectResponse as DebitMemoCollectResponsePydantic
from zuora_python_sdk.pydantic.debit_memo_collect_request_payment import DebitMemoCollectRequestPayment as DebitMemoCollectRequestPaymentPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DebitMemoCollectRequestSchema


request_body_debit_memo_collect_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DebitMemoCollectResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_collect_mapped_args(
        self,
        debit_memo_key: str,
        application_order: typing.Optional[DebitMemoCollectRequestApplicationOrder] = None,
        apply_credit: typing.Optional[bool] = None,
        collect: typing.Optional[bool] = None,
        payment: typing.Optional[DebitMemoCollectRequestPayment] = None,
    ...
    async def _adebit_memo_collect_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/collect',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_debit_memo_collect_request.serialize(body, content_type)
...
class DebitMemoCollectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_collect(
        self,
        debit_memo_key: str,
        application_order: typing.Optional[DebitMemoCollectRequestApplicationOrder] = None,
        apply_credit: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_collect_mapped_args(
        ...
        return await self._adebit_memo_collect_oapg(
            body=args.body,
    ...
    def debit_memo_collect(
        ...
        return self._debit_memo_collect_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoCollect(BaseApi):
    ...
    async def adebit_memo_collect(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DebitMemoCollectResponsePydantic:
        raw_response = await self.raw.adebit_memo_collect(
            debit_memo_key=debit_memo_key,
            application_order=application_order,
            apply_credit=apply_credit,
            collect=collect,
        ...
        if validate:
            return RootModel[DebitMemoCollectResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DebitMemoCollectResponsePydantic, raw_response.body)
    ...
    def debit_memo_collect(
        ...
        raw_response = self.raw.debit_memo_collect(
            debit_memo_key=debit_memo_key,
            application_order=application_order,
            apply_credit=apply_credit,
            collect=collect,
