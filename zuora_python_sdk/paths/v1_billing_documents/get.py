...
from zuora_python_sdk.model.billing_document_query_response_element_type import BillingDocumentQueryResponseElementType as BillingDocumentQueryResponseElementTypeSchema

from zuora_python_sdk.type.billing_document_query_response_element_type import BillingDocumentQueryResponseElementType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.billing_document_query_response_element_type import BillingDocumentQueryResponseElementType as BillingDocumentQueryResponseElementTypePydantic
...
AccountNumberSchema = schemas.UUIDSchema
DocumentDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'accountNumber': typing.Union[AccountNumberSchema, str, uuid.UUID, ],
        'documentDate': typing.Union[DocumentDateSchema, str, date, ],
...
request_query_document_date = api_client.QueryParameter(
    name="documentDate",
    style=api_client.ParameterStyle.FORM,
    schema=DocumentDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = BillingDocumentQueryResponseElementTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BillingDocumentQueryResponseElementType
...
class BaseApi(api_client.Api):
    ...
    def _billing_documents_mapped_args(
        self,
        ...
        if document_date is not None:
            _query_params["documentDate"] = document_date
    ...
    async def _abilling_documents_oapg(
        self,
...
class BillingDocumentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abilling_documents(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._billing_documents_mapped_args(
        ...
        return await self._abilling_documents_oapg(
    ...
    def billing_documents(
        ...
        return self._billing_documents_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class BillingDocuments(BaseApi):
    ...
    async def abilling_documents(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingDocumentQueryResponseElementTypePydantic:
        raw_response = await self.raw.abilling_documents(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return BillingDocumentQueryResponseElementTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(BillingDocumentQueryResponseElementTypePydantic, raw_response.body)
    ...
    def billing_documents(
        ...
        raw_response = self.raw.billing_documents(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
