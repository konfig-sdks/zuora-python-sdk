...
class BillRunRaw(BaseApi):
    ...
    async def abill_run(
        ...
        **kwargs,
        ...
        args = self._bill_run_mapped_args(
        ...
        return await self._abill_run_oapg(
    ...
    def bill_run(
        ...
        return self._bill_run_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BillRun(BaseApi):
    ...
    async def abill_run(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abill_run(
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def bill_run(
        ...
        raw_response = self.raw.bill_run(
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
