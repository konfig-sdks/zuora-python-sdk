...
class BaseApi(api_client.Api):
    ...
    def _delete_bill_run_mapped_args(
        self,
        bill_run_id: str,
    ...
    async def _adelete_bill_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bill-runs/{billRunId}',
            headers=_headers,
        )
...
class DeleteBillRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_bill_run(
        self,
        bill_run_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_bill_run_mapped_args(
        ...
        return await self._adelete_bill_run_oapg(
    ...
    def delete_bill_run(
        ...
        return self._delete_bill_run_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteBillRun(BaseApi):
    ...
    async def adelete_bill_run(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_bill_run(
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def delete_bill_run(
        ...
        raw_response = self.raw.delete_bill_run(
            bill_run_id=bill_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
