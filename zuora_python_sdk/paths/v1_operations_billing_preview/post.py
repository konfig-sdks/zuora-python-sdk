...
from zuora_python_sdk.model.post_billing_preview_param import PostBillingPreviewParam as PostBillingPreviewParamSchema
from zuora_python_sdk.model.billing_preview_result import BillingPreviewResult as BillingPreviewResultSchema

from zuora_python_sdk.type.post_billing_preview_param import PostBillingPreviewParam
from zuora_python_sdk.type.billing_preview_result import BillingPreviewResult

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_billing_preview_param import PostBillingPreviewParam as PostBillingPreviewParamPydantic
from zuora_python_sdk.pydantic.billing_preview_result import BillingPreviewResult as BillingPreviewResultPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostBillingPreviewParamSchema


request_body_post_billing_preview_param = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BillingPreviewResultSchema
...
class BaseApi(api_client.Api):
    ...
    def _billing_preview_mapped_args(
        self,
        target_date: date,
    ...
    async def _abilling_preview_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_billing_preview_param.serialize(body, content_type)
...
class BillingPreviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abilling_preview(
        self,
        target_date: date,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._billing_preview_mapped_args(
        ...
        return await self._abilling_preview_oapg(
            body=args.body,
    ...
    def billing_preview(
        ...
        return self._billing_preview_oapg(
            body=args.body,
            header_params=args.header,
        )

class BillingPreview(BaseApi):
    ...
    async def abilling_preview(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingPreviewResultPydantic:
        raw_response = await self.raw.abilling_preview(
            target_date=target_date,
            account_id=account_id,
            account_number=account_number,
            assume_renewal=assume_renewal,
        ...
        if validate:
            return BillingPreviewResultPydantic(**raw_response.body)
        return api_client.construct_model_instance(BillingPreviewResultPydantic, raw_response.body)
    ...
    def billing_preview(
        ...
        raw_response = self.raw.billing_preview(
            target_date=target_date,
            account_id=account_id,
            account_number=account_number,
            assume_renewal=assume_renewal,
