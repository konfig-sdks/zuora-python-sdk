...
from zuora_python_sdk.model.get_credit_memo_pdf_status_batch_response import GetCreditMemoPdfStatusBatchResponse as GetCreditMemoPdfStatusBatchResponseSchema
...
from zuora_python_sdk.type.get_credit_memo_pdf_status_batch_response import GetCreditMemoPdfStatusBatchResponse
...
from zuora_python_sdk.pydantic.get_credit_memo_pdf_status_batch_response import GetCreditMemoPdfStatusBatchResponse as GetCreditMemoPdfStatusBatchResponsePydantic

from . import path

# Query params
CreditMemoKeysSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'creditMemoKeys': typing.Union[CreditMemoKeysSchema, str, ],
    }
)
...
request_query_credit_memo_keys = api_client.QueryParameter(
    name="creditMemoKeys",
    style=api_client.ParameterStyle.FORM,
    schema=CreditMemoKeysSchema,
    required=True,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetCreditMemoPdfStatusBatchResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetCreditMemoPdfStatusBatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_pdf_status_mapped_args(
        self,
        credit_memo_keys: str,
        ...
        if credit_memo_keys is not None:
            _query_params["creditMemoKeys"] = credit_memo_keys
    ...
    async def _acredit_memo_pdf_status_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_credit_memo_keys,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/pdf-status',
            headers=_headers,
        )
    ...
    def _credit_memo_pdf_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreditMemoPdfStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_pdf_status(
        self,
        credit_memo_keys: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_pdf_status_mapped_args(
        ...
        return await self._acredit_memo_pdf_status_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def credit_memo_pdf_status(
        self,
        credit_memo_keys: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._credit_memo_pdf_status_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class CreditMemoPdfStatus(BaseApi):
    ...
    async def acredit_memo_pdf_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetCreditMemoPdfStatusBatchResponsePydantic:
        raw_response = await self.raw.acredit_memo_pdf_status(
            credit_memo_keys=credit_memo_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetCreditMemoPdfStatusBatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetCreditMemoPdfStatusBatchResponsePydantic, raw_response.body)
    ...
    def credit_memo_pdf_status(
        ...
        raw_response = self.raw.credit_memo_pdf_status(
            credit_memo_keys=credit_memo_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
