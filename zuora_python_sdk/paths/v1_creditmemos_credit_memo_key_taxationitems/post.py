...
from zuora_python_sdk.model.post_taxation_item_list_for_cm_type import POSTTaxationItemListForCMType as POSTTaxationItemListForCMTypeSchema
from zuora_python_sdk.model.get_taxation_item_list_type import GETTaxationItemListType as GETTaxationItemListTypeSchema
from zuora_python_sdk.model.post_taxation_item_for_cm_type import POSTTaxationItemForCMType as POSTTaxationItemForCMTypeSchema

from zuora_python_sdk.type.post_taxation_item_for_cm_type import POSTTaxationItemForCMType
from zuora_python_sdk.type.post_taxation_item_list_for_cm_type import POSTTaxationItemListForCMType
from zuora_python_sdk.type.get_taxation_item_list_type import GETTaxationItemListType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_taxation_item_list_for_cm_type import POSTTaxationItemListForCMType as POSTTaxationItemListForCMTypePydantic
from zuora_python_sdk.pydantic.post_taxation_item_for_cm_type import POSTTaxationItemForCMType as POSTTaxationItemForCMTypePydantic
from zuora_python_sdk.pydantic.get_taxation_item_list_type import GETTaxationItemListType as GETTaxationItemListTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTTaxationItemListForCMTypeSchema


request_body_post_taxation_item_list_for_cm_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETTaxationItemListTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_taxation_items_mapped_args(
        self,
        credit_memo_key: str,
        taxation_items: typing.Optional[typing.List[POSTTaxationItemForCMType]] = None,
        ...
        if taxation_items is not None:
            _body["taxationItems"] = taxation_items
        args.body = _body
    ...
    async def _acreate_taxation_items_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/taxationitems',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_taxation_item_list_for_cm_type.serialize(body, content_type)
    ...
    def _create_taxation_items_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateTaxationItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_taxation_items(
        self,
        credit_memo_key: str,
        taxation_items: typing.Optional[typing.List[POSTTaxationItemForCMType]] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_taxation_items_mapped_args(
            credit_memo_key=credit_memo_key,
            taxation_items=taxation_items,
        ...
        return await self._acreate_taxation_items_oapg(
            body=args.body,
    ...
    def create_taxation_items(
        ...
        return self._create_taxation_items_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateTaxationItems(BaseApi):
    ...
    async def acreate_taxation_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETTaxationItemListTypePydantic:
        raw_response = await self.raw.acreate_taxation_items(
            credit_memo_key=credit_memo_key,
            taxation_items=taxation_items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GETTaxationItemListTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETTaxationItemListTypePydantic, raw_response.body)
    ...
    def create_taxation_items(
        ...
        raw_response = self.raw.create_taxation_items(
            credit_memo_key=credit_memo_key,
            taxation_items=taxation_items,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
