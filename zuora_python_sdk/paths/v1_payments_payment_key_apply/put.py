...
from zuora_python_sdk.model.apply_payment_type import ApplyPaymentType as ApplyPaymentTypeSchema
...
from zuora_python_sdk.type.apply_payment_type import ApplyPaymentType
...
from zuora_python_sdk.pydantic.apply_payment_type import ApplyPaymentType as ApplyPaymentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ApplyPaymentTypeSchema


request_body_apply_payment_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _apply_payment_mapped_args(
        self,
        payment_key: str,
    ...
    async def _aapply_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/apply',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_apply_payment_type.serialize(body, content_type)
...
class ApplyPaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aapply_payment(
        self,
        payment_key: str,
        debit_memos: typing.Optional[typing.List[PaymentDebitMemoApplicationApplyRequestType]] = None,
        effective_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._apply_payment_mapped_args(
        ...
        return await self._aapply_payment_oapg(
            body=args.body,
    ...
    def apply_payment(
        ...
        return self._apply_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ApplyPayment(BaseApi):
    ...
    async def aapply_payment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aapply_payment(
            payment_key=payment_key,
            debit_memos=debit_memos,
            effective_date=effective_date,
            invoices=invoices,
    ...
    def apply_payment(
        ...
        raw_response = self.raw.apply_payment(
            payment_key=payment_key,
            debit_memos=debit_memos,
            effective_date=effective_date,
            invoices=invoices,
