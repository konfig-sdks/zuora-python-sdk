...
ProfileNumberSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'payment-method-id': typing.Union[PaymentMethodIdSchema, str, ],
        'profile-number': typing.Union[ProfileNumberSchema, decimal.Decimal, int, ],
    }
)
...
request_path_profile_number = api_client.PathParameter(
    name="profile-number",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProfileNumberSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
class BaseApi(api_client.Api):
    ...
    def _cancel_stored_credential_profile_mapped_args(
        self,
    ...
    async def _acancel_stored_credential_profile_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/profiles/{profile-number}/cancel',
            headers=_headers,
        )
    ...
    def _cancel_stored_credential_profile_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CancelStoredCredentialProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_stored_credential_profile(
        self,
        payment_method_id: str,
        profile_number: int,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_stored_credential_profile_mapped_args(
        ...
        return await self._acancel_stored_credential_profile_oapg(
    ...
    def cancel_stored_credential_profile(
        ...
        return self._cancel_stored_credential_profile_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelStoredCredentialProfile(BaseApi):
    ...
    async def acancel_stored_credential_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_stored_credential_profile(
            payment_method_id=payment_method_id,
            profile_number=profile_number,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    def cancel_stored_credential_profile(
        ...
        raw_response = self.raw.cancel_stored_credential_profile(
            payment_method_id=payment_method_id,
            profile_number=profile_number,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
