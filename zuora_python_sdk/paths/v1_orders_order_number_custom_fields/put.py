...
from zuora_python_sdk.model.put_order_patch_request_type_subscriptions import PUTOrderPatchRequestTypeSubscriptions as PUTOrderPatchRequestTypeSubscriptionsSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.put_order_patch_request_type import PUTOrderPatchRequestType as PUTOrderPatchRequestTypeSchema
...
from zuora_python_sdk.type.put_order_patch_request_type_subscriptions import PUTOrderPatchRequestTypeSubscriptions
from zuora_python_sdk.type.common_response import CommonResponse
from zuora_python_sdk.type.put_order_patch_request_type import PUTOrderPatchRequestType
...
from zuora_python_sdk.pydantic.put_order_patch_request_type_subscriptions import PUTOrderPatchRequestTypeSubscriptions as PUTOrderPatchRequestTypeSubscriptionsPydantic
from zuora_python_sdk.pydantic.common_response import CommonResponse as CommonResponsePydantic
from zuora_python_sdk.pydantic.put_order_patch_request_type import PUTOrderPatchRequestType as PUTOrderPatchRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTOrderPatchRequestTypeSchema


request_body_put_order_patch_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_order_custom_fields_mapped_args(
        self,
        order_number: str,
        custom_fields: typing.Optional[OrderObjectCustomFields] = None,
        subscriptions: typing.Optional[PUTOrderPatchRequestTypeSubscriptions] = None,
    ...
    async def _aupdate_order_custom_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/{orderNumber}/customFields',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_order_patch_request_type.serialize(body, content_type)
    ...
    def _update_order_custom_fields_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateOrderCustomFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_order_custom_fields(
        self,
        order_number: str,
        custom_fields: typing.Optional[OrderObjectCustomFields] = None,
        subscriptions: typing.Optional[PUTOrderPatchRequestTypeSubscriptions] = None,
        ...
        **kwargs,
        ...
        args = self._update_order_custom_fields_mapped_args(
        ...
        return await self._aupdate_order_custom_fields_oapg(
            body=args.body,
    ...
    def update_order_custom_fields(
        ...
        return self._update_order_custom_fields_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateOrderCustomFields(BaseApi):
    ...
    async def aupdate_order_custom_fields(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_order_custom_fields(
            order_number=order_number,
            custom_fields=custom_fields,
            subscriptions=subscriptions,
            accept_encoding=accept_encoding,
    ...
    def update_order_custom_fields(
        ...
        raw_response = self.raw.update_order_custom_fields(
            order_number=order_number,
            custom_fields=custom_fields,
            subscriptions=subscriptions,
            accept_encoding=accept_encoding,
