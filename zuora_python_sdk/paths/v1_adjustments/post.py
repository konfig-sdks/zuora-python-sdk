...
from zuora_python_sdk.model.post_create_billing_adjustment_request_type import POSTCreateBillingAdjustmentRequestType as POSTCreateBillingAdjustmentRequestTypeSchema
from zuora_python_sdk.model.post_create_billing_adjustment_request_type_charge_numbers import POSTCreateBillingAdjustmentRequestTypeChargeNumbers as POSTCreateBillingAdjustmentRequestTypeChargeNumbersSchema
from zuora_python_sdk.model.post_create_billing_adjustment_request_type_exclusion import POSTCreateBillingAdjustmentRequestTypeExclusion as POSTCreateBillingAdjustmentRequestTypeExclusionSchema
from zuora_python_sdk.model.get_adjustments_response_type import GETAdjustmentsResponseType as GETAdjustmentsResponseTypeSchema

from zuora_python_sdk.type.post_create_billing_adjustment_request_type import POSTCreateBillingAdjustmentRequestType
from zuora_python_sdk.type.post_create_billing_adjustment_request_type_charge_numbers import POSTCreateBillingAdjustmentRequestTypeChargeNumbers
from zuora_python_sdk.type.get_adjustments_response_type import GETAdjustmentsResponseType
from zuora_python_sdk.type.post_create_billing_adjustment_request_type_exclusion import POSTCreateBillingAdjustmentRequestTypeExclusion

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_create_billing_adjustment_request_type import POSTCreateBillingAdjustmentRequestType as POSTCreateBillingAdjustmentRequestTypePydantic
from zuora_python_sdk.pydantic.post_create_billing_adjustment_request_type_exclusion import POSTCreateBillingAdjustmentRequestTypeExclusion as POSTCreateBillingAdjustmentRequestTypeExclusionPydantic
from zuora_python_sdk.pydantic.get_adjustments_response_type import GETAdjustmentsResponseType as GETAdjustmentsResponseTypePydantic
from zuora_python_sdk.pydantic.post_create_billing_adjustment_request_type_charge_numbers import POSTCreateBillingAdjustmentRequestTypeChargeNumbers as POSTCreateBillingAdjustmentRequestTypeChargeNumbersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreateBillingAdjustmentRequestTypeSchema


request_body_post_create_billing_adjustment_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETAdjustmentsResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAdjustmentsResponseType
...
class BaseApi(api_client.Api):
    ...
    def _adjustment_mapped_args(
        self,
        end_date: date,
        start_date: date,
        account_number: typing.Optional[str] = None,
        charge_numbers: typing.Optional[POSTCreateBillingAdjustmentRequestTypeChargeNumbers] = None,
        deferred_revenue_accounting_code: typing.Optional[str] = None,
        exclusion: typing.Optional[POSTCreateBillingAdjustmentRequestTypeExclusion] = None,
        ...
        if charge_numbers is not None:
            _body["chargeNumbers"] = charge_numbers
    ...
    async def _aadjustment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/adjustments',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_billing_adjustment_request_type.serialize(body, content_type)
...
class AdjustmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadjustment(
        self,
        end_date: date,
        start_date: date,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._adjustment_mapped_args(
            end_date=end_date,
        ...
        return await self._aadjustment_oapg(
            body=args.body,
    ...
    def adjustment(
        ...
        return self._adjustment_oapg(
            body=args.body,
            header_params=args.header,
        )

class Adjustment(BaseApi):
    ...
    async def aadjustment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAdjustmentsResponseTypePydantic:
        raw_response = await self.raw.aadjustment(
            end_date=end_date,
            start_date=start_date,
            account_number=account_number,
            charge_numbers=charge_numbers,
        ...
        if validate:
            return RootModel[GETAdjustmentsResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAdjustmentsResponseTypePydantic, raw_response.body)
    ...
    def adjustment(
        ...
        raw_response = self.raw.adjustment(
            end_date=end_date,
            start_date=start_date,
            account_number=account_number,
            charge_numbers=charge_numbers,
