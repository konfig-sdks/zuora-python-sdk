...
from zuora_python_sdk.model.get_adjustments_by_subscription_number_response_type import GETAdjustmentsBySubscriptionNumberResponseType as GETAdjustmentsBySubscriptionNumberResponseTypeSchema

from zuora_python_sdk.type.get_adjustments_by_subscription_number_response_type import GETAdjustmentsBySubscriptionNumberResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_adjustments_by_subscription_number_response_type import GETAdjustmentsBySubscriptionNumberResponseType as GETAdjustmentsBySubscriptionNumberResponseTypePydantic
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'subscription-number': typing.Union[SubscriptionNumberSchema, str, ],
    }
)
...
request_query_subscription_number = api_client.QueryParameter(
...
SchemaFor200ResponseBodyApplicationJson = GETAdjustmentsBySubscriptionNumberResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAdjustmentsBySubscriptionNumberResponseType
...
class BaseApi(api_client.Api):
    ...
    def _list_subscription_delivery_adjustments_mapped_args(
        self,
        ...
        if subscription_number is not None:
            _query_params["subscription-number"] = subscription_number
    ...
    async def _alist_subscription_delivery_adjustments_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_subscription_number,
        ):
    ...
    def _list_subscription_delivery_adjustments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListSubscriptionDeliveryAdjustmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_subscription_delivery_adjustments(
        self,
        subscription_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_subscription_delivery_adjustments_mapped_args(
        ...
        return await self._alist_subscription_delivery_adjustments_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def list_subscription_delivery_adjustments(
        self,
        subscription_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._list_subscription_delivery_adjustments_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ListSubscriptionDeliveryAdjustments(BaseApi):
    ...
    async def alist_subscription_delivery_adjustments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAdjustmentsBySubscriptionNumberResponseTypePydantic:
        raw_response = await self.raw.alist_subscription_delivery_adjustments(
            subscription_number=subscription_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETAdjustmentsBySubscriptionNumberResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAdjustmentsBySubscriptionNumberResponseTypePydantic, raw_response.body)
    ...
    def list_subscription_delivery_adjustments(
        ...
        raw_response = self.raw.list_subscription_delivery_adjustments(
            subscription_number=subscription_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
