...
class BaseApi(api_client.Api):
    ...
    def _custom_object_record_by_id_mapped_args(
        self,
        authorization: str,
        object: str,
        id: str,
    ...
    async def _acustom_object_record_by_id_oapg(
        self,
    ...
    def _custom_object_record_by_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectRecordByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_record_by_id(
        self,
        authorization: str,
        object: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._custom_object_record_by_id_mapped_args(
        ...
        return await self._acustom_object_record_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def custom_object_record_by_id(
        self,
        authorization: str,
        object: str,
        id: str,
        ...
        return self._custom_object_record_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectRecordById(BaseApi):
    ...
    async def acustom_object_record_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acustom_object_record_by_id(
            authorization=authorization,
            object=object,
            id=id,
            accept_encoding=accept_encoding,
    ...
    def custom_object_record_by_id(
        ...
        raw_response = self.raw.custom_object_record_by_id(
            authorization=authorization,
            object=object,
            id=id,
            accept_encoding=accept_encoding,
