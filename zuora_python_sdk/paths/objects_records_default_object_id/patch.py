...
from zuora_python_sdk.model.custom_object_record_with_all_fields import CustomObjectRecordWithAllFields as CustomObjectRecordWithAllFieldsSchema
...
from zuora_python_sdk.type.custom_object_record_with_all_fields import CustomObjectRecordWithAllFields

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.custom_object_record_with_all_fields import CustomObjectRecordWithAllFields as CustomObjectRecordWithAllFieldsPydantic
...
# body param
SchemaForRequestBodyApplicationMergePatchjson = CustomObjectRecordWithOnlyCustomFieldsSchema


request_body_custom_object_record_with_only_custom_fields = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CustomObjectRecordWithAllFieldsSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomObjectRecordWithAllFields
...
SchemaFor404ResponseBodyApplicationJson = CommonResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _partial_update_custom_object_record_mapped_args(
        self,
        authorization: str,
        object: str,
        id: str,
    ...
    async def _apartial_update_custom_object_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_custom_object_record_with_only_custom_fields.serialize(body, content_type)
    ...
    def _partial_update_custom_object_record_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class PartialUpdateCustomObjectRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apartial_update_custom_object_record(
        self,
        authorization: str,
        object: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._partial_update_custom_object_record_mapped_args(
        ...
        return await self._apartial_update_custom_object_record_oapg(
            body=args.body,
    ...
    def partial_update_custom_object_record(
        self,
        authorization: str,
        object: str,
        id: str,
        ...
        return self._partial_update_custom_object_record_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PartialUpdateCustomObjectRecord(BaseApi):
    ...
    async def apartial_update_custom_object_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomObjectRecordWithAllFieldsPydantic:
        raw_response = await self.raw.apartial_update_custom_object_record(
            authorization=authorization,
            object=object,
            id=id,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return RootModel[CustomObjectRecordWithAllFieldsPydantic](raw_response.body).root
        return api_client.construct_model_instance(CustomObjectRecordWithAllFieldsPydantic, raw_response.body)
    ...
    def partial_update_custom_object_record(
        ...
        raw_response = self.raw.partial_update_custom_object_record(
            authorization=authorization,
            object=object,
            id=id,
            idempotency_key=idempotency_key,
