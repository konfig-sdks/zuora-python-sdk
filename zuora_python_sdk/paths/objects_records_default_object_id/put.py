...
# body param
SchemaForRequestBodyApplicationJson = CustomObjectRecordWithOnlyCustomFieldsSchema
...
class BaseApi(api_client.Api):
    ...
    def _custom_object_record_mapped_args(
        self,
        authorization: str,
        object: str,
        id: str,
    ...
    async def _acustom_object_record_oapg(
        self,
    ...
    def _custom_object_record_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CustomObjectRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_record(
        self,
        authorization: str,
        object: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._custom_object_record_mapped_args(
        ...
        return await self._acustom_object_record_oapg(
            body=args.body,
    ...
    def custom_object_record(
        ...
        return self._custom_object_record_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CustomObjectRecord(BaseApi):
    ...
    async def acustom_object_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acustom_object_record(
            authorization=authorization,
            object=object,
            id=id,
            accept_encoding=accept_encoding,
    ...
    def custom_object_record(
        ...
        raw_response = self.raw.custom_object_record(
            authorization=authorization,
            object=object,
            id=id,
            accept_encoding=accept_encoding,
