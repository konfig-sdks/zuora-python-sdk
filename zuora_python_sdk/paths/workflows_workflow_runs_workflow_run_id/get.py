...
from zuora_python_sdk.model.get_workflow_response import GetWorkflowResponse as GetWorkflowResponseSchema

from zuora_python_sdk.type.get_workflow_response import GetWorkflowResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_workflow_response import GetWorkflowResponse as GetWorkflowResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetWorkflowResponseSchema
    ...
    async def _aget_workflow_run_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workflows/workflow_runs/{workflow_run_id}',
            headers=_headers,
        )
...
class GetWorkflowRun(BaseApi):
    ...
    async def aget_workflow_run(
        ...
        **kwargs,
        ...
        if validate:
            return GetWorkflowResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetWorkflowResponsePydantic, raw_response.body)
