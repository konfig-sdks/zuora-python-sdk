...
class BaseApi(api_client.Api):
    ...
    def _order_activate_mapped_args(
        self,
        order_number: str,
    ...
    async def _aorder_activate_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/{orderNumber}/activate',
            headers=_headers,
        )
...
class OrderActivateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_activate(
        self,
        order_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_activate_mapped_args(
        ...
        return await self._aorder_activate_oapg(
    ...
    def order_activate(
        ...
        return self._order_activate_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class OrderActivate(BaseApi):
    ...
    async def aorder_activate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorder_activate(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def order_activate(
        ...
        raw_response = self.raw.order_activate(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
