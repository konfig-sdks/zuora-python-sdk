...
from zuora_python_sdk.model.post_upload_file_for_debit_memo_request import PostUploadFileForDebitMemoRequest as PostUploadFileForDebitMemoRequestSchema
...
from zuora_python_sdk.type.post_upload_file_for_debit_memo_request import PostUploadFileForDebitMemoRequest
...
from zuora_python_sdk.pydantic.post_upload_file_for_debit_memo_request import PostUploadFileForDebitMemoRequest as PostUploadFileForDebitMemoRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostUploadFileForDebitMemoRequestSchema


request_body_post_upload_file_for_debit_memo_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upload_file_for_debit_memo_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _aupload_file_for_debit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/files',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_post_upload_file_for_debit_memo_request.serialize(body, content_type)
    ...
    def _upload_file_for_debit_memo_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UploadFileForDebitMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_file_for_debit_memo(
        self,
        debit_memo_key: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._upload_file_for_debit_memo_mapped_args(
        ...
        return await self._aupload_file_for_debit_memo_oapg(
            body=args.body,
    ...
    def upload_file_for_debit_memo(
        ...
        return self._upload_file_for_debit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UploadFileForDebitMemo(BaseApi):
    ...
    async def aupload_file_for_debit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupload_file_for_debit_memo(
            debit_memo_key=debit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def upload_file_for_debit_memo(
        ...
        raw_response = self.raw.upload_file_for_debit_memo(
            debit_memo_key=debit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
