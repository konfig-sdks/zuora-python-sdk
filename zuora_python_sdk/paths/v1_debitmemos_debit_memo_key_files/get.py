...
from zuora_python_sdk.model.get_debit_memo_files_response import GETDebitMemoFilesResponse as GETDebitMemoFilesResponseSchema

from zuora_python_sdk.type.get_debit_memo_files_response import GETDebitMemoFilesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_files_response import GETDebitMemoFilesResponse as GETDebitMemoFilesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETDebitMemoFilesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETDebitMemoFilesResponse
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_files_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _adebit_memo_files_oapg(
        self,
...
class DebitMemoFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_files(
        self,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_files_mapped_args(
        ...
        return await self._adebit_memo_files_oapg(
    ...
    def debit_memo_files(
        ...
        return self._debit_memo_files_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoFiles(BaseApi):
    ...
    async def adebit_memo_files(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETDebitMemoFilesResponsePydantic:
        raw_response = await self.raw.adebit_memo_files(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETDebitMemoFilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETDebitMemoFilesResponsePydantic, raw_response.body)
    ...
    def debit_memo_files(
        ...
        raw_response = self.raw.debit_memo_files(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
