...
from zuora_python_sdk.model.delete_unresiger_apple_pay_domain_response import DELETEUnresigerApplePayDomainResponse as DELETEUnresigerApplePayDomainResponseSchema

from zuora_python_sdk.type.delete_unresiger_apple_pay_domain_response import DELETEUnresigerApplePayDomainResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.delete_unresiger_apple_pay_domain_response import DELETEUnresigerApplePayDomainResponse as DELETEUnresigerApplePayDomainResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DELETEUnresigerApplePayDomainResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DELETEUnresigerApplePayDomainResponse
...
class BaseApi(api_client.Api):
    ...
    def _unregister_apple_pay_domain_mapped_args(
        self,
        id: str,
    ...
    async def _aunregister_apple_pay_domain_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payment-methods/apple-pay/domains/{id}',
            headers=_headers,
        )
    ...
    def _unregister_apple_pay_domain_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UnregisterApplePayDomainRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunregister_apple_pay_domain(
        self,
        id: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._unregister_apple_pay_domain_mapped_args(
            id=id,
        ...
        return await self._aunregister_apple_pay_domain_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def unregister_apple_pay_domain(
        self,
        id: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._unregister_apple_pay_domain_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class UnregisterApplePayDomain(BaseApi):
    ...
    async def aunregister_apple_pay_domain(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DELETEUnresigerApplePayDomainResponsePydantic:
        raw_response = await self.raw.aunregister_apple_pay_domain(
            id=id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return DELETEUnresigerApplePayDomainResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DELETEUnresigerApplePayDomainResponsePydantic, raw_response.body)
    ...
    def unregister_apple_pay_domain(
        ...
        raw_response = self.raw.unregister_apple_pay_domain(
            id=id,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
