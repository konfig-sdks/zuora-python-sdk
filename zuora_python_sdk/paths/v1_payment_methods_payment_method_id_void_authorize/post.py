...
from zuora_python_sdk.model.post_void_authorize_response import POSTVoidAuthorizeResponse as POSTVoidAuthorizeResponseSchema
from zuora_python_sdk.model.post_void_authorize import POSTVoidAuthorize as POSTVoidAuthorizeSchema
from zuora_python_sdk.model.post_void_authorize_gateway_options import POSTVoidAuthorizeGatewayOptions as POSTVoidAuthorizeGatewayOptionsSchema

from zuora_python_sdk.type.post_void_authorize_response import POSTVoidAuthorizeResponse
from zuora_python_sdk.type.post_void_authorize import POSTVoidAuthorize
from zuora_python_sdk.type.post_void_authorize_gateway_options import POSTVoidAuthorizeGatewayOptions

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_void_authorize import POSTVoidAuthorize as POSTVoidAuthorizePydantic
from zuora_python_sdk.pydantic.post_void_authorize_gateway_options import POSTVoidAuthorizeGatewayOptions as POSTVoidAuthorizeGatewayOptionsPydantic
from zuora_python_sdk.pydantic.post_void_authorize_response import POSTVoidAuthorizeResponse as POSTVoidAuthorizeResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTVoidAuthorizeSchema


request_body_post_void_authorize = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTVoidAuthorizeResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTVoidAuthorizeResponse
...
class BaseApi(api_client.Api):
    ...
    def _cancel_authorization_mapped_args(
        ...
        gateway_options: typing.Optional[POSTVoidAuthorizeGatewayOptions] = None,
    ...
    async def _acancel_authorization_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/voidAuthorize',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_void_authorize.serialize(body, content_type)
...
class CancelAuthorization(BaseApi):
    ...
    async def acancel_authorization(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTVoidAuthorizeResponsePydantic:
        ...
        if validate:
            return POSTVoidAuthorizeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTVoidAuthorizeResponsePydantic, raw_response.body)
