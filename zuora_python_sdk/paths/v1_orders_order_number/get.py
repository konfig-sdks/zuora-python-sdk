...
from zuora_python_sdk.model.get_order_response import GetOrderResponse as GetOrderResponseSchema

from zuora_python_sdk.type.get_order_response import GetOrderResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_order_response import GetOrderResponse as GetOrderResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetOrderResponseSchema
...
class Order0Raw(BaseApi):
    ...
    async def aorder_0(
        ...
        **kwargs,
        ...
        args = self._order_0_mapped_args(
        ...
        return await self._aorder_0_oapg(
    ...
    def order_0(
        ...
        return self._order_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Order0(BaseApi):
    ...
    async def aorder_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOrderResponsePydantic:
        raw_response = await self.raw.aorder_0(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GetOrderResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetOrderResponsePydantic, raw_response.body)
