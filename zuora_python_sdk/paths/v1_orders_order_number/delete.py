...
class Order2Raw(BaseApi):
    ...
    async def aorder_2(
        ...
        **kwargs,
        ...
        args = self._order_2_mapped_args(
        ...
        return await self._aorder_2_oapg(
    ...
    def order_2(
        ...
        return self._order_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Order2(BaseApi):
    ...
    async def aorder_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorder_2(
            order_number=order_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
