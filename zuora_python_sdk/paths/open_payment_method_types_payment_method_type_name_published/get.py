...
from zuora_python_sdk.model.get_open_payment_method_type_publish_response import GetOpenPaymentMethodTypePublishResponse as GetOpenPaymentMethodTypePublishResponseSchema

from zuora_python_sdk.type.get_open_payment_method_type_publish_response import GetOpenPaymentMethodTypePublishResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_open_payment_method_type_publish_response import GetOpenPaymentMethodTypePublishResponse as GetOpenPaymentMethodTypePublishResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetOpenPaymentMethodTypePublishResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetOpenPaymentMethodTypePublishResponse
...
class BaseApi(api_client.Api):
    ...
    def _open_payment_method_type_publish_mapped_args(
        self,
        authorization: str,
    ...
    async def _aopen_payment_method_type_publish_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/open-payment-method-types/{paymentMethodTypeName}/published',
            headers=_headers,
        )
    ...
    def _open_payment_method_type_publish_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class OpenPaymentMethodTypePublishRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aopen_payment_method_type_publish(
        self,
        authorization: str,
        payment_method_type_name: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._open_payment_method_type_publish_mapped_args(
        ...
        return await self._aopen_payment_method_type_publish_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def open_payment_method_type_publish(
        self,
        authorization: str,
        payment_method_type_name: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._open_payment_method_type_publish_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class OpenPaymentMethodTypePublish(BaseApi):
    ...
    async def aopen_payment_method_type_publish(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOpenPaymentMethodTypePublishResponsePydantic:
        raw_response = await self.raw.aopen_payment_method_type_publish(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GetOpenPaymentMethodTypePublishResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetOpenPaymentMethodTypePublishResponsePydantic, raw_response.body)
    ...
    def open_payment_method_type_publish(
        ...
        raw_response = self.raw.open_payment_method_type_publish(
            authorization=authorization,
            payment_method_type_name=payment_method_type_name,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
