...
from zuora_python_sdk.model.proxy_modify_usage import ProxyModifyUsage as ProxyModifyUsageSchema
...
from zuora_python_sdk.type.proxy_modify_usage import ProxyModifyUsage
...
from zuora_python_sdk.pydantic.proxy_modify_usage import ProxyModifyUsage as ProxyModifyUsagePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyModifyUsageSchema


request_body_proxy_modify_usage = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _ap_ut_usage_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_modify_usage.serialize(body, content_type)
...
class PUtUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ut_usage(
        self,
        body: ProxyModifyUsage,
        id: str,
        end_date_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._p_ut_usage_mapped_args(
            body=body,
            id=id,
            end_date_time=end_date_time,
            quantity=quantity,
            rbe_status=rbe_status,
        ...
        return await self._ap_ut_usage_oapg(
            body=args.body,
...
class PUtUsage(BaseApi):
    ...
    async def ap_ut_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ut_usage(
            body=body,
            id=id,
            end_date_time=end_date_time,
            quantity=quantity,
    ...
    def p_ut_usage(
        ...
        raw_response = self.raw.p_ut_usage(
            body=body,
            id=id,
            end_date_time=end_date_time,
            quantity=quantity,
