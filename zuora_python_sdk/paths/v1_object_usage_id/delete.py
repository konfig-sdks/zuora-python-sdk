...
class BaseApi(api_client.Api):
    ...
    def _d_elete_usage_mapped_args(
        self,
        id: str,
    ...
    async def _ad_elete_usage_oapg(
        self,
...
class DEleteUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ad_elete_usage(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._d_elete_usage_mapped_args(
            id=id,
        ...
        return await self._ad_elete_usage_oapg(
    ...
    def d_elete_usage(
        ...
        return self._d_elete_usage_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DEleteUsage(BaseApi):
    ...
    async def ad_elete_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ad_elete_usage(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def d_elete_usage(
        ...
        raw_response = self.raw.d_elete_usage(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
