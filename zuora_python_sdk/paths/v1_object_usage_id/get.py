...
from zuora_python_sdk.model.proxy_get_usage import ProxyGetUsage as ProxyGetUsageSchema
...
from zuora_python_sdk.type.proxy_get_usage import ProxyGetUsage
...
from zuora_python_sdk.pydantic.proxy_get_usage import ProxyGetUsage as ProxyGetUsagePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetUsageSchema
...
class GEtUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ag_et_usage(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._g_et_usage_mapped_args(
            id=id,
        ...
        return await self._ag_et_usage_oapg(
    ...
    def g_et_usage(
        ...
        return self._g_et_usage_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GEtUsage(BaseApi):
    ...
    async def ag_et_usage(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetUsagePydantic:
        raw_response = await self.raw.ag_et_usage(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[ProxyGetUsagePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProxyGetUsagePydantic, raw_response.body)
    ...
    def g_et_usage(
        ...
        raw_response = self.raw.g_et_usage(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
