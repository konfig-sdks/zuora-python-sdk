...
from zuora_python_sdk.model.get_booking_date_backfill_job_by_id_response import GetBookingDateBackfillJobByIdResponse as GetBookingDateBackfillJobByIdResponseSchema

from zuora_python_sdk.type.get_booking_date_backfill_job_by_id_response import GetBookingDateBackfillJobByIdResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_booking_date_backfill_job_by_id_response import GetBookingDateBackfillJobByIdResponse as GetBookingDateBackfillJobByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetBookingDateBackfillJobByIdResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetBookingDateBackfillJobByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _booking_date_backfill_job_by_id_mapped_args(
        self,
        authorization: str,
        job_id: str,
    ...
    async def _abooking_date_backfill_job_by_id_oapg(
        self,
    ...
    def _booking_date_backfill_job_by_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BookingDateBackfillJobByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abooking_date_backfill_job_by_id(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._booking_date_backfill_job_by_id_mapped_args(
        ...
        return await self._abooking_date_backfill_job_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def booking_date_backfill_job_by_id(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._booking_date_backfill_job_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BookingDateBackfillJobById(BaseApi):
    ...
    async def abooking_date_backfill_job_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetBookingDateBackfillJobByIdResponsePydantic:
        raw_response = await self.raw.abooking_date_backfill_job_by_id(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GetBookingDateBackfillJobByIdResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetBookingDateBackfillJobByIdResponsePydantic, raw_response.body)
    ...
    def booking_date_backfill_job_by_id(
        ...
        raw_response = self.raw.booking_date_backfill_job_by_id(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
