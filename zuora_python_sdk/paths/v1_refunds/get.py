...
from zuora_python_sdk.model.get_refund_collection_type import GETRefundCollectionType as GETRefundCollectionTypeSchema

from zuora_python_sdk.type.get_refund_collection_type import GETRefundCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_refund_collection_type import GETRefundCollectionType as GETRefundCollectionTypePydantic
...
RefundDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'methodType': typing.Union[MethodTypeSchema, str, ],
        'number': typing.Union[NumberSchema, str, ],
        'paymentId': typing.Union[PaymentIdSchema, str, ],
        'refundDate': typing.Union[RefundDateSchema, str, date, ],
...
request_query_method_type = api_client.QueryParameter(
    name="methodType",
    style=api_client.ParameterStyle.FORM,
    schema=MethodTypeSchema,
    explode=True,
)
...
request_query_refund_date = api_client.QueryParameter(
    name="refundDate",
    style=api_client.ParameterStyle.FORM,
    schema=RefundDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GETRefundCollectionTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _refunds_mapped_args(
        ...
        if method_type is not None:
            _query_params["methodType"] = method_type
        if number is not None:
            _query_params["number"] = number
        if payment_id is not None:
            _query_params["paymentId"] = payment_id
        if refund_date is not None:
            _query_params["refundDate"] = refund_date
    ...
    async def _arefunds_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_method_type,
            request_query_number,
            request_query_payment_id,
            request_query_refund_date,
...
class RefundsRaw(BaseApi):
    ...
    async def arefunds(
        ...
        **kwargs,
        ...
        args = self._refunds_mapped_args(
        ...
        return await self._arefunds_oapg(
    ...
    def refunds(
        ...
        return self._refunds_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class Refunds(BaseApi):
    ...
    async def arefunds(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundCollectionTypePydantic:
        raw_response = await self.raw.arefunds(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETRefundCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETRefundCollectionTypePydantic, raw_response.body)
