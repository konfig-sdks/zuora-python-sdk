...
from zuora_python_sdk.model.debit_memo_from_charge_detail_type import DebitMemoFromChargeDetailType as DebitMemoFromChargeDetailTypeSchema
from zuora_python_sdk.model.debit_memo_from_charge_request import DebitMemoFromChargeRequest as DebitMemoFromChargeRequestSchema
from zuora_python_sdk.model.get_debit_memo_type import GETDebitMemoType as GETDebitMemoTypeSchema
from zuora_python_sdk.model.debit_memo_from_charge_custom_rates_type import DebitMemoFromChargeCustomRatesType as DebitMemoFromChargeCustomRatesTypeSchema

from zuora_python_sdk.type.debit_memo_from_charge_request import DebitMemoFromChargeRequest
from zuora_python_sdk.type.get_debit_memo_type import GETDebitMemoType
from zuora_python_sdk.type.debit_memo_from_charge_detail_type import DebitMemoFromChargeDetailType
from zuora_python_sdk.type.debit_memo_from_charge_custom_rates_type import DebitMemoFromChargeCustomRatesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_type import GETDebitMemoType as GETDebitMemoTypePydantic
from zuora_python_sdk.pydantic.debit_memo_from_charge_custom_rates_type import DebitMemoFromChargeCustomRatesType as DebitMemoFromChargeCustomRatesTypePydantic
from zuora_python_sdk.pydantic.debit_memo_from_charge_detail_type import DebitMemoFromChargeDetailType as DebitMemoFromChargeDetailTypePydantic
from zuora_python_sdk.pydantic.debit_memo_from_charge_request import DebitMemoFromChargeRequest as DebitMemoFromChargeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DebitMemoFromChargeRequestSchema


request_body_debit_memo_from_charge_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETDebitMemoTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_from_prpc_mapped_args(
        self,
        body: DebitMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        auto_pay: typing.Optional[bool] = None,
        auto_post: typing.Optional[bool] = None,
        charges: typing.Optional[typing.List[DebitMemoFromChargeDetailType]] = None,
        comment: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        custom_rates: typing.Optional[typing.List[DebitMemoFromChargeCustomRatesType]] = None,
    ...
    async def _adebit_memo_from_prpc_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_debit_memo_from_charge_request.serialize(body, content_type)
    ...
    def _debit_memo_from_prpc_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DebitMemoFromPrpcRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_from_prpc(
        self,
        body: DebitMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_from_prpc_mapped_args(
            body=body,
        ...
        return await self._adebit_memo_from_prpc_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def debit_memo_from_prpc(
        self,
        body: DebitMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        return self._debit_memo_from_prpc_oapg(
            body=args.body,
            header_params=args.header,
        )

class DebitMemoFromPrpc(BaseApi):
    ...
    async def adebit_memo_from_prpc(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETDebitMemoTypePydantic:
        raw_response = await self.raw.adebit_memo_from_prpc(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_pay=auto_pay,
        ...
        if validate:
            return RootModel[GETDebitMemoTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETDebitMemoTypePydantic, raw_response.body)
    ...
    def debit_memo_from_prpc(
        ...
        raw_response = self.raw.debit_memo_from_prpc(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_pay=auto_pay,
