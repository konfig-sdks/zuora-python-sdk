...
from zuora_python_sdk.model.batch_debit_memo_type import BatchDebitMemoType as BatchDebitMemoTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.put_batch_debit_memos_request import PUTBatchDebitMemosRequest as PUTBatchDebitMemosRequestSchema

from zuora_python_sdk.type.batch_debit_memo_type import BatchDebitMemoType
from zuora_python_sdk.type.put_batch_debit_memos_request import PUTBatchDebitMemosRequest
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.batch_debit_memo_type import BatchDebitMemoType as BatchDebitMemoTypePydantic
from zuora_python_sdk.pydantic.put_batch_debit_memos_request import PUTBatchDebitMemosRequest as PUTBatchDebitMemosRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTBatchDebitMemosRequestSchema


request_body_put_batch_debit_memos_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_debit_memos_due_dates_mapped_args(
        self,
        debit_memos: typing.Optional[typing.List[BatchDebitMemoType]] = None,
    ...
    async def _aupdate_debit_memos_due_dates_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_batch_debit_memos_request.serialize(body, content_type)
    ...
    def _update_debit_memos_due_dates_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDebitMemosDueDatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_debit_memos_due_dates(
        self,
        debit_memos: typing.Optional[typing.List[BatchDebitMemoType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_debit_memos_due_dates_mapped_args(
        ...
        return await self._aupdate_debit_memos_due_dates_oapg(
            body=args.body,
    ...
    def update_debit_memos_due_dates(
        ...
        return self._update_debit_memos_due_dates_oapg(
            body=args.body,
            header_params=args.header,
        )

class UpdateDebitMemosDueDates(BaseApi):
    ...
    async def aupdate_debit_memos_due_dates(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_debit_memos_due_dates(
            debit_memos=debit_memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def update_debit_memos_due_dates(
        ...
        raw_response = self.raw.update_debit_memos_due_dates(
            debit_memos=debit_memos,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
