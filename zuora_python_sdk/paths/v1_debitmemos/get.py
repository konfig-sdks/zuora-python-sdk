...
from zuora_python_sdk.model.get_debit_memo_collection_type import GETDebitMemoCollectionType as GETDebitMemoCollectionTypeSchema

from zuora_python_sdk.type.get_debit_memo_collection_type import GETDebitMemoCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_collection_type import GETDebitMemoCollectionType as GETDebitMemoCollectionTypePydantic
...
BalanceSchema = schemas.Float64Schema
BeAppliedAmountSchema = schemas.Float64Schema
CreatedByIdSchema = schemas.StrSchema
CreatedDateSchema = schemas.DateTimeSchema
CurrencySchema = schemas.StrSchema
DebitMemoDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'balance': typing.Union[BalanceSchema, decimal.Decimal, int, float, ],
        'beAppliedAmount': typing.Union[BeAppliedAmountSchema, decimal.Decimal, int, float, ],
        ...
        'debitMemoDate': typing.Union[DebitMemoDateSchema, str, date, ],
...
request_query_be_applied_amount = api_client.QueryParameter(
    name="beAppliedAmount",
    style=api_client.ParameterStyle.FORM,
    schema=BeAppliedAmountSchema,
    explode=True,
)
...
request_query_debit_memo_date = api_client.QueryParameter(
    name="debitMemoDate",
    style=api_client.ParameterStyle.FORM,
    schema=DebitMemoDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GETDebitMemoCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETDebitMemoCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _debit_memos_mapped_args(
        ...
        balance: typing.Optional[typing.Union[int, float]] = None,
        be_applied_amount: typing.Optional[typing.Union[int, float]] = None,
        created_by_id: typing.Optional[str] = None,
        created_date: typing.Optional[datetime] = None,
        currency: typing.Optional[str] = None,
        debit_memo_date: typing.Optional[date] = None,
        ...
        if balance is not None:
            _query_params["balance"] = balance
        if be_applied_amount is not None:
            _query_params["beAppliedAmount"] = be_applied_amount
        ...
        if debit_memo_date is not None:
            _query_params["debitMemoDate"] = debit_memo_date
...
class DebitMemosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memos(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memos_mapped_args(
        ...
        return await self._adebit_memos_oapg(
    ...
    def debit_memos(
        ...
        return self._debit_memos_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DebitMemos(BaseApi):
    ...
    async def adebit_memos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETDebitMemoCollectionTypePydantic:
        raw_response = await self.raw.adebit_memos(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETDebitMemoCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETDebitMemoCollectionTypePydantic, raw_response.body)
    ...
    def debit_memos(
        ...
        raw_response = self.raw.debit_memos(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
