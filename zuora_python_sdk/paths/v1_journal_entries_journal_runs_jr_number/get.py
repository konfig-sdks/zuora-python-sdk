...
from zuora_python_sdk.model.get_journal_entries_in_journal_run_type import GETJournalEntriesInJournalRunType as GETJournalEntriesInJournalRunTypeSchema

from zuora_python_sdk.type.get_journal_entries_in_journal_run_type import GETJournalEntriesInJournalRunType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_journal_entries_in_journal_run_type import GETJournalEntriesInJournalRunType as GETJournalEntriesInJournalRunTypePydantic
...
# Path params
JrNumberSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'jr-number': typing.Union[JrNumberSchema, str, ],
    }
)
...
request_path_jr_number = api_client.PathParameter(
    name="jr-number",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JrNumberSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETJournalEntriesInJournalRunTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETJournalEntriesInJournalRunType
...
class BaseApi(api_client.Api):
    ...
    def _all_summary_journal_entries_mapped_args(
        self,
        jr_number: str,
    ...
    async def _aall_summary_journal_entries_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-entries/journal-runs/{jr-number}',
            headers=_headers,
        )
    ...
    def _all_summary_journal_entries_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AllSummaryJournalEntriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_summary_journal_entries(
        self,
        jr_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_summary_journal_entries_mapped_args(
            jr_number=jr_number,
        ...
        return await self._aall_summary_journal_entries_oapg(
    ...
    def all_summary_journal_entries(
        self,
        jr_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._all_summary_journal_entries_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class AllSummaryJournalEntries(BaseApi):
    ...
    async def aall_summary_journal_entries(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETJournalEntriesInJournalRunTypePydantic:
        raw_response = await self.raw.aall_summary_journal_entries(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETJournalEntriesInJournalRunTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETJournalEntriesInJournalRunTypePydantic, raw_response.body)
    ...
    def all_summary_journal_entries(
        ...
        raw_response = self.raw.all_summary_journal_entries(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
