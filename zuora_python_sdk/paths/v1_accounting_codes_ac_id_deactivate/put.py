...
class BaseApi(api_client.Api):
    ...
    def _deactivate_accounting_code_mapped_args(
        self,
        ac_id: str,
    ...
    async def _adeactivate_accounting_code_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-codes/{ac-id}/deactivate',
            headers=_headers,
        )
    ...
    def _deactivate_accounting_code_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeactivateAccountingCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_accounting_code(
        self,
        ac_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._deactivate_accounting_code_mapped_args(
            ac_id=ac_id,
        ...
        return await self._adeactivate_accounting_code_oapg(
    ...
    def deactivate_accounting_code(
        ...
        return self._deactivate_accounting_code_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeactivateAccountingCode(BaseApi):
    ...
    async def adeactivate_accounting_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeactivate_accounting_code(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def deactivate_accounting_code(
        ...
        raw_response = self.raw.deactivate_accounting_code(
            ac_id=ac_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
