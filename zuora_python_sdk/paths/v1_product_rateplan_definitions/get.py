...
from zuora_python_sdk.model.get_product_rate_plan_definitions_response import GETProductRatePlanDefinitionsResponse as GETProductRatePlanDefinitionsResponseSchema

from zuora_python_sdk.type.get_product_rate_plan_definitions_response import GETProductRatePlanDefinitionsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plan_definitions_response import GETProductRatePlanDefinitionsResponse as GETProductRatePlanDefinitionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlanDefinitionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlanDefinitionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_product_rate_plan_definitions_mapped_args(
        self,
    ...
    async def _aretrieve_product_rate_plan_definitions_oapg(
        self,
    ...
    def _retrieve_product_rate_plan_definitions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetrieveProductRatePlanDefinitionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_product_rate_plan_definitions(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_product_rate_plan_definitions_mapped_args(
        ...
        return await self._aretrieve_product_rate_plan_definitions_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def retrieve_product_rate_plan_definitions(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._retrieve_product_rate_plan_definitions_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class RetrieveProductRatePlanDefinitions(BaseApi):
    ...
    async def aretrieve_product_rate_plan_definitions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlanDefinitionsResponsePydantic:
        raw_response = await self.raw.aretrieve_product_rate_plan_definitions(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETProductRatePlanDefinitionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductRatePlanDefinitionsResponsePydantic, raw_response.body)
    ...
    def retrieve_product_rate_plan_definitions(
        ...
        raw_response = self.raw.retrieve_product_rate_plan_definitions(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
