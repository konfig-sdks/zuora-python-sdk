...
from zuora_python_sdk.model.post_rate_plan_definition_response import POSTRatePlanDefinitionResponse as POSTRatePlanDefinitionResponseSchema
from zuora_python_sdk.model.post_rate_plan_definition_request import POSTRatePlanDefinitionRequest as POSTRatePlanDefinitionRequestSchema

from zuora_python_sdk.type.post_rate_plan_definition_request import POSTRatePlanDefinitionRequest
from zuora_python_sdk.type.post_rate_plan_definition_response import POSTRatePlanDefinitionResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_rate_plan_definition_request import POSTRatePlanDefinitionRequest as POSTRatePlanDefinitionRequestPydantic
from zuora_python_sdk.pydantic.post_rate_plan_definition_response import POSTRatePlanDefinitionResponse as POSTRatePlanDefinitionResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTRatePlanDefinitionRequestSchema


request_body_post_rate_plan_definition_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTRatePlanDefinitionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTRatePlanDefinitionResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_product_rate_plan_definition_mapped_args(
        self,
    ...
    async def _acreate_product_rate_plan_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/product-rateplan-definitions',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_rate_plan_definition_request.serialize(body, content_type)
    ...
    def _create_product_rate_plan_definition_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateProductRatePlanDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_product_rate_plan_definition(
        self,
        product_rate_plan_charge_id: typing.Optional[str] = None,
        product_rate_plan_charge_number: typing.Optional[str] = None,
        product_rate_plan_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_product_rate_plan_definition_mapped_args(
        ...
        return await self._acreate_product_rate_plan_definition_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_product_rate_plan_definition(
        self,
        product_rate_plan_charge_id: typing.Optional[str] = None,
        product_rate_plan_charge_number: typing.Optional[str] = None,
        product_rate_plan_id: typing.Optional[str] = None,
        ...
        return self._create_product_rate_plan_definition_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateProductRatePlanDefinition(BaseApi):
    ...
    async def acreate_product_rate_plan_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTRatePlanDefinitionResponsePydantic:
        raw_response = await self.raw.acreate_product_rate_plan_definition(
            product_rate_plan_charge_id=product_rate_plan_charge_id,
            product_rate_plan_charge_number=product_rate_plan_charge_number,
            product_rate_plan_id=product_rate_plan_id,
            product_rate_plan_number=product_rate_plan_number,
        ...
        if validate:
            return POSTRatePlanDefinitionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTRatePlanDefinitionResponsePydantic, raw_response.body)
    ...
    def create_product_rate_plan_definition(
        ...
        raw_response = self.raw.create_product_rate_plan_definition(
            product_rate_plan_charge_id=product_rate_plan_charge_id,
            product_rate_plan_charge_number=product_rate_plan_charge_number,
            product_rate_plan_id=product_rate_plan_id,
            product_rate_plan_number=product_rate_plan_number,
