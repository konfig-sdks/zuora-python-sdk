...
class BaseApi(api_client.Api):
    ...
    def _post_debit_memo_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _apost_debit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/post',
            headers=_headers,
        )
...
class PostDebitMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apost_debit_memo(
        self,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._post_debit_memo_mapped_args(
        ...
        return await self._apost_debit_memo_oapg(
    ...
    def post_debit_memo(
        ...
        return self._post_debit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PostDebitMemo(BaseApi):
    ...
    async def apost_debit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apost_debit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def post_debit_memo(
        ...
        raw_response = self.raw.post_debit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
