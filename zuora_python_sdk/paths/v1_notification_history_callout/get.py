...
from zuora_python_sdk.model.get_callout_history_vos_type import GETCalloutHistoryVOsType as GETCalloutHistoryVOsTypeSchema

from zuora_python_sdk.type.get_callout_history_vos_type import GETCalloutHistoryVOsType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_callout_history_vos_type import GETCalloutHistoryVOsType as GETCalloutHistoryVOsTypePydantic
...
FailedOnlySchema = schemas.BoolSchema
EventCategorySchema = schemas.StrSchema
IncludeResponseContentSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'failedOnly': typing.Union[FailedOnlySchema, bool, ],
        'eventCategory': typing.Union[EventCategorySchema, str, ],
        'includeResponseContent': typing.Union[IncludeResponseContentSchema, bool, ],
    },
    total=False
)
...
request_query_object_id = api_client.QueryParameter(
    name="objectId",
    style=api_client.ParameterStyle.FORM,
    schema=ObjectIdSchema,
    explode=True,
)
request_query_failed_only = api_client.QueryParameter(
    name="failedOnly",
    style=api_client.ParameterStyle.FORM,
    schema=FailedOnlySchema,
    explode=True,
)
...
request_query_include_response_content = api_client.QueryParameter(
    name="includeResponseContent",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeResponseContentSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GETCalloutHistoryVOsTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _callout_history_mapped_args(
        self,
        ...
        failed_only: typing.Optional[bool] = None,
        event_category: typing.Optional[str] = None,
        include_response_content: typing.Optional[bool] = None,
        ...
        if object_id is not None:
            _query_params["objectId"] = object_id
        if failed_only is not None:
            _query_params["failedOnly"] = failed_only
        if event_category is not None:
            _query_params["eventCategory"] = event_category
        if include_response_content is not None:
            _query_params["includeResponseContent"] = include_response_content
    ...
    async def _acallout_history_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_object_id,
            request_query_failed_only,
            request_query_event_category,
            request_query_include_response_content,
        ):
...
class CalloutHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acallout_history(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._callout_history_mapped_args(
        ...
        return await self._acallout_history_oapg(
    ...
    def callout_history(
        ...
        return self._callout_history_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class CalloutHistory(BaseApi):
    ...
    async def acallout_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCalloutHistoryVOsTypePydantic:
        raw_response = await self.raw.acallout_history(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETCalloutHistoryVOsTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCalloutHistoryVOsTypePydantic, raw_response.body)
    ...
    def callout_history(
        ...
        raw_response = self.raw.callout_history(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
