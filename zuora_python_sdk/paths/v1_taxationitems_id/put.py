...
from zuora_python_sdk.model.get_taxation_item_type import GETTaxationItemType as GETTaxationItemTypeSchema
from zuora_python_sdk.model.put_taxation_item_type import PUTTaxationItemType as PUTTaxationItemTypeSchema

from zuora_python_sdk.type.put_taxation_item_type import PUTTaxationItemType
from zuora_python_sdk.type.get_taxation_item_type import GETTaxationItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_taxation_item_type import GETTaxationItemType as GETTaxationItemTypePydantic
from zuora_python_sdk.pydantic.put_taxation_item_type import PUTTaxationItemType as PUTTaxationItemTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTTaxationItemTypeSchema


request_body_put_taxation_item_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETTaxationItemTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _taxation_item_0_mapped_args(
        self,
        body: PUTTaxationItemType,
        id: str,
        exempt_amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        location_code: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tax_amount: typing.Optional[typing.Union[int, float]] = None,
        tax_code: typing.Optional[str] = None,
        tax_code_description: typing.Optional[str] = None,
        tax_date: typing.Optional[date] = None,
        tax_rate: typing.Optional[typing.Union[int, float]] = None,
        tax_rate_description: typing.Optional[str] = None,
        tax_rate_type: typing.Optional[str] = None,
        ...
        if exempt_amount is not None:
            _body["exemptAmount"] = exempt_amount
        if finance_information is not None:
            _body["financeInformation"] = finance_information
        if jurisdiction is not None:
            _body["jurisdiction"] = jurisdiction
        if location_code is not None:
            _body["locationCode"] = location_code
        if name is not None:
            _body["name"] = name
        ...
        if tax_code_description is not None:
            _body["taxCodeDescription"] = tax_code_description
        if tax_date is not None:
            _body["taxDate"] = tax_date
        if tax_rate is not None:
            _body["taxRate"] = tax_rate
        if tax_rate_description is not None:
            _body["taxRateDescription"] = tax_rate_description
        if tax_rate_type is not None:
            _body["taxRateType"] = tax_rate_type
    ...
    async def _ataxation_item_0_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_taxation_item_type.serialize(body, content_type)
...
class TaxationItem0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_item_0(
        self,
        body: PUTTaxationItemType,
        id: str,
        exempt_amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_item_0_mapped_args(
            body=body,
            id=id,
        ...
        return await self._ataxation_item_0_oapg(
            body=args.body,
    ...
    def taxation_item_0(
        ...
        return self._taxation_item_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItem0(BaseApi):
    ...
    async def ataxation_item_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETTaxationItemTypePydantic:
        raw_response = await self.raw.ataxation_item_0(
            body=body,
            id=id,
            exempt_amount=exempt_amount,
            finance_information=finance_information,
        ...
        if validate:
            return RootModel[GETTaxationItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETTaxationItemTypePydantic, raw_response.body)
    ...
    def taxation_item_0(
        ...
        raw_response = self.raw.taxation_item_0(
            body=body,
            id=id,
            exempt_amount=exempt_amount,
            finance_information=finance_information,
