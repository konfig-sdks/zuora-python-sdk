...
class BaseApi(api_client.Api):
    ...
    def _taxation_item_1_mapped_args(
        self,
        id: str,
    ...
    async def _ataxation_item_1_oapg(
        self,
...
class TaxationItem1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_item_1(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_item_1_mapped_args(
            id=id,
        ...
        return await self._ataxation_item_1_oapg(
    ...
    def taxation_item_1(
        ...
        return self._taxation_item_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItem1(BaseApi):
    ...
    async def ataxation_item_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ataxation_item_1(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def taxation_item_1(
        ...
        raw_response = self.raw.taxation_item_1(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
