...
class BaseApi(api_client.Api):
    ...
    def _taxation_item_mapped_args(
        self,
        id: str,
    ...
    async def _ataxation_item_oapg(
        self,
...
class TaxationItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_item(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_item_mapped_args(
            id=id,
        ...
        return await self._ataxation_item_oapg(
    ...
    def taxation_item(
        ...
        return self._taxation_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItem(BaseApi):
    ...
    async def ataxation_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ataxation_item(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def taxation_item(
        ...
        raw_response = self.raw.taxation_item(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
