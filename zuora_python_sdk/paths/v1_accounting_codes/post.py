...
from zuora_python_sdk.model.post_accounting_code_type import POSTAccountingCodeType as POSTAccountingCodeTypeSchema
from zuora_python_sdk.model.post_accounting_code_response_type import POSTAccountingCodeResponseType as POSTAccountingCodeResponseTypeSchema

from zuora_python_sdk.type.post_accounting_code_response_type import POSTAccountingCodeResponseType
from zuora_python_sdk.type.post_accounting_code_type import POSTAccountingCodeType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_accounting_code_response_type import POSTAccountingCodeResponseType as POSTAccountingCodeResponseTypePydantic
from zuora_python_sdk.pydantic.post_accounting_code_type import POSTAccountingCodeType as POSTAccountingCodeTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTAccountingCodeTypeSchema


request_body_post_accounting_code_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTAccountingCodeResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTAccountingCodeResponseType
...
class BaseApi(api_client.Api):
    ...
    def _accounting_code_mapped_args(
        self,
        body: POSTAccountingCodeType,
        gl_account_name: typing.Optional[str] = None,
        gl_account_number: typing.Optional[str] = None,
        ...
        if gl_account_name is not None:
            _body["glAccountName"] = gl_account_name
        if gl_account_number is not None:
            _body["glAccountNumber"] = gl_account_number
        if name is not None:
            _body["name"] = name
    ...
    async def _aaccounting_code_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_accounting_code_type.serialize(body, content_type)
...
class AccountingCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_code(
        self,
        body: POSTAccountingCodeType,
        gl_account_name: typing.Optional[str] = None,
        gl_account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_code_mapped_args(
            body=body,
        ...
        return await self._aaccounting_code_oapg(
            body=args.body,
    ...
    def accounting_code(
        ...
        return self._accounting_code_oapg(
            body=args.body,
            header_params=args.header,
        )

class AccountingCode(BaseApi):
    ...
    async def aaccounting_code(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTAccountingCodeResponseTypePydantic:
        raw_response = await self.raw.aaccounting_code(
            body=body,
            gl_account_name=gl_account_name,
            gl_account_number=gl_account_number,
            name=name,
        ...
        if validate:
            return POSTAccountingCodeResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTAccountingCodeResponseTypePydantic, raw_response.body)
    ...
    def accounting_code(
        ...
        raw_response = self.raw.accounting_code(
            body=body,
            gl_account_name=gl_account_name,
            gl_account_number=gl_account_number,
            name=name,
