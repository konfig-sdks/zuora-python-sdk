...
from zuora_python_sdk.model.get_accounting_codes_type import GETAccountingCodesType as GETAccountingCodesTypeSchema

from zuora_python_sdk.type.get_accounting_codes_type import GETAccountingCodesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_accounting_codes_type import GETAccountingCodesType as GETAccountingCodesTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAccountingCodesTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _all_accounting_codes_mapped_args(
        self,
    ...
    async def _aall_accounting_codes_oapg(
        self,
    ...
    def _all_accounting_codes_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AllAccountingCodesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_accounting_codes(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_accounting_codes_mapped_args(
        ...
        return await self._aall_accounting_codes_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def all_accounting_codes(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._all_accounting_codes_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class AllAccountingCodes(BaseApi):
    ...
    async def aall_accounting_codes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountingCodesTypePydantic:
        raw_response = await self.raw.aall_accounting_codes(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETAccountingCodesTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAccountingCodesTypePydantic, raw_response.body)
    ...
    def all_accounting_codes(
        ...
        raw_response = self.raw.all_accounting_codes(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
