...
from zuora_python_sdk.model.options import Options as OptionsSchema
from zuora_python_sdk.model.subscription_data import SubscriptionData as SubscriptionDataSchema
from zuora_python_sdk.model.payment_data import PaymentData as PaymentDataSchema
from zuora_python_sdk.model.account_data import AccountData as AccountDataSchema
from zuora_python_sdk.model.sign_up_response import SignUpResponse as SignUpResponseSchema
from zuora_python_sdk.model.sign_up_request import SignUpRequest as SignUpRequestSchema
from zuora_python_sdk.model.custom_fields import CustomFields as CustomFieldsSchema

from zuora_python_sdk.type.custom_fields import CustomFields
from zuora_python_sdk.type.sign_up_response import SignUpResponse
from zuora_python_sdk.type.options import Options
from zuora_python_sdk.type.subscription_data import SubscriptionData
from zuora_python_sdk.type.account_data import AccountData
from zuora_python_sdk.type.sign_up_request import SignUpRequest
from zuora_python_sdk.type.payment_data import PaymentData

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.sign_up_response import SignUpResponse as SignUpResponsePydantic
from zuora_python_sdk.pydantic.payment_data import PaymentData as PaymentDataPydantic
from zuora_python_sdk.pydantic.custom_fields import CustomFields as CustomFieldsPydantic
from zuora_python_sdk.pydantic.sign_up_request import SignUpRequest as SignUpRequestPydantic
from zuora_python_sdk.pydantic.options import Options as OptionsPydantic
from zuora_python_sdk.pydantic.account_data import AccountData as AccountDataPydantic
from zuora_python_sdk.pydantic.subscription_data import SubscriptionData as SubscriptionDataPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SignUpRequestSchema


request_body_sign_up_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SignUpResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _sign_up_mapped_args(
        self,
        authorization: str,
        account_data: typing.Optional[AccountData] = None,
        account_identifier_field: typing.Optional[str] = None,
        custom_fields: typing.Optional[CustomFields] = None,
        options: typing.Optional[Options] = None,
        payment_data: typing.Optional[PaymentData] = None,
        subscription_data: typing.Optional[SubscriptionData] = None,
        ...
        if account_data is not None:
            _body["accountData"] = account_data
        if account_identifier_field is not None:
            _body["accountIdentifierField"] = account_identifier_field
        if custom_fields is not None:
            _body["customFields"] = custom_fields
        if options is not None:
            _body["options"] = options
        if payment_data is not None:
            _body["paymentData"] = payment_data
        if subscription_data is not None:
            _body["subscriptionData"] = subscription_data
        args.body = _body
    ...
    async def _asign_up_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/sign-up',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_sign_up_request.serialize(body, content_type)
...
class SignUpRaw(BaseApi):
    ...
    async def asign_up(
        ...
        **kwargs,
        ...
        args = self._sign_up_mapped_args(
            authorization=authorization,
            account_data=account_data,
            account_identifier_field=account_identifier_field,
        ...
        return await self._asign_up_oapg(
            body=args.body,
...
class SignUp(BaseApi):
    ...
    async def asign_up(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SignUpResponsePydantic:
        raw_response = await self.raw.asign_up(
            authorization=authorization,
            account_data=account_data,
            account_identifier_field=account_identifier_field,
            custom_fields=custom_fields,
        ...
        if validate:
            return SignUpResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SignUpResponsePydantic, raw_response.body)
