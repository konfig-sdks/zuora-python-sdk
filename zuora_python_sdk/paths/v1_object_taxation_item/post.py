...
from zuora_python_sdk.model.proxy_create_taxation_item import ProxyCreateTaxationItem as ProxyCreateTaxationItemSchema
...
from zuora_python_sdk.type.proxy_create_taxation_item import ProxyCreateTaxationItem

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.proxy_create_taxation_item import ProxyCreateTaxationItem as ProxyCreateTaxationItemPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyCreateTaxationItemSchema


request_body_proxy_create_taxation_item = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_taxation_item_mapped_args(
        self,
        body: ProxyCreateTaxationItem,
        ...
        if invoice_item_id is not None:
            _body["InvoiceItemId"] = invoice_item_id
    ...
    async def _ap_ost_taxation_item_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_create_taxation_item.serialize(body, content_type)
...
class POstTaxationItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_taxation_item(
        self,
        body: ProxyCreateTaxationItem,
        accounting_code: typing.Optional[str] = None,
        exempt_amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._p_ost_taxation_item_mapped_args(
            body=body,
        ...
        return await self._ap_ost_taxation_item_oapg(
            body=args.body,
    ...
    def p_ost_taxation_item(
        ...
        return self._p_ost_taxation_item_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstTaxationItem(BaseApi):
    ...
    async def ap_ost_taxation_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ost_taxation_item(
            body=body,
            accounting_code=accounting_code,
            exempt_amount=exempt_amount,
            invoice_item_id=invoice_item_id,
    ...
    def p_ost_taxation_item(
        ...
        raw_response = self.raw.p_ost_taxation_item(
            body=body,
            accounting_code=accounting_code,
            exempt_amount=exempt_amount,
            invoice_item_id=invoice_item_id,
