...
from zuora_python_sdk.model.post_subscription_preview_type_preview_account_info import POSTSubscriptionPreviewTypePreviewAccountInfo as POSTSubscriptionPreviewTypePreviewAccountInfoSchema
from zuora_python_sdk.model.post_subscription_preview_type import POSTSubscriptionPreviewType as POSTSubscriptionPreviewTypeSchema
from zuora_python_sdk.model.post_subscription_preview_response_type import POSTSubscriptionPreviewResponseType as POSTSubscriptionPreviewResponseTypeSchema
from zuora_python_sdk.model.post_srp_create_type import POSTSrpCreateType as POSTSrpCreateTypeSchema

from zuora_python_sdk.type.post_subscription_preview_type_preview_account_info import POSTSubscriptionPreviewTypePreviewAccountInfo
from zuora_python_sdk.type.post_subscription_preview_type import POSTSubscriptionPreviewType
from zuora_python_sdk.type.post_srp_create_type import POSTSrpCreateType
from zuora_python_sdk.type.post_subscription_preview_response_type import POSTSubscriptionPreviewResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_subscription_preview_response_type import POSTSubscriptionPreviewResponseType as POSTSubscriptionPreviewResponseTypePydantic
from zuora_python_sdk.pydantic.post_subscription_preview_type_preview_account_info import POSTSubscriptionPreviewTypePreviewAccountInfo as POSTSubscriptionPreviewTypePreviewAccountInfoPydantic
from zuora_python_sdk.pydantic.post_srp_create_type import POSTSrpCreateType as POSTSrpCreateTypePydantic
from zuora_python_sdk.pydantic.post_subscription_preview_type import POSTSubscriptionPreviewType as POSTSubscriptionPreviewTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTSubscriptionPreviewTypeSchema


request_body_post_subscription_preview_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTSubscriptionPreviewResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTSubscriptionPreviewResponseType
...
class BaseApi(api_client.Api):
    ...
    def _preview_subscription_mapped_args(
        self,
        body: POSTSubscriptionPreviewType,
        ...
        preview_account_info: typing.Optional[POSTSubscriptionPreviewTypePreviewAccountInfo] = None,
    ...
    async def _apreview_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_subscription_preview_type.serialize(body, content_type)
    ...
    def _preview_subscription_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PreviewSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apreview_subscription(
        self,
        body: POSTSubscriptionPreviewType,
        account_key: typing.Optional[str] = None,
        contract_effective_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._preview_subscription_mapped_args(
            body=body,
        ...
        return await self._apreview_subscription_oapg(
            body=args.body,
    ...
    def preview_subscription(
        ...
        return self._preview_subscription_oapg(
            body=args.body,
            header_params=args.header,
        )

class PreviewSubscription(BaseApi):
    ...
    async def apreview_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTSubscriptionPreviewResponseTypePydantic:
        raw_response = await self.raw.apreview_subscription(
            body=body,
            account_key=account_key,
            contract_effective_date=contract_effective_date,
            customer_acceptance_date=customer_acceptance_date,
        ...
        if validate:
            return POSTSubscriptionPreviewResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTSubscriptionPreviewResponseTypePydantic, raw_response.body)
    ...
    def preview_subscription(
        ...
        raw_response = self.raw.preview_subscription(
            body=body,
            account_key=account_key,
            contract_effective_date=contract_effective_date,
            customer_acceptance_date=customer_acceptance_date,
