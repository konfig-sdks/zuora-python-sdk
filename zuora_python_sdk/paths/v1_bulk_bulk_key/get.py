...
from zuora_python_sdk.model.get_mass_update_type import GETMassUpdateType as GETMassUpdateTypeSchema

from zuora_python_sdk.type.get_mass_update_type import GETMassUpdateType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_mass_update_type import GETMassUpdateType as GETMassUpdateTypePydantic
...
# Path params
BulkKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'bulk-key': typing.Union[BulkKeySchema, str, ],
    }
)
...
request_path_bulk_key = api_client.PathParameter(
    name="bulk-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BulkKeySchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETMassUpdateTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _mass_updater_0_mapped_args(
        self,
        bulk_key: str,
    ...
    async def _amass_updater_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/bulk/{bulk-key}',
            headers=_headers,
        )
...
class MassUpdater0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amass_updater_0(
        self,
        bulk_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._mass_updater_0_mapped_args(
            bulk_key=bulk_key,
        ...
        return await self._amass_updater_0_oapg(
    ...
    def mass_updater_0(
        ...
        return self._mass_updater_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class MassUpdater0(BaseApi):
    ...
    async def amass_updater_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETMassUpdateTypePydantic:
        raw_response = await self.raw.amass_updater_0(
            bulk_key=bulk_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETMassUpdateTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETMassUpdateTypePydantic, raw_response.body)
    ...
    def mass_updater_0(
        ...
        raw_response = self.raw.mass_updater_0(
            bulk_key=bulk_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
