...
class BaseApi(api_client.Api):
    ...
    def _scrub_payment_methods_mapped_args(
        self,
    ...
    async def _ascrub_payment_methods_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/scrub',
            headers=_headers,
        )
    ...
    def _scrub_payment_methods_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ScrubPaymentMethodsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascrub_payment_methods(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._scrub_payment_methods_mapped_args(
        ...
        return await self._ascrub_payment_methods_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def scrub_payment_methods(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._scrub_payment_methods_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ScrubPaymentMethods(BaseApi):
    ...
    async def ascrub_payment_methods(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ascrub_payment_methods(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def scrub_payment_methods(
        ...
        raw_response = self.raw.scrub_payment_methods(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
