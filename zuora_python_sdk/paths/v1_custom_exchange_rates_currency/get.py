...
from zuora_python_sdk.model.get_custom_exchange_rates_type import GETCustomExchangeRatesType as GETCustomExchangeRatesTypeSchema

from zuora_python_sdk.type.get_custom_exchange_rates_type import GETCustomExchangeRatesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_custom_exchange_rates_type import GETCustomExchangeRatesType as GETCustomExchangeRatesTypePydantic
...
request_path_currency = api_client.PathParameter(
    name="currency",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = GETCustomExchangeRatesTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETCustomExchangeRatesType
...
class BaseApi(api_client.Api):
    ...
    def _custom_exchange_rates_mapped_args(
        self,
        currency: str,
        start_date: str,
        end_date: str,
    ...
    async def _acustom_exchange_rates_oapg(
        self,
    ...
    def _custom_exchange_rates_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CustomExchangeRatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_exchange_rates(
        self,
        currency: str,
        start_date: str,
        end_date: str,
        ...
        **kwargs,
        ...
        args = self._custom_exchange_rates_mapped_args(
            currency=currency,
        ...
        return await self._acustom_exchange_rates_oapg(
    ...
    def custom_exchange_rates(
        ...
        return self._custom_exchange_rates_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class CustomExchangeRates(BaseApi):
    ...
    async def acustom_exchange_rates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCustomExchangeRatesTypePydantic:
        raw_response = await self.raw.acustom_exchange_rates(
            currency=currency,
            start_date=start_date,
            end_date=end_date,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GETCustomExchangeRatesTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCustomExchangeRatesTypePydantic, raw_response.body)
    ...
    def custom_exchange_rates(
        ...
        raw_response = self.raw.custom_exchange_rates(
            currency=currency,
            start_date=start_date,
            end_date=end_date,
            accept_encoding=accept_encoding,
