...
from zuora_python_sdk.model.post_reverse_payment_request import POSTReversePaymentRequest as POSTReversePaymentRequestSchema
from zuora_python_sdk.model.post_reverse_payment_response import POSTReversePaymentResponse as POSTReversePaymentResponseSchema

from zuora_python_sdk.type.post_reverse_payment_response import POSTReversePaymentResponse
from zuora_python_sdk.type.post_reverse_payment_request import POSTReversePaymentRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_reverse_payment_response import POSTReversePaymentResponse as POSTReversePaymentResponsePydantic
from zuora_python_sdk.pydantic.post_reverse_payment_request import POSTReversePaymentRequest as POSTReversePaymentRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'payment-key': typing.Union[PaymentKeySchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = POSTReversePaymentRequestSchema


request_body_post_reverse_payment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTReversePaymentResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTReversePaymentResponse
...
class BaseApi(api_client.Api):
    ...
    def _reverse_payment_mapped_args(
        self,
        amount: typing.Union[int, float],
        payment_key: str,
        gateway_reconciliation_reason: typing.Optional[str] = None,
        gateway_reconciliation_status: typing.Optional[str] = None,
        gateway_response: typing.Optional[str] = None,
        gateway_response_code: typing.Optional[str] = None,
        payout_id: typing.Optional[str] = None,
        reference_id: typing.Optional[str] = None,
        second_reference_id: typing.Optional[str] = None,
        settled_on: typing.Optional[datetime] = None,
        ...
        if gateway_reconciliation_reason is not None:
            _body["gatewayReconciliationReason"] = gateway_reconciliation_reason
        if gateway_reconciliation_status is not None:
            _body["gatewayReconciliationStatus"] = gateway_reconciliation_status
        if gateway_response is not None:
            _body["gatewayResponse"] = gateway_response
        if gateway_response_code is not None:
            _body["gatewayResponseCode"] = gateway_response_code
        if payout_id is not None:
            _body["payoutId"] = payout_id
        if reference_id is not None:
            _body["referenceId"] = reference_id
        if second_reference_id is not None:
            _body["secondReferenceId"] = second_reference_id
        if settled_on is not None:
            _body["settledOn"] = settled_on
        args.body = _body
    ...
    async def _areverse_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/gateway-settlement/payments/{payment-key}/chargeback',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_reverse_payment_request.serialize(body, content_type)
...
class ReversePaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areverse_payment(
        self,
        amount: typing.Union[int, float],
        payment_key: str,
        gateway_reconciliation_reason: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._reverse_payment_mapped_args(
            amount=amount,
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
            gateway_response=gateway_response,
            gateway_response_code=gateway_response_code,
            payout_id=payout_id,
            reference_id=reference_id,
            second_reference_id=second_reference_id,
        ...
        return await self._areverse_payment_oapg(
            body=args.body,
    ...
    def reverse_payment(
        ...
        return self._reverse_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReversePayment(BaseApi):
    ...
    async def areverse_payment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTReversePaymentResponsePydantic:
        raw_response = await self.raw.areverse_payment(
            amount=amount,
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
        ...
        if validate:
            return POSTReversePaymentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTReversePaymentResponsePydantic, raw_response.body)
    ...
    def reverse_payment(
        ...
        raw_response = self.raw.reverse_payment(
            amount=amount,
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
