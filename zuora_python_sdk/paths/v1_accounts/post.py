...
from zuora_python_sdk.model.post_payment_method_request import POSTPaymentMethodRequest as POSTPaymentMethodRequestSchema
from zuora_python_sdk.model.post_account_type_subscription import POSTAccountTypeSubscription as POSTAccountTypeSubscriptionSchema
from zuora_python_sdk.model.post_account_type import POSTAccountType as POSTAccountTypeSchema
from zuora_python_sdk.model.post_account_type_sold_to_contact import POSTAccountTypeSoldToContact as POSTAccountTypeSoldToContactSchema
from zuora_python_sdk.model.post_account_response_type import POSTAccountResponseType as POSTAccountResponseTypeSchema
from zuora_python_sdk.model.post_account_type_bill_to_contact import POSTAccountTypeBillToContact as POSTAccountTypeBillToContactSchema
from zuora_python_sdk.model.post_account_type_credit_card import POSTAccountTypeCreditCard as POSTAccountTypeCreditCardSchema
from zuora_python_sdk.model.post_account_e_invoice_profile import PostAccountEInvoiceProfile as PostAccountEInvoiceProfileSchema

from zuora_python_sdk.type.post_account_type_subscription import POSTAccountTypeSubscription
from zuora_python_sdk.type.post_account_e_invoice_profile import PostAccountEInvoiceProfile
from zuora_python_sdk.type.post_account_type_credit_card import POSTAccountTypeCreditCard
from zuora_python_sdk.type.post_account_type import POSTAccountType
from zuora_python_sdk.type.post_account_type_bill_to_contact import POSTAccountTypeBillToContact
from zuora_python_sdk.type.post_account_response_type import POSTAccountResponseType
from zuora_python_sdk.type.post_payment_method_request import POSTPaymentMethodRequest
from zuora_python_sdk.type.post_account_type_sold_to_contact import POSTAccountTypeSoldToContact

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_account_type import POSTAccountType as POSTAccountTypePydantic
from zuora_python_sdk.pydantic.post_account_type_credit_card import POSTAccountTypeCreditCard as POSTAccountTypeCreditCardPydantic
from zuora_python_sdk.pydantic.post_account_type_sold_to_contact import POSTAccountTypeSoldToContact as POSTAccountTypeSoldToContactPydantic
from zuora_python_sdk.pydantic.post_account_response_type import POSTAccountResponseType as POSTAccountResponseTypePydantic
from zuora_python_sdk.pydantic.post_account_e_invoice_profile import PostAccountEInvoiceProfile as PostAccountEInvoiceProfilePydantic
from zuora_python_sdk.pydantic.post_account_type_subscription import POSTAccountTypeSubscription as POSTAccountTypeSubscriptionPydantic
from zuora_python_sdk.pydantic.post_account_type_bill_to_contact import POSTAccountTypeBillToContact as POSTAccountTypeBillToContactPydantic
from zuora_python_sdk.pydantic.post_payment_method_request import POSTPaymentMethodRequest as POSTPaymentMethodRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTAccountTypeSchema


request_body_post_account_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTAccountResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _account_mapped_args(
        self,
        body: POSTAccountType,
        account_number: typing.Optional[str] = None,
        additional_email_addresses: typing.Optional[typing.List[str]] = None,
        ...
        auto_pay: typing.Optional[bool] = None,
        batch: typing.Optional[str] = None,
        bill_cycle_day: typing.Optional[int] = None,
        bill_to_contact: typing.Optional[POSTAccountTypeBillToContact] = None,
        collect: typing.Optional[bool] = None,
        communication_profile_id: typing.Optional[str] = None,
        credit_card: typing.Optional[POSTAccountTypeCreditCard] = None,
        credit_memo_reason_code: typing.Optional[str] = None,
        credit_memo_template_id: typing.Optional[str] = None,
        crm_id: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        debit_memo_template_id: typing.Optional[str] = None,
        document_date: typing.Optional[date] = None,
        einvoice_profile: typing.Optional[PostAccountEInvoiceProfile] = None,
        hpm_credit_card_payment_method_id: typing.Optional[str] = None,
        invoice: typing.Optional[bool] = None,
        invoice_collect: typing.Optional[bool] = None,
        invoice_delivery_prefs_email: typing.Optional[bool] = None,
        invoice_delivery_prefs_print: typing.Optional[bool] = None,
        invoice_target_date: typing.Optional[date] = None,
        invoice_template_id: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        notes: typing.Optional[str] = None,
        organization_label: typing.Optional[str] = None,
        parent_id: typing.Optional[str] = None,
        partner_account: typing.Optional[bool] = None,
        payment_gateway: typing.Optional[str] = None,
        payment_method: typing.Optional[POSTPaymentMethodRequest] = None,
        payment_term: typing.Optional[str] = None,
        profile_number: typing.Optional[str] = None,
        run_billing: typing.Optional[bool] = None,
        sales_rep: typing.Optional[str] = None,
        sequence_set_id: typing.Optional[str] = None,
        sold_to_contact: typing.Optional[POSTAccountTypeSoldToContact] = None,
        sold_to_same_as_bill_to: typing.Optional[bool] = None,
        subscription: typing.Optional[POSTAccountTypeSubscription] = None,
        tagging: typing.Optional[str] = None,
        target_date: typing.Optional[date] = None,
        tax_info: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        class__ns: typing.Optional[str] = None,
        customer_type__ns: typing.Optional[str] = None,
        ...
        syncto_net_suite__ns: typing.Optional[str] = None,
        ...
        if additional_email_addresses is not None:
            _body["additionalEmailAddresses"] = additional_email_addresses
        ...
        if credit_memo_template_id is not None:
            _body["creditMemoTemplateId"] = credit_memo_template_id
        if crm_id is not None:
            _body["crmId"] = crm_id
        if currency is not None:
            _body["currency"] = currency
        if debit_memo_template_id is not None:
            _body["debitMemoTemplateId"] = debit_memo_template_id
        if document_date is not None:
            _body["documentDate"] = document_date
        if einvoice_profile is not None:
            _body["einvoiceProfile"] = einvoice_profile
        if hpm_credit_card_payment_method_id is not None:
            _body["hpmCreditCardPaymentMethodId"] = hpm_credit_card_payment_method_id
        ...
        if syncto_net_suite__ns is not None:
            _body["SynctoNetSuite__NS"] = syncto_net_suite__ns
    ...
    async def _aaccount_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_account_type.serialize(body, content_type)
...
class AccountRaw(BaseApi):
    ...
    async def aaccount(
        ...
        **kwargs,
        ...
        args = self._account_mapped_args(
            body=body,
            ...
            credit_memo_template_id=credit_memo_template_id,
            crm_id=crm_id,
            currency=currency,
            debit_memo_template_id=debit_memo_template_id,
            document_date=document_date,
            einvoice_profile=einvoice_profile,
            hpm_credit_card_payment_method_id=hpm_credit_card_payment_method_id,
            invoice=invoice,
            invoice_collect=invoice_collect,
            invoice_delivery_prefs_email=invoice_delivery_prefs_email,
            invoice_delivery_prefs_print=invoice_delivery_prefs_print,
            ...
            sold_to_same_as_bill_to=sold_to_same_as_bill_to,
            subscription=subscription,
            tagging=tagging,
            target_date=target_date,
            tax_info=tax_info,
            class__ns=class__ns,
            customer_type__ns=customer_type__ns,
            ...
            syncto_net_suite__ns=syncto_net_suite__ns,
        ...
        return await self._aaccount_oapg(
            body=args.body,
...
class Account(BaseApi):
    ...
    async def aaccount(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTAccountResponseTypePydantic:
        raw_response = await self.raw.aaccount(
            body=body,
            account_number=account_number,
            additional_email_addresses=additional_email_addresses,
            application_order=application_order,
        ...
        if validate:
            return POSTAccountResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTAccountResponseTypePydantic, raw_response.body)
