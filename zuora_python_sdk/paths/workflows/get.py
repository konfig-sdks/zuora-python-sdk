...
from zuora_python_sdk.model.get_workflows_response import GetWorkflowsResponse as GetWorkflowsResponseSchema

from zuora_python_sdk.type.get_workflows_response import GetWorkflowsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_workflows_response import GetWorkflowsResponse as GetWorkflowsResponsePydantic

from . import path

# Query params
CalloutTriggerSchema = schemas.BoolSchema
IntervalSchema = schemas.StrSchema
NameSchema = schemas.StrSchema
OndemandTriggerSchema = schemas.BoolSchema
ScheduledTriggerSchema = schemas.BoolSchema
PageSchema = schemas.IntSchema
PageLengthSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'callout_trigger': typing.Union[CalloutTriggerSchema, bool, ],
        'interval': typing.Union[IntervalSchema, str, ],
        'name': typing.Union[NameSchema, str, ],
        'ondemand_trigger': typing.Union[OndemandTriggerSchema, bool, ],
        'scheduled_trigger': typing.Union[ScheduledTriggerSchema, bool, ],
        'page': typing.Union[PageSchema, decimal.Decimal, int, ],
        'page_length': typing.Union[PageLengthSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_callout_trigger = api_client.QueryParameter(
    name="callout_trigger",
    style=api_client.ParameterStyle.FORM,
    schema=CalloutTriggerSchema,
    explode=True,
)
...
request_query_ondemand_trigger = api_client.QueryParameter(
    name="ondemand_trigger",
    style=api_client.ParameterStyle.FORM,
    schema=OndemandTriggerSchema,
    explode=True,
)
request_query_scheduled_trigger = api_client.QueryParameter(
...
request_query_page_length = api_client.QueryParameter(
    name="page_length",
    style=api_client.ParameterStyle.FORM,
    schema=PageLengthSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetWorkflowsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflows_mapped_args(
        ...
        callout_trigger: typing.Optional[bool] = None,
        interval: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ondemand_trigger: typing.Optional[bool] = None,
        scheduled_trigger: typing.Optional[bool] = None,
        page: typing.Optional[int] = None,
        page_length: typing.Optional[int] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _header_params = {}
        if callout_trigger is not None:
            _query_params["callout_trigger"] = callout_trigger
        if interval is not None:
            _query_params["interval"] = interval
        if name is not None:
            _query_params["name"] = name
        if ondemand_trigger is not None:
            _query_params["ondemand_trigger"] = ondemand_trigger
        if scheduled_trigger is not None:
            _query_params["scheduled_trigger"] = scheduled_trigger
        if page is not None:
            _query_params["page"] = page
        if page_length is not None:
            _query_params["page_length"] = page_length
    ...
    async def _aworkflows_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_callout_trigger,
            request_query_interval,
            request_query_name,
            request_query_ondemand_trigger,
            request_query_scheduled_trigger,
            request_query_page,
            request_query_page_length,
        ):
...
class Workflows(BaseApi):
    ...
    async def aworkflows(
        ...
        **kwargs,
        ...
        if validate:
            return GetWorkflowsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetWorkflowsResponsePydantic, raw_response.body)
