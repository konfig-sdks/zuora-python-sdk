...
from zuora_python_sdk.model.post_upload_file_for_invoice_request import PostUploadFileForInvoiceRequest as PostUploadFileForInvoiceRequestSchema

from zuora_python_sdk.type.post_upload_file_for_invoice_request import PostUploadFileForInvoiceRequest
...
from zuora_python_sdk.pydantic.post_upload_file_for_invoice_request import PostUploadFileForInvoiceRequest as PostUploadFileForInvoiceRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostUploadFileForInvoiceRequestSchema


request_body_post_upload_file_for_invoice_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upload_file_for_invoice_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _aupload_file_for_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/files',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_post_upload_file_for_invoice_request.serialize(body, content_type)
    ...
    def _upload_file_for_invoice_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UploadFileForInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_file_for_invoice(
        self,
        invoice_key: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._upload_file_for_invoice_mapped_args(
        ...
        return await self._aupload_file_for_invoice_oapg(
            body=args.body,
    ...
    def upload_file_for_invoice(
        ...
        return self._upload_file_for_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UploadFileForInvoice(BaseApi):
    ...
    async def aupload_file_for_invoice(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupload_file_for_invoice(
            invoice_key=invoice_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def upload_file_for_invoice(
        ...
        raw_response = self.raw.upload_file_for_invoice(
            invoice_key=invoice_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
