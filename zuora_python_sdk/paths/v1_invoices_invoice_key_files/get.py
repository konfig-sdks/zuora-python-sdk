...
from zuora_python_sdk.model.get_invoice_files_response import GETInvoiceFilesResponse as GETInvoiceFilesResponseSchema

from zuora_python_sdk.type.get_invoice_files_response import GETInvoiceFilesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_invoice_files_response import GETInvoiceFilesResponse as GETInvoiceFilesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETInvoiceFilesResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _invoice_files_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _ainvoice_files_oapg(
        self,
...
class InvoiceFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoice_files(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._invoice_files_mapped_args(
        ...
        return await self._ainvoice_files_oapg(
    ...
    def invoice_files(
        ...
        return self._invoice_files_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class InvoiceFiles(BaseApi):
    ...
    async def ainvoice_files(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETInvoiceFilesResponsePydantic:
        raw_response = await self.raw.ainvoice_files(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETInvoiceFilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETInvoiceFilesResponsePydantic, raw_response.body)
    ...
    def invoice_files(
        ...
        raw_response = self.raw.invoice_files(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
