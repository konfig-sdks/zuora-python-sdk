...
class BaseApi(api_client.Api):
    ...
    def _post_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _apost_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/post',
            headers=_headers,
        )
...
class PostCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apost_credit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._post_credit_memo_mapped_args(
        ...
        return await self._apost_credit_memo_oapg(
    ...
    def post_credit_memo(
        ...
        return self._post_credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PostCreditMemo(BaseApi):
    ...
    async def apost_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apost_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def post_credit_memo(
        ...
        raw_response = self.raw.post_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
