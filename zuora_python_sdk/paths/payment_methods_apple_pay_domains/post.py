...
from zuora_python_sdk.model.post_register_apple_pay_domain_response import POSTRegisterApplePayDomainResponse as POSTRegisterApplePayDomainResponseSchema
from zuora_python_sdk.model.post_register_apple_pay_domain_request import POSTRegisterApplePayDomainRequest as POSTRegisterApplePayDomainRequestSchema

from zuora_python_sdk.type.post_register_apple_pay_domain_response import POSTRegisterApplePayDomainResponse
from zuora_python_sdk.type.post_register_apple_pay_domain_request import POSTRegisterApplePayDomainRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_register_apple_pay_domain_request import POSTRegisterApplePayDomainRequest as POSTRegisterApplePayDomainRequestPydantic
from zuora_python_sdk.pydantic.post_register_apple_pay_domain_response import POSTRegisterApplePayDomainResponse as POSTRegisterApplePayDomainResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTRegisterApplePayDomainRequestSchema


request_body_post_register_apple_pay_domain_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTRegisterApplePayDomainResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTRegisterApplePayDomainResponse
...
class BaseApi(api_client.Api):
    ...
    def _register_apple_pay_domain_mapped_args(
        self,
        domain_name: str,
    ...
    async def _aregister_apple_pay_domain_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payment-methods/apple-pay/domains',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_register_apple_pay_domain_request.serialize(body, content_type)
    ...
    def _register_apple_pay_domain_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RegisterApplePayDomainRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aregister_apple_pay_domain(
        self,
        domain_name: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._register_apple_pay_domain_mapped_args(
        ...
        return await self._aregister_apple_pay_domain_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def register_apple_pay_domain(
        self,
        domain_name: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._register_apple_pay_domain_oapg(
            body=args.body,
            header_params=args.header,
        )

class RegisterApplePayDomain(BaseApi):
    ...
    async def aregister_apple_pay_domain(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTRegisterApplePayDomainResponsePydantic:
        raw_response = await self.raw.aregister_apple_pay_domain(
            domain_name=domain_name,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return POSTRegisterApplePayDomainResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTRegisterApplePayDomainResponsePydantic, raw_response.body)
    ...
    def register_apple_pay_domain(
        ...
        raw_response = self.raw.register_apple_pay_domain(
            domain_name=domain_name,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
