...
from zuora_python_sdk.model.get_list_apple_pay_domains_response import GETListApplePayDomainsResponse as GETListApplePayDomainsResponseSchema

from zuora_python_sdk.type.get_list_apple_pay_domains_response import GETListApplePayDomainsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_list_apple_pay_domains_response import GETListApplePayDomainsResponse as GETListApplePayDomainsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETListApplePayDomainsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETListApplePayDomainsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_apple_pay_domains_mapped_args(
        self,
        ...
        if domain_name is not None:
            _query_params["domainName"] = domain_name
    ...
    async def _alist_apple_pay_domains_oapg(
        self,
    ...
    def _list_apple_pay_domains_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListApplePayDomainsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_apple_pay_domains(
        self,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_apple_pay_domains_mapped_args(
        ...
        return await self._alist_apple_pay_domains_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def list_apple_pay_domains(
        self,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._list_apple_pay_domains_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ListApplePayDomains(BaseApi):
    ...
    async def alist_apple_pay_domains(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETListApplePayDomainsResponsePydantic:
        raw_response = await self.raw.alist_apple_pay_domains(
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETListApplePayDomainsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETListApplePayDomainsResponsePydantic, raw_response.body)
    ...
    def list_apple_pay_domains(
        ...
        raw_response = self.raw.list_apple_pay_domains(
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
