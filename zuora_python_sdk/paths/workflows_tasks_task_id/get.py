...
class BaseApi(api_client.Api):
    ...
    def _workflows_task_mapped_args(
        self,
        authorization: str,
        task_id: str,
    ...
    async def _aworkflows_task_oapg(
        self,
...
class WorkflowsTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflows_task(
        self,
        authorization: str,
        task_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflows_task_mapped_args(
        ...
        return await self._aworkflows_task_oapg(
    ...
    def workflows_task(
        ...
        return self._workflows_task_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class WorkflowsTask(BaseApi):
    ...
    async def aworkflows_task(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aworkflows_task(
            authorization=authorization,
            task_id=task_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def workflows_task(
        ...
        raw_response = self.raw.workflows_task(
            authorization=authorization,
            task_id=task_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
