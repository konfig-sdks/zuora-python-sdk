...
from zuora_python_sdk.model.list_all_catalog_groups_response import ListAllCatalogGroupsResponse as ListAllCatalogGroupsResponseSchema

from zuora_python_sdk.type.list_all_catalog_groups_response import ListAllCatalogGroupsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.list_all_catalog_groups_response import ListAllCatalogGroupsResponse as ListAllCatalogGroupsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListAllCatalogGroupsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ListAllCatalogGroupsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_catalog_groups_mapped_args(
        self,
    ...
    async def _alist_all_catalog_groups_oapg(
        self,
    ...
    def _list_all_catalog_groups_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListAllCatalogGroupsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_catalog_groups(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_all_catalog_groups_mapped_args(
        ...
        return await self._alist_all_catalog_groups_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def list_all_catalog_groups(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._list_all_catalog_groups_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ListAllCatalogGroups(BaseApi):
    ...
    async def alist_all_catalog_groups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListAllCatalogGroupsResponsePydantic:
        raw_response = await self.raw.alist_all_catalog_groups(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return ListAllCatalogGroupsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListAllCatalogGroupsResponsePydantic, raw_response.body)
    ...
    def list_all_catalog_groups(
        ...
        raw_response = self.raw.list_all_catalog_groups(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
