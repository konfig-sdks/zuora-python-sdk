...
from zuora_python_sdk.model.post_catalog_group_request import POSTCatalogGroupRequest as POSTCatalogGroupRequestSchema
...
from zuora_python_sdk.type.post_catalog_group_request import POSTCatalogGroupRequest
from zuora_python_sdk.type.catalog_group_response import CatalogGroupResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_catalog_group_request import POSTCatalogGroupRequest as POSTCatalogGroupRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCatalogGroupRequestSchema


request_body_post_catalog_group_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_catalog_group_mapped_args(
        self,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        product_rate_plans: typing.Optional[typing.List[POSTorPUTCatalogGroupAddProductRatePlan]] = None,
        ...
        if product_rate_plans is not None:
            _body["productRatePlans"] = product_rate_plans
        if type is not None:
            _body["type"] = type
        args.body = _body
    ...
    async def _acreate_catalog_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/catalog-groups',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_catalog_group_request.serialize(body, content_type)
    ...
    def _create_catalog_group_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateCatalogGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_catalog_group(
        self,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        product_rate_plans: typing.Optional[typing.List[POSTorPUTCatalogGroupAddProductRatePlan]] = None,
        ...
        **kwargs,
        ...
        args = self._create_catalog_group_mapped_args(
            body=body,
            description=description,
            name=name,
            product_rate_plans=product_rate_plans,
            type=type,
        ...
        return await self._acreate_catalog_group_oapg(
            body=args.body,
    ...
    def create_catalog_group(
        ...
        return self._create_catalog_group_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateCatalogGroup(BaseApi):
    ...
    async def acreate_catalog_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_catalog_group(
            body=body,
            description=description,
            name=name,
            product_rate_plans=product_rate_plans,
    ...
    def create_catalog_group(
        ...
        raw_response = self.raw.create_catalog_group(
            body=body,
            description=description,
            name=name,
            product_rate_plans=product_rate_plans,
