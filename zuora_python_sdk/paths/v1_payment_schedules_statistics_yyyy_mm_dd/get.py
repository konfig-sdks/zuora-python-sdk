...
from zuora_python_sdk.model.get_payment_schedule_statistic_response import GETPaymentScheduleStatisticResponse as GETPaymentScheduleStatisticResponseSchema

from zuora_python_sdk.type.get_payment_schedule_statistic_response import GETPaymentScheduleStatisticResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_schedule_statistic_response import GETPaymentScheduleStatisticResponse as GETPaymentScheduleStatisticResponsePydantic
...
# Path params
YyyyMmDdSchema = schemas.DateSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'yyyy-mm-dd': typing.Union[YyyyMmDdSchema, str, date, ],
    }
)
...
request_path_yyyy_mm_dd = api_client.PathParameter(
    name="yyyy-mm-dd",
    style=api_client.ParameterStyle.SIMPLE,
    schema=YyyyMmDdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentScheduleStatisticResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentScheduleStatisticResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_schedule_statistic_mapped_args(
        self,
        yyyy_mm_dd: date,
    ...
    async def _apayment_schedule_statistic_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/statistics/{yyyy-mm-dd}',
            headers=_headers,
        )
    ...
    def _payment_schedule_statistic_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PaymentScheduleStatisticRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_schedule_statistic(
        self,
        yyyy_mm_dd: date,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_schedule_statistic_mapped_args(
        ...
        return await self._apayment_schedule_statistic_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def payment_schedule_statistic(
        self,
        yyyy_mm_dd: date,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._payment_schedule_statistic_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentScheduleStatistic(BaseApi):
    ...
    async def apayment_schedule_statistic(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentScheduleStatisticResponsePydantic:
        raw_response = await self.raw.apayment_schedule_statistic(
            yyyy_mm_dd=yyyy_mm_dd,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETPaymentScheduleStatisticResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentScheduleStatisticResponsePydantic, raw_response.body)
    ...
    def payment_schedule_statistic(
        ...
        raw_response = self.raw.payment_schedule_statistic(
            yyyy_mm_dd=yyyy_mm_dd,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
