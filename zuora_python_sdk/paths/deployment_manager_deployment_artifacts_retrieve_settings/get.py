...
SchemaFor200ResponseBodyApplicationJson = SettingSourceComponentResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: SettingSourceComponentResponse
...
class BaseApi(api_client.Api):
    ...
    def _source_component_details_mapped_args(
        self,
        authorization: str,
    ...
    async def _asource_component_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployment_artifacts/retrieve-settings',
            headers=_headers,
        )
    ...
    def _source_component_details_oapg(
        self,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SourceComponentDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asource_component_details(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._source_component_details_mapped_args(
        ...
        return await self._asource_component_details_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def source_component_details(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._source_component_details_oapg(
            header_params=args.header,
        )

class SourceComponentDetails(BaseApi):
    ...
    async def asource_component_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SettingSourceComponentResponsePydantic:
        raw_response = await self.raw.asource_component_details(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return SettingSourceComponentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SettingSourceComponentResponsePydantic, raw_response.body)
    ...
    def source_component_details(
        ...
        raw_response = self.raw.source_component_details(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
