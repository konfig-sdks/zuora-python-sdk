...
from zuora_python_sdk.model.refund_credit_memo_item_type import RefundCreditMemoItemType as RefundCreditMemoItemTypeSchema
from zuora_python_sdk.model.credit_memo_from_charge_custom_rates_type import CreditMemoFromChargeCustomRatesType as CreditMemoFromChargeCustomRatesTypeSchema
from zuora_python_sdk.model.get_refund_credit_memo_type import GETRefundCreditMemoType as GETRefundCreditMemoTypeSchema
from zuora_python_sdk.model.post_non_ref_refund_type import PostNonRefRefundType as PostNonRefRefundTypeSchema

from zuora_python_sdk.type.refund_credit_memo_item_type import RefundCreditMemoItemType
from zuora_python_sdk.type.post_non_ref_refund_type import PostNonRefRefundType
from zuora_python_sdk.type.get_refund_credit_memo_type import GETRefundCreditMemoType
from zuora_python_sdk.type.credit_memo_from_charge_custom_rates_type import CreditMemoFromChargeCustomRatesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_non_ref_refund_type import PostNonRefRefundType as PostNonRefRefundTypePydantic
from zuora_python_sdk.pydantic.credit_memo_from_charge_custom_rates_type import CreditMemoFromChargeCustomRatesType as CreditMemoFromChargeCustomRatesTypePydantic
from zuora_python_sdk.pydantic.get_refund_credit_memo_type import GETRefundCreditMemoType as GETRefundCreditMemoTypePydantic
from zuora_python_sdk.pydantic.refund_credit_memo_item_type import RefundCreditMemoItemType as RefundCreditMemoItemTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostNonRefRefundTypeSchema


request_body_post_non_ref_refund_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETRefundCreditMemoTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _refund_credit_memo_mapped_args(
        self,
        body: PostNonRefRefundType,
        credit_memo_key: str,
        comment: typing.Optional[str] = None,
        custom_rates: typing.Optional[typing.List[CreditMemoFromChargeCustomRatesType]] = None,
        ...
        items: typing.Optional[typing.List[RefundCreditMemoItemType]] = None,
    ...
    async def _arefund_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/refunds',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_non_ref_refund_type.serialize(body, content_type)
...
class RefundCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefund_credit_memo(
        self,
        body: PostNonRefRefundType,
        credit_memo_key: str,
        comment: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._refund_credit_memo_mapped_args(
            body=body,
        ...
        return await self._arefund_credit_memo_oapg(
            body=args.body,
    ...
    def refund_credit_memo(
        ...
        return self._refund_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RefundCreditMemo(BaseApi):
    ...
    async def arefund_credit_memo(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundCreditMemoTypePydantic:
        raw_response = await self.raw.arefund_credit_memo(
            body=body,
            credit_memo_key=credit_memo_key,
            comment=comment,
            custom_rates=custom_rates,
        ...
        if validate:
            return RootModel[GETRefundCreditMemoTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRefundCreditMemoTypePydantic, raw_response.body)
    ...
    def refund_credit_memo(
        ...
        raw_response = self.raw.refund_credit_memo(
            body=body,
            credit_memo_key=credit_memo_key,
            comment=comment,
            custom_rates=custom_rates,
