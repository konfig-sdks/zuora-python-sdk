...
from zuora_python_sdk.model.post_resend_callout_notifications import POSTResendCalloutNotifications as POSTResendCalloutNotificationsSchema
from zuora_python_sdk.model.resend_callout_notifications_failed_response import ResendCalloutNotificationsFailedResponse as ResendCalloutNotificationsFailedResponseSchema

from zuora_python_sdk.type.resend_callout_notifications_failed_response import ResendCalloutNotificationsFailedResponse
from zuora_python_sdk.type.post_resend_callout_notifications import POSTResendCalloutNotifications

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.resend_callout_notifications_failed_response import ResendCalloutNotificationsFailedResponse as ResendCalloutNotificationsFailedResponsePydantic
from zuora_python_sdk.pydantic.post_resend_callout_notifications import POSTResendCalloutNotifications as POSTResendCalloutNotificationsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTResendCalloutNotificationsSchema


request_body_post_resend_callout_notifications = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = ResendCalloutNotificationsFailedResponseSchema
...
class ApiResponseFor202(api_client.ApiResponse):
    body: ResendCalloutNotificationsFailedResponse
...
SchemaFor400ResponseBodyApplicationJson = ResendCalloutNotificationsFailedResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _resend_callout_notifications_mapped_args(
        self,
        body: POSTResendCalloutNotifications,
        authorization: str,
    ...
    async def _aresend_callout_notifications_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/callout-histories/resend',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_resend_callout_notifications.serialize(body, content_type)
    ...
    def _resend_callout_notifications_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ResendCalloutNotificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresend_callout_notifications(
        self,
        body: POSTResendCalloutNotifications,
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._resend_callout_notifications_mapped_args(
            body=body,
        ...
        return await self._aresend_callout_notifications_oapg(
            body=args.body,
    ...
    def resend_callout_notifications(
        ...
        return self._resend_callout_notifications_oapg(
            body=args.body,
            header_params=args.header,
        )

class ResendCalloutNotifications(BaseApi):
    ...
    async def aresend_callout_notifications(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ResendCalloutNotificationsFailedResponsePydantic:
        raw_response = await self.raw.aresend_callout_notifications(
            body=body,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return ResendCalloutNotificationsFailedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ResendCalloutNotificationsFailedResponsePydantic, raw_response.body)
    ...
    def resend_callout_notifications(
        ...
        raw_response = self.raw.resend_callout_notifications(
            body=body,
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
