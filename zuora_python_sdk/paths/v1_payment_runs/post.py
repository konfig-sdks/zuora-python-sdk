...
from zuora_python_sdk.model.get_payment_run_type import GETPaymentRunType as GETPaymentRunTypeSchema
from zuora_python_sdk.model.post_payment_run_request import POSTPaymentRunRequest as POSTPaymentRunRequestSchema
from zuora_python_sdk.model.post_payment_run_request_organization_labels import POSTPaymentRunRequestOrganizationLabels as POSTPaymentRunRequestOrganizationLabelsSchema
from zuora_python_sdk.model.post_payment_run_data_element_request import POSTPaymentRunDataElementRequest as POSTPaymentRunDataElementRequestSchema

from zuora_python_sdk.type.post_payment_run_request import POSTPaymentRunRequest
from zuora_python_sdk.type.post_payment_run_data_element_request import POSTPaymentRunDataElementRequest
from zuora_python_sdk.type.post_payment_run_request_organization_labels import POSTPaymentRunRequestOrganizationLabels
from zuora_python_sdk.type.get_payment_run_type import GETPaymentRunType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_payment_run_request import POSTPaymentRunRequest as POSTPaymentRunRequestPydantic
from zuora_python_sdk.pydantic.get_payment_run_type import GETPaymentRunType as GETPaymentRunTypePydantic
from zuora_python_sdk.pydantic.post_payment_run_request_organization_labels import POSTPaymentRunRequestOrganizationLabels as POSTPaymentRunRequestOrganizationLabelsPydantic
from zuora_python_sdk.pydantic.post_payment_run_data_element_request import POSTPaymentRunDataElementRequest as POSTPaymentRunDataElementRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTPaymentRunRequestSchema


request_body_post_payment_run_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentRunTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _payment_run_mapped_args(
        self,
        account_id: typing.Optional[str] = None,
        apply_credit_balance: typing.Optional[bool] = None,
        auto_apply_credit_memo: typing.Optional[bool] = None,
        auto_apply_unapplied_payment: typing.Optional[bool] = None,
        batch: typing.Optional[str] = None,
        bill_cycle_day: typing.Optional[str] = None,
        billing_run_id: typing.Optional[str] = None,
        collect_payment: typing.Optional[bool] = None,
        consolidated_payment: typing.Optional[bool] = None,
        currency: typing.Optional[str] = None,
        data: typing.Optional[typing.List[POSTPaymentRunDataElementRequest]] = None,
        organization_labels: typing.Optional[POSTPaymentRunRequestOrganizationLabels] = None,
        payment_gateway_id: typing.Optional[str] = None,
        process_payment_with_closed_pm: typing.Optional[bool] = None,
        run_date: typing.Optional[datetime] = None,
        ...
        if auto_apply_credit_memo is not None:
            _body["autoApplyCreditMemo"] = auto_apply_credit_memo
        if auto_apply_unapplied_payment is not None:
            _body["autoApplyUnappliedPayment"] = auto_apply_unapplied_payment
        if batch is not None:
            _body["batch"] = batch
        if bill_cycle_day is not None:
            _body["billCycleDay"] = bill_cycle_day
        if billing_run_id is not None:
            _body["billingRunId"] = billing_run_id
        if collect_payment is not None:
            _body["collectPayment"] = collect_payment
        if consolidated_payment is not None:
            _body["consolidatedPayment"] = consolidated_payment
        ...
        if payment_gateway_id is not None:
            _body["paymentGatewayId"] = payment_gateway_id
        if process_payment_with_closed_pm is not None:
            _body["processPaymentWithClosedPM"] = process_payment_with_closed_pm
        if run_date is not None:
            _body["runDate"] = run_date
    ...
    async def _apayment_run_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_payment_run_request.serialize(body, content_type)
...
class PaymentRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_run(
        self,
        account_id: typing.Optional[str] = None,
        apply_credit_balance: typing.Optional[bool] = None,
        auto_apply_credit_memo: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._payment_run_mapped_args(
            account_id=account_id,
            apply_credit_balance=apply_credit_balance,
            auto_apply_credit_memo=auto_apply_credit_memo,
            auto_apply_unapplied_payment=auto_apply_unapplied_payment,
            batch=batch,
            ...
            process_payment_with_closed_pm=process_payment_with_closed_pm,
            run_date=run_date,
        ...
        return await self._apayment_run_oapg(
            body=args.body,
    ...
    def payment_run(
        ...
        return self._payment_run_oapg(
            body=args.body,
            header_params=args.header,
        )

class PaymentRun(BaseApi):
    ...
    async def apayment_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentRunTypePydantic:
        raw_response = await self.raw.apayment_run(
            account_id=account_id,
            apply_credit_balance=apply_credit_balance,
            auto_apply_credit_memo=auto_apply_credit_memo,
            auto_apply_unapplied_payment=auto_apply_unapplied_payment,
        ...
        if validate:
            return GETPaymentRunTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentRunTypePydantic, raw_response.body)
    ...
    def payment_run(
        ...
        raw_response = self.raw.payment_run(
            account_id=account_id,
            apply_credit_balance=apply_credit_balance,
            auto_apply_credit_memo=auto_apply_credit_memo,
            auto_apply_unapplied_payment=auto_apply_unapplied_payment,
