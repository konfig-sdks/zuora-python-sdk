...
from zuora_python_sdk.model.get_payment_run_collection_type import GETPaymentRunCollectionType as GETPaymentRunCollectionTypeSchema

from zuora_python_sdk.type.get_payment_run_collection_type import GETPaymentRunCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_run_collection_type import GETPaymentRunCollectionType as GETPaymentRunCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentRunCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentRunCollectionType
...
class PaymentRunsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_runs(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_runs_mapped_args(
        ...
        return await self._apayment_runs_oapg(
    ...
    def payment_runs(
        ...
        return self._payment_runs_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class PaymentRuns(BaseApi):
    ...
    async def apayment_runs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentRunCollectionTypePydantic:
        raw_response = await self.raw.apayment_runs(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETPaymentRunCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentRunCollectionTypePydantic, raw_response.body)
    ...
    def payment_runs(
        ...
        raw_response = self.raw.payment_runs(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
