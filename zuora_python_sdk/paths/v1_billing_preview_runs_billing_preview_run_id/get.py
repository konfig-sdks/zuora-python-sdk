...
from zuora_python_sdk.model.get_billing_preview_run_response import GetBillingPreviewRunResponse as GetBillingPreviewRunResponseSchema

from zuora_python_sdk.type.get_billing_preview_run_response import GetBillingPreviewRunResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_billing_preview_run_response import GetBillingPreviewRunResponse as GetBillingPreviewRunResponsePydantic
...
# Path params
BillingPreviewRunIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'billingPreviewRunId': typing.Union[BillingPreviewRunIdSchema, str, ],
    }
)
...
request_path_billing_preview_run_id = api_client.PathParameter(
    name="billingPreviewRunId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BillingPreviewRunIdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GetBillingPreviewRunResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetBillingPreviewRunResponse
...
class BaseApi(api_client.Api):
    ...
    def _billing_preview_run_0_mapped_args(
        self,
    ...
    async def _abilling_preview_run_0_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_billing_preview_run_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/billing-preview-runs/{billingPreviewRunId}',
            headers=_headers,
        )
    ...
    def _billing_preview_run_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BillingPreviewRun0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abilling_preview_run_0(
        self,
        billing_preview_run_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._billing_preview_run_0_mapped_args(
        ...
        return await self._abilling_preview_run_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def billing_preview_run_0(
        self,
        billing_preview_run_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._billing_preview_run_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BillingPreviewRun0(BaseApi):
    ...
    async def abilling_preview_run_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetBillingPreviewRunResponsePydantic:
        raw_response = await self.raw.abilling_preview_run_0(
            billing_preview_run_id=billing_preview_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetBillingPreviewRunResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetBillingPreviewRunResponsePydantic, raw_response.body)
    ...
    def billing_preview_run_0(
        ...
        raw_response = self.raw.billing_preview_run_0(
            billing_preview_run_id=billing_preview_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
