...
class BaseApi(api_client.Api):
    ...
    def _sequence_set_1_mapped_args(
        self,
        id: str,
    ...
    async def _asequence_set_1_oapg(
        self,
...
class SequenceSet1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asequence_set_1(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._sequence_set_1_mapped_args(
            id=id,
        ...
        return await self._asequence_set_1_oapg(
    ...
    def sequence_set_1(
        ...
        return self._sequence_set_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SequenceSet1(BaseApi):
    ...
    async def asequence_set_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asequence_set_1(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def sequence_set_1(
        ...
        raw_response = self.raw.sequence_set_1(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
