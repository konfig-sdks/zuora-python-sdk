...
from zuora_python_sdk.model.get_sequence_set_response import GETSequenceSetResponse as GETSequenceSetResponseSchema

from zuora_python_sdk.type.get_sequence_set_response import GETSequenceSetResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_sequence_set_response import GETSequenceSetResponse as GETSequenceSetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETSequenceSetResponseSchema
...
class SequenceSetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asequence_set(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._sequence_set_mapped_args(
            id=id,
        ...
        return await self._asequence_set_oapg(
    ...
    def sequence_set(
        ...
        return self._sequence_set_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SequenceSet(BaseApi):
    ...
    async def asequence_set(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETSequenceSetResponsePydantic:
        raw_response = await self.raw.asequence_set(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETSequenceSetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETSequenceSetResponsePydantic, raw_response.body)
    ...
    def sequence_set(
        ...
        raw_response = self.raw.sequence_set(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
