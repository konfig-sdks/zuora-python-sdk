...
from zuora_python_sdk.model.post_reconcile_refund_request import POSTReconcileRefundRequest as POSTReconcileRefundRequestSchema
from zuora_python_sdk.model.post_reconcile_refund_response import POSTReconcileRefundResponse as POSTReconcileRefundResponseSchema

from zuora_python_sdk.type.post_reconcile_refund_request import POSTReconcileRefundRequest
from zuora_python_sdk.type.post_reconcile_refund_response import POSTReconcileRefundResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_reconcile_refund_request import POSTReconcileRefundRequest as POSTReconcileRefundRequestPydantic
from zuora_python_sdk.pydantic.post_reconcile_refund_response import POSTReconcileRefundResponse as POSTReconcileRefundResponsePydantic
...
# Path params
RefundKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'refund-key': typing.Union[RefundKeySchema, str, ],
    }
)
...
request_path_refund_key = api_client.PathParameter(
    name="refund-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RefundKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = POSTReconcileRefundRequestSchema


request_body_post_reconcile_refund_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTReconcileRefundResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTReconcileRefundResponse
...
class BaseApi(api_client.Api):
    ...
    def _reconcile_refund_mapped_args(
        self,
        refund_key: str,
        action: typing.Optional[str] = None,
        action_date: typing.Optional[str] = None,
    ...
    async def _areconcile_refund_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refund-key}/reconcile',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_reconcile_refund_request.serialize(body, content_type)
...
class ReconcileRefundRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areconcile_refund(
        self,
        refund_key: str,
        action: typing.Optional[str] = None,
        action_date: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._reconcile_refund_mapped_args(
        ...
        return await self._areconcile_refund_oapg(
            body=args.body,
    ...
    def reconcile_refund(
        ...
        return self._reconcile_refund_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReconcileRefund(BaseApi):
    ...
    async def areconcile_refund(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTReconcileRefundResponsePydantic:
        raw_response = await self.raw.areconcile_refund(
            refund_key=refund_key,
            action=action,
            action_date=action_date,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
        ...
        if validate:
            return POSTReconcileRefundResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTReconcileRefundResponsePydantic, raw_response.body)
    ...
    def reconcile_refund(
        ...
        raw_response = self.raw.reconcile_refund(
            refund_key=refund_key,
            action=action,
            action_date=action_date,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
