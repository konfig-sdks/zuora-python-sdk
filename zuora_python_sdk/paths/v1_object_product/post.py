...
from zuora_python_sdk.model.proxy_create_product import ProxyCreateProduct as ProxyCreateProductSchema
...
from zuora_python_sdk.type.proxy_create_product import ProxyCreateProduct
...
from zuora_python_sdk.pydantic.proxy_create_product import ProxyCreateProduct as ProxyCreateProductPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyCreateProductSchema


request_body_proxy_create_product = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_product_mapped_args(
        self,
        body: ProxyCreateProduct,
        allow_feature_changes: typing.Optional[bool] = None,
        category: typing.Optional[str] = None,
        description: typing.Optional[str] = None,
        effective_end_date: typing.Optional[date] = None,
        effective_start_date: typing.Optional[date] = None,
        name: typing.Optional[str] = None,
        product_number: typing.Optional[str] = None,
        ...
        if allow_feature_changes is not None:
            _body["AllowFeatureChanges"] = allow_feature_changes
        ...
        if product_number is not None:
            _body["ProductNumber"] = product_number
        if sku is not None:
            _body["SKU"] = sku
    ...
    async def _ap_ost_product_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_create_product.serialize(body, content_type)
...
class POstProductRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_product(
        self,
        body: ProxyCreateProduct,
        allow_feature_changes: typing.Optional[bool] = None,
        category: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_ost_product_mapped_args(
            body=body,
        ...
        return await self._ap_ost_product_oapg(
            body=args.body,
    ...
    def p_ost_product(
        ...
        return self._p_ost_product_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstProduct(BaseApi):
    ...
    async def ap_ost_product(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ost_product(
            body=body,
            allow_feature_changes=allow_feature_changes,
            category=category,
            description=description,
    ...
    def p_ost_product(
        ...
        raw_response = self.raw.p_ost_product(
            body=body,
            allow_feature_changes=allow_feature_changes,
            category=category,
            description=description,
