...
from zuora_python_sdk.model.get_journal_run_type import GETJournalRunType as GETJournalRunTypeSchema

from zuora_python_sdk.type.get_journal_run_type import GETJournalRunType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_journal_run_type import GETJournalRunType as GETJournalRunTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETJournalRunTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _journal_run_0_mapped_args(
        self,
        jr_number: str,
    ...
    async def _ajournal_run_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-runs/{jr-number}',
            headers=_headers,
        )
...
class JournalRun0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajournal_run_0(
        self,
        jr_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._journal_run_0_mapped_args(
            jr_number=jr_number,
        ...
        return await self._ajournal_run_0_oapg(
    ...
    def journal_run_0(
        ...
        return self._journal_run_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class JournalRun0(BaseApi):
    ...
    async def ajournal_run_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETJournalRunTypePydantic:
        raw_response = await self.raw.ajournal_run_0(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETJournalRunTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETJournalRunTypePydantic, raw_response.body)
    ...
    def journal_run_0(
        ...
        raw_response = self.raw.journal_run_0(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
