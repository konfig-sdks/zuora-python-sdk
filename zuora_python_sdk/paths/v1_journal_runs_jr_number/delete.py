...
class BaseApi(api_client.Api):
    ...
    def _journal_run_1_mapped_args(
        self,
        jr_number: str,
    ...
    async def _ajournal_run_1_oapg(
        self,
...
class JournalRun1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajournal_run_1(
        self,
        jr_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._journal_run_1_mapped_args(
            jr_number=jr_number,
        ...
        return await self._ajournal_run_1_oapg(
    ...
    def journal_run_1(
        ...
        return self._journal_run_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class JournalRun1(BaseApi):
    ...
    async def ajournal_run_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ajournal_run_1(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def journal_run_1(
        ...
        raw_response = self.raw.journal_run_1(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
