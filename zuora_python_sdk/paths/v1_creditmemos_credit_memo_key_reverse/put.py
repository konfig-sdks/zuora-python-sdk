...
from zuora_python_sdk.model.put_reverse_credit_memo_response_type import PutReverseCreditMemoResponseType as PutReverseCreditMemoResponseTypeSchema
from zuora_python_sdk.model.put_reverse_credit_memo_type import PutReverseCreditMemoType as PutReverseCreditMemoTypeSchema

from zuora_python_sdk.type.put_reverse_credit_memo_type import PutReverseCreditMemoType
from zuora_python_sdk.type.put_reverse_credit_memo_response_type import PutReverseCreditMemoResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_reverse_credit_memo_type import PutReverseCreditMemoType as PutReverseCreditMemoTypePydantic
from zuora_python_sdk.pydantic.put_reverse_credit_memo_response_type import PutReverseCreditMemoResponseType as PutReverseCreditMemoResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutReverseCreditMemoTypeSchema


request_body_put_reverse_credit_memo_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PutReverseCreditMemoResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PutReverseCreditMemoResponseType
...
class BaseApi(api_client.Api):
    ...
    def _reverse_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
        apply_effective_date: typing.Optional[date] = None,
        ...
        if apply_effective_date is not None:
            _body["applyEffectiveDate"] = apply_effective_date
    ...
    async def _areverse_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/reverse',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_reverse_credit_memo_type.serialize(body, content_type)
...
class ReverseCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areverse_credit_memo(
        self,
        credit_memo_key: str,
        apply_effective_date: typing.Optional[date] = None,
        memo_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._reverse_credit_memo_mapped_args(
            credit_memo_key=credit_memo_key,
            apply_effective_date=apply_effective_date,
            memo_date=memo_date,
        ...
        return await self._areverse_credit_memo_oapg(
            body=args.body,
    ...
    def reverse_credit_memo(
        ...
        return self._reverse_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReverseCreditMemo(BaseApi):
    ...
    async def areverse_credit_memo(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PutReverseCreditMemoResponseTypePydantic:
        raw_response = await self.raw.areverse_credit_memo(
            credit_memo_key=credit_memo_key,
            apply_effective_date=apply_effective_date,
            memo_date=memo_date,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return PutReverseCreditMemoResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PutReverseCreditMemoResponseTypePydantic, raw_response.body)
    ...
    def reverse_credit_memo(
        ...
        raw_response = self.raw.reverse_credit_memo(
            credit_memo_key=credit_memo_key,
            apply_effective_date=apply_effective_date,
            memo_date=memo_date,
            accept_encoding=accept_encoding,
