...
class DebitMemo1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_1(
        self,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_1_mapped_args(
        ...
        return await self._adebit_memo_1_oapg(
    ...
    def debit_memo_1(
        ...
        return self._debit_memo_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemo1(BaseApi):
    ...
    async def adebit_memo_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adebit_memo_1(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def debit_memo_1(
        ...
        raw_response = self.raw.debit_memo_1(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
