...
class DebitMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo(
        self,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_mapped_args(
        ...
        return await self._adebit_memo_oapg(
    ...
    def debit_memo(
        ...
        return self._debit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemo(BaseApi):
    ...
    async def adebit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adebit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def debit_memo(
        ...
        raw_response = self.raw.debit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
