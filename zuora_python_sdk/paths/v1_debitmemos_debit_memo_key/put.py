...
from zuora_python_sdk.model.put_debit_memo_type import PUTDebitMemoType as PUTDebitMemoTypeSchema
from zuora_python_sdk.model.put_debit_memo_item_type import PUTDebitMemoItemType as PUTDebitMemoItemTypeSchema

from zuora_python_sdk.type.get_debit_memo_type import GETDebitMemoType
from zuora_python_sdk.type.put_debit_memo_item_type import PUTDebitMemoItemType
from zuora_python_sdk.type.put_debit_memo_type import PUTDebitMemoType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_type import GETDebitMemoType as GETDebitMemoTypePydantic
from zuora_python_sdk.pydantic.put_debit_memo_type import PUTDebitMemoType as PUTDebitMemoTypePydantic
from zuora_python_sdk.pydantic.put_debit_memo_item_type import PUTDebitMemoItemType as PUTDebitMemoItemTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTDebitMemoTypeSchema


request_body_put_debit_memo_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_0_mapped_args(
        ...
        items: typing.Optional[typing.List[PUTDebitMemoItemType]] = None,
    ...
    async def _adebit_memo_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_debit_memo_type.serialize(body, content_type)
...
class DebitMemo0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_0(
        self,
        body: PUTDebitMemoType,
        debit_memo_key: str,
        auto_pay: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_0_mapped_args(
            body=body,
        ...
        return await self._adebit_memo_0_oapg(
            body=args.body,
    ...
    def debit_memo_0(
        ...
        return self._debit_memo_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemo0(BaseApi):
    ...
    async def adebit_memo_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adebit_memo_0(
            body=body,
            debit_memo_key=debit_memo_key,
            auto_pay=auto_pay,
            comment=comment,
    ...
    def debit_memo_0(
        ...
        raw_response = self.raw.debit_memo_0(
            body=body,
            debit_memo_key=debit_memo_key,
            auto_pay=auto_pay,
            comment=comment,
