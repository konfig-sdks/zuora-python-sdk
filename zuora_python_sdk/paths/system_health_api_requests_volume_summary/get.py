...
from zuora_python_sdk.model.get_api_volume_summary_response import GetApiVolumeSummaryResponse as GetApiVolumeSummaryResponseSchema

from zuora_python_sdk.type.get_api_volume_summary_response import GetApiVolumeSummaryResponse
...
from zuora_python_sdk.pydantic.get_api_volume_summary_response import GetApiVolumeSummaryResponse as GetApiVolumeSummaryResponsePydantic

from . import path

# Query params
PathSchema = schemas.StrSchema
HttpMethodSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'httpMethod': typing.Union[HttpMethodSchema, str, ],
    },
    total=False
)
...
request_query_http_method = api_client.QueryParameter(
    name="httpMethod",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = GetApiVolumeSummaryResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetApiVolumeSummaryResponse
...
class BaseApi(api_client.Api):
    ...
    def _system_health_api_volume_summary_mapped_args(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        if http_method is not None:
            _query_params["httpMethod"] = http_method
    ...
    async def _asystem_health_api_volume_summary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/system-health/api-requests/volume-summary',
            headers=_headers,
        )
    ...
    def _system_health_api_volume_summary_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SystemHealthApiVolumeSummaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asystem_health_api_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        **kwargs,
        ...
        args = self._system_health_api_volume_summary_mapped_args(
        ...
        return await self._asystem_health_api_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def system_health_api_volume_summary(
        self,
        authorization: str,
        start_time: datetime,
        end_time: datetime,
        ...
        return self._system_health_api_volume_summary_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class SystemHealthApiVolumeSummary(BaseApi):
    ...
    async def asystem_health_api_volume_summary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetApiVolumeSummaryResponsePydantic:
        raw_response = await self.raw.asystem_health_api_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GetApiVolumeSummaryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetApiVolumeSummaryResponsePydantic, raw_response.body)
    ...
    def system_health_api_volume_summary(
        ...
        raw_response = self.raw.system_health_api_volume_summary(
            authorization=authorization,
            start_time=start_time,
            end_time=end_time,
            accept_encoding=accept_encoding,
