...
from zuora_python_sdk.model.get_order_action_rate_plan_response import GetOrderActionRatePlanResponse as GetOrderActionRatePlanResponseSchema

from zuora_python_sdk.type.get_order_action_rate_plan_response import GetOrderActionRatePlanResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_order_action_rate_plan_response import GetOrderActionRatePlanResponse as GetOrderActionRatePlanResponsePydantic
...
# Path params
RatePlanIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ratePlanId': typing.Union[RatePlanIdSchema, str, ],
    }
)
...
request_path_rate_plan_id = api_client.PathParameter(
    name="ratePlanId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RatePlanIdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GetOrderActionRatePlanResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetOrderActionRatePlanResponse
    ...
    async def _arate_plan_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/rateplans/{ratePlanId}',
            headers=_headers,
        )
...
class RatePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arate_plan(
        self,
        rate_plan_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._rate_plan_mapped_args(
        ...
        return await self._arate_plan_oapg(
    ...
    def rate_plan(
        ...
        return self._rate_plan_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RatePlan(BaseApi):
    ...
    async def arate_plan(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOrderActionRatePlanResponsePydantic:
        raw_response = await self.raw.arate_plan(
            rate_plan_id=rate_plan_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GetOrderActionRatePlanResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetOrderActionRatePlanResponsePydantic, raw_response.body)
    ...
    def rate_plan(
        ...
        raw_response = self.raw.rate_plan(
            rate_plan_id=rate_plan_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
