...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'file-id': typing.Union[FileIdSchema, str, ],
    }
)
    ...
    async def _afiles_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/files/{file-id}',
            headers=_headers,
        )
...
class FilesRaw(BaseApi):
    ...
    async def afiles(
        ...
        **kwargs,
        ...
        return await self._afiles_oapg(
...
class Files(BaseApi):
    ...
    async def afiles(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afiles(
            file_id=file_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
