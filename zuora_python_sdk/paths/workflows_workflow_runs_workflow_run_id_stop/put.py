...
from zuora_python_sdk.model.stop_workflow_run_success import StopWorkflowRunSuccess as StopWorkflowRunSuccessSchema
from zuora_python_sdk.model.stop_workflow_run_error import StopWorkflowRunError as StopWorkflowRunErrorSchema

from zuora_python_sdk.type.stop_workflow_run_success import StopWorkflowRunSuccess
from zuora_python_sdk.type.stop_workflow_run_error import StopWorkflowRunError

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.stop_workflow_run_error import StopWorkflowRunError as StopWorkflowRunErrorPydantic
from zuora_python_sdk.pydantic.stop_workflow_run_success import StopWorkflowRunSuccess as StopWorkflowRunSuccessPydantic
...
SchemaFor200ResponseBodyApplicationJson = StopWorkflowRunSuccessSchema
...
SchemaFor404ResponseBodyApplicationJson = StopWorkflowRunErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _stop_workflow_run_mapped_args(
        self,
        authorization: str,
        workflow_run_id: str,
    ...
    async def _astop_workflow_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workflows/workflow_runs/{workflow_run_id}/stop',
            headers=_headers,
        )
...
class StopWorkflowRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astop_workflow_run(
        self,
        authorization: str,
        workflow_run_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._stop_workflow_run_mapped_args(
        ...
        return await self._astop_workflow_run_oapg(
    ...
    def stop_workflow_run(
        ...
        return self._stop_workflow_run_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class StopWorkflowRun(BaseApi):
    ...
    async def astop_workflow_run(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StopWorkflowRunSuccessPydantic:
        raw_response = await self.raw.astop_workflow_run(
            authorization=authorization,
            workflow_run_id=workflow_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return StopWorkflowRunSuccessPydantic(**raw_response.body)
        return api_client.construct_model_instance(StopWorkflowRunSuccessPydantic, raw_response.body)
    ...
    def stop_workflow_run(
        ...
        raw_response = self.raw.stop_workflow_run(
            authorization=authorization,
            workflow_run_id=workflow_run_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
