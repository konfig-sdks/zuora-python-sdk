...
from zuora_python_sdk.model.notifications_query_notification_definitions_response import NotificationsQueryNotificationDefinitionsResponse as NotificationsQueryNotificationDefinitionsResponseSchema

from zuora_python_sdk.type.error_response import ErrorResponse
from zuora_python_sdk.type.notifications_query_notification_definitions_response import NotificationsQueryNotificationDefinitionsResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.notifications_query_notification_definitions_response import NotificationsQueryNotificationDefinitionsResponse as NotificationsQueryNotificationDefinitionsResponsePydantic
...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
ProfileIdSchema = schemas.UUIDSchema
EventCategorySchema = schemas.NumberSchema
EventTypeNameSchema = schemas.StrSchema
EmailTemplateIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'profileId': typing.Union[ProfileIdSchema, str, uuid.UUID, ],
        'eventCategory': typing.Union[EventCategorySchema, decimal.Decimal, int, float, ],
        'eventTypeName': typing.Union[EventTypeNameSchema, str, ],
        'emailTemplateId': typing.Union[EmailTemplateIdSchema, str, uuid.UUID, ],
    },
    total=False
)
...
request_query_event_category = api_client.QueryParameter(
    name="eventCategory",
    style=api_client.ParameterStyle.FORM,
    schema=EventCategorySchema,
    explode=True,
)
request_query_event_type_name = api_client.QueryParameter(
    name="eventTypeName",
    style=api_client.ParameterStyle.FORM,
    schema=EventTypeNameSchema,
    explode=True,
)
request_query_email_template_id = api_client.QueryParameter(
    name="emailTemplateId",
    style=api_client.ParameterStyle.FORM,
    schema=EmailTemplateIdSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = NotificationsQueryNotificationDefinitionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: NotificationsQueryNotificationDefinitionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _query_notification_definitions_mapped_args(
        self,
        authorization: str,
        ...
        if event_category is not None:
            _query_params["eventCategory"] = event_category
        if event_type_name is not None:
            _query_params["eventTypeName"] = event_type_name
        if email_template_id is not None:
            _query_params["emailTemplateId"] = email_template_id
    ...
    async def _aquery_notification_definitions_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_event_category,
            request_query_event_type_name,
            request_query_email_template_id,
        ):
    ...
    def _query_notification_definitions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class QueryNotificationDefinitionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_notification_definitions(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._query_notification_definitions_mapped_args(
        ...
        return await self._aquery_notification_definitions_oapg(
    ...
    def query_notification_definitions(
        ...
        return self._query_notification_definitions_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class QueryNotificationDefinitions(BaseApi):
    ...
    async def aquery_notification_definitions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NotificationsQueryNotificationDefinitionsResponsePydantic:
        raw_response = await self.raw.aquery_notification_definitions(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return NotificationsQueryNotificationDefinitionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NotificationsQueryNotificationDefinitionsResponsePydantic, raw_response.body)
    ...
    def query_notification_definitions(
        ...
        raw_response = self.raw.query_notification_definitions(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
