...
from zuora_python_sdk.model.post_accounting_period_response_type import POSTAccountingPeriodResponseType as POSTAccountingPeriodResponseTypeSchema
from zuora_python_sdk.model.post_accounting_period_type import POSTAccountingPeriodType as POSTAccountingPeriodTypeSchema

from zuora_python_sdk.type.post_accounting_period_type import POSTAccountingPeriodType
from zuora_python_sdk.type.post_accounting_period_response_type import POSTAccountingPeriodResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_accounting_period_response_type import POSTAccountingPeriodResponseType as POSTAccountingPeriodResponseTypePydantic
from zuora_python_sdk.pydantic.post_accounting_period_type import POSTAccountingPeriodType as POSTAccountingPeriodTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTAccountingPeriodTypeSchema


request_body_post_accounting_period_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTAccountingPeriodResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTAccountingPeriodResponseType
...
class BaseApi(api_client.Api):
    ...
    def _accounting_period_mapped_args(
        self,
        body: POSTAccountingPeriodType,
        end_date: typing.Optional[date] = None,
        fiscal_year: typing.Optional[str] = None,
        fiscal_quarter: typing.Optional[int] = None,
        ...
        if fiscal_year is not None:
            _body["fiscalYear"] = fiscal_year
        if fiscal_quarter is not None:
            _body["fiscal_quarter"] = fiscal_quarter
        if name is not None:
            _body["name"] = name
    ...
    async def _aaccounting_period_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_accounting_period_type.serialize(body, content_type)
...
class AccountingPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccounting_period(
        self,
        body: POSTAccountingPeriodType,
        end_date: typing.Optional[date] = None,
        fiscal_year: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._accounting_period_mapped_args(
            body=body,
            end_date=end_date,
        ...
        return await self._aaccounting_period_oapg(
            body=args.body,
    ...
    def accounting_period(
        ...
        return self._accounting_period_oapg(
            body=args.body,
            header_params=args.header,
        )

class AccountingPeriod(BaseApi):
    ...
    async def aaccounting_period(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTAccountingPeriodResponseTypePydantic:
        raw_response = await self.raw.aaccounting_period(
            body=body,
            end_date=end_date,
            fiscal_year=fiscal_year,
            fiscal_quarter=fiscal_quarter,
        ...
        if validate:
            return POSTAccountingPeriodResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTAccountingPeriodResponseTypePydantic, raw_response.body)
    ...
    def accounting_period(
        ...
        raw_response = self.raw.accounting_period(
            body=body,
            end_date=end_date,
            fiscal_year=fiscal_year,
            fiscal_quarter=fiscal_quarter,
