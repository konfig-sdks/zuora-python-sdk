...
from zuora_python_sdk.model.get_accounting_periods_type import GETAccountingPeriodsType as GETAccountingPeriodsTypeSchema

from zuora_python_sdk.type.get_accounting_periods_type import GETAccountingPeriodsType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_accounting_periods_type import GETAccountingPeriodsType as GETAccountingPeriodsTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAccountingPeriodsTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _all_accounting_periods_mapped_args(
        self,
    ...
    async def _aall_accounting_periods_oapg(
        self,
    ...
    def _all_accounting_periods_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AllAccountingPeriodsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_accounting_periods(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_accounting_periods_mapped_args(
        ...
        return await self._aall_accounting_periods_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def all_accounting_periods(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._all_accounting_periods_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class AllAccountingPeriods(BaseApi):
    ...
    async def aall_accounting_periods(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountingPeriodsTypePydantic:
        raw_response = await self.raw.aall_accounting_periods(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETAccountingPeriodsTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAccountingPeriodsTypePydantic, raw_response.body)
    ...
    def all_accounting_periods(
        ...
        raw_response = self.raw.all_accounting_periods(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
