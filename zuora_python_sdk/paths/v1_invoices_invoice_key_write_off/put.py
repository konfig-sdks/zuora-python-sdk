...
from zuora_python_sdk.model.put_write_off_invoice_response import PUTWriteOffInvoiceResponse as PUTWriteOffInvoiceResponseSchema
from zuora_python_sdk.model.put_write_off_invoice_request import PUTWriteOffInvoiceRequest as PUTWriteOffInvoiceRequestSchema
from zuora_python_sdk.model.credit_memo_item_from_write_off_invoice import CreditMemoItemFromWriteOffInvoice as CreditMemoItemFromWriteOffInvoiceSchema

from zuora_python_sdk.type.put_write_off_invoice_request import PUTWriteOffInvoiceRequest
from zuora_python_sdk.type.put_write_off_invoice_response import PUTWriteOffInvoiceResponse
from zuora_python_sdk.type.credit_memo_item_from_write_off_invoice import CreditMemoItemFromWriteOffInvoice

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.credit_memo_item_from_write_off_invoice import CreditMemoItemFromWriteOffInvoice as CreditMemoItemFromWriteOffInvoicePydantic
from zuora_python_sdk.pydantic.put_write_off_invoice_request import PUTWriteOffInvoiceRequest as PUTWriteOffInvoiceRequestPydantic
from zuora_python_sdk.pydantic.put_write_off_invoice_response import PUTWriteOffInvoiceResponse as PUTWriteOffInvoiceResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTWriteOffInvoiceRequestSchema


request_body_put_write_off_invoice_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTWriteOffInvoiceResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTWriteOffInvoiceResponse
...
class BaseApi(api_client.Api):
    ...
    def _write_off_invoice_mapped_args(
        self,
        invoice_key: str,
        comment: typing.Optional[str] = None,
        items: typing.Optional[typing.List[CreditMemoItemFromWriteOffInvoice]] = None,
        memo_date: typing.Optional[date] = None,
    ...
    async def _awrite_off_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/write-off',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_write_off_invoice_request.serialize(body, content_type)
...
class WriteOffInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awrite_off_invoice(
        self,
        invoice_key: str,
        comment: typing.Optional[str] = None,
        items: typing.Optional[typing.List[CreditMemoItemFromWriteOffInvoice]] = None,
        ...
        **kwargs,
        ...
        args = self._write_off_invoice_mapped_args(
        ...
        return await self._awrite_off_invoice_oapg(
            body=args.body,
    ...
    def write_off_invoice(
        ...
        return self._write_off_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class WriteOffInvoice(BaseApi):
    ...
    async def awrite_off_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTWriteOffInvoiceResponsePydantic:
        raw_response = await self.raw.awrite_off_invoice(
            invoice_key=invoice_key,
            comment=comment,
            items=items,
            memo_date=memo_date,
        ...
        if validate:
            return PUTWriteOffInvoiceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTWriteOffInvoiceResponsePydantic, raw_response.body)
    ...
    def write_off_invoice(
        ...
        raw_response = self.raw.write_off_invoice(
            invoice_key=invoice_key,
            comment=comment,
            items=items,
            memo_date=memo_date,
