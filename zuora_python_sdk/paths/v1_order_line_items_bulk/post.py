...
from zuora_python_sdk.model.post_order_line_item_update_type import PostOrderLineItemUpdateType as PostOrderLineItemUpdateTypeSchema
from zuora_python_sdk.model.get_order_line_item_response_type import GetOrderLineItemResponseType as GetOrderLineItemResponseTypeSchema
from zuora_python_sdk.model.processing_options import ProcessingOptions as ProcessingOptionsSchema
from zuora_python_sdk.model.post_order_line_items_request_type import PostOrderLineItemsRequestType as PostOrderLineItemsRequestTypeSchema

from zuora_python_sdk.type.get_order_line_item_response_type import GetOrderLineItemResponseType
from zuora_python_sdk.type.post_order_line_item_update_type import PostOrderLineItemUpdateType
from zuora_python_sdk.type.processing_options import ProcessingOptions
from zuora_python_sdk.type.post_order_line_items_request_type import PostOrderLineItemsRequestType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_order_line_item_update_type import PostOrderLineItemUpdateType as PostOrderLineItemUpdateTypePydantic
from zuora_python_sdk.pydantic.processing_options import ProcessingOptions as ProcessingOptionsPydantic
from zuora_python_sdk.pydantic.post_order_line_items_request_type import PostOrderLineItemsRequestType as PostOrderLineItemsRequestTypePydantic
from zuora_python_sdk.pydantic.get_order_line_item_response_type import GetOrderLineItemResponseType as GetOrderLineItemResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostOrderLineItemsRequestTypeSchema


request_body_post_order_line_items_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GetOrderLineItemResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetOrderLineItemResponseType
...
class BaseApi(api_client.Api):
    ...
    def _order_line_items_mapped_args(
        self,
        order_line_items: typing.Optional[typing.List[PostOrderLineItemUpdateType]] = None,
        processing_options: typing.Optional[ProcessingOptions] = None,
    ...
    async def _aorder_line_items_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_order_line_items_request_type.serialize(body, content_type)
...
class OrderLineItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_line_items(
        self,
        order_line_items: typing.Optional[typing.List[PostOrderLineItemUpdateType]] = None,
        processing_options: typing.Optional[ProcessingOptions] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_line_items_mapped_args(
        ...
        return await self._aorder_line_items_oapg(
            body=args.body,
    ...
    def order_line_items(
        ...
        return self._order_line_items_oapg(
            body=args.body,
            header_params=args.header,
        )

class OrderLineItems(BaseApi):
    ...
    async def aorder_line_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetOrderLineItemResponseTypePydantic:
        raw_response = await self.raw.aorder_line_items(
            order_line_items=order_line_items,
            processing_options=processing_options,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[GetOrderLineItemResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetOrderLineItemResponseTypePydantic, raw_response.body)
    ...
    def order_line_items(
        ...
        raw_response = self.raw.order_line_items(
            order_line_items=order_line_items,
            processing_options=processing_options,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
