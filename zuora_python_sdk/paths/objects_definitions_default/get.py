...
class BaseApi(api_client.Api):
    ...
    def _all_custom_object_definitions_in_namespace_mapped_args(
        self,
        authorization: str,
    ...
    async def _aall_custom_object_definitions_in_namespace_oapg(
        self,
    ...
    def _all_custom_object_definitions_in_namespace_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AllCustomObjectDefinitionsInNamespaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aall_custom_object_definitions_in_namespace(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._all_custom_object_definitions_in_namespace_mapped_args(
        ...
        return await self._aall_custom_object_definitions_in_namespace_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def all_custom_object_definitions_in_namespace(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._all_custom_object_definitions_in_namespace_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class AllCustomObjectDefinitionsInNamespace(BaseApi):
    ...
    async def aall_custom_object_definitions_in_namespace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aall_custom_object_definitions_in_namespace(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
    ...
    def all_custom_object_definitions_in_namespace(
        ...
        raw_response = self.raw.all_custom_object_definitions_in_namespace(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_track_id=zuora_track_id,
