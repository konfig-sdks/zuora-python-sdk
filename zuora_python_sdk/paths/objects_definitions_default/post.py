...
from zuora_python_sdk.model.post_custom_object_definitions_request_definitions import PostCustomObjectDefinitionsRequestDefinitions as PostCustomObjectDefinitionsRequestDefinitionsSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.get_all_custom_object_definitions_in_namespace_response import GETAllCustomObjectDefinitionsInNamespaceResponse as GETAllCustomObjectDefinitionsInNamespaceResponseSchema
from zuora_python_sdk.model.post_custom_object_definitions_request import PostCustomObjectDefinitionsRequest as PostCustomObjectDefinitionsRequestSchema

from zuora_python_sdk.type.post_custom_object_definitions_request import PostCustomObjectDefinitionsRequest
from zuora_python_sdk.type.post_custom_object_definitions_request_definitions import PostCustomObjectDefinitionsRequestDefinitions
from zuora_python_sdk.type.get_all_custom_object_definitions_in_namespace_response import GETAllCustomObjectDefinitionsInNamespaceResponse
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_custom_object_definitions_request_definitions import PostCustomObjectDefinitionsRequestDefinitions as PostCustomObjectDefinitionsRequestDefinitionsPydantic
from zuora_python_sdk.pydantic.get_all_custom_object_definitions_in_namespace_response import GETAllCustomObjectDefinitionsInNamespaceResponse as GETAllCustomObjectDefinitionsInNamespaceResponsePydantic
from zuora_python_sdk.pydantic.post_custom_object_definitions_request import PostCustomObjectDefinitionsRequest as PostCustomObjectDefinitionsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostCustomObjectDefinitionsRequestSchema


request_body_post_custom_object_definitions_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETAllCustomObjectDefinitionsInNamespaceResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAllCustomObjectDefinitionsInNamespaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _custom_object_definitions_mapped_args(
        self,
        authorization: str,
        definitions: typing.Optional[PostCustomObjectDefinitionsRequestDefinitions] = None,
    ...
    async def _acustom_object_definitions_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_custom_object_definitions_request.serialize(body, content_type)
    ...
    def _custom_object_definitions_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomObjectDefinitionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustom_object_definitions(
        self,
        authorization: str,
        definitions: typing.Optional[PostCustomObjectDefinitionsRequestDefinitions] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._custom_object_definitions_mapped_args(
        ...
        return await self._acustom_object_definitions_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def custom_object_definitions(
        self,
        authorization: str,
        definitions: typing.Optional[PostCustomObjectDefinitionsRequestDefinitions] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._custom_object_definitions_oapg(
            body=args.body,
            header_params=args.header,
        )

class CustomObjectDefinitions(BaseApi):
    ...
    async def acustom_object_definitions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAllCustomObjectDefinitionsInNamespaceResponsePydantic:
        raw_response = await self.raw.acustom_object_definitions(
            authorization=authorization,
            definitions=definitions,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GETAllCustomObjectDefinitionsInNamespaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAllCustomObjectDefinitionsInNamespaceResponsePydantic, raw_response.body)
    ...
    def custom_object_definitions(
        ...
        raw_response = self.raw.custom_object_definitions(
            authorization=authorization,
            definitions=definitions,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
