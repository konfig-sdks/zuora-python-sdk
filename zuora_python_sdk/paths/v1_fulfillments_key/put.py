...
from zuora_python_sdk.model.fulfillment_custom_fields import FulfillmentCustomFields as FulfillmentCustomFieldsSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.put_fulfillment_request_type import PutFulfillmentRequestType as PutFulfillmentRequestTypeSchema

from zuora_python_sdk.type.put_fulfillment_request_type import PutFulfillmentRequestType
from zuora_python_sdk.type.common_response import CommonResponse
from zuora_python_sdk.type.fulfillment_custom_fields import FulfillmentCustomFields

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.fulfillment_custom_fields import FulfillmentCustomFields as FulfillmentCustomFieldsPydantic
from zuora_python_sdk.pydantic.put_fulfillment_request_type import PutFulfillmentRequestType as PutFulfillmentRequestTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutFulfillmentRequestTypeSchema


request_body_put_fulfillment_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_1_mapped_args(
        self,
        key: str,
        description: typing.Optional[str] = None,
        bill_target_date: typing.Optional[date] = None,
        carrier: typing.Optional[str] = None,
        custom_fields: typing.Optional[FulfillmentCustomFields] = None,
        ...
        fulfillment_date: typing.Optional[date] = None,
        fulfillment_location: typing.Optional[str] = None,
        fulfillment_system: typing.Optional[str] = None,
        fulfillment_type: typing.Optional[str] = None,
        ...
        if fulfillment_date is not None:
            _body["fulfillmentDate"] = fulfillment_date
        if fulfillment_location is not None:
            _body["fulfillmentLocation"] = fulfillment_location
        if fulfillment_system is not None:
            _body["fulfillmentSystem"] = fulfillment_system
        if fulfillment_type is not None:
            _body["fulfillmentType"] = fulfillment_type
    ...
    async def _afulfillment_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/fulfillments/{key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_fulfillment_request_type.serialize(body, content_type)
...
class Fulfillment1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_1(
        self,
        key: str,
        description: typing.Optional[str] = None,
        bill_target_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_1_mapped_args(
            key=key,
        ...
        return await self._afulfillment_1_oapg(
            body=args.body,
    ...
    def fulfillment_1(
        ...
        return self._fulfillment_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class Fulfillment1(BaseApi):
    ...
    async def afulfillment_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afulfillment_1(
            key=key,
            description=description,
            bill_target_date=bill_target_date,
            carrier=carrier,
    ...
    def fulfillment_1(
        ...
        raw_response = self.raw.fulfillment_1(
            key=key,
            description=description,
            bill_target_date=bill_target_date,
            carrier=carrier,
