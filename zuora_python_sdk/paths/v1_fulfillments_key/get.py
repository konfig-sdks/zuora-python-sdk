...
from zuora_python_sdk.model.get_fulfillment_response_type import GetFulfillmentResponseType as GetFulfillmentResponseTypeSchema

from zuora_python_sdk.type.get_fulfillment_response_type import GetFulfillmentResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_fulfillment_response_type import GetFulfillmentResponseType as GetFulfillmentResponseTypePydantic

from . import path

# Query params
FulfillmentItemsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fulfillment-items': typing.Union[FulfillmentItemsSchema, bool, ],
    },
    total=False
)
...
request_query_fulfillment_items = api_client.QueryParameter(
    name="fulfillment-items",
    style=api_client.ParameterStyle.FORM,
    schema=FulfillmentItemsSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetFulfillmentResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetFulfillmentResponseType
...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_0_mapped_args(
        self,
        key: str,
        ...
        fulfillment_items: typing.Optional[bool] = None,
        ...
        if fulfillment_items is not None:
            _query_params["fulfillment-items"] = fulfillment_items
    ...
    async def _afulfillment_0_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_fulfillment_items,
        ):
...
class Fulfillment0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_0(
        self,
        key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_0_mapped_args(
            key=key,
        ...
        return await self._afulfillment_0_oapg(
    ...
    def fulfillment_0(
        ...
        return self._fulfillment_0_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class Fulfillment0(BaseApi):
    ...
    async def afulfillment_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetFulfillmentResponseTypePydantic:
        raw_response = await self.raw.afulfillment_0(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GetFulfillmentResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetFulfillmentResponseTypePydantic, raw_response.body)
    ...
    def fulfillment_0(
        ...
        raw_response = self.raw.fulfillment_0(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
