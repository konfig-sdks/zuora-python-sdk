...
class BaseApi(api_client.Api):
    ...
    def _fulfillment_2_mapped_args(
        self,
        key: str,
    ...
    async def _afulfillment_2_oapg(
        self,
...
class Fulfillment2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afulfillment_2(
        self,
        key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._fulfillment_2_mapped_args(
            key=key,
        ...
        return await self._afulfillment_2_oapg(
    ...
    def fulfillment_2(
        ...
        return self._fulfillment_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Fulfillment2(BaseApi):
    ...
    async def afulfillment_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afulfillment_2(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def fulfillment_2(
        ...
        raw_response = self.raw.fulfillment_2(
            key=key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
