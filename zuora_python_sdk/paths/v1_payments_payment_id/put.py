...
from zuora_python_sdk.model.update_payment_type import UpdatePaymentType as UpdatePaymentTypeSchema

from zuora_python_sdk.type.update_payment_type import UpdatePaymentType
from zuora_python_sdk.type.getar_payment_type import GETARPaymentType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.update_payment_type import UpdatePaymentType as UpdatePaymentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdatePaymentTypeSchema


request_body_update_payment_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_payment_mapped_args(
        self,
        ...
        gateway_state: typing.Optional[str] = None,
        ...
        if gateway_state is not None:
            _body["gatewayState"] = gateway_state
    ...
    async def _aupdate_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_payment_type.serialize(body, content_type)
...
class UpdatePaymentRaw(BaseApi):
    ...
    async def aupdate_payment(
        ...
        **kwargs,
        ...
        args = self._update_payment_mapped_args(
            body=body,
        ...
        return await self._aupdate_payment_oapg(
            body=args.body,
    ...
    def update_payment(
        ...
        return self._update_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdatePayment(BaseApi):
    ...
    async def aupdate_payment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_payment(
            body=body,
            payment_id=payment_id,
            comment=comment,
            finance_information=finance_information,
    ...
    def update_payment(
        ...
        raw_response = self.raw.update_payment(
            body=body,
            payment_id=payment_id,
            comment=comment,
            finance_information=finance_information,
