...
from zuora_python_sdk.model.create_or_update_email_templates_response import CreateOrUpdateEmailTemplatesResponse as CreateOrUpdateEmailTemplatesResponseSchema
from zuora_python_sdk.model.post_create_or_update_email_template_request import POSTCreateOrUpdateEmailTemplateRequest as POSTCreateOrUpdateEmailTemplateRequestSchema
from zuora_python_sdk.model.post_create_or_update_email_template_request_format import POSTCreateOrUpdateEmailTemplateRequestFormat as POSTCreateOrUpdateEmailTemplateRequestFormatSchema

from zuora_python_sdk.type.post_create_or_update_email_template_request import POSTCreateOrUpdateEmailTemplateRequest
from zuora_python_sdk.type.post_create_or_update_email_template_request_format import POSTCreateOrUpdateEmailTemplateRequestFormat
from zuora_python_sdk.type.create_or_update_email_templates_response import CreateOrUpdateEmailTemplatesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_create_or_update_email_template_request import POSTCreateOrUpdateEmailTemplateRequest as POSTCreateOrUpdateEmailTemplateRequestPydantic
from zuora_python_sdk.pydantic.create_or_update_email_templates_response import CreateOrUpdateEmailTemplatesResponse as CreateOrUpdateEmailTemplatesResponsePydantic
from zuora_python_sdk.pydantic.post_create_or_update_email_template_request_format import POSTCreateOrUpdateEmailTemplateRequestFormat as POSTCreateOrUpdateEmailTemplateRequestFormatPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTCreateOrUpdateEmailTemplateRequestSchema


request_body_post_create_or_update_email_template_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CreateOrUpdateEmailTemplatesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CreateOrUpdateEmailTemplatesResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_email_templates_mapped_args(
        self,
        authorization: str,
        allow_partial_success: typing.Optional[bool] = None,
        email_templates: typing.Optional[typing.List[POSTCreateOrUpdateEmailTemplateRequestFormat]] = None,
        ...
        if email_templates is not None:
            _body["emailTemplates"] = email_templates
        args.body = _body
    ...
    async def _acreate_or_update_email_templates_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/email-templates/import',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_create_or_update_email_template_request.serialize(body, content_type)
    ...
    def _create_or_update_email_templates_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateOrUpdateEmailTemplatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_email_templates(
        self,
        authorization: str,
        allow_partial_success: typing.Optional[bool] = None,
        email_templates: typing.Optional[typing.List[POSTCreateOrUpdateEmailTemplateRequestFormat]] = None,
        ...
        **kwargs,
        ...
        args = self._create_or_update_email_templates_mapped_args(
        ...
        return await self._acreate_or_update_email_templates_oapg(
            body=args.body,
    ...
    def create_or_update_email_templates(
        ...
        return self._create_or_update_email_templates_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateOrUpdateEmailTemplates(BaseApi):
    ...
    async def acreate_or_update_email_templates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CreateOrUpdateEmailTemplatesResponsePydantic:
        raw_response = await self.raw.acreate_or_update_email_templates(
            authorization=authorization,
            allow_partial_success=allow_partial_success,
            email_templates=email_templates,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return CreateOrUpdateEmailTemplatesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CreateOrUpdateEmailTemplatesResponsePydantic, raw_response.body)
    ...
    def create_or_update_email_templates(
        ...
        raw_response = self.raw.create_or_update_email_templates(
            authorization=authorization,
            allow_partial_success=allow_partial_success,
            email_templates=email_templates,
            idempotency_key=idempotency_key,
