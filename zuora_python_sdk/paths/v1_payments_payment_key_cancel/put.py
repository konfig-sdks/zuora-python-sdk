...
class BaseApi(api_client.Api):
    ...
    def _cancel_payment_mapped_args(
        self,
        payment_key: str,
    ...
    async def _acancel_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/cancel',
            headers=_headers,
        )
...
class CancelPaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_payment(
        self,
        payment_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_payment_mapped_args(
        ...
        return await self._acancel_payment_oapg(
...
class CancelPayment(BaseApi):
    ...
    async def acancel_payment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_payment(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def cancel_payment(
        ...
        raw_response = self.raw.cancel_payment(
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
