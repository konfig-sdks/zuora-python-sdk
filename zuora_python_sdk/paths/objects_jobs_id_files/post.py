...
# body param
SchemaForRequestBodyTextCsv = schemas.StrSchema
...
class BaseApi(api_client.Api):
    ...
    def _upload_file_for_custom_object_bulk_job_mapped_args(
        self,
        body: str,
        authorization: str,
        id: str,
    ...
    async def _aupload_file_for_custom_object_bulk_job_oapg(
        self,
    ...
    def _upload_file_for_custom_object_bulk_job_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UploadFileForCustomObjectBulkJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_file_for_custom_object_bulk_job(
        self,
        body: str,
        authorization: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._upload_file_for_custom_object_bulk_job_mapped_args(
            body=body,
        ...
        return await self._aupload_file_for_custom_object_bulk_job_oapg(
            body=args.body,
    ...
    def upload_file_for_custom_object_bulk_job(
        self,
        body: str,
        authorization: str,
        id: str,
        ...
        return self._upload_file_for_custom_object_bulk_job_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UploadFileForCustomObjectBulkJob(BaseApi):
    ...
    async def aupload_file_for_custom_object_bulk_job(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupload_file_for_custom_object_bulk_job(
            body=body,
            authorization=authorization,
            id=id,
            idempotency_key=idempotency_key,
    ...
    def upload_file_for_custom_object_bulk_job(
        ...
        raw_response = self.raw.upload_file_for_custom_object_bulk_job(
            body=body,
            authorization=authorization,
            id=id,
            idempotency_key=idempotency_key,
