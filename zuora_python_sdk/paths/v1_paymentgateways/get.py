...
from zuora_python_sdk.model.get_payment_gatways_response import GETPaymentGatwaysResponse as GETPaymentGatwaysResponseSchema

from zuora_python_sdk.type.get_payment_gatways_response import GETPaymentGatwaysResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_gatways_response import GETPaymentGatwaysResponse as GETPaymentGatwaysResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentGatwaysResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentGatwaysResponse
...
class BaseApi(api_client.Api):
    ...
    def _paymentgateways_mapped_args(
        self,
    ...
    async def _apaymentgateways_oapg(
        self,
...
class PaymentgatewaysRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apaymentgateways(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._paymentgateways_mapped_args(
        ...
        return await self._apaymentgateways_oapg(
    ...
    def paymentgateways(
        ...
        return self._paymentgateways_oapg(
            header_params=args.header,
        )

class Paymentgateways(BaseApi):
    ...
    async def apaymentgateways(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentGatwaysResponsePydantic:
        raw_response = await self.raw.apaymentgateways(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETPaymentGatwaysResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentGatwaysResponsePydantic, raw_response.body)
    ...
    def paymentgateways(
        ...
        raw_response = self.raw.paymentgateways(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
