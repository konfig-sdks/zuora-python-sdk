...
class CreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_mapped_args(
        ...
        return await self._acredit_memo_oapg(
    ...
    def credit_memo(
        ...
        return self._credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemo(BaseApi):
    ...
    async def acredit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acredit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def credit_memo(
        ...
        raw_response = self.raw.credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
