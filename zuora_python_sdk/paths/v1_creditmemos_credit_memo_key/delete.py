...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_0_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _acredit_memo_0_oapg(
        self,
...
class CreditMemo0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_0(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_0_mapped_args(
        ...
        return await self._acredit_memo_0_oapg(
    ...
    def credit_memo_0(
        ...
        return self._credit_memo_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemo0(BaseApi):
    ...
    async def acredit_memo_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acredit_memo_0(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def credit_memo_0(
        ...
        raw_response = self.raw.credit_memo_0(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
