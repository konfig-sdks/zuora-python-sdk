...
from zuora_python_sdk.model.put_credit_memo_type import PUTCreditMemoType as PUTCreditMemoTypeSchema
from zuora_python_sdk.model.put_credit_memo_item_type import PUTCreditMemoItemType as PUTCreditMemoItemTypeSchema

from zuora_python_sdk.type.put_credit_memo_item_type import PUTCreditMemoItemType
from zuora_python_sdk.type.get_credit_memo_type import GETCreditMemoType
from zuora_python_sdk.type.put_credit_memo_type import PUTCreditMemoType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_credit_memo_item_type import PUTCreditMemoItemType as PUTCreditMemoItemTypePydantic
from zuora_python_sdk.pydantic.get_credit_memo_type import GETCreditMemoType as GETCreditMemoTypePydantic
from zuora_python_sdk.pydantic.put_credit_memo_type import PUTCreditMemoType as PUTCreditMemoTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTCreditMemoTypeSchema


request_body_put_credit_memo_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_credit_memo_mapped_args(
        self,
        ...
        items: typing.Optional[typing.List[PUTCreditMemoItemType]] = None,
        ...
        if auto_apply_upon_posting is not None:
            _body["autoApplyUponPosting"] = auto_apply_upon_posting
    ...
    async def _aupdate_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_credit_memo_type.serialize(body, content_type)
...
class UpdateCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_credit_memo(
        self,
        body: PUTCreditMemoType,
        credit_memo_key: str,
        auto_apply_upon_posting: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_credit_memo_mapped_args(
            body=body,
        ...
        return await self._aupdate_credit_memo_oapg(
            body=args.body,
    ...
    def update_credit_memo(
        ...
        return self._update_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateCreditMemo(BaseApi):
    ...
    async def aupdate_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_credit_memo(
            body=body,
            credit_memo_key=credit_memo_key,
            auto_apply_upon_posting=auto_apply_upon_posting,
            comment=comment,
    ...
    def update_credit_memo(
        ...
        raw_response = self.raw.update_credit_memo(
            body=body,
            credit_memo_key=credit_memo_key,
            auto_apply_upon_posting=auto_apply_upon_posting,
            comment=comment,
