...
from zuora_python_sdk.model.put_reverse_invoice_type import PutReverseInvoiceType as PutReverseInvoiceTypeSchema
from zuora_python_sdk.model.put_reverse_invoice_response_type import PutReverseInvoiceResponseType as PutReverseInvoiceResponseTypeSchema

from zuora_python_sdk.type.put_reverse_invoice_type import PutReverseInvoiceType
from zuora_python_sdk.type.put_reverse_invoice_response_type import PutReverseInvoiceResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_reverse_invoice_response_type import PutReverseInvoiceResponseType as PutReverseInvoiceResponseTypePydantic
from zuora_python_sdk.pydantic.put_reverse_invoice_type import PutReverseInvoiceType as PutReverseInvoiceTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutReverseInvoiceTypeSchema


request_body_put_reverse_invoice_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PutReverseInvoiceResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PutReverseInvoiceResponseType
...
class BaseApi(api_client.Api):
    ...
    def _reverse_invoice_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _areverse_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/reverse',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_reverse_invoice_type.serialize(body, content_type)
...
class ReverseInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areverse_invoice(
        self,
        invoice_key: str,
        apply_effective_date: typing.Optional[date] = None,
        memo_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._reverse_invoice_mapped_args(
        ...
        return await self._areverse_invoice_oapg(
            body=args.body,
    ...
    def reverse_invoice(
        ...
        return self._reverse_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReverseInvoice(BaseApi):
    ...
    async def areverse_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PutReverseInvoiceResponseTypePydantic:
        raw_response = await self.raw.areverse_invoice(
            invoice_key=invoice_key,
            apply_effective_date=apply_effective_date,
            memo_date=memo_date,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return PutReverseInvoiceResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PutReverseInvoiceResponseTypePydantic, raw_response.body)
    ...
    def reverse_invoice(
        ...
        raw_response = self.raw.reverse_invoice(
            invoice_key=invoice_key,
            apply_effective_date=apply_effective_date,
            memo_date=memo_date,
            accept_encoding=accept_encoding,
