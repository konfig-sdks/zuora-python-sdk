...
class BaseApi(api_client.Api):
    ...
    def _delete_notification_definition_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _adelete_notification_definition_oapg(
        self,
    ...
    def _delete_notification_definition_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteNotificationDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_notification_definition(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_notification_definition_mapped_args(
        ...
        return await self._adelete_notification_definition_oapg(
    ...
    def delete_notification_definition(
        ...
        return self._delete_notification_definition_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteNotificationDefinition(BaseApi):
    ...
    async def adelete_notification_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_notification_definition(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def delete_notification_definition(
        ...
        raw_response = self.raw.delete_notification_definition(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
