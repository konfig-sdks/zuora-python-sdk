...
ZuoraRequestIdSchema = schemas.StrSchema
zuora_request_id_parameter = api_client.HeaderParameter(
    name="Zuora-Request-Id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ZuoraRequestIdSchema,
...
class BaseApi(api_client.Api):
    ...
    def _get_notification_definition_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _aget_notification_definition_oapg(
        self,
    ...
    def _get_notification_definition_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetNotificationDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_notification_definition(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_notification_definition_mapped_args(
        ...
        return await self._aget_notification_definition_oapg(
    ...
    def get_notification_definition(
        ...
        return self._get_notification_definition_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetNotificationDefinition(BaseApi):
    ...
    async def aget_notification_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_notification_definition(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def get_notification_definition(
        ...
        raw_response = self.raw.get_notification_definition(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
