...
from zuora_python_sdk.model.order_action_common import OrderActionCommon as OrderActionCommonSchema
from zuora_python_sdk.model.put_order_actions_request_type import PUTOrderActionsRequestType as PUTOrderActionsRequestTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.order_action_common import OrderActionCommon
from zuora_python_sdk.type.put_order_actions_request_type import PUTOrderActionsRequestType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_order_actions_request_type import PUTOrderActionsRequestType as PUTOrderActionsRequestTypePydantic
from zuora_python_sdk.pydantic.common_response import CommonResponse as CommonResponsePydantic
from zuora_python_sdk.pydantic.order_action_common import OrderActionCommon as OrderActionCommonPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTOrderActionsRequestTypeSchema


request_body_put_order_actions_request_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _order_actions_mapped_args(
        self,
        id: str,
        order_action: typing.Optional[OrderActionCommon] = None,
        ...
        if order_action is not None:
            _body["orderAction"] = order_action
        args.body = _body
    ...
    async def _aorder_actions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orderActions/{id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_order_actions_request_type.serialize(body, content_type)
...
class OrderActionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorder_actions(
        self,
        id: str,
        order_action: typing.Optional[OrderActionCommon] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._order_actions_mapped_args(
            id=id,
        ...
        return await self._aorder_actions_oapg(
            body=args.body,
    ...
    def order_actions(
        ...
        return self._order_actions_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class OrderActions(BaseApi):
    ...
    async def aorder_actions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorder_actions(
            id=id,
            order_action=order_action,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def order_actions(
        ...
        raw_response = self.raw.order_actions(
            id=id,
            order_action=order_action,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
