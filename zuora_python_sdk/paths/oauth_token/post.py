...
from zuora_python_sdk.model.o_auth_create_token_request import OAuthCreateTokenRequest as OAuthCreateTokenRequestSchema
from zuora_python_sdk.model.token_response import TokenResponse as TokenResponseSchema

from zuora_python_sdk.type.o_auth_create_token_request import OAuthCreateTokenRequest
from zuora_python_sdk.type.token_response import TokenResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.o_auth_create_token_request import OAuthCreateTokenRequest as OAuthCreateTokenRequestPydantic
from zuora_python_sdk.pydantic.token_response import TokenResponse as TokenResponsePydantic
...
# body param
SchemaForRequestBodyApplicationXWwwFormUrlencoded = OAuthCreateTokenRequestSchema


request_body_o_auth_create_token_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_token_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_o_auth_create_token_request.serialize(body, content_type)
...
class CreateTokenRaw(BaseApi):
    ...
    async def acreate_token(
        ...
        **kwargs,
        ...
        args = self._create_token_mapped_args(
            client_id=client_id,
            client_secret=client_secret,
            grant_type=grant_type,
            zuora_track_id=zuora_track_id,
        )
        return await self._acreate_token_oapg(
            body=args.body,
...
class CreateToken(BaseApi):
    ...
    async def acreate_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_token(
            client_id=client_id,
            client_secret=client_secret,
            grant_type=grant_type,
            zuora_track_id=zuora_track_id,
    ...
    def create_token(
        ...
        raw_response = self.raw.create_token(
            client_id=client_id,
            client_secret=client_secret,
            grant_type=grant_type,
            zuora_track_id=zuora_track_id,
