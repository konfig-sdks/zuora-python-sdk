...
from zuora_python_sdk.model.get_account_type import GETAccountType as GETAccountTypeSchema

from zuora_python_sdk.type.get_account_type import GETAccountType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_account_type import GETAccountType as GETAccountTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAccountTypeSchema
...
class Account0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccount_0(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._account_0_mapped_args(
        ...
        return await self._aaccount_0_oapg(
    ...
    def account_0(
        ...
        return self._account_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Account0(BaseApi):
    ...
    async def aaccount_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAccountTypePydantic:
        raw_response = await self.raw.aaccount_0(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETAccountTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAccountTypePydantic, raw_response.body)
    ...
    def account_0(
        ...
        raw_response = self.raw.account_0(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
