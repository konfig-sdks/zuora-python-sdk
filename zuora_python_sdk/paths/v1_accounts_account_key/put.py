...
from zuora_python_sdk.model.put_account_einvoice_profile import PUTAccountEinvoiceProfile as PUTAccountEinvoiceProfileSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.put_account_type import PUTAccountType as PUTAccountTypeSchema
from zuora_python_sdk.model.put_account_type_bill_to_contact import PUTAccountTypeBillToContact as PUTAccountTypeBillToContactSchema
from zuora_python_sdk.model.put_account_type_sold_to_contact import PUTAccountTypeSoldToContact as PUTAccountTypeSoldToContactSchema

from zuora_python_sdk.type.put_account_einvoice_profile import PUTAccountEinvoiceProfile
from zuora_python_sdk.type.put_account_type import PUTAccountType
from zuora_python_sdk.type.put_account_type_bill_to_contact import PUTAccountTypeBillToContact
from zuora_python_sdk.type.put_account_type_sold_to_contact import PUTAccountTypeSoldToContact
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_account_type_sold_to_contact import PUTAccountTypeSoldToContact as PUTAccountTypeSoldToContactPydantic
from zuora_python_sdk.pydantic.put_account_einvoice_profile import PUTAccountEinvoiceProfile as PUTAccountEinvoiceProfilePydantic
from zuora_python_sdk.pydantic.put_account_type import PUTAccountType as PUTAccountTypePydantic
from zuora_python_sdk.pydantic.put_account_type_bill_to_contact import PUTAccountTypeBillToContact as PUTAccountTypeBillToContactPydantic
...
# Path params
AccountKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'account-key': typing.Union[AccountKeySchema, str, ],
    }
)
...
request_path_account_key = api_client.PathParameter(
    name="account-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AccountKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTAccountTypeSchema


request_body_put_account_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _account_1_mapped_args(
        ...
        bill_to_contact: typing.Optional[PUTAccountTypeBillToContact] = None,
        ...
        customer_service_rep_name: typing.Optional[str] = None,
        debit_memo_template_id: typing.Optional[str] = None,
        default_payment_method_id: typing.Optional[str] = None,
        einvoice_profile: typing.Optional[PUTAccountEinvoiceProfile] = None,
        ...
        sold_to_contact: typing.Optional[PUTAccountTypeSoldToContact] = None,
        ...
        if customer_service_rep_name is not None:
            _body["customerServiceRepName"] = customer_service_rep_name
        ...
        if default_payment_method_id is not None:
            _body["defaultPaymentMethodId"] = default_payment_method_id
    ...
    async def _aaccount_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/{account-key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_account_type.serialize(body, content_type)
...
class Account1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccount_1(
        self,
        body: PUTAccountType,
        account_key: str,
        additional_email_addresses: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._account_1_mapped_args(
            body=body,
            ...
            crm_id=crm_id,
            customer_service_rep_name=customer_service_rep_name,
        ...
        return await self._aaccount_1_oapg(
            body=args.body,
    ...
    def account_1(
        ...
        return self._account_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class Account1(BaseApi):
    ...
    async def aaccount_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccount_1(
            body=body,
            account_key=account_key,
            additional_email_addresses=additional_email_addresses,
            auto_pay=auto_pay,
    ...
    def account_1(
        ...
        raw_response = self.raw.account_1(
            body=body,
            account_key=account_key,
            additional_email_addresses=additional_email_addresses,
            auto_pay=auto_pay,
