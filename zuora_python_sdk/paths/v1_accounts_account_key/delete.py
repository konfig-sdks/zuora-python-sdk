...
from zuora_python_sdk.model.delete_account_response_type import DeleteAccountResponseType as DeleteAccountResponseTypeSchema

from zuora_python_sdk.type.delete_account_response_type import DeleteAccountResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.delete_account_response_type import DeleteAccountResponseType as DeleteAccountResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeleteAccountResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteAccountResponseType
...
class Account2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccount_2(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._account_2_mapped_args(
        ...
        return await self._aaccount_2_oapg(
    ...
    def account_2(
        ...
        return self._account_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Account2(BaseApi):
    ...
    async def aaccount_2(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteAccountResponseTypePydantic:
        raw_response = await self.raw.aaccount_2(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return DeleteAccountResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteAccountResponseTypePydantic, raw_response.body)
    ...
    def account_2(
        ...
        raw_response = self.raw.account_2(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
