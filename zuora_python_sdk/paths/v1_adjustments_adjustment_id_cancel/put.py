...
from zuora_python_sdk.model.get_cancel_adjustment_response_type import GETCancelAdjustmentResponseType as GETCancelAdjustmentResponseTypeSchema

from zuora_python_sdk.type.get_cancel_adjustment_response_type import GETCancelAdjustmentResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_cancel_adjustment_response_type import GETCancelAdjustmentResponseType as GETCancelAdjustmentResponseTypePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'adjustmentId': typing.Union[AdjustmentIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GETCancelAdjustmentResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETCancelAdjustmentResponseType
...
class BaseApi(api_client.Api):
    ...
    def _cancel_adjustment_mapped_args(
        self,
        adjustment_id: str,
    ...
    async def _acancel_adjustment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/adjustments/{adjustmentId}/cancel',
            headers=_headers,
        )
...
class CancelAdjustmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_adjustment(
        self,
        adjustment_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_adjustment_mapped_args(
        ...
        return await self._acancel_adjustment_oapg(
    ...
    def cancel_adjustment(
        ...
        return self._cancel_adjustment_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelAdjustment(BaseApi):
    ...
    async def acancel_adjustment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCancelAdjustmentResponseTypePydantic:
        raw_response = await self.raw.acancel_adjustment(
            adjustment_id=adjustment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETCancelAdjustmentResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETCancelAdjustmentResponseTypePydantic, raw_response.body)
    ...
    def cancel_adjustment(
        ...
        raw_response = self.raw.cancel_adjustment(
            adjustment_id=adjustment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
