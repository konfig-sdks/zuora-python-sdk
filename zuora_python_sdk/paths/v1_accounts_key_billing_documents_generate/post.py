...
from zuora_python_sdk.model.post_generate_billing_document_type_subscription_ids import PostGenerateBillingDocumentTypeSubscriptionIds as PostGenerateBillingDocumentTypeSubscriptionIdsSchema
from zuora_python_sdk.model.post_generate_billing_document_type_charge_type_to_exclude import PostGenerateBillingDocumentTypeChargeTypeToExclude as PostGenerateBillingDocumentTypeChargeTypeToExcludeSchema
from zuora_python_sdk.model.post_generate_billing_document_type import PostGenerateBillingDocumentType as PostGenerateBillingDocumentTypeSchema
from zuora_python_sdk.model.generate_billing_document_response_type import GenerateBillingDocumentResponseType as GenerateBillingDocumentResponseTypeSchema

from zuora_python_sdk.type.post_generate_billing_document_type_charge_type_to_exclude import PostGenerateBillingDocumentTypeChargeTypeToExclude
from zuora_python_sdk.type.generate_billing_document_response_type import GenerateBillingDocumentResponseType
from zuora_python_sdk.type.post_generate_billing_document_type_subscription_ids import PostGenerateBillingDocumentTypeSubscriptionIds
from zuora_python_sdk.type.post_generate_billing_document_type import PostGenerateBillingDocumentType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.generate_billing_document_response_type import GenerateBillingDocumentResponseType as GenerateBillingDocumentResponseTypePydantic
from zuora_python_sdk.pydantic.post_generate_billing_document_type_charge_type_to_exclude import PostGenerateBillingDocumentTypeChargeTypeToExclude as PostGenerateBillingDocumentTypeChargeTypeToExcludePydantic
from zuora_python_sdk.pydantic.post_generate_billing_document_type_subscription_ids import PostGenerateBillingDocumentTypeSubscriptionIds as PostGenerateBillingDocumentTypeSubscriptionIdsPydantic
from zuora_python_sdk.pydantic.post_generate_billing_document_type import PostGenerateBillingDocumentType as PostGenerateBillingDocumentTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostGenerateBillingDocumentTypeSchema


request_body_post_generate_billing_document_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GenerateBillingDocumentResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GenerateBillingDocumentResponseType
...
class BaseApi(api_client.Api):
    ...
    def _generate_billing_documents_mapped_args(
        self,
        key: str,
        auto_post: typing.Optional[bool] = None,
        auto_renew: typing.Optional[bool] = None,
        charge_type_to_exclude: typing.Optional[PostGenerateBillingDocumentTypeChargeTypeToExclude] = None,
        credit_memo_reason_code: typing.Optional[str] = None,
        effective_date: typing.Optional[date] = None,
        subscription_ids: typing.Optional[PostGenerateBillingDocumentTypeSubscriptionIds] = None,
        ...
        if subscription_ids is not None:
            _body["subscriptionIds"] = subscription_ids
    ...
    async def _agenerate_billing_documents_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounts/{key}/billing-documents/generate',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_generate_billing_document_type.serialize(body, content_type)
    ...
    def _generate_billing_documents_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GenerateBillingDocumentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_billing_documents(
        self,
        key: str,
        auto_post: typing.Optional[bool] = None,
        auto_renew: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._generate_billing_documents_mapped_args(
            key=key,
            auto_post=auto_post,
        ...
        return await self._agenerate_billing_documents_oapg(
            body=args.body,
    ...
    def generate_billing_documents(
        ...
        return self._generate_billing_documents_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class GenerateBillingDocuments(BaseApi):
    ...
    async def agenerate_billing_documents(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GenerateBillingDocumentResponseTypePydantic:
        raw_response = await self.raw.agenerate_billing_documents(
            key=key,
            auto_post=auto_post,
            auto_renew=auto_renew,
            charge_type_to_exclude=charge_type_to_exclude,
        ...
        if validate:
            return GenerateBillingDocumentResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GenerateBillingDocumentResponseTypePydantic, raw_response.body)
    ...
    def generate_billing_documents(
        ...
        raw_response = self.raw.generate_billing_documents(
            key=key,
            auto_post=auto_post,
            auto_renew=auto_renew,
            charge_type_to_exclude=charge_type_to_exclude,
