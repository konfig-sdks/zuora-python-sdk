...
from zuora_python_sdk.model.get_all_orders_response_type import GetAllOrdersResponseType as GetAllOrdersResponseTypeSchema

from zuora_python_sdk.type.get_all_orders_response_type import GetAllOrdersResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_all_orders_response_type import GetAllOrdersResponseType as GetAllOrdersResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetAllOrdersResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _pending_orders_by_subscription_number_mapped_args(
        self,
    ...
    async def _apending_orders_by_subscription_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/orders/subscription/{subscription-key}/pending',
            headers=_headers,
        )
    ...
    def _pending_orders_by_subscription_number_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PendingOrdersBySubscriptionNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apending_orders_by_subscription_number(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._pending_orders_by_subscription_number_mapped_args(
        ...
        return await self._apending_orders_by_subscription_number_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def pending_orders_by_subscription_number(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._pending_orders_by_subscription_number_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PendingOrdersBySubscriptionNumber(BaseApi):
    ...
    async def apending_orders_by_subscription_number(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetAllOrdersResponseTypePydantic:
        raw_response = await self.raw.apending_orders_by_subscription_number(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetAllOrdersResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetAllOrdersResponseTypePydantic, raw_response.body)
    ...
    def pending_orders_by_subscription_number(
        ...
        raw_response = self.raw.pending_orders_by_subscription_number(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
