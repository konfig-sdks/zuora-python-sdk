...
from zuora_python_sdk.model.proxy_bad_request_response import ProxyBadRequestResponse as ProxyBadRequestResponseSchema
...
from zuora_python_sdk.model.proxy_create_product_rate_plan import ProxyCreateProductRatePlan as ProxyCreateProductRatePlanSchema
...
from zuora_python_sdk.type.proxy_bad_request_response import ProxyBadRequestResponse
from zuora_python_sdk.type.proxy_create_product_rate_plan import ProxyCreateProductRatePlan
...
from zuora_python_sdk.pydantic.proxy_create_product_rate_plan import ProxyCreateProductRatePlan as ProxyCreateProductRatePlanPydantic
...
from zuora_python_sdk.pydantic.proxy_bad_request_response import ProxyBadRequestResponse as ProxyBadRequestResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyCreateProductRatePlanSchema


request_body_proxy_create_product_rate_plan = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyApplicationJson = ProxyBadRequestResponseSchema
...
class WWWAuthenticateSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "Basic realm=Zuora API, ZSession realm=Zuora API, Bearer realm=Zuora API": "BASIC_REALMZUORA_API_ZSESSION_REALMZUORA_API_BEARER_REALMZUORA_API",
        }
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_product_rate_plan_mapped_args(
        self,
        body: ProxyCreateProductRatePlan,
        active_currencies: typing.Optional[typing.List[str]] = None,
        description: typing.Optional[str] = None,
        effective_end_date: typing.Optional[date] = None,
        effective_start_date: typing.Optional[date] = None,
        grade: typing.Optional[typing.Union[int, float]] = None,
        name: typing.Optional[str] = None,
        product_id: typing.Optional[str] = None,
        product_rate_plan_number: typing.Optional[str] = None,
        billing_period__ns: typing.Optional[str] = None,
        ...
        multi_currency_price__ns: typing.Optional[str] = None,
        price__ns: typing.Optional[str] = None,
        ...
        if active_currencies is not None:
            _body["ActiveCurrencies"] = active_currencies
        ...
        if billing_period__ns is not None:
            _body["BillingPeriod__NS"] = billing_period__ns
        ...
        if multi_currency_price__ns is not None:
            _body["MultiCurrencyPrice__NS"] = multi_currency_price__ns
        if price__ns is not None:
            _body["Price__NS"] = price__ns
    ...
    async def _ap_ost_product_rate_plan_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_create_product_rate_plan.serialize(body, content_type)
    ...
    def _p_ost_product_rate_plan_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class POstProductRatePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ost_product_rate_plan(
        self,
        body: ProxyCreateProductRatePlan,
        active_currencies: typing.Optional[typing.List[str]] = None,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_ost_product_rate_plan_mapped_args(
            body=body,
            ...
            billing_period__ns=billing_period__ns,
            class__ns=class__ns,
            ...
            multi_currency_price__ns=multi_currency_price__ns,
            price__ns=price__ns,
        ...
        return await self._ap_ost_product_rate_plan_oapg(
            body=args.body,
    ...
    def p_ost_product_rate_plan(
        ...
        return self._p_ost_product_rate_plan_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POstProductRatePlan(BaseApi):
    ...
    async def ap_ost_product_rate_plan(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ost_product_rate_plan(
            body=body,
            active_currencies=active_currencies,
            description=description,
            effective_end_date=effective_end_date,
    ...
    def p_ost_product_rate_plan(
        ...
        raw_response = self.raw.p_ost_product_rate_plan(
            body=body,
            active_currencies=active_currencies,
            description=description,
            effective_end_date=effective_end_date,
