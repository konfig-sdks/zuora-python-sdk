...
from zuora_python_sdk.model.get_debit_memo_item_type import GETDebitMemoItemType as GETDebitMemoItemTypeSchema

from zuora_python_sdk.type.get_debit_memo_item_type import GETDebitMemoItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_debit_memo_item_type import GETDebitMemoItemType as GETDebitMemoItemTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETDebitMemoItemTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_item_mapped_args(
        self,
        dmitemid: str,
        debit_memo_key: str,
    ...
    async def _adebit_memo_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/items/{dmitemid}',
            headers=_headers,
        )
...
class DebitMemoItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_item(
        self,
        dmitemid: str,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_item_mapped_args(
            dmitemid=dmitemid,
        ...
        return await self._adebit_memo_item_oapg(
    ...
    def debit_memo_item(
        ...
        return self._debit_memo_item_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoItem(BaseApi):
    ...
    async def adebit_memo_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETDebitMemoItemTypePydantic:
        raw_response = await self.raw.adebit_memo_item(
            dmitemid=dmitemid,
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GETDebitMemoItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETDebitMemoItemTypePydantic, raw_response.body)
    ...
    def debit_memo_item(
        ...
        raw_response = self.raw.debit_memo_item(
            dmitemid=dmitemid,
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
