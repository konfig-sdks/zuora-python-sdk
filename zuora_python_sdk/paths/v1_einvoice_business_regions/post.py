...
from zuora_python_sdk.model.create_e_invoicing_business_region_request import CreateEInvoicingBusinessRegionRequest as CreateEInvoicingBusinessRegionRequestSchema

from zuora_python_sdk.type.get_e_invoicing_business_region_response import GetEInvoicingBusinessRegionResponse
from zuora_python_sdk.type.create_e_invoicing_business_region_request import CreateEInvoicingBusinessRegionRequest
...
from zuora_python_sdk.pydantic.create_e_invoicing_business_region_request import CreateEInvoicingBusinessRegionRequest as CreateEInvoicingBusinessRegionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateEInvoicingBusinessRegionRequestSchema


request_body_create_e_invoicing_business_region_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_e_invoicing_business_region_mapped_args(
        self,
    ...
    async def _acreate_e_invoicing_business_region_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/business-regions',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_e_invoicing_business_region_request.serialize(body, content_type)
    ...
    def _create_e_invoicing_business_region_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateEInvoicingBusinessRegionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_e_invoicing_business_region(
        self,
        address_line1: typing.Optional[str] = None,
        address_line2: typing.Optional[str] = None,
        business_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_e_invoicing_business_region_mapped_args(
            body=body,
        ...
        return await self._acreate_e_invoicing_business_region_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def create_e_invoicing_business_region(
        self,
        address_line1: typing.Optional[str] = None,
        address_line2: typing.Optional[str] = None,
        business_name: typing.Optional[str] = None,
        ...
        return self._create_e_invoicing_business_region_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateEInvoicingBusinessRegion(BaseApi):
    ...
    async def acreate_e_invoicing_business_region(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_e_invoicing_business_region(
            body=body,
            address_line1=address_line1,
            address_line2=address_line2,
            business_name=business_name,
    ...
    def create_e_invoicing_business_region(
        ...
        raw_response = self.raw.create_e_invoicing_business_region(
            body=body,
            address_line1=address_line1,
            address_line2=address_line2,
            business_name=business_name,
