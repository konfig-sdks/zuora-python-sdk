...
from zuora_python_sdk.model.get_bulkpdf_generation_job_response_type import GETBulkpdfGenerationJobResponseType as GETBulkpdfGenerationJobResponseTypeSchema

from zuora_python_sdk.type.get_bulkpdf_generation_job_response_type import GETBulkpdfGenerationJobResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_bulkpdf_generation_job_response_type import GETBulkpdfGenerationJobResponseType as GETBulkpdfGenerationJobResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETBulkpdfGenerationJobResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETBulkpdfGenerationJobResponseType
...
class BaseApi(api_client.Api):
    ...
    def _bulk_pdfto_zip_generation_0_mapped_args(
        self,
        job_id: str,
    ...
    async def _abulk_pdfto_zip_generation_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/operations/bulk-pdf/{jobId}',
            headers=_headers,
        )
    ...
    def _bulk_pdfto_zip_generation_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BulkPdftoZipGeneration0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abulk_pdfto_zip_generation_0(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._bulk_pdfto_zip_generation_0_mapped_args(
            job_id=job_id,
        ...
        return await self._abulk_pdfto_zip_generation_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def bulk_pdfto_zip_generation_0(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._bulk_pdfto_zip_generation_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class BulkPdftoZipGeneration0(BaseApi):
    ...
    async def abulk_pdfto_zip_generation_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETBulkpdfGenerationJobResponseTypePydantic:
        raw_response = await self.raw.abulk_pdfto_zip_generation_0(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETBulkpdfGenerationJobResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETBulkpdfGenerationJobResponseTypePydantic, raw_response.body)
    ...
    def bulk_pdfto_zip_generation_0(
        ...
        raw_response = self.raw.bulk_pdfto_zip_generation_0(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
