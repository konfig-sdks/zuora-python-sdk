...
class BaseApi(api_client.Api):
    ...
    def _pending_close_accounting_period_mapped_args(
        self,
        ap_id: str,
    ...
    async def _apending_close_accounting_period_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-periods/{ap-id}/pending-close',
            headers=_headers,
        )
    ...
    def _pending_close_accounting_period_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PendingCloseAccountingPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apending_close_accounting_period(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._pending_close_accounting_period_mapped_args(
            ap_id=ap_id,
        ...
        return await self._apending_close_accounting_period_oapg(
    ...
    def pending_close_accounting_period(
        ...
        return self._pending_close_accounting_period_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PendingCloseAccountingPeriod(BaseApi):
    ...
    async def apending_close_accounting_period(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apending_close_accounting_period(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def pending_close_accounting_period(
        ...
        raw_response = self.raw.pending_close_accounting_period(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
