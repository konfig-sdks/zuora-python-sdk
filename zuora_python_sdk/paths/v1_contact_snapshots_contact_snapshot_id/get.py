...
from zuora_python_sdk.model.get_contact_snapshot_response import GETContactSnapshotResponse as GETContactSnapshotResponseSchema

from zuora_python_sdk.type.get_contact_snapshot_response import GETContactSnapshotResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_contact_snapshot_response import GETContactSnapshotResponse as GETContactSnapshotResponsePydantic
...
# Path params
ContactSnapshotIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'contact-snapshot-id': typing.Union[ContactSnapshotIdSchema, str, ],
    }
)
...
request_path_contact_snapshot_id = api_client.PathParameter(
    name="contact-snapshot-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ContactSnapshotIdSchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETContactSnapshotResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETContactSnapshotResponse
...
class BaseApi(api_client.Api):
    ...
    def _contact_snapshot_mapped_args(
        self,
        contact_snapshot_id: str,
    ...
    async def _acontact_snapshot_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_contact_snapshot_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/contact-snapshots/{contact-snapshot-id}',
            headers=_headers,
        )
...
class ContactSnapshotRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontact_snapshot(
        self,
        contact_snapshot_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._contact_snapshot_mapped_args(
        ...
        return await self._acontact_snapshot_oapg(
    ...
    def contact_snapshot(
        ...
        return self._contact_snapshot_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ContactSnapshot(BaseApi):
    ...
    async def acontact_snapshot(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETContactSnapshotResponsePydantic:
        raw_response = await self.raw.acontact_snapshot(
            contact_snapshot_id=contact_snapshot_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETContactSnapshotResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETContactSnapshotResponsePydantic, raw_response.body)
    ...
    def contact_snapshot(
        ...
        raw_response = self.raw.contact_snapshot(
            contact_snapshot_id=contact_snapshot_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
