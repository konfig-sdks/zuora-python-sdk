...
from zuora_python_sdk.model.get_invoice_application_part_collection_type import GetInvoiceApplicationPartCollectionType as GetInvoiceApplicationPartCollectionTypeSchema

from zuora_python_sdk.type.get_invoice_application_part_collection_type import GetInvoiceApplicationPartCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_invoice_application_part_collection_type import GetInvoiceApplicationPartCollectionType as GetInvoiceApplicationPartCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetInvoiceApplicationPartCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetInvoiceApplicationPartCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _invoice_application_parts_mapped_args(
        self,
        invoice_key: str,
    ...
    async def _ainvoice_application_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/application-parts',
            headers=_headers,
        )
    ...
    def _invoice_application_parts_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class InvoiceApplicationPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvoice_application_parts(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._invoice_application_parts_mapped_args(
        ...
        return await self._ainvoice_application_parts_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def invoice_application_parts(
        self,
        invoice_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._invoice_application_parts_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class InvoiceApplicationParts(BaseApi):
    ...
    async def ainvoice_application_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetInvoiceApplicationPartCollectionTypePydantic:
        raw_response = await self.raw.ainvoice_application_parts(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetInvoiceApplicationPartCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetInvoiceApplicationPartCollectionTypePydantic, raw_response.body)
    ...
    def invoice_application_parts(
        ...
        raw_response = self.raw.invoice_application_parts(
            invoice_key=invoice_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
