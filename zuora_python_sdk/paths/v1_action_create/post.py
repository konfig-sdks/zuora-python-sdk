...
from zuora_python_sdk.model.action_pos_tcreate_response import ActionPosTcreateResponse as ActionPosTcreateResponseSchema
from zuora_python_sdk.model.z_object import ZObject as ZObjectSchema
from zuora_python_sdk.model.proxy_actioncreate_request import ProxyActioncreateRequest as ProxyActioncreateRequestSchema
...
from zuora_python_sdk.type.z_object import ZObject
from zuora_python_sdk.type.proxy_unauthorized_response import ProxyUnauthorizedResponse
from zuora_python_sdk.type.proxy_actioncreate_request import ProxyActioncreateRequest
from zuora_python_sdk.type.action_pos_tcreate_response import ActionPosTcreateResponse
...
from zuora_python_sdk.pydantic.proxy_actioncreate_request import ProxyActioncreateRequest as ProxyActioncreateRequestPydantic
from zuora_python_sdk.pydantic.action_pos_tcreate_response import ActionPosTcreateResponse as ActionPosTcreateResponsePydantic
from zuora_python_sdk.pydantic.z_object import ZObject as ZObjectPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyActioncreateRequestSchema


request_body_proxy_actioncreate_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ActionPosTcreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _p_os_tcreate_mapped_args(
        self,
        objects: typing.List[ZObject],
        type: str,
    ...
    async def _ap_os_tcreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_actioncreate_request.serialize(body, content_type)
...
class POsTcreateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_os_tcreate(
        self,
        objects: typing.List[ZObject],
        type: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_os_tcreate_mapped_args(
            objects=objects,
            type=type,
        ...
        return await self._ap_os_tcreate_oapg(
            body=args.body,
    ...
    def p_os_tcreate(
        ...
        return self._p_os_tcreate_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POsTcreate(BaseApi):
    ...
    async def ap_os_tcreate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionPosTcreateResponsePydantic:
        raw_response = await self.raw.ap_os_tcreate(
            objects=objects,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[ActionPosTcreateResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActionPosTcreateResponsePydantic, raw_response.body)
    ...
    def p_os_tcreate(
        ...
        raw_response = self.raw.p_os_tcreate(
            objects=objects,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
