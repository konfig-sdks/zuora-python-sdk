...
from zuora_python_sdk.model.get_data_query_job_response import GetDataQueryJobResponse as GetDataQueryJobResponseSchema

from zuora_python_sdk.type.data_query_error_response import DataQueryErrorResponse
from zuora_python_sdk.type.get_data_query_job_response import GetDataQueryJobResponse
...
from zuora_python_sdk.pydantic.get_data_query_job_response import GetDataQueryJobResponse as GetDataQueryJobResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'job-id': typing.Union[JobIdSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GetDataQueryJobResponseSchema
...
SchemaFor403ResponseBodyApplicationJson = DataQueryErrorResponseSchema
...
SchemaFor404ResponseBodyApplicationJson = DataQueryErrorResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _data_query_job_0_mapped_args(
        self,
        authorization: str,
        job_id: str,
    ...
    async def _adata_query_job_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/query/jobs/{job-id}',
            headers=_headers,
        )
...
class DataQueryJob0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_query_job_0(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_query_job_0_mapped_args(
        ...
        return await self._adata_query_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def data_query_job_0(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._data_query_job_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DataQueryJob0(BaseApi):
    ...
    async def adata_query_job_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetDataQueryJobResponsePydantic:
        raw_response = await self.raw.adata_query_job_0(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GetDataQueryJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetDataQueryJobResponsePydantic, raw_response.body)
    ...
    def data_query_job_0(
        ...
        raw_response = self.raw.data_query_job_0(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
