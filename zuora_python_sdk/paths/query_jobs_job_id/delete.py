...
from zuora_python_sdk.model.delete_data_query_job_response import DeleteDataQueryJobResponse as DeleteDataQueryJobResponseSchema

from zuora_python_sdk.type.data_query_error_response import DataQueryErrorResponse
from zuora_python_sdk.type.delete_data_query_job_response import DeleteDataQueryJobResponse
...
from zuora_python_sdk.pydantic.delete_data_query_job_response import DeleteDataQueryJobResponse as DeleteDataQueryJobResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeleteDataQueryJobResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteDataQueryJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _data_query_job_1_mapped_args(
        self,
        authorization: str,
        job_id: str,
    ...
    async def _adata_query_job_1_oapg(
        self,
...
class DataQueryJob1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adata_query_job_1(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._data_query_job_1_mapped_args(
        ...
        return await self._adata_query_job_1_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def data_query_job_1(
        self,
        authorization: str,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._data_query_job_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DataQueryJob1(BaseApi):
    ...
    async def adata_query_job_1(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteDataQueryJobResponsePydantic:
        raw_response = await self.raw.adata_query_job_1(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return DeleteDataQueryJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteDataQueryJobResponsePydantic, raw_response.body)
    ...
    def data_query_job_1(
        ...
        raw_response = self.raw.data_query_job_1(
            authorization=authorization,
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
