...
class BaseApi(api_client.Api):
    ...
    def _event_trigger_2_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _aevent_trigger_2_oapg(
        self,
...
class EventTrigger2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_trigger_2(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._event_trigger_2_mapped_args(
        ...
        return await self._aevent_trigger_2_oapg(
    ...
    def event_trigger_2(
        ...
        return self._event_trigger_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class EventTrigger2(BaseApi):
    ...
    async def aevent_trigger_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevent_trigger_2(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def event_trigger_2(
        ...
        raw_response = self.raw.event_trigger_2(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
