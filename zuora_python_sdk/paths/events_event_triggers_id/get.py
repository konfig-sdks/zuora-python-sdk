...
class BaseApi(api_client.Api):
    ...
    def _event_trigger_0_mapped_args(
        self,
        authorization: str,
        id: str,
    ...
    async def _aevent_trigger_0_oapg(
        self,
...
class EventTrigger0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_trigger_0(
        self,
        authorization: str,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._event_trigger_0_mapped_args(
        ...
        return await self._aevent_trigger_0_oapg(
    ...
    def event_trigger_0(
        ...
        return self._event_trigger_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class EventTrigger0(BaseApi):
    ...
    async def aevent_trigger_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevent_trigger_0(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def event_trigger_0(
        ...
        raw_response = self.raw.event_trigger_0(
            authorization=authorization,
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
