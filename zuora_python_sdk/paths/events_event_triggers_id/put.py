...
from zuora_python_sdk.model.event_trigger import EventTrigger as EventTriggerSchema
from zuora_python_sdk.model.put_event_trigger_request_event_type import PutEventTriggerRequestEventType as PutEventTriggerRequestEventTypeSchema
from zuora_python_sdk.model.put_event_trigger_request import PutEventTriggerRequest as PutEventTriggerRequestSchema

from zuora_python_sdk.type.error_response import ErrorResponse
from zuora_python_sdk.type.event_trigger import EventTrigger
from zuora_python_sdk.type.put_event_trigger_request_event_type import PutEventTriggerRequestEventType
from zuora_python_sdk.type.put_event_trigger_request import PutEventTriggerRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.event_trigger import EventTrigger as EventTriggerPydantic
from zuora_python_sdk.pydantic.put_event_trigger_request_event_type import PutEventTriggerRequestEventType as PutEventTriggerRequestEventTypePydantic
from zuora_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from zuora_python_sdk.pydantic.put_event_trigger_request import PutEventTriggerRequest as PutEventTriggerRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutEventTriggerRequestSchema


request_body_put_event_trigger_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EventTriggerSchema
...
class BaseApi(api_client.Api):
    ...
    def _event_trigger_1_mapped_args(
        self,
        authorization: str,
        id: str,
        ...
        event_type: typing.Optional[PutEventTriggerRequestEventType] = None,
    ...
    async def _aevent_trigger_1_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_event_trigger_request.serialize(body, content_type)
...
class EventTrigger1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_trigger_1(
        self,
        authorization: str,
        id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._event_trigger_1_mapped_args(
        ...
        return await self._aevent_trigger_1_oapg(
            body=args.body,
    ...
    def event_trigger_1(
        ...
        return self._event_trigger_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EventTrigger1(BaseApi):
    ...
    async def aevent_trigger_1(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EventTriggerPydantic:
        raw_response = await self.raw.aevent_trigger_1(
            authorization=authorization,
            id=id,
            description=description,
            active=active,
        ...
        if validate:
            return EventTriggerPydantic(**raw_response.body)
        return api_client.construct_model_instance(EventTriggerPydantic, raw_response.body)
    ...
    def event_trigger_1(
        ...
        raw_response = self.raw.event_trigger_1(
            authorization=authorization,
            id=id,
            description=description,
            active=active,
