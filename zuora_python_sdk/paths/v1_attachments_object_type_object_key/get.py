...
from zuora_python_sdk.model.get_attachments_response_type import GETAttachmentsResponseType as GETAttachmentsResponseTypeSchema

from zuora_python_sdk.type.get_attachments_response_type import GETAttachmentsResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_attachments_response_type import GETAttachmentsResponseType as GETAttachmentsResponseTypePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'object-type': typing.Union[ObjectTypeSchema, str, ],
        'object-key': typing.Union[ObjectKeySchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GETAttachmentsResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAttachmentsResponseType
...
class BaseApi(api_client.Api):
    ...
    def _attachments_list_mapped_args(
        self,
        object_type: str,
        object_key: str,
    ...
    async def _aattachments_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/attachments/{object-type}/{object-key}',
            headers=_headers,
        )
...
class AttachmentsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattachments_list(
        self,
        object_type: str,
        object_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._attachments_list_mapped_args(
        ...
        return await self._aattachments_list_oapg(
    ...
    def attachments_list(
        ...
        return self._attachments_list_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class AttachmentsList(BaseApi):
    ...
    async def aattachments_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAttachmentsResponseTypePydantic:
        raw_response = await self.raw.aattachments_list(
            object_type=object_type,
            object_key=object_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETAttachmentsResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAttachmentsResponseTypePydantic, raw_response.body)
    ...
    def attachments_list(
        ...
        raw_response = self.raw.attachments_list(
            object_type=object_type,
            object_key=object_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
