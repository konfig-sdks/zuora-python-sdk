...
from zuora_python_sdk.model.post_attachment_response_type import POSTAttachmentResponseType as POSTAttachmentResponseTypeSchema
from zuora_python_sdk.model.post_attachments_request import PostAttachmentsRequest as PostAttachmentsRequestSchema

from zuora_python_sdk.type.post_attachment_response_type import POSTAttachmentResponseType
from zuora_python_sdk.type.post_attachments_request import PostAttachmentsRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_attachment_response_type import POSTAttachmentResponseType as POSTAttachmentResponseTypePydantic
from zuora_python_sdk.pydantic.post_attachments_request import PostAttachmentsRequest as PostAttachmentsRequestPydantic
...
class AssociatedObjectTypeSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
AssociatedObjectKeySchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'associatedObjectType': typing.Union[AssociatedObjectTypeSchema, str, ],
        'associatedObjectKey': typing.Union[AssociatedObjectKeySchema, str, ],
    }
)
...
request_query_associated_object_type = api_client.QueryParameter(
    name="associatedObjectType",
    style=api_client.ParameterStyle.FORM,
    schema=AssociatedObjectTypeSchema,
    required=True,
    explode=True,
)
request_query_associated_object_key = api_client.QueryParameter(
    name="associatedObjectKey",
    style=api_client.ParameterStyle.FORM,
    schema=AssociatedObjectKeySchema,
    required=True,
    explode=True,
)
# Header params
...
# body param
SchemaForRequestBodyMultipartFormData = PostAttachmentsRequestSchema


request_body_post_attachments_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTAttachmentResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTAttachmentResponseType
...
class BaseApi(api_client.Api):
    ...
    def _attachments_mapped_args(
        ...
        if associated_object_type is not None:
            _query_params["associatedObjectType"] = associated_object_type
        if associated_object_key is not None:
            _query_params["associatedObjectKey"] = associated_object_key
    ...
    async def _aattachments_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_associated_object_type,
            request_query_associated_object_key,
        ):
        ...
        serialized_data = request_body_post_attachments_request.serialize(body, content_type)
...
class AttachmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattachments(
        self,
        associated_object_type: str,
        associated_object_key: str,
        file: typing.IO,
        ...
        **kwargs,
        ...
        args = self._attachments_mapped_args(
        ...
        return await self._aattachments_oapg(
            body=args.body,
...
class Attachments(BaseApi):
    ...
    async def aattachments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTAttachmentResponseTypePydantic:
        raw_response = await self.raw.aattachments(
            associated_object_type=associated_object_type,
            associated_object_key=associated_object_key,
            file=file,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return POSTAttachmentResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTAttachmentResponseTypePydantic, raw_response.body)
    ...
    def attachments(
        ...
        raw_response = self.raw.attachments(
            associated_object_type=associated_object_type,
            associated_object_key=associated_object_key,
            file=file,
            idempotency_key=idempotency_key,
