...
from zuora_python_sdk.model.proxy_get_payment_transaction_log import ProxyGetPaymentTransactionLog as ProxyGetPaymentTransactionLogSchema
...
from zuora_python_sdk.type.proxy_get_payment_transaction_log import ProxyGetPaymentTransactionLog
...
from zuora_python_sdk.pydantic.proxy_get_payment_transaction_log import ProxyGetPaymentTransactionLog as ProxyGetPaymentTransactionLogPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetPaymentTransactionLogSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProxyGetPaymentTransactionLog
...
class BaseApi(api_client.Api):
    ...
    def _g_et_payment_transaction_log_mapped_args(
        self,
        id: str,
    ...
    async def _ag_et_payment_transaction_log_oapg(
        self,
    ...
    def _g_et_payment_transaction_log_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GEtPaymentTransactionLogRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ag_et_payment_transaction_log(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._g_et_payment_transaction_log_mapped_args(
            id=id,
        ...
        return await self._ag_et_payment_transaction_log_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def g_et_payment_transaction_log(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._g_et_payment_transaction_log_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GEtPaymentTransactionLog(BaseApi):
    ...
    async def ag_et_payment_transaction_log(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetPaymentTransactionLogPydantic:
        raw_response = await self.raw.ag_et_payment_transaction_log(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return ProxyGetPaymentTransactionLogPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyGetPaymentTransactionLogPydantic, raw_response.body)
    ...
    def g_et_payment_transaction_log(
        ...
        raw_response = self.raw.g_et_payment_transaction_log(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
