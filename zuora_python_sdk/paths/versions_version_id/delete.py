...
from zuora_python_sdk.model.delete_workflow_success import DeleteWorkflowSuccess as DeleteWorkflowSuccessSchema
...
from zuora_python_sdk.type.delete_workflow_success import DeleteWorkflowSuccess

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.delete_workflow_success import DeleteWorkflowSuccess as DeleteWorkflowSuccessPydantic
...
# Path params
VersionIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'version_id': typing.Union[VersionIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = DeleteWorkflowSuccessSchema
...
SchemaFor403ResponseBodyApplicationJson = DeleteWorkflowErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflow_version_mapped_args(
        self,
        authorization: str,
        version_id: int,
    ...
    async def _aworkflow_version_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/versions/{version_id}',
            headers=_headers,
        )
...
class WorkflowVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_version(
        self,
        authorization: str,
        version_id: int,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflow_version_mapped_args(
        ...
        return await self._aworkflow_version_oapg(
    ...
    def workflow_version(
        ...
        return self._workflow_version_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class WorkflowVersion(BaseApi):
    ...
    async def aworkflow_version(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteWorkflowSuccessPydantic:
        raw_response = await self.raw.aworkflow_version(
            authorization=authorization,
            version_id=version_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return DeleteWorkflowSuccessPydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteWorkflowSuccessPydantic, raw_response.body)
    ...
    def workflow_version(
        ...
        raw_response = self.raw.workflow_version(
            authorization=authorization,
            version_id=version_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
