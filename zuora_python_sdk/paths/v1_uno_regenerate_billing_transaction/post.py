...
from zuora_python_sdk.model.regenerate_billing_request import RegenerateBillingRequest as RegenerateBillingRequestSchema

from zuora_python_sdk.type.regenerate_transaction_object_response import RegenerateTransactionObjectResponse
from zuora_python_sdk.type.regenerate_billing_request import RegenerateBillingRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.regenerate_billing_request import RegenerateBillingRequest as RegenerateBillingRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RegenerateBillingRequestSchema


request_body_regenerate_billing_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _regenerate_billing_transaction_mapped_args(
        self,
        authorization: str,
    ...
    async def _aregenerate_billing_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/uno-regenerate/billing-transaction',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_regenerate_billing_request.serialize(body, content_type)
    ...
    def _regenerate_billing_transaction_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class RegenerateBillingTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aregenerate_billing_transaction(
        self,
        authorization: str,
        document_id: typing.Optional[str] = None,
        number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._regenerate_billing_transaction_mapped_args(
        ...
        return await self._aregenerate_billing_transaction_oapg(
            body=args.body,
    ...
    def regenerate_billing_transaction(
        self,
        authorization: str,
        document_id: typing.Optional[str] = None,
        number: typing.Optional[str] = None,
        ...
        return self._regenerate_billing_transaction_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class RegenerateBillingTransaction(BaseApi):
    ...
    async def aregenerate_billing_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aregenerate_billing_transaction(
            authorization=authorization,
            document_id=document_id,
            number=number,
            type=type,
    ...
    def regenerate_billing_transaction(
        ...
        raw_response = self.raw.regenerate_billing_transaction(
            authorization=authorization,
            document_id=document_id,
            number=number,
            type=type,
