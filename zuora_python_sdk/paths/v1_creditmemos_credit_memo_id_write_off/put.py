...
from zuora_python_sdk.model.put_credit_memo_write_off import PUTCreditMemoWriteOff as PUTCreditMemoWriteOffSchema
from zuora_python_sdk.model.put_credit_memo_write_off_response_type import PUTCreditMemoWriteOffResponseType as PUTCreditMemoWriteOffResponseTypeSchema

from zuora_python_sdk.type.put_credit_memo_write_off import PUTCreditMemoWriteOff
from zuora_python_sdk.type.put_credit_memo_write_off_response_type import PUTCreditMemoWriteOffResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_credit_memo_write_off import PUTCreditMemoWriteOff as PUTCreditMemoWriteOffPydantic
from zuora_python_sdk.pydantic.put_credit_memo_write_off_response_type import PUTCreditMemoWriteOffResponseType as PUTCreditMemoWriteOffResponseTypePydantic
...
# Path params
CreditMemoIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'creditMemoId': typing.Union[CreditMemoIdSchema, str, ],
    }
)
...
request_path_credit_memo_id = api_client.PathParameter(
    name="creditMemoId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CreditMemoIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTCreditMemoWriteOffSchema


request_body_put_credit_memo_write_off = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTCreditMemoWriteOffResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTCreditMemoWriteOffResponseType
...
class BaseApi(api_client.Api):
    ...
    def _write_off_credit_memo_mapped_args(
        self,
        body: PUTCreditMemoWriteOff,
        credit_memo_id: str,
        ...
        if credit_memo_id is not None:
            _path_params["creditMemoId"] = credit_memo_id
        args.header = _header_params
        args.path = _path_params
        return args

    async def _awrite_off_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoId}/write-off',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_credit_memo_write_off.serialize(body, content_type)
    ...
    def _write_off_credit_memo_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class WriteOffCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awrite_off_credit_memo(
        self,
        body: PUTCreditMemoWriteOff,
        credit_memo_id: str,
        comment: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._write_off_credit_memo_mapped_args(
            body=body,
        ...
        return await self._awrite_off_credit_memo_oapg(
            body=args.body,
    ...
    def write_off_credit_memo(
        ...
        return self._write_off_credit_memo_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class WriteOffCreditMemo(BaseApi):
    ...
    async def awrite_off_credit_memo(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTCreditMemoWriteOffResponseTypePydantic:
        raw_response = await self.raw.awrite_off_credit_memo(
            body=body,
            credit_memo_id=credit_memo_id,
            comment=comment,
            memo_date=memo_date,
        ...
        if validate:
            return PUTCreditMemoWriteOffResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTCreditMemoWriteOffResponseTypePydantic, raw_response.body)
    ...
    def write_off_credit_memo(
        ...
        raw_response = self.raw.write_off_credit_memo(
            body=body,
            credit_memo_id=credit_memo_id,
            comment=comment,
            memo_date=memo_date,
