...
# Query params
DeploymentTemplateIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'deployment_template_id': typing.Union[DeploymentTemplateIdSchema, str, ],
    }
)
...
request_query_deployment_template_id = api_client.QueryParameter(
    name="deployment_template_id",
    style=api_client.ParameterStyle.FORM,
    schema=DeploymentTemplateIdSchema,
    required=True,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    ...
    def _download_deployment_template_mapped_args(
        self,
        authorization: str,
        ...
        if deployment_template_id is not None:
            _query_params["deployment_template_id"] = deployment_template_id
    ...
    async def _adownload_deployment_template_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_deployment_template_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/deployment-manager/deployment_artifacts',
            headers=_headers,
        )
    ...
    def _download_deployment_template_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DownloadDeploymentTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_deployment_template(
        self,
        authorization: str,
        deployment_template_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._download_deployment_template_mapped_args(
        ...
        return await self._adownload_deployment_template_oapg(
    ...
    def download_deployment_template(
        ...
        return self._download_deployment_template_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DownloadDeploymentTemplate(BaseApi):
    ...
    async def adownload_deployment_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_deployment_template(
            authorization=authorization,
            deployment_template_id=deployment_template_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def download_deployment_template(
        ...
        raw_response = self.raw.download_deployment_template(
            authorization=authorization,
            deployment_template_id=deployment_template_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
