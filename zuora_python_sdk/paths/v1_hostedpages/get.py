...
from zuora_python_sdk.model.get_hosted_pages_type import GetHostedPagesType as GetHostedPagesTypeSchema

from zuora_python_sdk.type.get_hosted_pages_type import GetHostedPagesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_hosted_pages_type import GetHostedPagesType as GetHostedPagesTypePydantic

from . import path

# Query params
VersionNumberSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'versionNumber': typing.Union[VersionNumberSchema, str, ],
    },
    total=False
)
...
request_query_version_number = api_client.QueryParameter(
    name="versionNumber",
...
SchemaFor200ResponseBodyApplicationJson = GetHostedPagesTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _hosted_pages_mapped_args(
        ...
        version_number: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _header_params = {}
        if version_number is not None:
            _query_params["versionNumber"] = version_number
...
class HostedPagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ahosted_pages(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._hosted_pages_mapped_args(
        ...
        return await self._ahosted_pages_oapg(
    ...
    def hosted_pages(
        ...
        return self._hosted_pages_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class HostedPages(BaseApi):
    ...
    async def ahosted_pages(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetHostedPagesTypePydantic:
        raw_response = await self.raw.ahosted_pages(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GetHostedPagesTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetHostedPagesTypePydantic, raw_response.body)
    ...
    def hosted_pages(
        ...
        raw_response = self.raw.hosted_pages(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
