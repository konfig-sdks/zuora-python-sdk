...
from zuora_python_sdk.model.get_invoice_pdf_status_batch_response import GetInvoicePdfStatusBatchResponse as GetInvoicePdfStatusBatchResponseSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.get_invoice_pdf_status_batch_response import GetInvoicePdfStatusBatchResponse
...
from zuora_python_sdk.pydantic.get_invoice_pdf_status_batch_response import GetInvoicePdfStatusBatchResponse as GetInvoicePdfStatusBatchResponsePydantic
from zuora_python_sdk.pydantic.common_response import CommonResponse as CommonResponsePydantic

from . import path

# Query params
InvoiceKeysSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'invoiceKeys': typing.Union[InvoiceKeysSchema, str, ],
    }
)
...
request_query_invoice_keys = api_client.QueryParameter(
    name="invoiceKeys",
    style=api_client.ParameterStyle.FORM,
    schema=InvoiceKeysSchema,
    required=True,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetInvoicePdfStatusBatchResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetInvoicePdfStatusBatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_pdf_status_mapped_args(
        self,
        invoice_keys: str,
        ...
        if invoice_keys is not None:
            _query_params["invoiceKeys"] = invoice_keys
    ...
    async def _aget_pdf_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/pdf-status',
            headers=_headers,
        )
...
class GetPdfStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pdf_status(
        self,
        invoice_keys: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_pdf_status_mapped_args(
        ...
        return await self._aget_pdf_status_oapg(
    ...
    def get_pdf_status(
        ...
        return self._get_pdf_status_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetPdfStatus(BaseApi):
    ...
    async def aget_pdf_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetInvoicePdfStatusBatchResponsePydantic:
        raw_response = await self.raw.aget_pdf_status(
            invoice_keys=invoice_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetInvoicePdfStatusBatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetInvoicePdfStatusBatchResponsePydantic, raw_response.body)
    ...
    def get_pdf_status(
        ...
        raw_response = self.raw.get_pdf_status(
            invoice_keys=invoice_keys,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
