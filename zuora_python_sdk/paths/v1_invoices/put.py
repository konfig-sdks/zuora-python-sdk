...
from zuora_python_sdk.model.batch_invoice_type import BatchInvoiceType as BatchInvoiceTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema
from zuora_python_sdk.model.put_batch_invoice_type import PutBatchInvoiceType as PutBatchInvoiceTypeSchema

from zuora_python_sdk.type.put_batch_invoice_type import PutBatchInvoiceType
from zuora_python_sdk.type.batch_invoice_type import BatchInvoiceType
from zuora_python_sdk.type.common_response import CommonResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_batch_invoice_type import PutBatchInvoiceType as PutBatchInvoiceTypePydantic
from zuora_python_sdk.pydantic.batch_invoice_type import BatchInvoiceType as BatchInvoiceTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutBatchInvoiceTypeSchema


request_body_put_batch_invoice_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _batch_update_invoices_mapped_args(
        self,
        invoices: typing.Optional[typing.List[BatchInvoiceType]] = None,
    ...
    async def _abatch_update_invoices_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_batch_invoice_type.serialize(body, content_type)
    ...
    def _batch_update_invoices_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class BatchUpdateInvoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abatch_update_invoices(
        self,
        invoices: typing.Optional[typing.List[BatchInvoiceType]] = None,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._batch_update_invoices_mapped_args(
            invoices=invoices,
        ...
        return await self._abatch_update_invoices_oapg(
            body=args.body,
    ...
    def batch_update_invoices(
        ...
        return self._batch_update_invoices_oapg(
            body=args.body,
            header_params=args.header,
        )

class BatchUpdateInvoices(BaseApi):
    ...
    async def abatch_update_invoices(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abatch_update_invoices(
            invoices=invoices,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def batch_update_invoices(
        ...
        raw_response = self.raw.batch_update_invoices(
            invoices=invoices,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
