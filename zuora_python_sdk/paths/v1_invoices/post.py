...
from zuora_python_sdk.model.invoice_with_custom_rates_type import InvoiceWithCustomRatesType as InvoiceWithCustomRatesTypeSchema
from zuora_python_sdk.model.post_invoice_type import PostInvoiceType as PostInvoiceTypeSchema
from zuora_python_sdk.model.post_create_invoice_contact_type import PostCreateInvoiceContactType as PostCreateInvoiceContactTypeSchema
from zuora_python_sdk.model.post_invoice_item_type import PostInvoiceItemType as PostInvoiceItemTypeSchema
from zuora_python_sdk.model.post_invoice_response import PostInvoiceResponse as PostInvoiceResponseSchema

from zuora_python_sdk.type.post_invoice_response import PostInvoiceResponse
from zuora_python_sdk.type.invoice_with_custom_rates_type import InvoiceWithCustomRatesType
from zuora_python_sdk.type.post_create_invoice_contact_type import PostCreateInvoiceContactType
from zuora_python_sdk.type.post_invoice_type import PostInvoiceType
from zuora_python_sdk.type.post_invoice_item_type import PostInvoiceItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_invoice_type import PostInvoiceType as PostInvoiceTypePydantic
from zuora_python_sdk.pydantic.post_invoice_response import PostInvoiceResponse as PostInvoiceResponsePydantic
from zuora_python_sdk.pydantic.post_create_invoice_contact_type import PostCreateInvoiceContactType as PostCreateInvoiceContactTypePydantic
from zuora_python_sdk.pydantic.post_invoice_item_type import PostInvoiceItemType as PostInvoiceItemTypePydantic
from zuora_python_sdk.pydantic.invoice_with_custom_rates_type import InvoiceWithCustomRatesType as InvoiceWithCustomRatesTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostInvoiceTypeSchema


request_body_post_invoice_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostInvoiceResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _standalone_invoice_mapped_args(
        self,
        body: PostInvoiceType,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        auto_pay: typing.Optional[bool] = None,
        bill_to_contact: typing.Optional[PostCreateInvoiceContactType] = None,
        bill_to_contact_id: typing.Optional[str] = None,
        comments: typing.Optional[str] = None,
        currency: typing.Optional[str] = None,
        custom_rates: typing.Optional[typing.List[InvoiceWithCustomRatesType]] = None,
        due_date: typing.Optional[date] = None,
        invoice_date: typing.Optional[date] = None,
        invoice_items: typing.Optional[typing.List[PostInvoiceItemType]] = None,
        invoice_number: typing.Optional[str] = None,
        payment_term: typing.Optional[str] = None,
        sequence_set: typing.Optional[str] = None,
        sold_to_contact: typing.Optional[PostCreateInvoiceContactType] = None,
        sold_to_contact_id: typing.Optional[str] = None,
        ...
        if bill_to_contact_id is not None:
            _body["billToContactId"] = bill_to_contact_id
        ...
        if transferred_to_accounting is not None:
            _body["transferredToAccounting"] = transferred_to_accounting
    ...
    async def _astandalone_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_invoice_type.serialize(body, content_type)
...
class StandaloneInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astandalone_invoice(
        self,
        body: PostInvoiceType,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._standalone_invoice_mapped_args(
            body=body,
        ...
        return await self._astandalone_invoice_oapg(
            body=args.body,
    ...
    def standalone_invoice(
        ...
        return self._standalone_invoice_oapg(
            body=args.body,
            header_params=args.header,
        )

class StandaloneInvoice(BaseApi):
    ...
    async def astandalone_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostInvoiceResponsePydantic:
        raw_response = await self.raw.astandalone_invoice(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_pay=auto_pay,
        ...
        if validate:
            return RootModel[PostInvoiceResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PostInvoiceResponsePydantic, raw_response.body)
    ...
    def standalone_invoice(
        ...
        raw_response = self.raw.standalone_invoice(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_pay=auto_pay,
