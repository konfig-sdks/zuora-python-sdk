...
class BaseApi(api_client.Api):
    ...
    def _journal_run_2_mapped_args(
        self,
        jr_number: str,
    ...
    async def _ajournal_run_2_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-runs/{jr-number}/cancel',
            headers=_headers,
        )
...
class JournalRun2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajournal_run_2(
        self,
        jr_number: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._journal_run_2_mapped_args(
            jr_number=jr_number,
        ...
        return await self._ajournal_run_2_oapg(
    ...
    def journal_run_2(
        ...
        return self._journal_run_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class JournalRun2(BaseApi):
    ...
    async def ajournal_run_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ajournal_run_2(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def journal_run_2(
        ...
        raw_response = self.raw.journal_run_2(
            jr_number=jr_number,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
