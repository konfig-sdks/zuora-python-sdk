...
from zuora_python_sdk.model.credit_memo_from_charge_request import CreditMemoFromChargeRequest as CreditMemoFromChargeRequestSchema
...
from zuora_python_sdk.model.credit_memo_from_charge_detail_type import CreditMemoFromChargeDetailType as CreditMemoFromChargeDetailTypeSchema

from zuora_python_sdk.type.get_credit_memo_type import GETCreditMemoType
from zuora_python_sdk.type.credit_memo_from_charge_request import CreditMemoFromChargeRequest
from zuora_python_sdk.type.credit_memo_from_charge_detail_type import CreditMemoFromChargeDetailType
from zuora_python_sdk.type.credit_memo_from_charge_custom_rates_type import CreditMemoFromChargeCustomRatesType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.credit_memo_from_charge_request import CreditMemoFromChargeRequest as CreditMemoFromChargeRequestPydantic
from zuora_python_sdk.pydantic.credit_memo_from_charge_detail_type import CreditMemoFromChargeDetailType as CreditMemoFromChargeDetailTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreditMemoFromChargeRequestSchema


request_body_credit_memo_from_charge_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_from_prpc_mapped_args(
        self,
        body: CreditMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        auto_post: typing.Optional[bool] = None,
        charges: typing.Optional[typing.List[CreditMemoFromChargeDetailType]] = None,
    ...
    async def _acredit_memo_from_prpc_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_credit_memo_from_charge_request.serialize(body, content_type)
    ...
    def _credit_memo_from_prpc_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreditMemoFromPrpcRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_from_prpc(
        self,
        body: CreditMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_from_prpc_mapped_args(
            body=body,
        ...
        return await self._acredit_memo_from_prpc_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def credit_memo_from_prpc(
        self,
        body: CreditMemoFromChargeRequest,
        account_id: typing.Optional[str] = None,
        account_number: typing.Optional[str] = None,
        ...
        return self._credit_memo_from_prpc_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreditMemoFromPrpc(BaseApi):
    ...
    async def acredit_memo_from_prpc(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acredit_memo_from_prpc(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_post=auto_post,
    ...
    def credit_memo_from_prpc(
        ...
        raw_response = self.raw.credit_memo_from_prpc(
            body=body,
            account_id=account_id,
            account_number=account_number,
            auto_post=auto_post,
