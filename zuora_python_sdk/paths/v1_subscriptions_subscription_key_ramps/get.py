...
from zuora_python_sdk.model.get_ramps_by_subscription_key_response_type import GETRampsBySubscriptionKeyResponseType as GETRampsBySubscriptionKeyResponseTypeSchema

from zuora_python_sdk.type.get_ramps_by_subscription_key_response_type import GETRampsBySubscriptionKeyResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_ramps_by_subscription_key_response_type import GETRampsBySubscriptionKeyResponseType as GETRampsBySubscriptionKeyResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETRampsBySubscriptionKeyResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETRampsBySubscriptionKeyResponseType
...
class BaseApi(api_client.Api):
    ...
    def _ramps_by_subscription_key_mapped_args(
        self,
    ...
    async def _aramps_by_subscription_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscriptionKey}/ramps',
            headers=_headers,
        )
    ...
    def _ramps_by_subscription_key_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RampsBySubscriptionKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aramps_by_subscription_key(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._ramps_by_subscription_key_mapped_args(
        ...
        return await self._aramps_by_subscription_key_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def ramps_by_subscription_key(
        self,
        subscription_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._ramps_by_subscription_key_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RampsBySubscriptionKey(BaseApi):
    ...
    async def aramps_by_subscription_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRampsBySubscriptionKeyResponseTypePydantic:
        raw_response = await self.raw.aramps_by_subscription_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETRampsBySubscriptionKeyResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETRampsBySubscriptionKeyResponseTypePydantic, raw_response.body)
    ...
    def ramps_by_subscription_key(
        ...
        raw_response = self.raw.ramps_by_subscription_key(
            subscription_key=subscription_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
