...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_pdf_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _adebit_memo_pdf_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/pdfs',
            headers=_headers,
        )
...
class DebitMemoPdfRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_pdf(
        self,
        debit_memo_key: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_pdf_mapped_args(
        ...
        return await self._adebit_memo_pdf_oapg(
    ...
    def debit_memo_pdf(
        ...
        return self._debit_memo_pdf_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoPdf(BaseApi):
    ...
    async def adebit_memo_pdf(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adebit_memo_pdf(
            debit_memo_key=debit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def debit_memo_pdf(
        ...
        raw_response = self.raw.debit_memo_pdf(
            debit_memo_key=debit_memo_key,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
