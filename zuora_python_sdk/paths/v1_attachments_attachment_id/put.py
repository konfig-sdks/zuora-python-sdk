...
from zuora_python_sdk.model.put_attachment_type import PUTAttachmentType as PUTAttachmentTypeSchema
from zuora_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from zuora_python_sdk.type.put_attachment_type import PUTAttachmentType
...
from zuora_python_sdk.pydantic.put_attachment_type import PUTAttachmentType as PUTAttachmentTypePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'attachment-id': typing.Union[AttachmentIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PUTAttachmentTypeSchema


request_body_put_attachment_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _attachments_1_mapped_args(
        self,
        attachment_id: str,
    ...
    async def _aattachments_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/attachments/{attachment-id}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_put_attachment_type.serialize(body, content_type)
...
class Attachments1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattachments_1(
        self,
        attachment_id: str,
        description: typing.Optional[str] = None,
        file_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._attachments_1_mapped_args(
        ...
        return await self._aattachments_1_oapg(
            body=args.body,
    ...
    def attachments_1(
        ...
        return self._attachments_1_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class Attachments1(BaseApi):
    ...
    async def aattachments_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aattachments_1(
            attachment_id=attachment_id,
            description=description,
            file_name=file_name,
            accept_encoding=accept_encoding,
    ...
    def attachments_1(
        ...
        raw_response = self.raw.attachments_1(
            attachment_id=attachment_id,
            description=description,
            file_name=file_name,
            accept_encoding=accept_encoding,
