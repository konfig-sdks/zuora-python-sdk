...
from zuora_python_sdk.model.get_attachment_response_type import GETAttachmentResponseType as GETAttachmentResponseTypeSchema

from zuora_python_sdk.type.get_attachment_response_type import GETAttachmentResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_attachment_response_type import GETAttachmentResponseType as GETAttachmentResponseTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETAttachmentResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAttachmentResponseType
...
class BaseApi(api_client.Api):
    ...
    def _attachments_0_mapped_args(
        self,
        attachment_id: str,
    ...
    async def _aattachments_0_oapg(
        self,
...
class Attachments0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattachments_0(
        self,
        attachment_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._attachments_0_mapped_args(
        ...
        return await self._aattachments_0_oapg(
    ...
    def attachments_0(
        ...
        return self._attachments_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Attachments0(BaseApi):
    ...
    async def aattachments_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAttachmentResponseTypePydantic:
        raw_response = await self.raw.aattachments_0(
            attachment_id=attachment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETAttachmentResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETAttachmentResponseTypePydantic, raw_response.body)
    ...
    def attachments_0(
        ...
        raw_response = self.raw.attachments_0(
            attachment_id=attachment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
