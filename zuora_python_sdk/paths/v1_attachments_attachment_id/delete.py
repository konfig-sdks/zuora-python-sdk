...
class BaseApi(api_client.Api):
    ...
    def _attachments_2_mapped_args(
        self,
        attachment_id: str,
    ...
    async def _aattachments_2_oapg(
        self,
...
class Attachments2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattachments_2(
        self,
        attachment_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._attachments_2_mapped_args(
        ...
        return await self._aattachments_2_oapg(
    ...
    def attachments_2(
        ...
        return self._attachments_2_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Attachments2(BaseApi):
    ...
    async def aattachments_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aattachments_2(
            attachment_id=attachment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def attachments_2(
        ...
        raw_response = self.raw.attachments_2(
            attachment_id=attachment_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
