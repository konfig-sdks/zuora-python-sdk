...
from zuora_python_sdk.model.get_adjustment_by_id_response_type import GETAdjustmentByIdResponseType as GETAdjustmentByIdResponseTypeSchema

from zuora_python_sdk.type.get_adjustment_by_id_response_type import GETAdjustmentByIdResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_adjustment_by_id_response_type import GETAdjustmentByIdResponseType as GETAdjustmentByIdResponseTypePydantic
...
# Path params
AdjustmentKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'adjustment-key': typing.Union[AdjustmentKeySchema, str, ],
    }
)
...
request_path_adjustment_key = api_client.PathParameter(
    name="adjustment-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AdjustmentKeySchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETAdjustmentByIdResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETAdjustmentByIdResponseType
    ...
    async def _aadjustment_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/adjustments/{adjustment-key}',
            headers=_headers,
        )
...
class Adjustment1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadjustment_1(
        self,
        adjustment_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._adjustment_1_mapped_args(
        ...
        return await self._aadjustment_1_oapg(
    ...
    def adjustment_1(
        ...
        return self._adjustment_1_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class Adjustment1(BaseApi):
    ...
    async def aadjustment_1(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETAdjustmentByIdResponseTypePydantic:
        raw_response = await self.raw.aadjustment_1(
            adjustment_key=adjustment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETAdjustmentByIdResponseTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETAdjustmentByIdResponseTypePydantic, raw_response.body)
    ...
    def adjustment_1(
        ...
        raw_response = self.raw.adjustment_1(
            adjustment_key=adjustment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
