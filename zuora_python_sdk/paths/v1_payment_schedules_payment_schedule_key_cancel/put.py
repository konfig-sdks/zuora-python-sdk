...
from zuora_python_sdk.model.put_cancel_payment_schedule_request import PUTCancelPaymentScheduleRequest as PUTCancelPaymentScheduleRequestSchema
...
from zuora_python_sdk.type.put_cancel_payment_schedule_request import PUTCancelPaymentScheduleRequest
from zuora_python_sdk.type.get_payment_schedule_response import GETPaymentScheduleResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_cancel_payment_schedule_request import PUTCancelPaymentScheduleRequest as PUTCancelPaymentScheduleRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTCancelPaymentScheduleRequestSchema


request_body_put_cancel_payment_schedule_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _cancel_payment_schedule_mapped_args(
        self,
        cancel_date: date,
    ...
    async def _acancel_payment_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-schedules/{paymentScheduleKey}/cancel',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_cancel_payment_schedule_request.serialize(body, content_type)
    ...
    def _cancel_payment_schedule_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CancelPaymentScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_payment_schedule(
        self,
        cancel_date: date,
        payment_schedule_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_payment_schedule_mapped_args(
        ...
        return await self._acancel_payment_schedule_oapg(
            body=args.body,
    ...
    def cancel_payment_schedule(
        ...
        return self._cancel_payment_schedule_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CancelPaymentSchedule(BaseApi):
    ...
    async def acancel_payment_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_payment_schedule(
            cancel_date=cancel_date,
            payment_schedule_key=payment_schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def cancel_payment_schedule(
        ...
        raw_response = self.raw.cancel_payment_schedule(
            cancel_date=cancel_date,
            payment_schedule_key=payment_schedule_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
