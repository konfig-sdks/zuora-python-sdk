...
from zuora_python_sdk.model.put_subscription_suspend_type import PUTSubscriptionSuspendType as PUTSubscriptionSuspendTypeSchema
from zuora_python_sdk.model.put_subscription_suspend_response_type import PUTSubscriptionSuspendResponseType as PUTSubscriptionSuspendResponseTypeSchema
from zuora_python_sdk.model.put_subscription_suspend_type_application_order import PUTSubscriptionSuspendTypeApplicationOrder as PUTSubscriptionSuspendTypeApplicationOrderSchema

from zuora_python_sdk.type.put_subscription_suspend_response_type import PUTSubscriptionSuspendResponseType
from zuora_python_sdk.type.put_subscription_suspend_type_application_order import PUTSubscriptionSuspendTypeApplicationOrder
from zuora_python_sdk.type.put_subscription_suspend_type import PUTSubscriptionSuspendType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_subscription_suspend_response_type import PUTSubscriptionSuspendResponseType as PUTSubscriptionSuspendResponseTypePydantic
from zuora_python_sdk.pydantic.put_subscription_suspend_type import PUTSubscriptionSuspendType as PUTSubscriptionSuspendTypePydantic
from zuora_python_sdk.pydantic.put_subscription_suspend_type_application_order import PUTSubscriptionSuspendTypeApplicationOrder as PUTSubscriptionSuspendTypeApplicationOrderPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTSubscriptionSuspendTypeSchema


request_body_put_subscription_suspend_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTSubscriptionSuspendResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTSubscriptionSuspendResponseType
...
class BaseApi(api_client.Api):
    ...
    def _suspend_subscription_mapped_args(
        self,
        suspend_policy: str,
        subscription_key: str,
        application_order: typing.Optional[PUTSubscriptionSuspendTypeApplicationOrder] = None,
        ...
        extends_term: typing.Optional[bool] = None,
        invoice: typing.Optional[bool] = None,
        invoice_collect: typing.Optional[bool] = None,
        invoice_target_date: typing.Optional[date] = None,
        order_date: typing.Optional[date] = None,
        resume: typing.Optional[bool] = None,
        resume_periods: typing.Optional[str] = None,
        resume_periods_type: typing.Optional[str] = None,
        resume_policy: typing.Optional[str] = None,
        resume_specific_date: typing.Optional[date] = None,
        run_billing: typing.Optional[bool] = None,
        suspend_periods: typing.Optional[str] = None,
        suspend_periods_type: typing.Optional[str] = None,
        suspend_specific_date: typing.Optional[date] = None,
        ...
        if extends_term is not None:
            _body["extendsTerm"] = extends_term
        ...
        if resume_periods is not None:
            _body["resumePeriods"] = resume_periods
        if resume_periods_type is not None:
            _body["resumePeriodsType"] = resume_periods_type
        if resume_policy is not None:
            _body["resumePolicy"] = resume_policy
        if resume_specific_date is not None:
            _body["resumeSpecificDate"] = resume_specific_date
        if run_billing is not None:
            _body["runBilling"] = run_billing
        if suspend_periods is not None:
            _body["suspendPeriods"] = suspend_periods
        if suspend_periods_type is not None:
            _body["suspendPeriodsType"] = suspend_periods_type
        if suspend_policy is not None:
            _body["suspendPolicy"] = suspend_policy
        if suspend_specific_date is not None:
            _body["suspendSpecificDate"] = suspend_specific_date
    ...
    async def _asuspend_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/suspend',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_subscription_suspend_type.serialize(body, content_type)
    ...
    def _suspend_subscription_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SuspendSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asuspend_subscription(
        self,
        suspend_policy: str,
        subscription_key: str,
        application_order: typing.Optional[PUTSubscriptionSuspendTypeApplicationOrder] = None,
        ...
        **kwargs,
        ...
        args = self._suspend_subscription_mapped_args(
            ...
            extends_term=extends_term,
            invoice=invoice,
            invoice_collect=invoice_collect,
            invoice_target_date=invoice_target_date,
            order_date=order_date,
            resume=resume,
            resume_periods=resume_periods,
            resume_periods_type=resume_periods_type,
            resume_policy=resume_policy,
            resume_specific_date=resume_specific_date,
            run_billing=run_billing,
            suspend_periods=suspend_periods,
            suspend_periods_type=suspend_periods_type,
            suspend_specific_date=suspend_specific_date,
        ...
        return await self._asuspend_subscription_oapg(
            body=args.body,
    ...
    def suspend_subscription(
        ...
        return self._suspend_subscription_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class SuspendSubscription(BaseApi):
    ...
    async def asuspend_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTSubscriptionSuspendResponseTypePydantic:
        raw_response = await self.raw.asuspend_subscription(
            suspend_policy=suspend_policy,
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
        ...
        if validate:
            return PUTSubscriptionSuspendResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTSubscriptionSuspendResponseTypePydantic, raw_response.body)
    ...
    def suspend_subscription(
        ...
        raw_response = self.raw.suspend_subscription(
            suspend_policy=suspend_policy,
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
