...
from zuora_python_sdk.model.put_renew_subscription_response_type import PUTRenewSubscriptionResponseType as PUTRenewSubscriptionResponseTypeSchema
from zuora_python_sdk.model.put_renew_subscription_type_application_order import PUTRenewSubscriptionTypeApplicationOrder as PUTRenewSubscriptionTypeApplicationOrderSchema
from zuora_python_sdk.model.put_renew_subscription_type import PUTRenewSubscriptionType as PUTRenewSubscriptionTypeSchema

from zuora_python_sdk.type.put_renew_subscription_type import PUTRenewSubscriptionType
from zuora_python_sdk.type.put_renew_subscription_type_application_order import PUTRenewSubscriptionTypeApplicationOrder
from zuora_python_sdk.type.put_renew_subscription_response_type import PUTRenewSubscriptionResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_renew_subscription_type import PUTRenewSubscriptionType as PUTRenewSubscriptionTypePydantic
from zuora_python_sdk.pydantic.put_renew_subscription_response_type import PUTRenewSubscriptionResponseType as PUTRenewSubscriptionResponseTypePydantic
from zuora_python_sdk.pydantic.put_renew_subscription_type_application_order import PUTRenewSubscriptionTypeApplicationOrder as PUTRenewSubscriptionTypeApplicationOrderPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PUTRenewSubscriptionTypeSchema


request_body_put_renew_subscription_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTRenewSubscriptionResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PUTRenewSubscriptionResponseType
...
class BaseApi(api_client.Api):
    ...
    def _renew_subscription_mapped_args(
        self,
        subscription_key: str,
        application_order: typing.Optional[PUTRenewSubscriptionTypeApplicationOrder] = None,
    ...
    async def _arenew_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/{subscription-key}/renew',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_renew_subscription_type.serialize(body, content_type)
...
class RenewSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arenew_subscription(
        self,
        subscription_key: str,
        application_order: typing.Optional[PUTRenewSubscriptionTypeApplicationOrder] = None,
        apply_credit: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._renew_subscription_mapped_args(
        ...
        return await self._arenew_subscription_oapg(
            body=args.body,
    ...
    def renew_subscription(
        ...
        return self._renew_subscription_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RenewSubscription(BaseApi):
    ...
    async def arenew_subscription(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTRenewSubscriptionResponseTypePydantic:
        raw_response = await self.raw.arenew_subscription(
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
            apply_credit_balance=apply_credit_balance,
        ...
        if validate:
            return PUTRenewSubscriptionResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTRenewSubscriptionResponseTypePydantic, raw_response.body)
    ...
    def renew_subscription(
        ...
        raw_response = self.raw.renew_subscription(
            subscription_key=subscription_key,
            application_order=application_order,
            apply_credit=apply_credit,
            apply_credit_balance=apply_credit_balance,
