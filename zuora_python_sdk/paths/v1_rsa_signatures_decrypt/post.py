...
from zuora_python_sdk.model.post_decryption_type import POSTDecryptionType as POSTDecryptionTypeSchema
from zuora_python_sdk.model.post_decrypt_response_type import POSTDecryptResponseType as POSTDecryptResponseTypeSchema

from zuora_python_sdk.type.post_decryption_type import POSTDecryptionType
from zuora_python_sdk.type.post_decrypt_response_type import POSTDecryptResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_decryption_type import POSTDecryptionType as POSTDecryptionTypePydantic
from zuora_python_sdk.pydantic.post_decrypt_response_type import POSTDecryptResponseType as POSTDecryptResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTDecryptionTypeSchema


request_body_post_decryption_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTDecryptResponseTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _decrypt_rsa_signatures_mapped_args(
        self,
        method: str,
        public_key: str,
        signature: str,
    ...
    async def _adecrypt_rsa_signatures_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_decryption_type.serialize(body, content_type)
    ...
    def _decrypt_rsa_signatures_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DecryptRsaSignaturesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adecrypt_rsa_signatures(
        self,
        method: str,
        public_key: str,
        signature: str,
        ...
        **kwargs,
        ...
        args = self._decrypt_rsa_signatures_mapped_args(
            method=method,
        ...
        return await self._adecrypt_rsa_signatures_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def decrypt_rsa_signatures(
        self,
        method: str,
        public_key: str,
        signature: str,
        ...
        return self._decrypt_rsa_signatures_oapg(
            body=args.body,
            header_params=args.header,
        )

class DecryptRsaSignatures(BaseApi):
    ...
    async def adecrypt_rsa_signatures(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTDecryptResponseTypePydantic:
        raw_response = await self.raw.adecrypt_rsa_signatures(
            method=method,
            public_key=public_key,
            signature=signature,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return POSTDecryptResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTDecryptResponseTypePydantic, raw_response.body)
    ...
    def decrypt_rsa_signatures(
        ...
        raw_response = self.raw.decrypt_rsa_signatures(
            method=method,
            public_key=public_key,
            signature=signature,
            idempotency_key=idempotency_key,
