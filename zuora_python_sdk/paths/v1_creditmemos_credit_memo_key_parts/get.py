...
from zuora_python_sdk.model.get_credit_memo_parts_collection_type import GETCreditMemoPartsCollectionType as GETCreditMemoPartsCollectionTypeSchema

from zuora_python_sdk.type.get_credit_memo_parts_collection_type import GETCreditMemoPartsCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_credit_memo_parts_collection_type import GETCreditMemoPartsCollectionType as GETCreditMemoPartsCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETCreditMemoPartsCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETCreditMemoPartsCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_parts_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _acredit_memo_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/parts',
            headers=_headers,
        )
...
class CreditMemoPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_parts(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_parts_mapped_args(
        ...
        return await self._acredit_memo_parts_oapg(
    ...
    def credit_memo_parts(
        ...
        return self._credit_memo_parts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoParts(BaseApi):
    ...
    async def acredit_memo_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCreditMemoPartsCollectionTypePydantic:
        raw_response = await self.raw.acredit_memo_parts(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETCreditMemoPartsCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETCreditMemoPartsCollectionTypePydantic, raw_response.body)
    ...
    def credit_memo_parts(
        ...
        raw_response = self.raw.credit_memo_parts(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
