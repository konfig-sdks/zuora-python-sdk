...
class BaseApi(api_client.Api):
    ...
    def _run_trial_balance_mapped_args(
        self,
        ap_id: str,
    ...
    async def _arun_trial_balance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/accounting-periods/{ap-id}/run-trial-balance',
            headers=_headers,
        )
...
class RunTrialBalanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arun_trial_balance(
        self,
        ap_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._run_trial_balance_mapped_args(
            ap_id=ap_id,
        ...
        return await self._arun_trial_balance_oapg(
    ...
    def run_trial_balance(
        ...
        return self._run_trial_balance_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RunTrialBalance(BaseApi):
    ...
    async def arun_trial_balance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arun_trial_balance(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def run_trial_balance(
        ...
        raw_response = self.raw.run_trial_balance(
            ap_id=ap_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
