...
from zuora_python_sdk.model.get_payment_method_updater_instances_response import GETPaymentMethodUpdaterInstancesResponse as GETPaymentMethodUpdaterInstancesResponseSchema

from zuora_python_sdk.type.get_payment_method_updater_instances_response import GETPaymentMethodUpdaterInstancesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_method_updater_instances_response import GETPaymentMethodUpdaterInstancesResponse as GETPaymentMethodUpdaterInstancesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentMethodUpdaterInstancesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentMethodUpdaterInstancesResponse
...
class BaseApi(api_client.Api):
    ...
    def _payment_method_updater_instances_mapped_args(
        self,
    ...
    async def _apayment_method_updater_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-method-updaters',
            headers=_headers,
        )
    ...
    def _payment_method_updater_instances_oapg(
        self,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PaymentMethodUpdaterInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_method_updater_instances(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_method_updater_instances_mapped_args(
        ...
        return await self._apayment_method_updater_instances_oapg(
            header_params=args.header,
            **kwargs,
        )
    
    def payment_method_updater_instances(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        return self._payment_method_updater_instances_oapg(
            header_params=args.header,
        )

class PaymentMethodUpdaterInstances(BaseApi):
    ...
    async def apayment_method_updater_instances(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentMethodUpdaterInstancesResponsePydantic:
        raw_response = await self.raw.apayment_method_updater_instances(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return GETPaymentMethodUpdaterInstancesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentMethodUpdaterInstancesResponsePydantic, raw_response.body)
    ...
    def payment_method_updater_instances(
        ...
        raw_response = self.raw.payment_method_updater_instances(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
