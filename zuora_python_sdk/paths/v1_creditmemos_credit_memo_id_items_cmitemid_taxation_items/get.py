...
from zuora_python_sdk.model.get_taxation_items_of_credit_memo_item_type import GETTaxationItemsOfCreditMemoItemType as GETTaxationItemsOfCreditMemoItemTypeSchema

from zuora_python_sdk.type.get_taxation_items_of_credit_memo_item_type import GETTaxationItemsOfCreditMemoItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_taxation_items_of_credit_memo_item_type import GETTaxationItemsOfCreditMemoItemType as GETTaxationItemsOfCreditMemoItemTypePydantic
...
# Path params
CmitemidSchema = schemas.StrSchema
CreditMemoIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'cmitemid': typing.Union[CmitemidSchema, str, ],
...
request_path_cmitemid = api_client.PathParameter(
    name="cmitemid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CmitemidSchema,
    required=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GETTaxationItemsOfCreditMemoItemTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETTaxationItemsOfCreditMemoItemType
...
class BaseApi(api_client.Api):
    ...
    def _taxation_items_of_credit_memo_item_mapped_args(
        self,
        cmitemid: str,
        credit_memo_id: str,
        ...
        if cmitemid is not None:
            _path_params["cmitemid"] = cmitemid
    ...
    async def _ataxation_items_of_credit_memo_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoId}/items/{cmitemid}/taxation-items',
            headers=_headers,
        )
    ...
    def _taxation_items_of_credit_memo_item_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class TaxationItemsOfCreditMemoItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ataxation_items_of_credit_memo_item(
        self,
        cmitemid: str,
        credit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._taxation_items_of_credit_memo_item_mapped_args(
            cmitemid=cmitemid,
        ...
        return await self._ataxation_items_of_credit_memo_item_oapg(
    ...
    def taxation_items_of_credit_memo_item(
        self,
        cmitemid: str,
        credit_memo_id: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._taxation_items_of_credit_memo_item_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class TaxationItemsOfCreditMemoItem(BaseApi):
    ...
    async def ataxation_items_of_credit_memo_item(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETTaxationItemsOfCreditMemoItemTypePydantic:
        raw_response = await self.raw.ataxation_items_of_credit_memo_item(
            cmitemid=cmitemid,
            credit_memo_id=credit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return RootModel[GETTaxationItemsOfCreditMemoItemTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETTaxationItemsOfCreditMemoItemTypePydantic, raw_response.body)
    ...
    def taxation_items_of_credit_memo_item(
        ...
        raw_response = self.raw.taxation_items_of_credit_memo_item(
            cmitemid=cmitemid,
            credit_memo_id=credit_memo_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
