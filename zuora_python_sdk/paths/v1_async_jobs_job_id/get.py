...
from zuora_python_sdk.model.get_job_status_and_response_response import GetJobStatusAndResponseResponse as GetJobStatusAndResponseResponseSchema

from zuora_python_sdk.type.get_job_status_and_response_response import GetJobStatusAndResponseResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_job_status_and_response_response import GetJobStatusAndResponseResponse as GetJobStatusAndResponseResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetJobStatusAndResponseResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetJobStatusAndResponseResponse
...
class BaseApi(api_client.Api):
    ...
    def _job_status_and_response_mapped_args(
        self,
        job_id: str,
    ...
    async def _ajob_status_and_response_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/async-jobs/{jobId}',
            headers=_headers,
        )
    ...
    def _job_status_and_response_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class JobStatusAndResponseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajob_status_and_response(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._job_status_and_response_mapped_args(
            job_id=job_id,
        ...
        return await self._ajob_status_and_response_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def job_status_and_response(
        self,
        job_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._job_status_and_response_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class JobStatusAndResponse(BaseApi):
    ...
    async def ajob_status_and_response(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetJobStatusAndResponseResponsePydantic:
        raw_response = await self.raw.ajob_status_and_response(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GetJobStatusAndResponseResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetJobStatusAndResponseResponsePydantic, raw_response.body)
    ...
    def job_status_and_response(
        ...
        raw_response = self.raw.job_status_and_response(
            job_id=job_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
