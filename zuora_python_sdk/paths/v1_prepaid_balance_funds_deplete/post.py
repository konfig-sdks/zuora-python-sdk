...
from zuora_python_sdk.model.post_deplete_fund_request_type import POSTDepleteFundRequestType as POSTDepleteFundRequestTypeSchema
from zuora_python_sdk.model.post_deplete_fund_response_type import POSTDepleteFundResponseType as POSTDepleteFundResponseTypeSchema

from zuora_python_sdk.type.post_deplete_fund_response_type import POSTDepleteFundResponseType
from zuora_python_sdk.type.post_deplete_fund_request_type import POSTDepleteFundRequestType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_deplete_fund_request_type import POSTDepleteFundRequestType as POSTDepleteFundRequestTypePydantic
from zuora_python_sdk.pydantic.post_deplete_fund_response_type import POSTDepleteFundResponseType as POSTDepleteFundResponseTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTDepleteFundRequestTypeSchema


request_body_post_deplete_fund_request_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTDepleteFundResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTDepleteFundResponseType
...
class BaseApi(api_client.Api):
    ...
    def _deplete_funds_mapped_args(
        self,
        fund_ids: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
    ...
    async def _adeplete_funds_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/prepaid-balance-funds/deplete',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_deplete_fund_request_type.serialize(body, content_type)
...
class DepleteFundsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeplete_funds(
        self,
        fund_ids: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._deplete_funds_mapped_args(
            body=body,
            fund_ids=fund_ids,
        ...
        return await self._adeplete_funds_oapg(
            body=args.body,
    ...
    def deplete_funds(
        ...
        return self._deplete_funds_oapg(
            body=args.body,
            header_params=args.header,
        )

class DepleteFunds(BaseApi):
    ...
    async def adeplete_funds(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTDepleteFundResponseTypePydantic:
        raw_response = await self.raw.adeplete_funds(
            body=body,
            fund_ids=fund_ids,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return POSTDepleteFundResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTDepleteFundResponseTypePydantic, raw_response.body)
    ...
    def deplete_funds(
        ...
        raw_response = self.raw.deplete_funds(
            body=body,
            fund_ids=fund_ids,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
