...
from zuora_python_sdk.model.put_tasks_request import PutTasksRequest as PutTasksRequestSchema
from zuora_python_sdk.model.bad_request_response import BadRequestResponse as BadRequestResponseSchema
from zuora_python_sdk.model.tasks_response import TasksResponse as TasksResponseSchema
from zuora_python_sdk.model.update_task import UpdateTask as UpdateTaskSchema

from zuora_python_sdk.type.tasks_response import TasksResponse
from zuora_python_sdk.type.update_task import UpdateTask
from zuora_python_sdk.type.bad_request_response import BadRequestResponse
from zuora_python_sdk.type.put_tasks_request import PutTasksRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.update_task import UpdateTask as UpdateTaskPydantic
from zuora_python_sdk.pydantic.put_tasks_request import PutTasksRequest as PutTasksRequestPydantic
from zuora_python_sdk.pydantic.bad_request_response import BadRequestResponse as BadRequestResponsePydantic
from zuora_python_sdk.pydantic.tasks_response import TasksResponse as TasksResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutTasksRequestSchema


request_body_put_tasks_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TasksResponseSchema
...
SchemaFor404ResponseBodyApplicationJson = BadRequestResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflows_tasks_update_mapped_args(
        self,
        authorization: str,
        data: typing.Optional[typing.List[UpdateTask]] = None,
    ...
    async def _aworkflows_tasks_update_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_put_tasks_request.serialize(body, content_type)
    ...
    def _workflows_tasks_update_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class WorkflowsTasksUpdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflows_tasks_update(
        self,
        authorization: str,
        data: typing.Optional[typing.List[UpdateTask]] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._workflows_tasks_update_mapped_args(
        ...
        return await self._aworkflows_tasks_update_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def workflows_tasks_update(
        self,
        authorization: str,
        data: typing.Optional[typing.List[UpdateTask]] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._workflows_tasks_update_oapg(
            body=args.body,
            header_params=args.header,
        )

class WorkflowsTasksUpdate(BaseApi):
    ...
    async def aworkflows_tasks_update(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksResponsePydantic:
        raw_response = await self.raw.aworkflows_tasks_update(
            authorization=authorization,
            data=data,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return TasksResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksResponsePydantic, raw_response.body)
    ...
    def workflows_tasks_update(
        ...
        raw_response = self.raw.workflows_tasks_update(
            authorization=authorization,
            data=data,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
