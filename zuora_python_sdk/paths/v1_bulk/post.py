...
from zuora_python_sdk.model.post_mass_updater_request import PostMassUpdaterRequest as PostMassUpdaterRequestSchema
from zuora_python_sdk.model.post_mass_update_response_type import POSTMassUpdateResponseType as POSTMassUpdateResponseTypeSchema

from zuora_python_sdk.type.post_mass_update_response_type import POSTMassUpdateResponseType
from zuora_python_sdk.type.post_mass_updater_request import PostMassUpdaterRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_mass_update_response_type import POSTMassUpdateResponseType as POSTMassUpdateResponseTypePydantic
from zuora_python_sdk.pydantic.post_mass_updater_request import PostMassUpdaterRequest as PostMassUpdaterRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PostMassUpdaterRequestSchema


request_body_post_mass_updater_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTMassUpdateResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTMassUpdateResponseType
...
class BaseApi(api_client.Api):
    ...
    async def _amass_updater_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_post_mass_updater_request.serialize(body, content_type)
...
class MassUpdaterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amass_updater(
        self,
        file: typing.IO,
        params: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._mass_updater_mapped_args(
            file=file,
            params=params,
        ...
        return await self._amass_updater_oapg(
            body=args.body,
    ...
    def mass_updater(
        ...
        return self._mass_updater_oapg(
            body=args.body,
            header_params=args.header,
        )

class MassUpdater(BaseApi):
    ...
    async def amass_updater(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTMassUpdateResponseTypePydantic:
        raw_response = await self.raw.amass_updater(
            file=file,
            params=params,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return POSTMassUpdateResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTMassUpdateResponseTypePydantic, raw_response.body)
    ...
    def mass_updater(
        ...
        raw_response = self.raw.mass_updater(
            file=file,
            params=params,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
