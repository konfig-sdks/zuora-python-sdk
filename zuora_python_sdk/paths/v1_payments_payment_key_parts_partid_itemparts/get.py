...
from zuora_python_sdk.model.get_payment_item_part_collection_type import GETPaymentItemPartCollectionType as GETPaymentItemPartCollectionTypeSchema

from zuora_python_sdk.type.get_payment_item_part_collection_type import GETPaymentItemPartCollectionType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_item_part_collection_type import GETPaymentItemPartCollectionType as GETPaymentItemPartCollectionTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentItemPartCollectionTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETPaymentItemPartCollectionType
...
class BaseApi(api_client.Api):
    ...
    def _payment_item_parts_mapped_args(
        self,
        partid: str,
        payment_key: str,
    ...
    async def _apayment_item_parts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payments/{paymentKey}/parts/{partid}/itemparts',
            headers=_headers,
        )
...
class PaymentItemPartsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_item_parts(
        self,
        partid: str,
        payment_key: str,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_item_parts_mapped_args(
            partid=partid,
        ...
        return await self._apayment_item_parts_oapg(
    ...
    def payment_item_parts(
        ...
        return self._payment_item_parts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentItemParts(BaseApi):
    ...
    async def apayment_item_parts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentItemPartCollectionTypePydantic:
        raw_response = await self.raw.apayment_item_parts(
            partid=partid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        if validate:
            return GETPaymentItemPartCollectionTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETPaymentItemPartCollectionTypePydantic, raw_response.body)
    ...
    def payment_item_parts(
        ...
        raw_response = self.raw.payment_item_parts(
            partid=partid,
            payment_key=payment_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
