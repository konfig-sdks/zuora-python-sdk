...
from zuora_python_sdk.model.template_response import TemplateResponse as TemplateResponseSchema

from zuora_python_sdk.type.template_response import TemplateResponse
from zuora_python_sdk.type.config_template_error_response import ConfigTemplateErrorResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.template_response import TemplateResponse as TemplateResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TemplateResponseSchema
...
class TemplatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atemplates(
        self,
        authorization: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._templates_mapped_args(
        ...
        return await self._atemplates_oapg(
...
class Templates(BaseApi):
    ...
    async def atemplates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TemplateResponsePydantic:
        raw_response = await self.raw.atemplates(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
        ...
        if validate:
            return TemplateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TemplateResponsePydantic, raw_response.body)
    ...
    def templates(
        ...
        raw_response = self.raw.templates(
            authorization=authorization,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            zuora_entity_ids=zuora_entity_ids,
