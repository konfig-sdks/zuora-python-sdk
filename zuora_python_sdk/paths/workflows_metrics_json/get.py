...
from zuora_python_sdk.model.usages_response import UsagesResponse as UsagesResponseSchema

from zuora_python_sdk.type.usages_response import UsagesResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.usages_response import UsagesResponse as UsagesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsagesResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflows_usages_mapped_args(
        self,
        authorization: str,
        start_date: date,
        end_date: date,
    ...
    async def _aworkflows_usages_oapg(
        self,
...
class WorkflowsUsagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflows_usages(
        self,
        authorization: str,
        start_date: date,
        end_date: date,
        ...
        **kwargs,
        ...
        args = self._workflows_usages_mapped_args(
        ...
        return await self._aworkflows_usages_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def workflows_usages(
        self,
        authorization: str,
        start_date: date,
        end_date: date,
        ...
        return self._workflows_usages_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class WorkflowsUsages(BaseApi):
    ...
    async def aworkflows_usages(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsagesResponsePydantic:
        raw_response = await self.raw.aworkflows_usages(
            authorization=authorization,
            start_date=start_date,
            end_date=end_date,
            metrics=metrics,
        ...
        if validate:
            return UsagesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsagesResponsePydantic, raw_response.body)
    ...
    def workflows_usages(
        ...
        raw_response = self.raw.workflows_usages(
            authorization=authorization,
            start_date=start_date,
            end_date=end_date,
            metrics=metrics,
