...
class BaseApi(api_client.Api):
    ...
    def _unpost_credit_memo_mapped_args(
        self,
        credit_memo_key: str,
    ...
    async def _aunpost_credit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/creditmemos/{creditMemoKey}/unpost',
            headers=_headers,
        )
...
class UnpostCreditMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunpost_credit_memo(
        self,
        credit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._unpost_credit_memo_mapped_args(
        ...
        return await self._aunpost_credit_memo_oapg(
    ...
    def unpost_credit_memo(
        ...
        return self._unpost_credit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class UnpostCreditMemo(BaseApi):
    ...
    async def aunpost_credit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunpost_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def unpost_credit_memo(
        ...
        raw_response = self.raw.unpost_credit_memo(
            credit_memo_key=credit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
