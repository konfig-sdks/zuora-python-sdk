...
from zuora_python_sdk.model.get_refund_item_part_type import GETRefundItemPartType as GETRefundItemPartTypeSchema

from zuora_python_sdk.type.get_refund_item_part_type import GETRefundItemPartType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_refund_item_part_type import GETRefundItemPartType as GETRefundItemPartTypePydantic
...
# Path params
ItempartidSchema = schemas.StrSchema
RefundpartidSchema = schemas.StrSchema
RefundKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'itempartid': typing.Union[ItempartidSchema, str, ],
        'refundpartid': typing.Union[RefundpartidSchema, str, ],
        'refundKey': typing.Union[RefundKeySchema, str, ],
    }
)
...
request_path_itempartid = api_client.PathParameter(
    name="itempartid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ItempartidSchema,
    required=True,
)
request_path_refundpartid = api_client.PathParameter(
    name="refundpartid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RefundpartidSchema,
    required=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GETRefundItemPartTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _refund_item_part_mapped_args(
        self,
        itempartid: str,
        refundpartid: str,
        refund_key: str,
    ...
    async def _arefund_item_part_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_itempartid,
            request_path_refundpartid,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundKey}/parts/{refundpartid}/itemparts/{itempartid}',
            headers=_headers,
        )
...
class RefundItemPartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefund_item_part(
        self,
        itempartid: str,
        refundpartid: str,
        refund_key: str,
        ...
        **kwargs,
        ...
        args = self._refund_item_part_mapped_args(
        ...
        return await self._arefund_item_part_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def refund_item_part(
        self,
        itempartid: str,
        refundpartid: str,
        refund_key: str,
        ...
        return self._refund_item_part_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RefundItemPart(BaseApi):
    ...
    async def arefund_item_part(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETRefundItemPartTypePydantic:
        raw_response = await self.raw.arefund_item_part(
            itempartid=itempartid,
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return GETRefundItemPartTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETRefundItemPartTypePydantic, raw_response.body)
    ...
    def refund_item_part(
        ...
        raw_response = self.raw.refund_item_part(
            itempartid=itempartid,
            refundpartid=refundpartid,
            refund_key=refund_key,
            accept_encoding=accept_encoding,
