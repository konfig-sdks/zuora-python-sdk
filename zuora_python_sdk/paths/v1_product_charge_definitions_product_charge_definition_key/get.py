...
# Query params
HideInheritedValuesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'hide-inherited-values': typing.Union[HideInheritedValuesSchema, bool, ],
    },
    total=False
)
...
request_query_hide_inherited_values = api_client.QueryParameter(
    name="hide-inherited-values",
    style=api_client.ParameterStyle.FORM,
    schema=HideInheritedValuesSchema,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_product_charge_definition_mapped_args(
        self,
        ...
        hide_inherited_values: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _header_params = {}
        _path_params = {}
        if hide_inherited_values is not None:
            _query_params["hide-inherited-values"] = hide_inherited_values
    ...
    async def _aretrieve_product_charge_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_hide_inherited_values,
        ):
    ...
    def _retrieve_product_charge_definition_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RetrieveProductChargeDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_product_charge_definition(
        self,
        product_charge_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_product_charge_definition_mapped_args(
            ...
            hide_inherited_values=hide_inherited_values,
        )
        return await self._aretrieve_product_charge_definition_oapg(
    ...
    def retrieve_product_charge_definition(
        self,
        product_charge_definition_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._retrieve_product_charge_definition_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class RetrieveProductChargeDefinition(BaseApi):
    ...
    async def aretrieve_product_charge_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aretrieve_product_charge_definition(
            product_charge_definition_key=product_charge_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def retrieve_product_charge_definition(
        ...
        raw_response = self.raw.retrieve_product_charge_definition(
            product_charge_definition_key=product_charge_definition_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
