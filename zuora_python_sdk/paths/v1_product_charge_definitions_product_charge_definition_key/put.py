...
from zuora_python_sdk.model.put_product_charge_definition_request import PUTProductChargeDefinitionRequest as PUTProductChargeDefinitionRequestSchema
from zuora_python_sdk.model.get_product_charge_definition_response import GETProductChargeDefinitionResponse as GETProductChargeDefinitionResponseSchema
from zuora_python_sdk.model.post_product_charge_definition_pricing import POSTProductChargeDefinitionPricing as POSTProductChargeDefinitionPricingSchema

from zuora_python_sdk.type.get_product_charge_definition_response import GETProductChargeDefinitionResponse
from zuora_python_sdk.type.put_product_charge_definition_request import PUTProductChargeDefinitionRequest
from zuora_python_sdk.type.post_product_charge_definition_pricing import POSTProductChargeDefinitionPricing

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_product_charge_definition_request import PUTProductChargeDefinitionRequest as PUTProductChargeDefinitionRequestPydantic
from zuora_python_sdk.pydantic.post_product_charge_definition_pricing import POSTProductChargeDefinitionPricing as POSTProductChargeDefinitionPricingPydantic
from zuora_python_sdk.pydantic.get_product_charge_definition_response import GETProductChargeDefinitionResponse as GETProductChargeDefinitionResponsePydantic
...
# Path params
ProductChargeDefinitionKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product-charge-definition-key': typing.Union[ProductChargeDefinitionKeySchema, str, ],
    }
)
...
request_path_product_charge_definition_key = api_client.PathParameter(
    name="product-charge-definition-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProductChargeDefinitionKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTProductChargeDefinitionRequestSchema


request_body_put_product_charge_definition_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETProductChargeDefinitionResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductChargeDefinitionResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_product_charge_definition_mapped_args(
        self,
        product_charge_definition_key: str,
        billing_period: typing.Optional[str] = None,
        billing_timing: typing.Optional[str] = None,
        charge_model: typing.Optional[str] = None,
        default_quantity: typing.Optional[typing.Optional[typing.Union[int, float]]] = None,
        ...
        prices: typing.Optional[typing.List[POSTProductChargeDefinitionPricing]] = None,
        specific_billing_period: typing.Optional[typing.Optional[typing.Union[int, float]]] = None,
        ...
        term: typing.Optional[typing.Optional[typing.Union[int, float]]] = None,
        term_period_type: typing.Optional[typing.Optional[str]] = None,
        term_type: typing.Optional[typing.Optional[str]] = None,
        ...
        if term is not None:
            _body["term"] = term
        if term_period_type is not None:
            _body["termPeriodType"] = term_period_type
        ...
        if product_charge_definition_key is not None:
            _path_params["product-charge-definition-key"] = product_charge_definition_key
        args.header = _header_params
        args.path = _path_params
        return args

    async def _aupdate_product_charge_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_product_charge_definition_key,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/product-charge-definitions/{product-charge-definition-key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_product_charge_definition_request.serialize(body, content_type)
    ...
    def _update_product_charge_definition_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateProductChargeDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_product_charge_definition(
        self,
        product_charge_definition_key: str,
        billing_period: typing.Optional[str] = None,
        billing_timing: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_product_charge_definition_mapped_args(
            product_charge_definition_key=product_charge_definition_key,
            ...
            taxable=taxable,
            term=term,
            term_period_type=term_period_type,
            term_type=term_type,
            uom=uom,
        ...
        return await self._aupdate_product_charge_definition_oapg(
            body=args.body,
    ...
    def update_product_charge_definition(
        self,
        product_charge_definition_key: str,
        billing_period: typing.Optional[str] = None,
        billing_timing: typing.Optional[str] = None,
        ...
        return self._update_product_charge_definition_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateProductChargeDefinition(BaseApi):
    ...
    async def aupdate_product_charge_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductChargeDefinitionResponsePydantic:
        raw_response = await self.raw.aupdate_product_charge_definition(
            product_charge_definition_key=product_charge_definition_key,
            billing_period=billing_period,
            billing_timing=billing_timing,
            charge_model=charge_model,
        ...
        if validate:
            return GETProductChargeDefinitionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductChargeDefinitionResponsePydantic, raw_response.body)
    ...
    def update_product_charge_definition(
        ...
        raw_response = self.raw.update_product_charge_definition(
            product_charge_definition_key=product_charge_definition_key,
            billing_period=billing_period,
            billing_timing=billing_timing,
            charge_model=charge_model,
