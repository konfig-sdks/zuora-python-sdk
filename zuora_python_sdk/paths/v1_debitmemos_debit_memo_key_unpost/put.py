...
class BaseApi(api_client.Api):
    ...
    def _unpost_debit_memo_mapped_args(
        self,
        debit_memo_key: str,
    ...
    async def _aunpost_debit_memo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/debitmemos/{debitMemoKey}/unpost',
            headers=_headers,
        )
...
class UnpostDebitMemoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunpost_debit_memo(
        self,
        debit_memo_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._unpost_debit_memo_mapped_args(
        ...
        return await self._aunpost_debit_memo_oapg(
    ...
    def unpost_debit_memo(
        ...
        return self._unpost_debit_memo_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class UnpostDebitMemo(BaseApi):
    ...
    async def aunpost_debit_memo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunpost_debit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def unpost_debit_memo(
        ...
        raw_response = self.raw.unpost_debit_memo(
            debit_memo_key=debit_memo_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
