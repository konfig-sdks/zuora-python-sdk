...
from zuora_python_sdk.model.proxy_actionquery_request_conf import ProxyActionqueryRequestConf as ProxyActionqueryRequestConfSchema
...
from zuora_python_sdk.model.proxy_actionquery_request import ProxyActionqueryRequest as ProxyActionqueryRequestSchema
from zuora_python_sdk.model.proxy_actionquery_response import ProxyActionqueryResponse as ProxyActionqueryResponseSchema

from zuora_python_sdk.type.proxy_actionquery_request_conf import ProxyActionqueryRequestConf
from zuora_python_sdk.type.proxy_unauthorized_response import ProxyUnauthorizedResponse
from zuora_python_sdk.type.proxy_actionquery_response import ProxyActionqueryResponse
from zuora_python_sdk.type.proxy_actionquery_request import ProxyActionqueryRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.proxy_actionquery_request_conf import ProxyActionqueryRequestConf as ProxyActionqueryRequestConfPydantic
from zuora_python_sdk.pydantic.proxy_actionquery_response import ProxyActionqueryResponse as ProxyActionqueryResponsePydantic
...
from zuora_python_sdk.pydantic.proxy_actionquery_request import ProxyActionqueryRequest as ProxyActionqueryRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyActionqueryRequestSchema


request_body_proxy_actionquery_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProxyActionqueryResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _p_os_tquery_mapped_args(
        self,
        query_string: str,
        conf: typing.Optional[ProxyActionqueryRequestConf] = None,
    ...
    async def _ap_os_tquery_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_actionquery_request.serialize(body, content_type)
...
class POsTqueryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_os_tquery(
        self,
        query_string: str,
        conf: typing.Optional[ProxyActionqueryRequestConf] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_os_tquery_mapped_args(
        ...
        return await self._ap_os_tquery_oapg(
            body=args.body,
    ...
    def p_os_tquery(
        ...
        return self._p_os_tquery_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POsTquery(BaseApi):
    ...
    async def ap_os_tquery(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyActionqueryResponsePydantic:
        raw_response = await self.raw.ap_os_tquery(
            query_string=query_string,
            conf=conf,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return ProxyActionqueryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyActionqueryResponsePydantic, raw_response.body)
    ...
    def p_os_tquery(
        ...
        raw_response = self.raw.p_os_tquery(
            query_string=query_string,
            conf=conf,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
