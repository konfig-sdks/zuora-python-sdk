...
from zuora_python_sdk.model.putpm_account_holder_info import PUTPMAccountHolderInfo as PUTPMAccountHolderInfoSchema
from zuora_python_sdk.model.put_payment_method_response import PUTPaymentMethodResponse as PUTPaymentMethodResponseSchema
from zuora_python_sdk.model.put_payment_method_request import PUTPaymentMethodRequest as PUTPaymentMethodRequestSchema

from zuora_python_sdk.type.put_payment_method_response import PUTPaymentMethodResponse
from zuora_python_sdk.type.put_payment_method_request import PUTPaymentMethodRequest
from zuora_python_sdk.type.putpm_account_holder_info import PUTPMAccountHolderInfo

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_payment_method_request import PUTPaymentMethodRequest as PUTPaymentMethodRequestPydantic
from zuora_python_sdk.pydantic.put_payment_method_response import PUTPaymentMethodResponse as PUTPaymentMethodResponsePydantic
from zuora_python_sdk.pydantic.putpm_account_holder_info import PUTPMAccountHolderInfo as PUTPMAccountHolderInfoPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'payment-method-id': typing.Union[PaymentMethodIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PUTPaymentMethodRequestSchema


request_body_put_payment_method_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PUTPaymentMethodResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _payment_method_0_mapped_args(
        self,
        body: PUTPaymentMethodRequest,
        payment_method_id: str,
        account_holder_info: typing.Optional[PUTPMAccountHolderInfo] = None,
    ...
    async def _apayment_method_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_payment_method_request.serialize(body, content_type)
...
class PaymentMethod0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_method_0(
        self,
        body: PUTPaymentMethodRequest,
        payment_method_id: str,
        account_holder_info: typing.Optional[PUTPMAccountHolderInfo] = None,
        ...
        **kwargs,
        ...
        args = self._payment_method_0_mapped_args(
            body=body,
        ...
        return await self._apayment_method_0_oapg(
            body=args.body,
    ...
    def payment_method_0(
        ...
        return self._payment_method_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PaymentMethod0(BaseApi):
    ...
    async def apayment_method_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PUTPaymentMethodResponsePydantic:
        raw_response = await self.raw.apayment_method_0(
            body=body,
            payment_method_id=payment_method_id,
            account_holder_info=account_holder_info,
            account_key=account_key,
        ...
        if validate:
            return PUTPaymentMethodResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PUTPaymentMethodResponsePydantic, raw_response.body)
    ...
    def payment_method_0(
        ...
        raw_response = self.raw.payment_method_0(
            body=body,
            payment_method_id=payment_method_id,
            account_holder_info=account_holder_info,
            account_key=account_key,
