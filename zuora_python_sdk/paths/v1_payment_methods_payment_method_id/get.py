...
from zuora_python_sdk.model.get_payment_method_response import GETPaymentMethodResponse as GETPaymentMethodResponseSchema

from zuora_python_sdk.type.get_payment_method_response import GETPaymentMethodResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_payment_method_response import GETPaymentMethodResponse as GETPaymentMethodResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GETPaymentMethodResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _payment_method_mapped_args(
        self,
    ...
    async def _apayment_method_oapg(
        self,
...
class PaymentMethodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_method(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_method_mapped_args(
        ...
        return await self._apayment_method_oapg(
    ...
    def payment_method(
        ...
        return self._payment_method_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentMethod(BaseApi):
    ...
    async def apayment_method(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETPaymentMethodResponsePydantic:
        raw_response = await self.raw.apayment_method(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return RootModel[GETPaymentMethodResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETPaymentMethodResponsePydantic, raw_response.body)
    ...
    def payment_method(
        ...
        raw_response = self.raw.payment_method(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
