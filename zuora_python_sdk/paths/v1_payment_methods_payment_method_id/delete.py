...
class BaseApi(api_client.Api):
    ...
    def _payment_methods_0_mapped_args(
        self,
    ...
    async def _apayment_methods_0_oapg(
        self,
...
class PaymentMethods0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apayment_methods_0(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._payment_methods_0_mapped_args(
        ...
        return await self._apayment_methods_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def payment_methods_0(
        self,
        payment_method_id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._payment_methods_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class PaymentMethods0(BaseApi):
    ...
    async def apayment_methods_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apayment_methods_0(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def payment_methods_0(
        ...
        raw_response = self.raw.payment_methods_0(
            payment_method_id=payment_method_id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
