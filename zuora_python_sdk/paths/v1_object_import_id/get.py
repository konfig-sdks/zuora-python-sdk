...
from zuora_python_sdk.model.proxy_get_import import ProxyGetImport as ProxyGetImportSchema
...
from zuora_python_sdk.type.proxy_get_import import ProxyGetImport
...
from zuora_python_sdk.pydantic.proxy_get_import import ProxyGetImport as ProxyGetImportPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProxyGetImportSchema
...
class GEtImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ag_et_import(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._g_et_import_mapped_args(
            id=id,
        ...
        return await self._ag_et_import_oapg(
    ...
    def g_et_import(
        ...
        return self._g_et_import_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GEtImport(BaseApi):
    ...
    async def ag_et_import(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProxyGetImportPydantic:
        raw_response = await self.raw.ag_et_import(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return ProxyGetImportPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProxyGetImportPydantic, raw_response.body)
    ...
    def g_et_import(
        ...
        raw_response = self.raw.g_et_import(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
