...
from zuora_python_sdk.model.payment_collection_response_type import PaymentCollectionResponseType as PaymentCollectionResponseTypeSchema

from zuora_python_sdk.type.payment_collection_response_type import PaymentCollectionResponseType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.payment_collection_response_type import PaymentCollectionResponseType as PaymentCollectionResponseTypePydantic
...
CreditBalanceAmountSchema = schemas.Float64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'creditBalanceAmount': typing.Union[CreditBalanceAmountSchema, decimal.Decimal, int, float, ],
...
request_query_credit_balance_amount = api_client.QueryParameter(
    name="creditBalanceAmount",
    style=api_client.ParameterStyle.FORM,
    schema=CreditBalanceAmountSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PaymentCollectionResponseTypeSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentCollectionResponseType
...
class BaseApi(api_client.Api):
    ...
    def _retrieve_all_payments_mapped_args(
        self,
        ...
        credit_balance_amount: typing.Optional[typing.Union[int, float]] = None,
        ...
        if credit_balance_amount is not None:
            _query_params["creditBalanceAmount"] = credit_balance_amount
    ...
    async def _aretrieve_all_payments_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_credit_balance_amount,
    ...
    def _retrieve_all_payments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RetrieveAllPaymentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretrieve_all_payments(
        self,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        authorization: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._retrieve_all_payments_mapped_args(
        ...
        return await self._aretrieve_all_payments_oapg(
    ...
    def retrieve_all_payments(
        ...
        return self._retrieve_all_payments_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class RetrieveAllPayments(BaseApi):
    ...
    async def aretrieve_all_payments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentCollectionResponseTypePydantic:
        raw_response = await self.raw.aretrieve_all_payments(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
        ...
        if validate:
            return PaymentCollectionResponseTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentCollectionResponseTypePydantic, raw_response.body)
    ...
    def retrieve_all_payments(
        ...
        raw_response = self.raw.retrieve_all_payments(
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
            zuora_track_id=zuora_track_id,
