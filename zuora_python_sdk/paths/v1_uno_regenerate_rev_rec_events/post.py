...
class BaseApi(api_client.Api):
    ...
    def _create_rev_rec_events_mapped_args(
        self,
        authorization: str,
        ...
        if subscription_number is not None:
            _query_params["subscriptionNumber"] = subscription_number
        if mode is not None:
    ...
    async def _acreate_rev_rec_events_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/uno-regenerate/rev-rec-events',
            headers=_headers,
        )
    ...
    def _create_rev_rec_events_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateRevRecEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_rev_rec_events(
        self,
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_rev_rec_events_mapped_args(
        ...
        return await self._acreate_rev_rec_events_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def create_rev_rec_events(
        self,
        authorization: str,
        idempotency_key: typing.Optional[str] = None,
        accept_encoding: typing.Optional[str] = None,
        ...
        return self._create_rev_rec_events_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class CreateRevRecEvents(BaseApi):
    ...
    async def acreate_rev_rec_events(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_rev_rec_events(
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
    ...
    def create_rev_rec_events(
        ...
        raw_response = self.raw.create_rev_rec_events(
            authorization=authorization,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
