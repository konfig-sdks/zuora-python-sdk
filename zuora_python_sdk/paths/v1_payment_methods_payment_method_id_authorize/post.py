...
from zuora_python_sdk.model.post_authorize_response import POSTAuthorizeResponse as POSTAuthorizeResponseSchema
from zuora_python_sdk.model.post_delay_authorize_capture import POSTDelayAuthorizeCapture as POSTDelayAuthorizeCaptureSchema
from zuora_python_sdk.model.post_delay_authorize_capture_gateway_options import POSTDelayAuthorizeCaptureGatewayOptions as POSTDelayAuthorizeCaptureGatewayOptionsSchema

from zuora_python_sdk.type.post_delay_authorize_capture import POSTDelayAuthorizeCapture
from zuora_python_sdk.type.post_delay_authorize_capture_gateway_options import POSTDelayAuthorizeCaptureGatewayOptions
from zuora_python_sdk.type.post_authorize_response import POSTAuthorizeResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_authorize_response import POSTAuthorizeResponse as POSTAuthorizeResponsePydantic
from zuora_python_sdk.pydantic.post_delay_authorize_capture import POSTDelayAuthorizeCapture as POSTDelayAuthorizeCapturePydantic
from zuora_python_sdk.pydantic.post_delay_authorize_capture_gateway_options import POSTDelayAuthorizeCaptureGatewayOptions as POSTDelayAuthorizeCaptureGatewayOptionsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTDelayAuthorizeCaptureSchema


request_body_post_delay_authorize_capture = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTAuthorizeResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_authorization_mapped_args(
        self,
        ...
        gateway_options: typing.Optional[POSTDelayAuthorizeCaptureGatewayOptions] = None,
    ...
    async def _acreate_authorization_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payment-methods/{payment-method-id}/authorize',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_delay_authorize_capture.serialize(body, content_type)
    ...
    def _create_authorization_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateAuthorizationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_authorization(
        self,
        amount: typing.Union[int, float],
        gateway_order_id: str,
        payment_method_id: str,
        ...
        **kwargs,
        ...
        args = self._create_authorization_mapped_args(
            amount=amount,
        ...
        return await self._acreate_authorization_oapg(
            body=args.body,
    ...
    def create_authorization(
        ...
        return self._create_authorization_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateAuthorization(BaseApi):
    ...
    async def acreate_authorization(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTAuthorizeResponsePydantic:
        raw_response = await self.raw.acreate_authorization(
            amount=amount,
            gateway_order_id=gateway_order_id,
            payment_method_id=payment_method_id,
            account_id=account_id,
        ...
        if validate:
            return POSTAuthorizeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTAuthorizeResponsePydantic, raw_response.body)
    ...
    def create_authorization(
        ...
        raw_response = self.raw.create_authorization(
            amount=amount,
            gateway_order_id=gateway_order_id,
            payment_method_id=payment_method_id,
            account_id=account_id,
