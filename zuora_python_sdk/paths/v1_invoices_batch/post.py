...
from zuora_python_sdk.model.post_batch_invoices_type import PostBatchInvoicesType as PostBatchInvoicesTypeSchema
from zuora_python_sdk.model.post_batch_invoice_response import PostBatchInvoiceResponse as PostBatchInvoiceResponseSchema

from zuora_python_sdk.type.post_batch_invoices_type import PostBatchInvoicesType
from zuora_python_sdk.type.post_invoice_type import PostInvoiceType
from zuora_python_sdk.type.post_batch_invoice_response import PostBatchInvoiceResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_invoice_type import PostInvoiceType as PostInvoiceTypePydantic
from zuora_python_sdk.pydantic.post_batch_invoices_type import PostBatchInvoicesType as PostBatchInvoicesTypePydantic
from zuora_python_sdk.pydantic.post_batch_invoice_response import PostBatchInvoiceResponse as PostBatchInvoiceResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostBatchInvoicesTypeSchema


request_body_post_batch_invoices_type = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PostBatchInvoiceResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _standalone_invoices_mapped_args(
        self,
        invoices: typing.Optional[typing.List[PostInvoiceType]] = None,
        use_single_transaction: typing.Optional[bool] = None,
        ...
        if use_single_transaction is not None:
            _body["useSingleTransaction"] = use_single_transaction
        args.body = _body
    ...
    async def _astandalone_invoices_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/batch',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_batch_invoices_type.serialize(body, content_type)
...
class StandaloneInvoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astandalone_invoices(
        self,
        invoices: typing.Optional[typing.List[PostInvoiceType]] = None,
        use_single_transaction: typing.Optional[bool] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._standalone_invoices_mapped_args(
            invoices=invoices,
        ...
        return await self._astandalone_invoices_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def standalone_invoices(
        self,
        invoices: typing.Optional[typing.List[PostInvoiceType]] = None,
        use_single_transaction: typing.Optional[bool] = None,
        idempotency_key: typing.Optional[str] = None,
        ...
        return self._standalone_invoices_oapg(
            body=args.body,
            header_params=args.header,
        )

class StandaloneInvoices(BaseApi):
    ...
    async def astandalone_invoices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PostBatchInvoiceResponsePydantic:
        raw_response = await self.raw.astandalone_invoices(
            invoices=invoices,
            use_single_transaction=use_single_transaction,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return PostBatchInvoiceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PostBatchInvoiceResponsePydantic, raw_response.body)
    ...
    def standalone_invoices(
        ...
        raw_response = self.raw.standalone_invoices(
            invoices=invoices,
            use_single_transaction=use_single_transaction,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
