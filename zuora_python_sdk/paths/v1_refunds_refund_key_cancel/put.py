...
class BaseApi(api_client.Api):
    ...
    def _cancel_refund_mapped_args(
        self,
        refund_key: str,
    ...
    async def _acancel_refund_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/refunds/{refundKey}/cancel',
            headers=_headers,
        )
...
class CancelRefundRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_refund(
        self,
        refund_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._cancel_refund_mapped_args(
        ...
        return await self._acancel_refund_oapg(
    ...
    def cancel_refund(
        ...
        return self._cancel_refund_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelRefund(BaseApi):
    ...
    async def acancel_refund(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_refund(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def cancel_refund(
        ...
        raw_response = self.raw.cancel_refund(
            refund_key=refund_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
