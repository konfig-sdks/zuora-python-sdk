...
from zuora_python_sdk.model.get_credit_memo_type import GETCreditMemoType as GETCreditMemoTypeSchema
from zuora_python_sdk.model.credit_memo_item_from_invoice_item_type import CreditMemoItemFromInvoiceItemType as CreditMemoItemFromInvoiceItemTypeSchema
from zuora_python_sdk.model.credit_memo_from_invoice_request import CreditMemoFromInvoiceRequest as CreditMemoFromInvoiceRequestSchema

from zuora_python_sdk.type.credit_memo_from_invoice_request import CreditMemoFromInvoiceRequest
from zuora_python_sdk.type.credit_memo_item_from_invoice_item_type import CreditMemoItemFromInvoiceItemType
from zuora_python_sdk.type.get_credit_memo_type import GETCreditMemoType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.credit_memo_item_from_invoice_item_type import CreditMemoItemFromInvoiceItemType as CreditMemoItemFromInvoiceItemTypePydantic
from zuora_python_sdk.pydantic.get_credit_memo_type import GETCreditMemoType as GETCreditMemoTypePydantic
from zuora_python_sdk.pydantic.credit_memo_from_invoice_request import CreditMemoFromInvoiceRequest as CreditMemoFromInvoiceRequestPydantic
...
# Path params
InvoiceKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'invoiceKey': typing.Union[InvoiceKeySchema, str, ],
    }
)
...
request_path_invoice_key = api_client.PathParameter(
    name="invoiceKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InvoiceKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CreditMemoFromInvoiceRequestSchema


request_body_credit_memo_from_invoice_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GETCreditMemoTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _credit_memo_from_invoice_mapped_args(
        self,
        body: CreditMemoFromInvoiceRequest,
        invoice_key: str,
        auto_apply_to_invoice_upon_posting: typing.Optional[bool] = None,
        ...
        items: typing.Optional[typing.List[CreditMemoItemFromInvoiceItemType]] = None,
        reason_code: typing.Optional[str] = None,
        tax_auto_calculation: typing.Optional[bool] = None,
        ...
        if auto_apply_to_invoice_upon_posting is not None:
            _body["autoApplyToInvoiceUponPosting"] = auto_apply_to_invoice_upon_posting
        ...
        if exclude_from_auto_apply_rules is not None:
            _body["excludeFromAutoApplyRules"] = exclude_from_auto_apply_rules
        ...
        if tax_auto_calculation is not None:
            _body["taxAutoCalculation"] = tax_auto_calculation
    ...
    async def _acredit_memo_from_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/creditmemos',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_credit_memo_from_invoice_request.serialize(body, content_type)
    ...
    def _credit_memo_from_invoice_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreditMemoFromInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acredit_memo_from_invoice(
        self,
        body: CreditMemoFromInvoiceRequest,
        invoice_key: str,
        auto_apply_to_invoice_upon_posting: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._credit_memo_from_invoice_mapped_args(
            body=body,
            invoice_key=invoice_key,
            auto_apply_to_invoice_upon_posting=auto_apply_to_invoice_upon_posting,
            auto_post=auto_post,
            comment=comment,
            ...
            tax_auto_calculation=tax_auto_calculation,
        ...
        return await self._acredit_memo_from_invoice_oapg(
            body=args.body,
    ...
    def credit_memo_from_invoice(
        ...
        return self._credit_memo_from_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreditMemoFromInvoice(BaseApi):
    ...
    async def acredit_memo_from_invoice(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETCreditMemoTypePydantic:
        raw_response = await self.raw.acredit_memo_from_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_apply_to_invoice_upon_posting=auto_apply_to_invoice_upon_posting,
            auto_post=auto_post,
        ...
        if validate:
            return RootModel[GETCreditMemoTypePydantic](raw_response.body).root
        return api_client.construct_model_instance(GETCreditMemoTypePydantic, raw_response.body)
    ...
    def credit_memo_from_invoice(
        ...
        raw_response = self.raw.credit_memo_from_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_apply_to_invoice_upon_posting=auto_apply_to_invoice_upon_posting,
            auto_post=auto_post,
