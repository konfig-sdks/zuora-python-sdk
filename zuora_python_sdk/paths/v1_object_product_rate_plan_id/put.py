...
from zuora_python_sdk.model.proxy_modify_product_rate_plan import ProxyModifyProductRatePlan as ProxyModifyProductRatePlanSchema

from zuora_python_sdk.type.proxy_modify_product_rate_plan import ProxyModifyProductRatePlan
...
from zuora_python_sdk.pydantic.proxy_modify_product_rate_plan import ProxyModifyProductRatePlan as ProxyModifyProductRatePlanPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyModifyProductRatePlanSchema


request_body_proxy_modify_product_rate_plan = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_ut_product_rate_plan_mapped_args(
        self,
        body: ProxyModifyProductRatePlan,
        id: str,
    ...
    async def _ap_ut_product_rate_plan_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_modify_product_rate_plan.serialize(body, content_type)
    ...
    def _p_ut_product_rate_plan_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class PUtProductRatePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_ut_product_rate_plan(
        self,
        body: ProxyModifyProductRatePlan,
        id: str,
        active_currencies: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._p_ut_product_rate_plan_mapped_args(
            body=body,
            id=id,
        ...
        return await self._ap_ut_product_rate_plan_oapg(
            body=args.body,
    ...
    def p_ut_product_rate_plan(
        ...
        return self._p_ut_product_rate_plan_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class PUtProductRatePlan(BaseApi):
    ...
    async def ap_ut_product_rate_plan(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ap_ut_product_rate_plan(
            body=body,
            id=id,
            active_currencies=active_currencies,
            description=description,
    ...
    def p_ut_product_rate_plan(
        ...
        raw_response = self.raw.p_ut_product_rate_plan(
            body=body,
            id=id,
            active_currencies=active_currencies,
            description=description,
