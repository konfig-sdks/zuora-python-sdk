...
class BaseApi(api_client.Api):
    ...
    def _d_elete_product_rate_plan_mapped_args(
        self,
        id: str,
    ...
    async def _ad_elete_product_rate_plan_oapg(
        self,
    ...
    def _d_elete_product_rate_plan_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DEleteProductRatePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ad_elete_product_rate_plan(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._d_elete_product_rate_plan_mapped_args(
            id=id,
        ...
        return await self._ad_elete_product_rate_plan_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def d_elete_product_rate_plan(
        self,
        id: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        return self._d_elete_product_rate_plan_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DEleteProductRatePlan(BaseApi):
    ...
    async def ad_elete_product_rate_plan(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ad_elete_product_rate_plan(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
    ...
    def d_elete_product_rate_plan(
        ...
        raw_response = self.raw.d_elete_product_rate_plan(
            id=id,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
