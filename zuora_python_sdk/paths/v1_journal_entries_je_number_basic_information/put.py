...
from zuora_python_sdk.model.put_journal_entry_item_type import PUTJournalEntryItemType as PUTJournalEntryItemTypeSchema
from zuora_python_sdk.model.put_basic_summary_journal_entry_type import PUTBasicSummaryJournalEntryType as PUTBasicSummaryJournalEntryTypeSchema

from zuora_python_sdk.type.put_basic_summary_journal_entry_type import PUTBasicSummaryJournalEntryType
from zuora_python_sdk.type.common_response import CommonResponse
from zuora_python_sdk.type.put_journal_entry_item_type import PUTJournalEntryItemType

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.put_journal_entry_item_type import PUTJournalEntryItemType as PUTJournalEntryItemTypePydantic
from zuora_python_sdk.pydantic.put_basic_summary_journal_entry_type import PUTBasicSummaryJournalEntryType as PUTBasicSummaryJournalEntryTypePydantic
...
# Path params
JeNumberSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'je-number': typing.Union[JeNumberSchema, str, ],
    }
)
...
request_path_je_number = api_client.PathParameter(
    name="je-number",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JeNumberSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PUTBasicSummaryJournalEntryTypeSchema


request_body_put_basic_summary_journal_entry_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _basic_summary_journal_entry_mapped_args(
        self,
        body: PUTBasicSummaryJournalEntryType,
        je_number: str,
        journal_entry_items: typing.Optional[typing.List[PUTJournalEntryItemType]] = None,
    ...
    async def _abasic_summary_journal_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/journal-entries/{je-number}/basic-information',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_put_basic_summary_journal_entry_type.serialize(body, content_type)
    ...
    def _basic_summary_journal_entry_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class BasicSummaryJournalEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abasic_summary_journal_entry(
        self,
        body: PUTBasicSummaryJournalEntryType,
        je_number: str,
        journal_entry_items: typing.Optional[typing.List[PUTJournalEntryItemType]] = None,
        ...
        **kwargs,
        ...
        args = self._basic_summary_journal_entry_mapped_args(
            body=body,
            je_number=je_number,
        ...
        return await self._abasic_summary_journal_entry_oapg(
            body=args.body,
    ...
    def basic_summary_journal_entry(
        self,
        body: PUTBasicSummaryJournalEntryType,
        je_number: str,
        journal_entry_items: typing.Optional[typing.List[PUTJournalEntryItemType]] = None,
        ...
        return self._basic_summary_journal_entry_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class BasicSummaryJournalEntry(BaseApi):
    ...
    async def abasic_summary_journal_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abasic_summary_journal_entry(
            body=body,
            je_number=je_number,
            journal_entry_items=journal_entry_items,
            notes=notes,
    ...
    def basic_summary_journal_entry(
        ...
        raw_response = self.raw.basic_summary_journal_entry(
            body=body,
            je_number=je_number,
            journal_entry_items=journal_entry_items,
            notes=notes,
