...
from zuora_python_sdk.model.post_workflow_definition_import_request import POSTWorkflowDefinitionImportRequest as POSTWorkflowDefinitionImportRequestSchema
from zuora_python_sdk.model.linkage import Linkage as LinkageSchema
from zuora_python_sdk.model.workflow import Workflow as WorkflowSchema
from zuora_python_sdk.model.task import Task as TaskSchema

from zuora_python_sdk.type.workflow import Workflow
from zuora_python_sdk.type.post_workflow_definition_import_request import POSTWorkflowDefinitionImportRequest
...
from zuora_python_sdk.pydantic.post_workflow_definition_import_request import POSTWorkflowDefinitionImportRequest as POSTWorkflowDefinitionImportRequestPydantic
from zuora_python_sdk.pydantic.task import Task as TaskPydantic
from zuora_python_sdk.pydantic.workflow import Workflow as WorkflowPydantic

from . import path

# Query params
WorkflowDefinitionIdSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'workflow_definition_id': typing.Union[WorkflowDefinitionIdSchema, decimal.Decimal, int, ],
...
request_query_workflow_definition_id = api_client.QueryParameter(
...
# body param
SchemaForRequestBodyApplicationJson = POSTWorkflowDefinitionImportRequestSchema


request_body_post_workflow_definition_import_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WorkflowSchema
...
class BaseApi(api_client.Api):
    ...
    def _workflow_import_mapped_args(
        self,
        authorization: str,
        ...
        workflow_definition_id: typing.Optional[int] = None,
        ...
        if workflow_definition_id is not None:
            _query_params["workflow_definition_id"] = workflow_definition_id
    ...
    async def _aworkflow_import_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_workflow_definition_id,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_post_workflow_definition_import_request.serialize(body, content_type)
...
class WorkflowImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aworkflow_import(
        self,
        authorization: str,
        linkages: typing.Optional[typing.List[Linkage]] = None,
        tasks: typing.Optional[typing.List[Task]] = None,
        ...
        **kwargs,
        ...
        args = self._workflow_import_mapped_args(
        ...
        return await self._aworkflow_import_oapg(
            body=args.body,
    ...
    def workflow_import(
        ...
        return self._workflow_import_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class WorkflowImport(BaseApi):
    ...
    async def aworkflow_import(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aworkflow_import(
            authorization=authorization,
            linkages=linkages,
            tasks=tasks,
            workflow=workflow,
        ...
        if validate:
            return WorkflowPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowPydantic, raw_response.body)
    ...
    def workflow_import(
        ...
        raw_response = self.raw.workflow_import(
            authorization=authorization,
            linkages=linkages,
            tasks=tasks,
            workflow=workflow,
