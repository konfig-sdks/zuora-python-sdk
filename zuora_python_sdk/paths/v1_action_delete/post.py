...
from zuora_python_sdk.model.action_pos_tdelete_response import ActionPosTdeleteResponse as ActionPosTdeleteResponseSchema
...
from zuora_python_sdk.model.proxy_actiondelete_request import ProxyActiondeleteRequest as ProxyActiondeleteRequestSchema
from zuora_python_sdk.model.proxy_actiondelete_request_ids import ProxyActiondeleteRequestIds as ProxyActiondeleteRequestIdsSchema

from zuora_python_sdk.type.action_pos_tdelete_response import ActionPosTdeleteResponse
from zuora_python_sdk.type.proxy_actiondelete_request_ids import ProxyActiondeleteRequestIds
from zuora_python_sdk.type.proxy_unauthorized_response import ProxyUnauthorizedResponse
from zuora_python_sdk.type.proxy_actiondelete_request import ProxyActiondeleteRequest
...
from zuora_python_sdk.pydantic.action_pos_tdelete_response import ActionPosTdeleteResponse as ActionPosTdeleteResponsePydantic
from zuora_python_sdk.pydantic.proxy_actiondelete_request import ProxyActiondeleteRequest as ProxyActiondeleteRequestPydantic
from zuora_python_sdk.pydantic.proxy_actiondelete_request_ids import ProxyActiondeleteRequestIds as ProxyActiondeleteRequestIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProxyActiondeleteRequestSchema


request_body_proxy_actiondelete_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ActionPosTdeleteResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _p_os_tdelete_mapped_args(
        self,
        ids: ProxyActiondeleteRequestIds,
        type: str,
    ...
    async def _ap_os_tdelete_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_proxy_actiondelete_request.serialize(body, content_type)
...
class POsTdeleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ap_os_tdelete(
        self,
        ids: ProxyActiondeleteRequestIds,
        type: str,
        idempotency_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._p_os_tdelete_mapped_args(
            ids=ids,
            type=type,
        ...
        return await self._ap_os_tdelete_oapg(
            body=args.body,
    ...
    def p_os_tdelete(
        ...
        return self._p_os_tdelete_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class POsTdelete(BaseApi):
    ...
    async def ap_os_tdelete(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionPosTdeleteResponsePydantic:
        raw_response = await self.raw.ap_os_tdelete(
            ids=ids,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
        ...
        if validate:
            return RootModel[ActionPosTdeleteResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActionPosTdeleteResponsePydantic, raw_response.body)
    ...
    def p_os_tdelete(
        ...
        raw_response = self.raw.p_os_tdelete(
            ids=ids,
            type=type,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
