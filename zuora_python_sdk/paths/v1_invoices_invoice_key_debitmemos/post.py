...
from zuora_python_sdk.model.debit_memo_from_invoice_request import DebitMemoFromInvoiceRequest as DebitMemoFromInvoiceRequestSchema
from zuora_python_sdk.model.debit_memo_item_from_invoice_item_type import DebitMemoItemFromInvoiceItemType as DebitMemoItemFromInvoiceItemTypeSchema
...
from zuora_python_sdk.type.debit_memo_item_from_invoice_item_type import DebitMemoItemFromInvoiceItemType
from zuora_python_sdk.type.debit_memo_from_invoice_request import DebitMemoFromInvoiceRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.debit_memo_from_invoice_request import DebitMemoFromInvoiceRequest as DebitMemoFromInvoiceRequestPydantic
from zuora_python_sdk.pydantic.get_debit_memo_type import GETDebitMemoType as GETDebitMemoTypePydantic
from zuora_python_sdk.pydantic.debit_memo_item_from_invoice_item_type import DebitMemoItemFromInvoiceItemType as DebitMemoItemFromInvoiceItemTypePydantic
...
# body param
SchemaForRequestBodyApplicationJson = DebitMemoFromInvoiceRequestSchema


request_body_debit_memo_from_invoice_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _debit_memo_from_invoice_mapped_args(
        self,
        body: DebitMemoFromInvoiceRequest,
        invoice_key: str,
        ...
        items: typing.Optional[typing.List[DebitMemoItemFromInvoiceItemType]] = None,
    ...
    async def _adebit_memo_from_invoice_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoices/{invoiceKey}/debitmemos',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_debit_memo_from_invoice_request.serialize(body, content_type)
    ...
    def _debit_memo_from_invoice_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class DebitMemoFromInvoiceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adebit_memo_from_invoice(
        self,
        body: DebitMemoFromInvoiceRequest,
        invoice_key: str,
        auto_pay: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._debit_memo_from_invoice_mapped_args(
            body=body,
        ...
        return await self._adebit_memo_from_invoice_oapg(
            body=args.body,
    ...
    def debit_memo_from_invoice(
        ...
        return self._debit_memo_from_invoice_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class DebitMemoFromInvoice(BaseApi):
    ...
    async def adebit_memo_from_invoice(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adebit_memo_from_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_pay=auto_pay,
            auto_post=auto_post,
    ...
    def debit_memo_from_invoice(
        ...
        raw_response = self.raw.debit_memo_from_invoice(
            body=body,
            invoice_key=invoice_key,
            auto_pay=auto_pay,
            auto_post=auto_post,
