...
from zuora_python_sdk.model.get_product_rate_plans_response import GETProductRatePlansResponse as GETProductRatePlansResponseSchema

from zuora_python_sdk.type.get_product_rate_plans_response import GETProductRatePlansResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_product_rate_plans_response import GETProductRatePlansResponse as GETProductRatePlansResponsePydantic
...
# Path params
ProductKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product-key': typing.Union[ProductKeySchema, str, ],
    }
)
...
request_path_product_key = api_client.PathParameter(
    name="product-key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProductKeySchema,
    required=True,
)
ContentEncodingSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = GETProductRatePlansResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GETProductRatePlansResponse
...
class BaseApi(api_client.Api):
    ...
    def _product_rate_plans_mapped_args(
        self,
        product_key: str,
    ...
    async def _aproduct_rate_plans_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/products/{product-key}/product-rate-plans',
            headers=_headers,
        )
...
class ProductRatePlansRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproduct_rate_plans(
        self,
        product_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._product_rate_plans_mapped_args(
        ...
        return await self._aproduct_rate_plans_oapg(
    ...
    def product_rate_plans(
        ...
        return self._product_rate_plans_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ProductRatePlans(BaseApi):
    ...
    async def aproduct_rate_plans(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETProductRatePlansResponsePydantic:
        raw_response = await self.raw.aproduct_rate_plans(
            product_key=product_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETProductRatePlansResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GETProductRatePlansResponsePydantic, raw_response.body)
    ...
    def product_rate_plans(
        ...
        raw_response = self.raw.product_rate_plans(
            product_key=product_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
