...
from zuora_python_sdk.model.regenerate_transaction_object_response import RegenerateTransactionObjectResponse as RegenerateTransactionObjectResponseSchema
from zuora_python_sdk.model.regenerate_booking_request import RegenerateBookingRequest as RegenerateBookingRequestSchema

from zuora_python_sdk.type.regenerate_transaction_object_response import RegenerateTransactionObjectResponse
from zuora_python_sdk.type.regenerate_booking_request import RegenerateBookingRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.regenerate_transaction_object_response import RegenerateTransactionObjectResponse as RegenerateTransactionObjectResponsePydantic
from zuora_python_sdk.pydantic.regenerate_booking_request import RegenerateBookingRequest as RegenerateBookingRequestPydantic

from . import path

# Query params
OnlyReSendSchema = schemas.BoolSchema
ReMigrateSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'onlyReSend': typing.Union[OnlyReSendSchema, bool, ],
        'reMigrate': typing.Union[ReMigrateSchema, bool, ],
    },
    total=False
)
...
request_query_only_re_send = api_client.QueryParameter(
    name="onlyReSend",
    style=api_client.ParameterStyle.FORM,
    schema=OnlyReSendSchema,
    explode=True,
)
request_query_re_migrate = api_client.QueryParameter(
    name="reMigrate",
    style=api_client.ParameterStyle.FORM,
    schema=ReMigrateSchema,
    explode=True,
)
# Header params
...
# body param
SchemaForRequestBodyApplicationJson = RegenerateBookingRequestSchema


request_body_regenerate_booking_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RegenerateTransactionObjectResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: RegenerateTransactionObjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _regenerate_booking_transaction_mapped_args(
        self,
        authorization: str,
        item_number: typing.Optional[str] = None,
        order_line_item_id: typing.Optional[str] = None,
        ...
        subscription_version: typing.Optional[int] = None,
        ...
        only_re_send: typing.Optional[bool] = None,
        re_migrate: typing.Optional[bool] = None,
        ...
        if order_line_item_id is not None:
            _body["orderLineItemId"] = order_line_item_id
        if order_number is not None:
            _body["orderNumber"] = order_number
        if subscription_id is not None:
            _body["subscriptionId"] = subscription_id
        if subscription_number is not None:
            _body["subscriptionNumber"] = subscription_number
        if subscription_version is not None:
            _body["subscriptionVersion"] = subscription_version
        if type is not None:
            _body["type"] = type
        args.body = _body
        if only_re_send is not None:
            _query_params["onlyReSend"] = only_re_send
        if re_migrate is not None:
            _query_params["reMigrate"] = re_migrate
    ...
    async def _aregenerate_booking_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_only_re_send,
            request_query_re_migrate,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/uno-regenerate/booking-transaction',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_regenerate_booking_request.serialize(body, content_type)
    ...
    def _regenerate_booking_transaction_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class RegenerateBookingTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aregenerate_booking_transaction(
        self,
        authorization: str,
        item_number: typing.Optional[str] = None,
        order_line_item_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._regenerate_booking_transaction_mapped_args(
            ...
            only_re_send=only_re_send,
            re_migrate=re_migrate,
        )
        return await self._aregenerate_booking_transaction_oapg(
            body=args.body,
    ...
    def regenerate_booking_transaction(
        self,
        authorization: str,
        item_number: typing.Optional[str] = None,
        order_line_item_id: typing.Optional[str] = None,
        ...
        return self._regenerate_booking_transaction_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class RegenerateBookingTransaction(BaseApi):
    ...
    async def aregenerate_booking_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RegenerateTransactionObjectResponsePydantic:
        raw_response = await self.raw.aregenerate_booking_transaction(
            authorization=authorization,
            item_number=item_number,
            order_line_item_id=order_line_item_id,
            order_number=order_number,
        ...
        if validate:
            return RegenerateTransactionObjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RegenerateTransactionObjectResponsePydantic, raw_response.body)
    ...
    def regenerate_booking_transaction(
        ...
        raw_response = self.raw.regenerate_booking_transaction(
            authorization=authorization,
            item_number=item_number,
            order_line_item_id=order_line_item_id,
            order_number=order_number,
