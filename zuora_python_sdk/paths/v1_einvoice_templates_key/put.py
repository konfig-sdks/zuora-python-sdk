...
from zuora_python_sdk.model.update_e_invoice_file_template_request import UpdateEInvoiceFileTemplateRequest as UpdateEInvoiceFileTemplateRequestSchema

from zuora_python_sdk.type.update_e_invoice_file_template_request import UpdateEInvoiceFileTemplateRequest
from zuora_python_sdk.type.get_e_invoice_file_template_response import GetEInvoiceFileTemplateResponse

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.update_e_invoice_file_template_request import UpdateEInvoiceFileTemplateRequest as UpdateEInvoiceFileTemplateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEInvoiceFileTemplateRequestSchema


request_body_update_e_invoice_file_template_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _e_invoice_file_template_0_mapped_args(
        self,
        key: str,
    ...
    async def _ae_invoice_file_template_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/einvoice/templates/{key}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_e_invoice_file_template_request.serialize(body, content_type)
    ...
    def _e_invoice_file_template_0_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class EInvoiceFileTemplate0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ae_invoice_file_template_0(
        self,
        key: str,
        content: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._e_invoice_file_template_0_mapped_args(
            body=body,
            key=key,
            content=content,
            country=country,
        ...
        return await self._ae_invoice_file_template_0_oapg(
            body=args.body,
    ...
    def e_invoice_file_template_0(
        ...
        return self._e_invoice_file_template_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class EInvoiceFileTemplate0(BaseApi):
    ...
    async def ae_invoice_file_template_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ae_invoice_file_template_0(
            body=body,
            key=key,
            content=content,
            country=country,
    ...
    def e_invoice_file_template_0(
        ...
        raw_response = self.raw.e_invoice_file_template_0(
            body=body,
            key=key,
            content=content,
            country=country,
