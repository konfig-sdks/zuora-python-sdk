...
from zuora_python_sdk.model.post_settle_payment_response import POSTSettlePaymentResponse as POSTSettlePaymentResponseSchema
from zuora_python_sdk.model.post_settle_payment_request import POSTSettlePaymentRequest as POSTSettlePaymentRequestSchema

from zuora_python_sdk.type.post_settle_payment_response import POSTSettlePaymentResponse
from zuora_python_sdk.type.post_settle_payment_request import POSTSettlePaymentRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.post_settle_payment_response import POSTSettlePaymentResponse as POSTSettlePaymentResponsePydantic
from zuora_python_sdk.pydantic.post_settle_payment_request import POSTSettlePaymentRequest as POSTSettlePaymentRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTSettlePaymentRequestSchema


request_body_post_settle_payment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = POSTSettlePaymentResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: POSTSettlePaymentResponse
...
class BaseApi(api_client.Api):
    ...
    def _settle_payment_mapped_args(
        self,
        payment_key: str,
    ...
    async def _asettle_payment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/gateway-settlement/payments/{payment-key}/settle',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_settle_payment_request.serialize(body, content_type)
...
class SettlePaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asettle_payment(
        self,
        payment_key: str,
        gateway_reconciliation_reason: typing.Optional[str] = None,
        gateway_reconciliation_status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._settle_payment_mapped_args(
        ...
        return await self._asettle_payment_oapg(
            body=args.body,
    ...
    def settle_payment(
        ...
        return self._settle_payment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class SettlePayment(BaseApi):
    ...
    async def asettle_payment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> POSTSettlePaymentResponsePydantic:
        raw_response = await self.raw.asettle_payment(
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
            payout_id=payout_id,
        ...
        if validate:
            return POSTSettlePaymentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(POSTSettlePaymentResponsePydantic, raw_response.body)
    ...
    def settle_payment(
        ...
        raw_response = self.raw.settle_payment(
            payment_key=payment_key,
            gateway_reconciliation_reason=gateway_reconciliation_reason,
            gateway_reconciliation_status=gateway_reconciliation_status,
            payout_id=payout_id,
