...
from zuora_python_sdk.model.get_subscription_wrapper import GETSubscriptionWrapper as GETSubscriptionWrapperSchema

from zuora_python_sdk.type.get_subscription_wrapper import GETSubscriptionWrapper

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.get_subscription_wrapper import GETSubscriptionWrapper as GETSubscriptionWrapperPydantic
...
SchemaFor200ResponseBodyApplicationJson = GETSubscriptionWrapperSchema
...
class BaseApi(api_client.Api):
    ...
    def _subscriptions_by_account_mapped_args(
        self,
        account_key: str,
    ...
    async def _asubscriptions_by_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriptions/accounts/{account-key}',
            headers=_headers,
        )
    ...
    def _subscriptions_by_account_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SubscriptionsByAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubscriptions_by_account(
        self,
        account_key: str,
        accept_encoding: typing.Optional[str] = None,
        content_encoding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._subscriptions_by_account_mapped_args(
        ...
        return await self._asubscriptions_by_account_oapg(
    ...
    def subscriptions_by_account(
        ...
        return self._subscriptions_by_account_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class SubscriptionsByAccount(BaseApi):
    ...
    async def asubscriptions_by_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GETSubscriptionWrapperPydantic:
        raw_response = await self.raw.asubscriptions_by_account(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
        ...
        if validate:
            return GETSubscriptionWrapperPydantic(**raw_response.body)
        return api_client.construct_model_instance(GETSubscriptionWrapperPydantic, raw_response.body)
    ...
    def subscriptions_by_account(
        ...
        raw_response = self.raw.subscriptions_by_account(
            account_key=account_key,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
            authorization=authorization,
