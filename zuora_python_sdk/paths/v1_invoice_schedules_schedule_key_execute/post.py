...
from zuora_python_sdk.model.post_execute_invoice_schedule_request import POSTExecuteInvoiceScheduleRequest as POSTExecuteInvoiceScheduleRequestSchema
from zuora_python_sdk.model.execute_invoice_schedule_bill_run_response import ExecuteInvoiceScheduleBillRunResponse as ExecuteInvoiceScheduleBillRunResponseSchema

from zuora_python_sdk.type.execute_invoice_schedule_bill_run_response import ExecuteInvoiceScheduleBillRunResponse
from zuora_python_sdk.type.post_execute_invoice_schedule_request import POSTExecuteInvoiceScheduleRequest

from ...api_client import Dictionary
from zuora_python_sdk.pydantic.execute_invoice_schedule_bill_run_response import ExecuteInvoiceScheduleBillRunResponse as ExecuteInvoiceScheduleBillRunResponsePydantic
from zuora_python_sdk.pydantic.post_execute_invoice_schedule_request import POSTExecuteInvoiceScheduleRequest as POSTExecuteInvoiceScheduleRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = POSTExecuteInvoiceScheduleRequestSchema


request_body_post_execute_invoice_schedule_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExecuteInvoiceScheduleBillRunResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ExecuteInvoiceScheduleBillRunResponse
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'autoEmail': api_client.MediaType(),
        'autoPost': api_client.MediaType(),
        'autoRenewal': api_client.MediaType(),
        'billRunFilters': api_client.MediaType(),
        'billRunNumber': api_client.MediaType(),
        'createdById': api_client.MediaType(),
        'createdDate': api_client.MediaType(),
        'id': api_client.MediaType(),
        'invoiceDate': api_client.MediaType(),
        'noEmailForZeroAmountInvoice': api_client.MediaType(),
        'status': api_client.MediaType(),
        'success': api_client.MediaType(),
        'targetDate': api_client.MediaType(),
        'updatedById': api_client.MediaType(),
        'updatedDate': api_client.MediaType(),
    },
    headers=[
...
class BaseApi(api_client.Api):
    ...
    def _execute_invoice_schedule_mapped_args(
        self,
        body: POSTExecuteInvoiceScheduleRequest,
        schedule_key: str,
        schedule_item_id: typing.Optional[str] = None,
        ...
        if schedule_item_id is not None:
            _body["scheduleItemId"] = schedule_item_id
    ...
    async def _aexecute_invoice_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/invoice-schedules/{scheduleKey}/execute',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_post_execute_invoice_schedule_request.serialize(body, content_type)
    ...
    def _execute_invoice_schedule_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ExecuteInvoiceScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexecute_invoice_schedule(
        self,
        body: POSTExecuteInvoiceScheduleRequest,
        schedule_key: str,
        schedule_item_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._execute_invoice_schedule_mapped_args(
            body=body,
        ...
        return await self._aexecute_invoice_schedule_oapg(
            body=args.body,
    ...
    def execute_invoice_schedule(
        ...
        return self._execute_invoice_schedule_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ExecuteInvoiceSchedule(BaseApi):
    ...
    async def aexecute_invoice_schedule(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExecuteInvoiceScheduleBillRunResponsePydantic:
        raw_response = await self.raw.aexecute_invoice_schedule(
            body=body,
            schedule_key=schedule_key,
            schedule_item_id=schedule_item_id,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return RootModel[ExecuteInvoiceScheduleBillRunResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ExecuteInvoiceScheduleBillRunResponsePydantic, raw_response.body)
    ...
    def execute_invoice_schedule(
        ...
        raw_response = self.raw.execute_invoice_schedule(
            body=body,
            schedule_key=schedule_key,
            schedule_item_id=schedule_item_id,
            idempotency_key=idempotency_key,
