...
class PUTPublicEmailTemplateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "active", "bccEmailAddress", "ccEmailAddress", "ccEmailType", "emailBody", "emailSubject", "encodingType", "fromEmailAddress", "fromEmailType", "fromName", "isHtml", "name", "replyToEmailAddress", "replyToEmailType", "toEmailAddress", "toEmailType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "active", "bccEmailAddress", "ccEmailAddress", "ccEmailType", "emailBody", "emailSubject", "encodingType", "fromEmailAddress", "fromEmailType", "fromName", "isHtml", "name", "replyToEmailAddress", "replyToEmailType", "toEmailAddress", "toEmailType", ], str]):
