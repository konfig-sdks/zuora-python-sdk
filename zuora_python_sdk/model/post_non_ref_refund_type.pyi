...
class PostNonRefRefundType(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class customRates(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['CreditMemoFromChargeCustomRatesType']:
                                return CreditMemoFromChargeCustomRatesType
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['CreditMemoFromChargeCustomRatesType'], typing.List['CreditMemoFromChargeCustomRatesType']],
                        ...
                        def __getitem__(self, i: int) -> 'CreditMemoFromChargeCustomRatesType':
                    ...
                    class financeInformation(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["bankAccountAccountingCode", "onAccountAccountingCode", "transferredToAccounting", "unappliedPaymentAccountingCode", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bankAccountAccountingCode", "onAccountAccountingCode", "transferredToAccounting", "unappliedPaymentAccountingCode", ], str]):
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['RefundCreditMemoItemType']:
                                return RefundCreditMemoItemType
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['RefundCreditMemoItemType'], typing.List['RefundCreditMemoItemType']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'items':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'RefundCreditMemoItemType':
                            return super().__getitem__(i)
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["comment", "customRates", "financeInformation", "gatewayId", "gatewayOptions", "items", "methodType", "paymentMethodId", "reasonCode", "referenceId", "refundDate", "secondRefundReferenceId", "softDescriptor", "softDescriptorPhone", "totalAmount", "type", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["comment", "customRates", "financeInformation", "gatewayId", "gatewayOptions", "items", "methodType", "paymentMethodId", "reasonCode", "referenceId", "refundDate", "secondRefundReferenceId", "softDescriptor", "softDescriptorPhone", "totalAmount", "type", ], str]):
                return super().get_item_oapg(name)
