...
class POSTSettlePaymentResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def financeInformation() -> typing.Type['POSTSettlePaymentResponseFinanceInformation']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["financeInformation"]) -> 'POSTSettlePaymentResponseFinanceInformation': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId", "amount", "appliedAmount", "authTransactionId", "bankIdentificationNumber", "cancelledOn", "comment", "createdById", "createdDate", "creditBalanceAmount", "currency", "effectiveDate", "financeInformation", "gatewayId", "gatewayOrderId", "gatewayReconciliationReason", "gatewayReconciliationStatus", "gatewayResponse", "gatewayResponseCode", "gatewayState", "id", "markedForSubmissionOn", "number", "organizationLabel", "paymentMethodId", "paymentMethodSnapshotId", "payoutId", "referenceId", "refundAmount", "secondPaymentReferenceId", "settledOn", "softDescriptor", "softDescriptorPhone", "status", "submittedOn", "success", "type", "unappliedAmount", "updatedById", "updatedDate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["financeInformation"]) -> typing.Union['POSTSettlePaymentResponseFinanceInformation', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        financeInformation: typing.Union['POSTSettlePaymentResponseFinanceInformation', schemas.Unset] = schemas.unset,
