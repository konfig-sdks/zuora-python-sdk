...
class PUTProductChargeDefinitionRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["billingPeriod", "billingTiming", "chargeModel", "defaultQuantity", "effectiveEndDate", "effectiveStartDate", "listPriceBase", "prices", "specificBillingPeriod", "specificListPriceBase", "taxCode", "taxMode", "taxable", "term", "termPeriodType", "termType", "uom", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["billingPeriod", "billingTiming", "chargeModel", "defaultQuantity", "effectiveEndDate", "effectiveStartDate", "listPriceBase", "prices", "specificBillingPeriod", "specificListPriceBase", "taxCode", "taxMode", "taxable", "term", "termPeriodType", "termType", "uom", ], str]):
