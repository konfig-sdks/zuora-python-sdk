...
If the `autoPay` field is set to `true`, you must provide one of the `paymentMethod`, `creditCard`, or `hpmCreditCardPaymentMethodId` field, but not multiple.
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class cardHolderInfo(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["addressLine1", "addressLine2", "cardHolderName", "city", "country", "email", "phone", "state", "zipCode", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["addressLine1", "addressLine2", "cardHolderName", "city", "country", "email", "phone", "state", "zipCode", ], str]):
            ...
            cardType: MetaOapg.properties.cardType
            cardHolderInfo: MetaOapg.properties.cardHolderInfo
            expirationMonth: MetaOapg.properties.expirationMonth
            cardNumber: MetaOapg.properties.cardNumber
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["cardHolderInfo"]) -> MetaOapg.properties.cardHolderInfo: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["cardHolderInfo", "cardNumber", "cardType", "expirationMonth", "expirationYear", "securityCode", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["cardHolderInfo"]) -> MetaOapg.properties.cardHolderInfo: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["cardNumber"]) -> MetaOapg.properties.cardNumber: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["cardType"]) -> MetaOapg.properties.cardType: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cardHolderInfo", "cardNumber", "cardType", "expirationMonth", "expirationYear", "securityCode", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                expirationYear: typing.Union[MetaOapg.properties.expirationYear, str, ],
                cardType: typing.Union[MetaOapg.properties.cardType, str, ],
                cardHolderInfo: typing.Union[MetaOapg.properties.cardHolderInfo, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                expirationMonth: typing.Union[MetaOapg.properties.expirationMonth, str, ],
