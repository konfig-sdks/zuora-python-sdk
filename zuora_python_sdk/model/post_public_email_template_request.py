...
class POSTPublicEmailTemplateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["emailBody", "emailSubject", "fromEmailType", "name", "toEmailType", "description", "active", "bccEmailAddress", "ccEmailAddress", "ccEmailType", "encodingType", "eventCategory", "eventTypeName", "eventTypeNamespace", "fromEmailAddress", "fromName", "isHtml", "replyToEmailAddress", "replyToEmailType", "toEmailAddress", ], str]):
