...
class CustomObjectAllFieldsDefinition(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class CreatedById(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "label", "origin", "type", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "label", "origin", "type", ], str]):
                    ...
                    class CreatedDate(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "origin", "type", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "origin", "type", ], str]):
                            return super().get_item_oapg(name)
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["CreatedById", "CreatedDate", "Id", "UpdatedById", "UpdatedDate", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CreatedById", "CreatedDate", "Id", "UpdatedById", "UpdatedDate", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                cls,
                *args: typing.Union[dict, frozendict.frozendict, ],
                CreatedById: typing.Union[MetaOapg.properties.CreatedById, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                CreatedDate: typing.Union[MetaOapg.properties.CreatedDate, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                Id: typing.Union[MetaOapg.properties.Id, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                UpdatedById: typing.Union[MetaOapg.properties.UpdatedById, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                UpdatedDate: typing.Union[MetaOapg.properties.UpdatedDate, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_0':
                return super().__new__(
