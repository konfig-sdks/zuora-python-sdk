        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    glAccountName = schemas.StrSchema
                    glAccountNumber = schemas.StrSchema
                    ...
                    class type(
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                ...
                                "On-Account Receivable": "ONACCOUNT_RECEIVABLE",
                                "Cash": "CASH",
                                "OtherAssets": "OTHER_ASSETS",
                                "CustomerCashOnAccount": "CUSTOMER_CASH_ON_ACCOUNT",
                        ...
                        @schemas.classproperty
                        def ACCOUNTS_RECEIVABLE(cls):
                            return cls("AccountsReceivable")
                        
                        @schemas.classproperty
                        def ONACCOUNT_RECEIVABLE(cls):
                            return cls("On-Account Receivable")
                        ...
                        @schemas.classproperty
                        def OTHER_ASSETS(cls):
                            return cls("OtherAssets")
                        
                        @schemas.classproperty
                        def CUSTOMER_CASH_ON_ACCOUNT(cls):
                            return cls("CustomerCashOnAccount")
                        
                        @schemas.classproperty
                        def DEFERRED_REVENUE(cls):
                            return cls("DeferredRevenue")
                        
                        @schemas.classproperty
                        def SALES_TAX_PAYABLE(cls):
                            return cls("SalesTaxPayable")
                        
                        @schemas.classproperty
                        def OTHER_LIABILITIES(cls):
                            return cls("OtherLiabilities")
                        
                        @schemas.classproperty
                        def SALES_REVENUE(cls):
                            return cls("SalesRevenue")
                        
                        @schemas.classproperty
                        def SALES_DISCOUNTS(cls):
                            return cls("SalesDiscounts")
                        
                        @schemas.classproperty
                        def OTHER_REVENUE(cls):
                            return cls("OtherRevenue")
                        
                        @schemas.classproperty
                        def OTHER_EQUITY(cls):
                            return cls("OtherEquity")
                        ...
                        @schemas.classproperty
                        def OTHER_EXPENSES(cls):
                            return cls("OtherExpenses")
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["glAccountName"]) -> MetaOapg.properties.glAccountName: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["category", "createdBy", "createdOn", "glAccountName", "glAccountNumber", "id", "name", "notes", "status", "success", "type", "updatedBy", "updatedOn", ], str]):
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["glAccountName"]) -> typing.Union[MetaOapg.properties.glAccountName, schemas.Unset]: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category", "createdBy", "createdOn", "glAccountName", "glAccountNumber", "id", "name", "notes", "status", "success", "type", "updatedBy", "updatedOn", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                glAccountName: typing.Union[MetaOapg.properties.glAccountName, str, schemas.Unset] = schemas.unset,
                glAccountNumber: typing.Union[MetaOapg.properties.glAccountNumber, str, schemas.Unset] = schemas.unset,
