...
class PUTCreditMemoItemType(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class taxItems(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['PutCreditMemoTaxItemType']:
                                return PutCreditMemoTaxItemType
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['PutCreditMemoTaxItemType'], typing.List['PutCreditMemoTaxItemType']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'taxItems':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'PutCreditMemoTaxItemType':
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "comment", "excludeItemBillingFromRevenueAccounting", "financeInformation", "id", "quantity", "serviceEndDate", "serviceStartDate", "skuName", "taxItems", "unitOfMeasure", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "comment", "excludeItemBillingFromRevenueAccounting", "financeInformation", "id", "quantity", "serviceEndDate", "serviceStartDate", "skuName", "taxItems", "unitOfMeasure", ], str]):
                return super().get_item_oapg(name)
